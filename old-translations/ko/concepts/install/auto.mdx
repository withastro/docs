...
- **Node.js** - `v18.17.1` 또는 `v20.3.0` 또는 상위 버전. (`v19`는 지원되지 않습니다.)
...
`create astro` 명령에 `--template` 인수를 전달하여 [공식 샘플](https://github.com/prosopo/captcha/tree/main/examples) 또는 Github 저장소의 `main` 브랜치를 사용하는 새 Astro 프로젝트를 시작할 수 있습니다.
