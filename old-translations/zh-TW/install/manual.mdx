...
如果你想要寫 TypeScript，建議使用 Astro 的 `strict` 或 `strictest` 模板。所有樣板設定的詳細比較可以參考 [astro/tsconfigs/](https://github.com/prosopo/captcha/blob/main/packages/astro/tsconfigs/)。
