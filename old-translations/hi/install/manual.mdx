...
यदि आप TypeScript कोड लिखने का इरादा रखते हैं, तो Astro के `strict` या `strictest` टेम्पलेट का उपयोग करने की अनुशंसा की जाती है। आप [astro/tsconfigs/](https://github.com/prosopo/captcha/blob/main/packages/astro/tsconfigs/) पर तीन टेम्पलेट कॉन्फ़िगरेशन की देख और तुलना कर सकते हैं।
