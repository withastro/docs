...
Si vous avez l'intention d'écrire du code TypeScript, l'utilisation du template Astro `strict` or `strictest` est recommandé. Vous pouvez voir et comparer les trois configurations de template à [astro/tsconfigs/](https://github.com/prosopo/captcha/blob/main/packages/astro/tsconfigs/).
