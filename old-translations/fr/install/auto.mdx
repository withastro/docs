---
title: Installation d'Astro avec le CLI automatique
description: "Comment installer Astro avec NPM, PNPM, ou Yarn via l'outil de création create-astro inclus avec le CLI."
---
...
- **Node.js** - version `v18.17.1` ou `v20.3.0` ou supérieure. ( `v19` n'est pas supportée.)
...
Vous pouvez également démarrer un nouveau projet astro basé sur un [exemple officiel](https://github.com/prosopo/captcha/tree/main/examples) ou sur la branche `main` de n'importe quel dépôt GitHub en passant un argument `--template` à la commande `create astro`.
