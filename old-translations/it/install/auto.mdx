...
Puoi anche iniziare un nuovo progetto Astro partendo da un [esempio ufficiale](https://github.com/prosopo/captcha/tree/main/examples) o dal ramo `main` di una qualunque repository di GitHub passando l'argomento `--template` al comando `create astro`.
