...
- **Node.js** - `v18.17.1` oppure `v20.3.0` o superiore. ( `v19` non è supportata.)
...
Se intendi scrivere codice TypeScript, è consigliato usare i template `strict` o `strictest` di Astro. Puoi vedere e confrontare i tre template di configurazione all'indirizzo [astro/tsconfigs/](https://github.com/prosopo/captcha/blob/main/packages/astro/tsconfigs/).
