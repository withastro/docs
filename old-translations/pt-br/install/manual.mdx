...
Se você pretende escrever código TypeScript, usar o template `strict` ou `strictest` do Astro é recomendado. Você pode ver e comparar as três configurações de template em [astro/tsconfigs/](https://github.com/prosopo/captcha/blob/main/packages/astro/tsconfigs/).
