...
Se tudo ocorrer bem, Astro deve estar servindo o seu projeto em [http://localhost:4321](http://localhost:4321)!
...
📚 **Entenda sua base de código:** Aprenda mais sobre a estrutura de projetos do Astro em nosso [guia de Estrutura de Projetos](/pt-br/basics/project-structure/).
