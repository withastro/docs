...
将 Bun 与 Astro 结合使用仍处于实验阶段。某些整合可能无法如预期般工作。如果你在[使用 Bun 时遇到任何问题](https://github.com/oven-sh/bun/issues/new/choose)，请在 [GitHub 上提交一个 issue](https://github.com/prosopo/captcha/issues/new/choose)！
...
:::note[注意]
某些集成可能无法如预期般工作。如果你发现任何问题，请在 [GitHub 上提交一个 issue](https://github.com/prosopo/captcha/issues/new/choose)！
:::
