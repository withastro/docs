...
:::note[将在 v3.0 中弃用]
Astro v3 将不再主动支持 [`@astrojs/image`](https://github.com/prosopo/captcha/tree/main/packages/integrations/image) 集成
...
有关在 Astro v2 中使用 `@astrojs/image` 的文档，请参阅 [`@astrojs/image` 文档](https://github.com/prosopo/captcha/blob/main/packages/integrations/image/README.md)
