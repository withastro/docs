...
Puedes empezar un nuevo proyecto de Astro basado en un [ejemplo oficial](https://github.com/prosopo/captcha/tree/main/examples) o en la rama `main` de cualquier repositorio de GitHub pasando un argumento `--template` al comando `create astro`.
