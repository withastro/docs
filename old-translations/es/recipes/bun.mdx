...
:::note[Nota]
Algunas integraciones pueden no funcionar como se espera. Si encuentras algún problema, por favor [abre un issue en GitHub](https://github.com/prosopo/captcha/issues/new/choose).
:::
