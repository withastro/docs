...
To install manually instead, see our [step-by-step manual installation guide](#manual-setup).
...
<ReadMore>Read more about [the Astro CLI](/reference/cli-reference/) and the terminal commands you will use as you build with Astro.</ReadMore>
