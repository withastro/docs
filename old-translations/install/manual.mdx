...
Follow the [create astro CLI wizard](/en/install-and-setup/) instead.
:::
...
If you followed this guide completely, you can jump directly to [Step 2: Start Astro](/install-and-setup/#start-the-astro-dev-server) to continue and learn how to run Astro for the first time.
