export class CopyButton {
	...
	constructor(codeHtmlLines: string[], copyButtonTitle: string) {
		this.codeLines = codeHtmlLines;
		this.code = '';
		this.title = copyButtonTitle;
