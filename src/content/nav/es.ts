...
export default navDictionary({
	...
	'guides.recipes': 'Recetas de cómo hacer',

	reference: 'Referencia',
	'reference.runtime': 'API de ejecución',
	'reference.other': 'Otras APIs de desarrollo',
	'reference.syntax': 'Sintaxis de Plantilla de Astro',
	...
	'thirdParty.cms': 'Sistemas de manejo de contenido',
	'thirdParty.backend': 'Servicio Backend',
