...
브라우저에서 사이트를 확인할 때, [Astro 개발 툴바](/ko/reference/configuration-reference/#dev-toolbar-options)를 사용할 수 있습니다. 이는 빌드하면서 [아일랜드](/ko/concepts/islands/)를 검사하고, 접근성 문제 등을 발견하는 데 도움이 됩니다.
