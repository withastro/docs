...
프로젝트에 React, Svelte 등과 같은 [UI 프레임워크 컴포넌트](/ko/basics/framework-components/)를 포함하거나 Tailwind 또는 Partytown과 같은 다른 도구를 사용하려는 경우 이 파일에서 [직접 통합을 가져오고 구성](/ko/guides/integrations-guide/)할 수 있습니다.
