...
**타입:** <code>(options: <a href="/ko/reference/modules/astro-assets/#imagetransform">ImageTransform</a>, imageConfig: <a href="/ko/reference/configuration-reference/#image-options">AstroConfig['image']</a>) => string | Promise\<string\></code><br />
<Since v="2.1.0" />
</p>
...
**타입:** <code>(url: URL, imageConfig: <a href="/ko/reference/configuration-reference/#image-options">AstroConfig['image']</a>) => \{ src: string, [key: string]: any \} | undefined | Promise\<\{ src: string, [key: string]: any \}\> | Promise\<undefined\></code><br />
<Since v="2.1.0" />
</p>
...
**타입:** <code>(inputBuffer: Uint8Array, options: \{ src: string, [key: string]: any \}, imageConfig: <a href="/ko/reference/configuration-reference/#image-options">AstroConfig['image']</a>) => Promise\<\{ data: Uint8Array; format: <a href="/ko/reference/modules/astro-assets/#imageoutputformat">ImageOutputFormat</a> \}\></code><br />
<Since v="2.1.0" />
</p>
...
**타입:** <code>(options: <a href="/ko/reference/modules/astro-assets/#imagetransform">ImageTransform</a>, imageConfig: <a href="/ko/reference/configuration-reference/#image-options">AstroConfig['image']</a> ) => Record\<string, any\> | Promise\<Record\<string, any\>\></code><br />
<Since v="2.1.0" />
</p>
...
**타입:** <code>(options: <a href="/ko/reference/modules/astro-assets/#imagetransform">ImageTransform</a>, imageConfig: <a href="/ko/reference/configuration-reference/#image-options">AstroConfig['image']</a> ) => UnresolvedSrcSetValue[] | Promise\<UnresolvedSrcSetValue[]\></code><br />
<Since v="3.3.0" />
</p>
...
**타입:** <code>(options: <a href="/ko/reference/modules/astro-assets/#imagetransform">ImageTransform</a>, imageConfig: <a href="/ko/reference/configuration-reference/#image-options">AstroConfig['image']</a> ) => ImageTransform | Promise\<ImageTransform\></code>
<Since v="2.1.4" />
</p>
