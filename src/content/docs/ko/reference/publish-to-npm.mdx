...
:::tip
키워드는 [통합 라이브러리](https://astro.build/integrations/)에서도 사용됩니다! NPM에서 찾는 키워드의 전체 목록은 [아래를 참조하세요](#integrations-library).
:::
...
#### 예: 명명된 가져오기 사용 \{#example-using-named-imports\}
...
#### 예: 네임스페이스 가져오기 사용 \{#example-using-namespace-imports\}
...
#### 예: 개별 가져오기 사용 \{#example-using-individual-imports\}
...
## 패키지 개발 \{#developing-your-package\}
...
## 컴포넌트 테스트 \{#testing-your-component\}
...
## 컴포넌트 게시 \{#publishing-your-component\}
...
### `package.json` 데이터 \{#packagejson-data\}
