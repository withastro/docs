...
<ReadMore>사용자 정의 사전 렌더러 구현에 대한 자세한 내용은 [어댑터 참조](/ko/reference/adapter-reference/)를 확인하세요.</ReadMore>
...
어댑터가 페이지 사전 렌더링을 제어하기 위해 제공할 수 있는 [사용자 정의 사전 렌더러](/ko/reference/adapter-reference/)를 설명합니다.
...
CSP 지시어를 `meta` 요소로 삽입할지, 응답 `header`로 삽입할지, [응답 헤더 설정을 지원하는 어댑터](/ko/reference/adapter-reference/)를 통해 삽입할지 여부를 지정합니다.
