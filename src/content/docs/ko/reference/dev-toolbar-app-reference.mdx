...
[Astro 통합](/ko/reference/configuration-reference/#통합)은 `addDevToolbarApp` 메서드를 사용하여 [`astro:config:setup` 후크](/ko/reference/integrations-reference/#astroconfigsetup)에 앱을 추가할 수 있습니다.
