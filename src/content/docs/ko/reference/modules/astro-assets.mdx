...
Astro 설정에 등록된 [`cssVariable`](/ko/reference/configuration-reference/#fontcssvariable)입니다:
...
모든 글꼴 링크를 항상 미리 로드하고 싶지 않을 수 있습니다. 이는 다른 중요한 리소스 로드를 차단하거나 현재 페이지에 필요하지 않은 글꼴을 다운로드할 수 있기 때문입니다.
