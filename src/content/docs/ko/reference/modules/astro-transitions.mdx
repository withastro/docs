...
다음 가져오기 항목들은 v6에서 사용 중단될 예정입니다. 프로젝트에서 계속 사용할 수 있지만, 지금 코드를 업데이트하는 것이 좋습니다.
...
:::caution[사용 중단 예정]
이 함수는 v6에서 사용 중단될 예정입니다. 프로젝트에서 계속 사용할 수 있지만, 지금 코드를 업데이트하는 것이 좋습니다.
:::
