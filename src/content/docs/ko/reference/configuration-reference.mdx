...
빌드 어댑터를 사용하여 선호하는 서버, 서버리스, 에지 호스트에 배포하세요. Astro SSR을 사용하려면 [Netlify](/ko/guides/deploy/netlify/#요청-시-렌더링을-위한-어댑터), [Vercel](/ko/guides/deploy/vercel/#요청-시-렌더링을-위한-어댑터) 등을 위한 자사 어댑터 중 하나를 가져오세요.
