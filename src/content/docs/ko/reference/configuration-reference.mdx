...
```
 ...
 이 기능은 안정적이며 실험적인 것으로 간주되지 않습니다. 그러나 이 기능은 어려운 성능 문제를 해결하기 위한 용도로만 사용되며, 이 옵션의 성능을 최대한 유지하기 위해 [마이너 릴리스](/en/upgrade-astro/#semantic-versioning)에서 주요 변경 사항이 발생할 수 있습니다. 이 기능을 사용하는 경우 모든 마이너 릴리스에 대한 [Astro 변경 로그](https://github.com/withastro/astro/blob/refs/heads/next/packages/astro/CHANGELOG.md)를 확인하시기 바랍니다.
 :::
