...
반응형 이미지의 기본 [`object-position` CSS 속성 값](https://developer.mozilla.org/ko/docs/Web/CSS/object-position)입니다. 개별 이미지 컴포넌트의 `position` prop을 사용하여 재정의할 수 있습니다. `layout`의 값을 먼저 설정해야 합니다.
