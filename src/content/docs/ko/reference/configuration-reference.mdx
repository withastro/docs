...
다음 구성의 경우, `src/pages/en/about.astro` 파일은 있지만 `src/pages/fr/about.astro`가 없는 경우 `astro build` 명령은 `dist/en/index.html` 페이지와 동일한 내용의 `dist/fr/about.html`을 생성합니다.
