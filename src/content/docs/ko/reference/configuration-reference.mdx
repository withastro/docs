...
`srcDir` 내의 fetch 엔트리포인트 파일을 사용자 지정합니다.
...
요청 파이프라인 사용자 지정에 대한 자세한 내용은 [고급 라우팅 가이드](/ko/guides/routing/#고급-라우팅)를 참조하세요.
...
기본적으로 Astro는 콘솔에 사람이 읽기 쉬운 형식의 로그를 출력하는 내장 로거를 사용합니다. [사용자 지정 로거 핸들러](/ko/reference/logger-reference/#사용자-지정-로거)를 제공하거나 [내장 로거 핸들러](/ko/reference/logger-reference/#내장-로거) 중 하나를 사용하여 이 동작을 사용자 지정할 수 있습니다.
