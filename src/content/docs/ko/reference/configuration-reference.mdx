...
Astro v7.2.0부터 이 옵션을 `false`로 설정하여 세션 지원을 비활성화할 수 있습니다. 세션을 비활성화하면 세션 런타임이 SSR 번들에서 제외되고, 어댑터는 기본 세션 드라이버를 구성하지 않습니다. 이는 번들 파싱 시간이 중요한 서버리스 및 엣지 런타임에서 유용합니다.
...
Markdown 가이드에서 [Markdown 프로세서 설정하기](/ko/guides/markdown-content/#markdown-프로세서-설정하기) 및 [기본 제공 기능 사용하기](/ko/guides/markdown-content/#기본-제공-기능)에 대해 자세히 알아보세요.
:::
