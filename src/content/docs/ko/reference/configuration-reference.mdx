...
사용자 정의 도메인 (또는 하위 도메인)을 사용하도록 하나 이상의 지원 언어의 URL 패턴을 구성할 수 있는 [실험적 `domains` 라우팅 전략](/ko/guides/internationalization/#domains-experimental)에 대한 지원을 활성화합니다.
...
이 실험적 기능의 제한 사항을 포함한 자세한 내용은 [국제화 가이드](/ko/guides/internationalization/#domains-experimental)를 참조하세요.
