...
<ReadMore>Astro 프로젝트에서 캐싱을 사용하는 방법에 대한 자세한 내용은 [캐싱 가이드](/ko/guides/caching/)를 참조하세요.</ReadMore>
...
```astro title="src/pages/index.astro"
---
Astro.logger.error("결제 ID를 찾을 수 없습니다.");
---
```
...
```astro title="src/pages/index.astro"
---
Astro.logger.warn("결제 ID를 찾을 수 없습니다.");
---
```  
...
```astro title="src/pages/index.astro"
---
Astro.logger.info("결제 ID를 찾을 수 없습니다.");
---
```
