...
[블로그 만들기 개요 튜토리얼](/ko/tutorial/0-introduction/)에서 Astro의 [내장된 파일 기반 라우팅](/ko/core-concepts/routing/#static-routes)에 대해 배웠습니다. `src/pages/` 폴더 내 모든 `.astro`, `.md`, `.mdx` 파일은 자동으로 사이트의 새 페이지가 됩니다.
...
8. 블로그 게시물 설명에 더 긴 페이드인을 추가하세요.
    ...
    📚 다양한 [전환 지시어](/ko/guides/view-transitions/#transition-directives) 및 [애니메이션 맞춤설정](/ko/guides/view-transitions/#customizing-animations)에 대해 자세히 알아보세요.
