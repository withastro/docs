...
<Steps>
1. 날짜와 시간을 조작하고 형식을 지정하기 위한 [`Day.js`](https://www.npmjs.com/package/dayjs)와, [`unified()` 프로세서](/ko/guides/markdown-content/#remark-및-rehype-플러그인-사용하기)를 사용하기 위한 [`@astrojs/markdown-remark`](https://www.npmjs.com/package/@astrojs/markdown-remark)를 설치합니다:
