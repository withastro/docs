...
1. 도우미 패키지 설치
   ...
   [`unified()` 프로세서](/ko/guides/markdown-content/#remark-및-rehype-플러그인-사용하기)를 사용하려면 [`@astrojs/markdown-remark`](https://www.npmjs.com/package/@astrojs/markdown-remark)를 설치하세요:
