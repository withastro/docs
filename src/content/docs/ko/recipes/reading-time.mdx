...
1. 다음 패키지들을 설치하세요:
    ...
    - [`unified()` 프로세서](/ko/guides/markdown-content/#remark-및-rehype-플러그인-사용하기)를 사용하기 위한 [`@astrojs/markdown-remark`](https://www.npmjs.com/package/@astrojs/markdown-remark)
