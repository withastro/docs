...
:::tip[Astro 액션으로 양식 작성하기]
Astro는 v4.15에서 양식 데이터 유효성 검사, 양식 제출에 따른 UI 업데이트 등 기본 HTML 양식에 비해 몇 가지 이점을 제공하는 액션을 추가했습니다. 대신 이 방법을 사용하여 양식을 작성하려면 [액션 가이드](/ko/guides/actions/)를 참조하여 이러한 기능에 대해 자세히 알아보세요.
:::
