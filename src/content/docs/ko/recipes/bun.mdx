...
Bun은 [Node.js API 호환성](https://bun.sh/docs/runtime/nodejs-apis)을 제공하므로 Astro 프로젝트에서 [서버 측 렌더링](/ko/guides/server-side-rendering/)을 위한 모든 Astro 어댑터를  사용할 수 있습니다:
