...
[Zed](https://zed.dev/)는 고성능 오픈 소스 코드 편집기입니다. IDE의 Extensions 탭에서 [Astro 확장](https://github.com/zed-extensions/astro)을 설치할 수 있습니다. 이 확장에는 구문 강조 표시, 코드 완성 및 포맷팅과 같은 기능이 포함되어 있습니다.
