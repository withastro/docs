...
[Zed](https://zed.dev/)는 버전 0.123.2에서 Astro에 대한 지원을 추가한 오픈 소스 코드 편집기입니다. IDE의 Extensions 탭에서 [Astro 확장](https://github.com/zed-extensions/astro)을 설치할 수 있습니다. 이 확장에는 구문 강조, 코드 완성, 포매팅과 같은 기능이 포함되어 있습니다.
