...
Astro 컴포넌트가 클라이언트 측에서 상호작용을 해야하는 경우, Astro 컴포넌트에 [표준 HTML `<script>` 태그](/ko/guides/client-side-scripts/)를 추가하거나, [UI 프레임워크 컴포넌트](/ko/basics/framework-components/#인터랙티브-컴포넌트-하이드레이션하기)를 사용할 수 있습니다.
...
:::tip
명명된 슬롯에 [UI 프레임워크 컴포넌트](/ko/basics/framework-components/)를 전달할 수도 있습니다!
:::
...
<ReadMore>Astro 프로젝트에서 [UI 프레임워크 컴포넌트](/ko/basics/framework-components/)를 사용하는 방법에 대해 자세히 알아보세요.</ReadMore>