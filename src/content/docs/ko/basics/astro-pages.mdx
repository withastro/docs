...
[요청 시 렌더링](/ko/guides/server-side-rendering/#주문형-서버-렌더링-활성화)된 페이지에 대해 사용자 정의 500 오류 페이지를 표시하려면 `src/pages/500.astro` 파일을 생성하세요. 이 사용자 정의 페이지는 사전 렌더링된 페이지에서는 사용할 수 없으며 사전 렌더링할 수도 없습니다.
