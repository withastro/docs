...
- [UI 프레임워크 components (React 등)](/ko/basics/framework-components/)
...
**컴포넌트**는 재사용 가능한 HTML 코드 단위입니다. 이는 [Astro 컴포넌트](/ko/basics/astro-components/) 또는 React나 Vue와 같은 [UI 프레임워크 컴포넌트](/ko/basics/framework-components/)일 수 있습니다. 이 디렉터리에 모든 프로젝트 컴포넌트를 그룹화하고 구성하는 것이 일반적입니다.
