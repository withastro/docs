...
- [유지 관리되지 않는 v6.4.8 스냅샷](https://v6.docs.astro.build/ko/getting-started/)
- [유지 관리되지 않는 v5.18.0 스냅샷](https://v5.docs.astro.build/ko/getting-started/)
- [유지 관리되지 않는 v4.16.17 스냅샷](https://v4.docs.astro.build/ko/getting-started/)
- [유지 관리되지 않는 v3.6.3 스냅샷](https://web.archive.org/web/20231203051122/https://docs.astro.build/ko/getting-started/)
- [유지 관리되지 않는 v2.10.15 스냅샷](https://web.archive.org/web/20230822134745/https://docs.astro.build/en/getting-started)
...
- Node.js의 최소 **_Maintenance_ LTS** (동일한 주버전 범위와 함께, 예를 들어 `22.14.*`에서 `22.20.*`로) 버전 업그레이드는 Astro의 **부** 릴리스에서 발생할 수 있습니다.
