...
Astro 컴포넌트에 클라이언트 측 상호 작용이 필요한 경우에는 [standard HTML `<script>` tags](/ko/guides/client-side-scripts/)나 [UI Framework components](/ko/core-concepts/framework-components/#hydrating-interactive-components)를 추가할 수 있습니다. 자세한 내용은 링크에서 확인해 보세요.
