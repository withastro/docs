...
[콘텐츠 컬렉션](/ko/guides/content-collections/)에서 사용하기 위해 원격 Markdown을 가져오려면, [`renderMarkdown()` 함수](/ko/reference/content-loader-reference/)에 접근할 수 있는 [사용자 정의 로더](/ko/guides/content-collections/)를 구축할 수 있습니다.
