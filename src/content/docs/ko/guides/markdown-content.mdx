...
<ReadMore>Astro의 [파일 기반 라우팅](/ko/core-concepts/routing/) 또는 [동적 경로](/ko/core-concepts/routing/#동적-경로) 생성 옵션에 대해 자세히 알아보세요.</ReadMore>
...
<ReadMore>[Markdown 레이아웃](/ko/core-concepts/layouts/#markdownmdx-레이아웃)에 대해 자세히 알아보세요.</ReadMore>
