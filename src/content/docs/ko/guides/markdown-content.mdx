...
Astro의 Markdown 프로세서는 기본적으로 [Smartypants](https://daringfireball.net/projects/smartypants/)에 기반한 스마트 구두점을 지원합니다. 이 기능은 일반 따옴표를 곡선형 따옴표로, 하이픈 두 개를 em dash로, 마침표 세 개를 줄임표로 자동 변환합니다.
