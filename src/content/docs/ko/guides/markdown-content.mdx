...
<ReadMore>파일 가져오기 대신 [콘텐츠 컬렉션을 사용하는 경우](/ko/guides/content-collections/)에 대해 자세히 알아보세요.</ReadMore>
...
<ReadMore>[컬렉션 쿼리에서 반환된 콘텐츠 사용하기](/ko/guides/content-collections/)에 대해 자세히 알아보세요.</ReadMore>
...
[콘텐츠 컬렉션](/ko/guides/content-collections/)에서 사용하기 위해 원격 Markdown을 가져오려면, [`renderMarkdown()` 함수](/ko/reference/content-loader-reference/#loadercontextrendermarkdown)에 접근할 수 있는 [사용자 정의 로더](/ko/guides/content-collections/)를 구축할 수 있습니다.
