...
Markdown 프로세서는 Markdown 구문을 파싱하고 HTML로 렌더링합니다. [기본 제공 기능](#기본-제공-기능)을 제공하거나 [플러그인](#markdown-프로세서-플러그인)을 사용하여 Markdown의 기능을 확장할 수 있습니다.
...
각 프로세서는 동일한 [기본 제공 기능](#기본-제공-기능)을 제공하지만 아키텍처와 장점에 약간의 차이가 있습니다.
...
Astro는 [구문 강조](/ko/guides/syntax-highlighting/)와 Markdown 프로세서를 제어할 수 있는 [Markdown 구성 옵션](/ko/reference/configuration-reference/#markdown-옵션)을 제공합니다. 또한 각 Markdown 프로세서는 [구성 가능한 기능](#기본-제공-기능)을 제공하며, Markdown 렌더링을 사용자 지정할 [플러그인](#markdown-프로세서-플러그인)을 추가할 수 있습니다.
