...
- [server-side rendering](/ko/guides/server-side-rendering/)이 활성화 되어있는 Astro 프로젝트여야 합니다.
...
:::팁
Astro의 [환경 변수](/ko/guides/environment-variables/)와 `.env`에 대해 자세히 알아봅시다.
:::
...
- [Supabase가 초기화된](#Astro-에서-Supabase-초기화-하기) Astro 프로젝트여야 합니다.
