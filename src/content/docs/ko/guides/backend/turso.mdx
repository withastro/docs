...
## Astro에서 Turso 초기화 \{#initializing-turso-in-astro\}
...
### LibSQL 클라이언트 설치 \{#install-libsql-client\}
...
### 새 클라이언트 초기화 \{#initialize-a-new-client\}
...
## 데이터베이스 쿼리 \{#querying-your-database\}
