...
v3 문서를 확인해야 합니까? [이전 버전의 문서 사이트(관리되지 않는 v3.6 스냅샷)](https://web.archive.org/web/20231203051122/https://docs.astro.build/en/getting-started/)를 방문하세요.
...
v3.x 프로젝트에 대한 문서를 참조해야 하는 경우, [v4.0이 릴리스되기 전 문서의 (유지관리되지 않는) 스냅샷](https://web.archive.org/web/20231203051122/https://docs.astro.build/en/getting-started/)을 찾아볼 수 있습니다.
