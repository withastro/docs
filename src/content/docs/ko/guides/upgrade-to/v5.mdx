...
description: 프로젝트를 Astro v5.0으로 업그레이드하는 방법.
sidebar:
  label: v5.0
i18nReady: true
---
...
필요한 경우 [Astro 통합을 수동으로 업그레이드](/ko/guides/integrations/#수동-업그레이드)할 수도 있으며, 프로젝트의 다른 종속성도 업그레이드해야 할 수 있습니다.
...
<ReadMore>[Astro의 공식 통합](/ko/guides/integrations/)에 대해 자세히 알아보세요.</ReadMore>
...
<ReadMore>[Astro에서 Markdown 프로세서 플러그인 사용하기](/ko/guides/markdown-content/#markdown-프로세서-플러그인)에 대해 자세히 알아보세요.</ReadMore>
