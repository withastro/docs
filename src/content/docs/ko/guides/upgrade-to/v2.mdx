...
## Astro v2.0 중요한 변경 사항 \{#astro-v20-breaking-changes\}
...
### Node.js 14에 대한 지원 종료 \{#removed-support-for-node-14\}
...
### 변경됨: `src/content/` 예약 폴더 \{#reserved-srccontent\}
...
### 변경됨: `Astro.site`의 후행 슬래시 \{#changed-astrosite-trailing-slash\}
...
### 변경됨: `_astro/` 풀더 통합 \{#changed-_astro-folder-for-build-assets\}
...
### 변경됨: 마크다운 플러그인 설정 \{#changed-markdown-plugin-configuration\}

#### `extendDefaultPlugins` 삭제됨 \{#removed-extenddefaultplugins\}
...
#### 신기능: `gfm`과 `smartypants` \{#added-gfm-and-smartypants\}
...
### 변경됨: MDX 플러그인 설정 \{#changed-mdx-plugin-configuration\}

#### `extendPlugins` 문법이 `extendMarkdownConfig` 로 변경되었습니다. \{#replaced-extendplugins-changed-to-extendmarkdownconfig\}
...
#### Markdown과 일치하도록 더 많은 MDX 설정 옵션들이 추가되었습니다. \{#added-more-mdx-config-options-to-match-markdown\}
...
### 변경됨: frontmatter에 대한 플러그인 접근 방식 \{#changed-plugin-access-to-frontmatter\}
...
### 변경됨: RSS 설정 변경 \{#changed-rss-configuration\}
...
### 변경됨: Svelte IDE 지원 변경 \{#changed-svelte-ide-support\}
...
### 삭제됨: `legacy.astroFlavoredMarkdown` 삭제 \{#removed-legacyastroflavoredmarkdown\}
...
### 삭제됨: `Astro.resolve()` \{#removed-astroresolve\}
...
### 삭제됨: `Astro.fetchContent()` \{#removed-astrofetchcontent\}
...
### 삭제됨: `Astro.canonicalURL` \{#removed-astrocanonicalurl\}
...
## Astro v2.0 Experimental 지원 종료 \{#astro-v20-experimental-flags-removed\}
