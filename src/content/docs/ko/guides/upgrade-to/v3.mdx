...
4. 이제 개별 페이지에서 모든 기본 전환을 비활성화하여 `transition:animate` 지시어를 명시적으로 사용하는 요소에만 애니메이션을 적용할 수 있습니다.
...
Astro v3.0에 대한 좋은 리소스를 알고 계십니까? [이 페이지를 편집](https://github.com/withastro/docs/edit/main/src/content/docs/ko/guides/upgrade-to/v3.mdx)하여 아래 링크를 추가하세요!
