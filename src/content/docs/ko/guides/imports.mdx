...
또한 Astro를 확장하여 React, Svelte, Vue 컴포넌트와 같은 다양한 [UI 프레임워크](/ko/basics/framework-components/)에 대한 지원을 추가할 수 있습니다. [Astro MDX 통합](/ko/guides/integrations-guide/mdx/)을 설치하고 프로젝트에서 `.mdx` 파일을 사용할 수도 있습니다.
