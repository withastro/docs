...
## Astro와 Ghost로 블로그 만들기 \{#making-a-blog-with-astro-and-ghost\}
...
1. Ghost 블로그
2. [Ghost 콘텐츠 API](https://www.npmjs.com/package/@tryghost/content-api)와 통합된 Astro 프로젝트 - Ghost로 Astro 프로젝트를 설정하는 방법에 대한 자세한 내용은 [Astro와 통합](#integrating-with-astro)을 참조하세요.
...
### 게시물 목록 표시하기 \{#displaying-a-list-of-posts\}
...
`src/pages/post/[slug].astro` 페이지는 각 게시물에 대해 [동적으로 페이지를 생성](/ko/guides/routing/#dynamic-routes)합니다.
