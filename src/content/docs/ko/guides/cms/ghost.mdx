...
Ghost와 연결하려면 선호하는 패키지 관리자에 대해 아래 명령을 사용하여 공식 콘텐츠 API 래퍼 [`@tryghost/content-api`](https://www.npmjs.com/package/@tryghost/content-api)를 설치하세요.
...
`src/pages/post/[slug].astro` 페이지는 각 게시물에 대해 [동적으로 페이지를 생성](/ko/core-concepts/routing/#동적-경로)합니다.
...
- [Ghost CMS & Astro 튜토리얼](https://matthiesen.xyz/blog/tutorial-ghost-cms-astro) - Adam Matthiesen