...
## Astro와의 통합 \{#integration-with-astro\}
...
### Front Matter CMS 확장 프로그램 설치 \{#install-the-front-matter-cms-extension\}
...
#### 콘텐츠 타입 구성 \{#content-type-configuration\}
...
### 편집기에서 아티클 미리보기 \{#preview-your-articles-in-the-editor\}
...
### Markdoc을 Front Matter CMS와 함께 사용하기 \{#using-markdoc-with-front-matter-cms\}
