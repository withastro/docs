...
## WordPress와 Astro로 블로그 만들기 \{#building-a-blog-with-wordpress-and-astro\}
...
### WordPress 게시물 목록 표시 \{#displaying-a-list-of-wordpress-posts\}
...
### WordPress API를 사용하여 페이지 생성 \{#using-the-wordpress-api-to-generate-pages\}

`src/pages/dinos/[slug].astro` 페이지는 각 공룡에 대한 페이지를 [동적으로 생성](/ko/guides/routing/#dynamic-routes)합니다.
...
### 임베디드 리소스 반환 \{#returning-embedded-resources\}
