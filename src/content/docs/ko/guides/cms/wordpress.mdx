...
WordPress에는 WordPress 데이터를 Astro에 연결하기 위한 [WordPress REST API](https://developer.wordpress.org/rest-api/)가 내장되어 있습니다. 선택적으로 사이트에 [WPGraphQL](https://wordpress.org/plugins/wp-graphql/)을 설치하여 GraphQL을 사용할 수 있습니다.
...
`src/pages/dinos/[slug].astro` 페이지는 각 공룡에 대한 페이지를 [동적으로 생성](/ko/core-concepts/routing/#동적-경로)합니다.
...
- [Soft Hard System](https://softhardsystem.com/) - Rafid Muhymin Wafi — [GitHub의 소스 코드](https://github.com/RafidMuhymin/softhardsystem)  
