...
Astro에서는 [`server` 또는 `hybrid` 출력](/ko/guides/server-side-rendering/#온디맨드-서버-렌더링-활성화)이 활성화된 상태로 구성된 프로젝트의 온디맨드 렌더링 경로를 통해 이 작업을 수행할 수 있습니다.
...
- 온디맨드 렌더링 Oauth 경로를 사용하는 Astro 템플릿: [astro-decap-starter-ssr](https://github.com/OliverSpeir/astro-decap-starter-ssr)
