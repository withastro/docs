...
### PayloadCMS 컬렉션을 위한 Astro 구성 \{#configuring-astro-for-your-payloadcms-collection\}
...
## PayloadCMS와 Astro로 블로그 구축하기 \{#building-a-blog-with-payloadcms-and-astro\}
...
### PayloadCMS API를 사용하여 페이지 생성 \{#using-the-payloadcms-api-to-generate-pages\}

`src/pages/posts/[slug].astro` 페이지를 생성하여 각 게시물에 대한 [페이지를 동적으로 생성](/ko/guides/routing/#dynamic-routes)합니다.
