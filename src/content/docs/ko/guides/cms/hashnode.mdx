...
## Astro와 Hashnode로 블로그 만들기 \{#making-a-blog-with-astro-and-hashnode\}
...
### 게시물 목록 표시 \{#displaying-a-list-of-posts\}
...
<Steps>
1. 각 게시물에 대해 [동적으로 페이지를 생성](/ko/guides/routing/#dynamic-routes)하려면 `src/pages/post/[slug].astro` 페이지를 생성하세요.
