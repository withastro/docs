...
- [기본 인증](https://www.drupal.org/docs/contributed-modules/api-authentication/basic-authentication)
- [API Key 기반 인증](https://www.drupal.org/docs/contributed-modules/api-authentication/api-key-authentication)
- [액세스 토큰/OAuth 기반 인증](https://www.drupal.org/docs/contributed-modules/api-authentication/oauth-authentication)
- [JWT Token 기반 인증](https://www.drupal.org/docs/contributed-modules/api-authentication/jwt-authentication)
- [타사 공급자 토큰 인증](https://www.drupal.org/docs/contributed-modules/api-authentication/third-party-provider-authentication)
