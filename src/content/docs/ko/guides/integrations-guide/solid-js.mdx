...
이 **[Astro 통합][astro-integration]** 을 통해 [SolidJS](https://www.solidjs.com/) 컴포넌트에 대한 서버 측 렌더링 및 클라이언트 측 하이드레이션이 가능해졌습니다.
...
[UI 프레임워크 컴포넌트](/ko/core-concepts/framework-components/)와 마찬가지로 SolidJS 컴포넌트를 사용하세요.
