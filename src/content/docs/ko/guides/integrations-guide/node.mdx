...
이 옵션을 활성화하면, 어댑터는 콘텐츠 보안 정책과 같이 Astro 기능에서 제공하는 사전 렌더링된 페이지의 헤더를 `Response` 객체를 사용하여 제공합니다.
...
요청 시 렌더링되는 페이지에 대한 Astro의 기본 [HTML 스트리밍](/ko/guides/on-demand-rendering/#html-스트리밍)을 비활성화합니다.
