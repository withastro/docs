...
Astro v7부터 기본 Markdown 프로세서는 Recma 플러그인을 지원하지 않습니다. 프로젝트에서 Recma 플러그인을 사용하는 경우, 대신 [`unified()` 프로세서](/ko/guides/markdown-content/#unified-프로세서로-전환하기)를 사용할 수 있습니다.
