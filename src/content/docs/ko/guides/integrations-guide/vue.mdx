...
Astro에는 공식 통합 설정을 자동화하는 `astro add` 명령이 포함되어 있습니다. 원하는 경우 통합을 [수동으로 설치](#manual-install)할 수도 있습니다.
...
Astro에서 첫 번째 Vue 컴포넌트를 사용하려면 [UI 프레임워크 문서](/ko/guides/framework-components/#using-framework-components)로 이동합니다. 다음을 확인할 수 있습니다.
...
#### Vue DevTools 사용자 정의 \{#customizing-vue-devtools\}
