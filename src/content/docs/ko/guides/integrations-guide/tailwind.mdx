...
이 **[Astro 통합][astro-integration]** 은 Tailwind 구성 파일에 대한 지원과 함께 프로젝트의 모든 `.astro` 파일 및 [프레임워크 컴포넌트](/ko/core-concepts/framework-components/)에 [Tailwind의](https://tailwindcss.com/) 유틸리티 CSS 클래스를 제공합니다.
