...
2. [사용 가능한 Snipcart 설정](https://docs.snipcart.com/v3/setup/installation#setting2)을 사용하여 `window.SnipcartSettings`를 맞춤설정하여 장바구니의 동작과 모양을 제어하세요.
...
4. `snipcart-checout` 클래스와 함께 Snipcart 체크아웃 버튼을 추가하여 카트를 열고 손님이 체크아웃 모달로 구매를 완료할 수 있도록 하세요.
