...
개발 툴바에는 개발 중 사이트를 디버깅하고 검사하는 데 유용한 여러 도구가 포함되어 있으며, 통합 디렉터리에서 [더 많은 개발 툴바 앱으로 확장](#extending-the-dev-toolbar)할 수 있습니다. [개발 툴바 API](/ko/reference/dev-toolbar-app-reference/)를 사용하여 [나만의 개발 툴바 앱을 만들 수도 있습니다](/ko/recipes/making-toolbar-apps/)!
...
## 개발 툴바 앱 확장 \{#extending-the-dev-toolbar\}
...
## 개발 툴바 비활성화 \{#disabling-the-dev-toolbar\}
