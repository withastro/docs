...
- WordPress 사이트는 온라인 대시보드를 사용하여 편집됩니다. Astro에서는 [코드 편집기](/ko/editor-setup/) 및 개발 환경을 사용하여 사이트를 유지 관리합니다. 컴퓨터에서 로컬로 개발하거나 StackBlitz, CodeSandbox와 같은 클라우드 편집기/개발 환경을 선택할 수 있습니다.
