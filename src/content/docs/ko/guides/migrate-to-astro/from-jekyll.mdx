...
## Jekyll과 Astro의 주요 유사점 \{#key-similarities-between-jekyll-and-astro\}
...
## Jekyll과 Astro의 주요 차이점 \{#key-differences-between-jekyll-and-astro\}
...
## Jekyll에서 아스트로로 전환 \{#switch-from-jekyll-to-astro\}
...
Markdown 페이지를 생성하기 위해 기존 Markdown 파일을 콘텐츠로 가져와 Liquid 템플릿 대신 [Astro Markdown 레이아웃](/ko/basics/layouts/#markdown-layouts)을 사용합니다.

기존 HTML 페이지 콘텐츠의 대부분은 [Astro 페이지](/ko/basics/astro-pages/)로 변환될 수 있으며 추가적으로 [변수, JSX와 유사한 표현식 및 컴포넌트 가져오기를 HTML 템플릿에서 직접 사용](/ko/basics/astro-syntax/#jsx-like-expressions)할 수 있습니다.
