...
## GitBook과 Astro의 주요 유사점 \{#key-similarities-between-gitbook-and-astro\}
...
## GitBook과 Astro의 주요 차이점 \{#key-differences-between-gitbook-and-astro\}
...
## GitBook에서 Astro로 전환 \{#switch-from-gitbook-to-astro\}
