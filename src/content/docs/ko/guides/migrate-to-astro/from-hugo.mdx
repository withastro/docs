...
## Hugo와 Astro의 주요 유사점 \{#key-similarities-between-hugo-and-astro\}

Hugo와 Astro는 프로젝트 마이그레이션에 도움이 되는 몇 가지 유사점을 공유합니다.

- Hugo와 Astro는 모두 블로그와 같은 [콘텐츠 중심 웹사이트](/ko/concepts/why-astro/#content-driven)에 이상적으로 적합한 최신 정적 사이트 생성기입니다.
...
## Hugo와 Astro의 주요 차이점 \{#key-differences-between-hugo-and-astro\}
...
## Hugo에서 Astro로 전환 \{#switch-from-hugo-to-astro\}
