...
[`import.meta.glob()`을 사용한 로컬 파일 가져오기](/ko/guides/imports/#importmetaglob), [콘텐츠 컬렉션을 사용한 쿼리](/ko/guides/content-collections/#컬렉션-쿼리) 또는 [원격 데이터 가져오기](/ko/guides/data-fetching/)에 대해 자세히 알아보세요.
