...
3. import 구문을 포함하여 필요한 JavaScript를 ["코드 펜스" (`---`)](/ko/core-concepts/astro-components/#컴포넌트-스크립트)로 이동합니다. 참고: [조건부 콘텐츠 렌더링](/ko/core-concepts/astro-syntax/#동적-html)을 위한 JavaScript는 Astro에서 직접 HTML 템플릿 내에 작성되는 경우가 많습니다.
