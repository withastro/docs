...
[astro.new](https://astro.new)에서 Astro의 문서 시작 및 기타 공식 템플릿을 찾을 수 있습니다. 각 프로젝트의 GitHub 저장소 링크는 물론 StackBlitz, CodeSandbox와 같은 온라인 개발 환경에서 작업 프로젝트를 열 수 있는 원클릭 링크도 제공됩니다.
