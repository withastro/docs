...
## Eleventy (11ty)와 Astro의 주요 유사점 \{#key-similarities-between-eleventy-11ty-and-astro\}
...
## Eleventy (11ty)와 Astro의 주요 차이점 \{#key-differences-between-eleventy-11ty-and-astro\}
...
- Eleventy에서는 CSS, JavaScript 및 기타 자산 번들링을 수동으로 구성해야 합니다. [Astro는 이 문제를 즉시 처리합니다](/ko/concepts/why-astro/#easy-to-use).

## Eleventy에서 Astro로 전환 \{#switch-from-eleventy-to-astro\}
