...
:::caution
`.env` 파일은 [구성 파일](/ko/guides/configuring-astro/#environment-variables)에서 불러올 수 없습니다.
:::
...
## 환경 변수 가져오기 \{#getting-environment-variables\}
...
## TypeScript 자동 완성 \{#intellisense-for-typescript\}
