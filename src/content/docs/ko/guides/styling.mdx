...
:::note
이는 [Astro SSR](/ko/guides/server-side-rendering/)과 관련이 없거나 필요하지 않은 [Vite 전용 설정](https://ko.vite.dev/config/ssr-options.html#ssr-noexternal)입니다.
:::
...
<ReadMore>Astro 통합 설치, 가져오기, 구성에 대한 지침은 [통합 가이드](/ko/guides/integrations-guide/)를 참조하세요.</ReadMore>
