...
`code`에 적용될 [Shiki 트랜스포머](https://shiki.style/packages/transformers#shikijs-transformers)의 배열입니다. Astro v4.14.0부터는 트랜스포머에 옵션을 전달하기 위해 [Shiki의 `meta` 속성](https://shiki.style/guide/transformers#meta)에 문자열을 제공할 수도 있습니다.
