...
[Prism 스타일시트를 추가하여 Prism의 강조 표시로 전환](#prism-스타일시트-추가)하거나, [`markdown.syntaxHighlighting`](/ko/reference/configuration-reference/#markdownsyntaxhighlight) 구성 옵션을 사용하여 Astro의 구문 강조 표시를 완전히 비활성화할 수 있습니다.
