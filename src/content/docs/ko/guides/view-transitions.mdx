...
<ReadMore>사용자 입력을 `navigate()` API와 함께 사용하는 경우, Astro의 [실험적 콘텐츠 보안 정책](/ko/reference/configuration-reference/#securitycsp)을 활성화하여 교차 사이트 스크립팅 (XSS) 위험으로부터 보호하는 것을 고려해 보세요.</ReadMore>
