...
내부 리디렉션의 경우 이전 경로 경로를 새 경로로 매핑하는 것입니다. Astro v5.2.0부터는 `https` 또는 `https`로 시작하고 [파싱 가능한](https://developer.mozilla.org/en-US/docs/Web/API/URL/canParse_static) 외부 URL로 리디렉션할 수도 있습니다:
