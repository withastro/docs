...
## 배포 안내서 \{#deployment-guides\}

<DeployGuidesNav />

## 빠른 배포 옵션 \{#quick-deploy-options\}
...
3. 사이트를 빌드하고 호스트에 배포합니다.
    ...
    다른 호스트에서는 [사이트를 로컬로 빌드](#building-your-site-locally)하고 명령줄을 사용하여 배포해야 합니다.
</Steps>

## 사이트를 로컬로 빌드 \{#building-your-site-locally\}
...
## SSR용 어댑터 추가 \{#adding-an-adapter-for-ssr\}
