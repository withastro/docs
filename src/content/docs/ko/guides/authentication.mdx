...
<ReadMore>이러한 백엔드 서비스에 대한 전용 가이드에서 [Supabase로 인증을 추가](/ko/guides/backend/supabase/#supabase로-인증-추가)하거나 [Firebase로 인증을 추가](/ko/guides/backend/firebase/#firebase로-인증-추가), 또는 [Scalekit으로 인증을 추가](/ko/guides/backend/scalekit/#scalekit로-인증-추가)하는 방법을 알아보세요.</ReadMore>
...
[Scalekit & Astro 가이드](/ko/guides/backend/scalekit/)를 따라 소셜 로그인, 엔터프라이즈 SSO 등을 사용하여 Astro SSR 프로젝트에 인증을 추가하세요.
