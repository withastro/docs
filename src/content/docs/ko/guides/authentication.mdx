...
<ReadMore>이러한 백엔드 서비스에 대한 전용 가이드에서 [Supabase로 인증을 추가](/ko/guides/backend/supabase/#adding-authentication-with-supabase)하거나 [Firebase로 인증을 추가](/ko/guides/backend/google-firebase/#adding-authentication-with-firebase)하는 방법을 알아보세요.</ReadMore>
