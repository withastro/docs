...
### Cloud Storage (정적 전용) \{#cloud-storage-static-only\}
...
#### Dockerfile 생성 및 컨테이너 빌드 \{#create-dockerfile--build-the-container\}
...
#### 컨테이너 배포 \{#deploying-the-container\}
