...
## Github Pages용 Astro 구성 \{#configure-astro-for-github-pages\}

### `github.io` URL에 배포 \{#deploying-to-a-githubio-url\}
...
### 사용자 정의 도메인으로 Github Pages 사용 \{#using-github-pages-with-a-custom-domain\}
...
## GitHub Action 구성 \{#configure-a-github-action\}
