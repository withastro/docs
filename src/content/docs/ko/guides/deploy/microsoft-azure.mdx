...
이 가이드에서는 Visual Studio Code를 사용하여 GitHub에 저장된 Astro 사이트를 배포하는 과정을 안내합니다. 다른 설정에 대해서는 [Azure Pipelines Task](https://learn.microsoft.com/en-us/azure/devops/pipelines/tasks/reference/azure-static-web-app-v0?view=azure-pipelines) 사용에 대한 Microsoft 가이드를 참조하세요.
