...
- [Cloudflare Pages Dashboard를 통해 배포하는 방법](#how-to-deploy-a-site-with-git)
- [Wrangler, Cloudflare CLI를 사용하여 배포하는 방법](#how-to-deploy-a-site-using-wrangler)
- [`@astrojs/cloudflare`를 사용하여 SSR 사이트를 배포하는 방법](#how-to-deploy-an-ssr-site)
...
## Git으로 사이트를 배포하는 방법 \{#how-to-deploy-a-site-with-git\}
...
## Wrangler를 사용하여 사이트를 배포하는 방법 \{#how-to-deploy-a-site-using-wrangler\}
...
### Wrangler를 사용하여 로컬에서 미리보기 활성화 \{#enabling-preview-locally-with-wrangler\}
...
## SSR 사이트 배포 방법 \{#how-to-deploy-an-ssr-site\}
...
### 클라이언트 측 수화 \{#client-side-hydration\}
...
### Node.js 런타임 API \{#nodejs-runtime-apis\}
...
- Node.js 런타임 API를 직접 가져오는 경우, 해결 방법에 대한 추가 단계는 Cloudflare의 [Node.js 호환성](/ko/guides/integrations-guide/cloudflare/#nodejs-compatibility)에 대한 Astro 문서에서 참조할 수 있습니다.
