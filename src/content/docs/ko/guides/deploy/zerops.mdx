...
## Zerops의 Astro Static 사이트 \{#astro-static-site-on-zerops\}

### Astro Static용 프로젝트 및 서비스 만들기 \{#creating-a-project-and-a-service-for-astro-static\}
...
### Astro Static 사이트 배포 \{#deploying-your-astro-static-site\}
...
이제 [Zerops CLI를 사용](#trigger-the-pipeline-using-zerops-cli-zcli)하거나 서비스 세부 세부 사항에서 [GitHub](https://docs.zerops.io/references/github-integration/) / [GitLab](https://docs.zerops.io/references/gitlab-integration) 저장소와 `app` 서비스를 연결하여 빌드 및 배포 파이프라인을 트리거할 수 있습니다.

## Zerops의 Astro SSR 사이트 \{#astro-ssr-site-on-zerops\}

### Astro SSR (Node.js)용 프로젝트 및 서비스 만들기 \{#creating-a-project-and-a-service-for-astro-ssr-nodejs\}
프로젝트와 서비스는 [`Project add`](https://app.zerops.io/dashboard/project-add) 마법사를 통해 추가하거나 다음 yaml 구조를 사용하여 가져올 수 있습니다.
...
### Astro SSR 사이트 배포 \{#deploying-your-astro-ssr-site\}
...
## Zerops CLI (zcli)를 사용하는 파이프라인 트리거 \{#trigger-the-pipeline-using-zerops-cli-zcli\}
