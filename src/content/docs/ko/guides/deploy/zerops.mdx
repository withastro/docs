...
아무것도 설치하거나 설정하지 않고 Zerops에서 Astro 실행을 테스트하고 싶나요? [Zerops x Astro - Static](https://github.com/zeropsio/recipe-astro-static) 또는 [Zerops x Astro - Node.js SSR](https://github.com/zeropsio/recipe-astro-static) 저장소를 사용하면 예시 Astro 사이트를 클릭 한 번으로 배포할 수 있습니다.
