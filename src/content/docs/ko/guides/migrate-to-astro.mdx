...
- Astro에서 직접 사용할 수 있는 [UI 프레임워크 컴포넌트](/ko/basics/framework-components/)
...
- [클라이언트 측 `<script>` 태그](/ko/guides/client-side-scripts/) 또는 [UI 프레임워크 컴포넌트](/ko/basics/framework-components/)를 사용하여 클라이언트 측 상호 작용을 제공합니다.

- 앱 전체 후크 또는 래퍼 대신 Nano Stores 또는 로컬 저장소를 사용하여 [공유 상태](/ko/basics/sharing-state/)를 관리합니다.
