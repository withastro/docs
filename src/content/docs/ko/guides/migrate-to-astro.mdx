...
## 마이그레이션 안내서 \{#migration-guides\}

<MigrationGuidesNav />

이러한 페이지 중 다수는 **스텁**입니다. 이는 여러분의 기여를 기다리는 리소스 모음입니다!

## 사이트를 Astro로 마이그레이션하는 이유는 무엇인가요? \{#why-migrate-your-site-to-astro\}
...
## 어떤 프로젝트를 Astro로 전환할 수 있나요? \{#which-projects-can-i-convert-to-astro\}
...
## 내 프로젝트 설계는 어떻게 바뀌나요? \{#how-will-my-project-design-change\}
