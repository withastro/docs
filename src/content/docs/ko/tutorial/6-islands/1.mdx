...
이 컴포넌트는 인사말 메시지 배열을 prop으로 사용하고 첫 번째 메시지를 환영 메시지로 표시합니다. 사용자는 버튼을 클릭하여 새로운 무작위 메시지를 받을 수 있습니다.
...
3. 홈 페이지 `index.astro`에서 이 컴포넌트를 가져와 사용하세요.
    ...
    브라우저에서 미리보기를 확인하세요. 인사말이 표시되지만 버튼이 작동하지 않습니다!
...
- [Astro 통합 안내서](/ko/guides/integrations/)
