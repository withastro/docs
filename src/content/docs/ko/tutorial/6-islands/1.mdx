...
## Astro 프로젝트에 Preact 추가 \{#add-preact-to-your-astro-project\}
...
## Preact 인사말 배너 포함 \{#include-a-preact-greeting-banner\}
...
- [Astro에서 UI 프레임워크 컴포넌트 사용](/ko/guides/framework-components/#using-framework-components)

- [Astro 클라이언트 지시어 참조](/ko/reference/directives-reference/#client-directives)
