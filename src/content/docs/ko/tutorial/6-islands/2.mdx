...
## 테마 토글 아이콘 추가 및 스타일 지정 \{#add-and-style-a-theme-toggle-icon\}
...
## 어두운 테마에 CSS 스타일 추가 \{#add-css-styling-for-a-dark-theme\}
...
## 클라이언트 측 상호작용 추가 \{#add-client-side-interactivity\}
