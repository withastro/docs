...
## 변수 정의 및 사용 \{#define-and-use-a-variable\}
...
## Astro에서 JavaScript 표현식 작성 \{#write-javascript-expressions-in-astro\}
...
## 요소를 조건부로 렌더링 \{#conditionally-render-elements\}
...
- [Astro의 동적 표현식](/ko/basics/astro-syntax/#jsx-like-expressions)
