...
## 새로운 `.astro` 파일 생성 \{#create-a-new-astro-file\}
...
## 직접 시도해 보기 - 블로그 페이지 추가 \{#try-it-yourself---add-a-blog-page\}

[위와 동일한 단계](#create-a-new-astro-file)에 따라 세 번째 페이지인 `blog.astro`를 사이트에 추가하세요.
...
3. 모든 페이지 상단에 [세 번째 탐색 링크를 추가](#add-navigation-links)하세요.
</Steps>
...
## 변경사항을 웹에 게시 \{#publish-your-changes-to-the-web\}
...
- [Astro의 파일 기반 라우팅](/ko/basics/astro-pages/#file-based-routing)
- [Astro 페이지 HTML](/ko/basics/astro-pages/#astro-pages)
