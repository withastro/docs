...
## 개별 페이지 스타일 지정 \{#style-an-individual-page\}
...
## 첫 번째 CSS 변수 사용 \{#use-your-first-css-variable\}
...
## 직접 시도해 보기 - CSS 변수 정의 \{#try-it-yourself---define-css-variables\}
...
### 참고 자료 \{#resources\}
- [Astro 구문과 JSX - 비교](/ko/basics/astro-syntax/#differences-between-astro-and-jsx)

- [Astro `<style>` 태그](/ko/guides/styling/#styling-in-astro)

- [Astro의 CSS 변수](/ko/guides/styling/#css-variables)
