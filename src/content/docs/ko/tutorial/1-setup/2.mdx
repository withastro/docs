...
## Astro 설정 마법사 실행 \{#launch-the-astro-setup-wizard\}
...
## VS Code에서 프로젝트 실행 \{#open-your-project-in-vs-code\}
...
## Astro를 개발 모드로 실행 \{#run-astro-in-dev-mode\}

작업하는 동안 프로젝트 파일을 _웹사이트로_ 미리 보려면 Astro가 개발 (dev) 모드에서 실행되어야 합니다.

### 개발 서버 시작 \{#start-the-dev-server\}
...
## 웹사이트 미리보기 \{#view-a-preview-of-your-website\}
