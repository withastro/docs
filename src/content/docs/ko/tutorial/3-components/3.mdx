...
## 직접 시도해 보기 - 새로운 Header 컴포넌트를 만들어 보세요. \{#try-it-yourself---build-a-new-header-component\}
...
## 직접 시도해 보기 - 페이지 업데이트 \{#try-it-yourself---update-your-pages\}
...
## 반응형 스타일 추가 \{#add-responsive-styles\}
