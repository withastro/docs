...
## 바닥글 컴포넌트 만들기 \{#create-a-footer-component\}
<Steps>
...
### `Footer.astro` 가져오기 및 사용 \{#import-and-use-footerastro\}
...
## 직접 시도해 보기 - 바닥글 맞춤설정 \{#try-it-yourself---personalize-your-footer\}
...
## 소셜 미디어 컴포넌트 만들기 \{#create-a-social-media-component\}
...
### 바닥글에 `Social.astro`를 가져와 사용 \{#import-and-use-socialastro-in-your-footer\}
...
## 소셜 미디어 컴포넌트 스타일 지정 \{#style-your-social-media-component\}
...
- [Astro 컴포넌트의 Props](/ko/basics/astro-components/#component-props)
