...
## 새로운 `src/components/` 폴더 생성 \{#create-a-new-srccomponents-folder\}

HTML을 생성하지만 웹 사이트의 새 페이지가 되지 않는 `.astro` 파일을 보관하려면 프로젝트에 `src/components/`라는 새 폴더가 필요합니다.

## 탐색 컴포넌트 만들기 \{#create-a-navigation-component\}
...
### Navigation.astro 가져오기 및 사용 \{#import-and-use-navigationastro\}
...
## 직접 시도해 보기 - 사이트의 나머지 부분에 탐색 기능을 추가하세요 \{#try-it-yourself---add-navigation-to-the-rest-of-your-site\}
