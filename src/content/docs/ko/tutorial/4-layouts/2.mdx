...
## 블로그 게시물에 레이아웃 추가 \{#add-a-layout-to-your-blog-posts\}
...
## 직접 시도해 보기 - 블로그 게시물 레이아웃 맞춤설정 \{#try-it-yourself---customize-your-blog-post-layout\}
...
- [Astro의 Markdown 레이아웃](/ko/guides/markdown-content/#frontmatter-layout)

- [Markdown 레이아웃 Props](/ko/basics/layouts/#markdown-layout-props)
