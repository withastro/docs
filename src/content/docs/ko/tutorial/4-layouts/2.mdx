...
- [Astro의 Markdown 레이아웃](/ko/guides/markdown-content/#프런트매터-layout)

- [Markdown 레이아웃 Props](/ko/core-concepts/layouts/#markdown-레이아웃-props)

- [YAML 소개](https://dev.to/paulasantamaria/introduction-to-yaml-125f) <Badge>외부 링크</Badge>
