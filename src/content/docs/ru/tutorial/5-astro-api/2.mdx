...
:::note
Даже если это выглядит сложно, вы можете попробовать следовать инструкциям и самостоятельно построить эту функцию! Если вы не хотите сейчас разбираться с необходимым JavaScript, вы можете перейти к [готовому примеру кода](#final-code-sample) и использовать его напрямую в своем проекте, заменяя существующий контент.
:::
