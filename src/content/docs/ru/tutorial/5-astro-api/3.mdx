...
## Используйте шаблон маршрутизации `/folder/index.astro` \{#use-the-pagesfolderindexastro-routing-pattern\}
...
## Попробуйте сами - Создайте страницу индекса тегов \{#try-it-yourself---make-a-tag-index-page\}
...
4. Проверьте предварительный просмотр в браузере ещё раз, и у вас должна быть отформатированная страница, готовая к добавлению контента!
</Steps>
</Box>

## Создайте массив тегов \{#create-an-array-of-tags\}
...
## Создайте свой список тегов \{#create-your-list-of-tags\}
...
## Добавьте стили к вашему списку тегов \{#add-styles-to-your-tag-list\}
...
## Добавьте эту страницу в вашу навигацию \{#add-this-page-to-your-navigation\}
...
## Задание: Включите теги в макет вашей записи блога \{#challenge-include-tags-in-your-blog-post-layout\}
...
Следуйте инструкциям ниже, а затем проверьте свою работу, сравнив её с [финальным образцом кода](#code-check-in-markdownpostlayout).
...
### Проверка кода: MarkdownPostLayout \{#code-check-in-markdownpostlayout\}
