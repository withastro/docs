...
Следуйте инструкциям ниже, а затем проверьте свою работу, сравнив ее с [финальным образцом кода](#code-check-in-markdownpostlayout).
...
- [Статическая маршрутизация в Astro](/ru/core-concepts/routing/#static-routes)
