...
## Попробуйте сами — Создайте новый компонент Header \{#try-it-yourself---build-a-new-header-component\}
...
## Попробуйте сами — Обновите ваши страницы \{#try-it-yourself---update-your-pages\}
...
## Добавьте отзывчивые стили \{#add-responsive-styles\}
