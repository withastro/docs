...
- [Дизайн основанный на компонентах](https://www.droptica.com/blog/component-based-design/) <Badge>external</Badge>

- [Семантические теги HTML](https://www.dofactory.com/html/semantics) <Badge>external</Badge>

- [Mobile-first дизайн](https://www.mobileapps.com/blog/mobile-first-design) <Badge>external</Badge>
