...
## Создание компонента Hamburger \{#build-a-hamburger-component\}
...
## Напишите ваш первый тег скрипта \{#write-your-first-script-tag\}
...
### Импорт файла `.js` \{#importing-a-js-file\}
