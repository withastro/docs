...
## Создание компонента Footer \{#create-a-footer-component\}
...
### Импорт и использование `Footer.astro` \{#import-and-use-footerastro\}
...
## Попробуйте сделать это сами — Настройте ваш подвал \{#try-it-yourself---personalize-your-footer\}
...
## Создание компонента социальных сетей \{#create-a-social-media-component\}
...
### Импорт и использование `Social.astro` в вашем подвале  \{#import-and-use-socialastro-in-your-footer\}
...
## Стилизация вашего компонента социальных сетей \{#style-your-social-media-component\}
