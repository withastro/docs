...
## Оформление отдельной страницы \{#style-an-individual-page\}
...
## Используйте свою первую переменную CSS \{#use-your-first-css-variable\}
...
## Попробуйте сами - Определите переменные CSS \{#try-it-yourself---define-css-variables\}
