...
3. Найти эту страницу в браузерном предпросмотре, добавив `/posts/post-1` в конец вашего существующего URL-адреса предварительного просмотра.
    ...
    (например, `localhost:4321/posts/post-1`)
...
2. Проверьте предварительный просмотр в браузере снова `localhost:4321/posts/post-1`. Теперь на этой странице должно быть содержимое.
