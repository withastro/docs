...
1. Создайте новый каталог в `src/pages/posts/`.

2. Добавьте новый (пустой) файл `post-1.md` внутри вашей новой папки `/posts/`.

3. Найдите эту страницу в браузерном предпросмотре, добавив `/posts/post-1` в конец вашего существующего URL-адреса предварительного просмотра.

    (например, `localhost:3000/posts/post-1`)
...
2. Проверьте предварительный просмотр в браузере снова `localhost:3000/posts/post-1`. Теперь на этой странице должно быть содержимое.
