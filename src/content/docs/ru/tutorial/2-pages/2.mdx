...
- [Шпаргалка по Markdown от The Markdown Guide](https://www.markdownguide.org/cheat-sheet/) <Badge>external</Badge>

- [Что такое инструменты разработчика браузера? MDN](https://developer.mozilla.org/ru/docs/Learn/Common_questions/Tools_and_setup/What_are_browser_developer_tools) <Badge>external</Badge>
