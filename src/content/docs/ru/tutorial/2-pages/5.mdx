...
## Добавление глобальной таблицы стилей \{#add-a-global-stylesheet\}
...
## Попробуйте сами - Импортируйте свою глобальную таблицу стилей \{#try-it-yourself---import-your-global-stylesheet\}
...
### Анализируем шаблон \{#analyze-the-pattern\}
