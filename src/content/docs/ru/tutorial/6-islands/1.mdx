...
## Добавьте Preact в ваш проект Astro \{#add-preact-to-your-astro-project\}
...
## Включите приветственный баннер Preact \{#include-a-preact-greeting-banner\}
...
### Анализируйте паттерн \{#analyze-the-pattern\}
