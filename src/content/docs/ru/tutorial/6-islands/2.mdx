---
type: tutorial
title: 'Возвращаемся на сушу. Превратите свой блог из дневного в ночной, и для этого не нужен остров!'
description: |-
...
Давайте создадим кликабельный иконку, которая позволит вашим пользователям переключаться между светлым и тёмным режимами, используя ещё один тег `<script>` для интерактивности... и не отправляя браузеру никакого JavaScript от фреймворка.
...
## Добавьте и стилизуйте иконку переключения темы \{#add-and-style-a-theme-toggle-icon\}
...
3. Посетите предварительный просмотр в браузере по адресу `http://localhost:4321`, чтобы увидеть иконку теперь на всех ваших страницах. Вы можете попробовать нажать на нее, но вы ещё не написали скрипт, чтобы сделать ее интерактивной.
</Steps>

## Добавьте стили CSS для тёмной темы \{#add-css-styling-for-a-dark-theme\}
...
## Добавьте интерактивность на стороне клиента \{#add-client-side-interactivity\}
