...
Массив ключевых слов, относящихся к вашему компоненту, используемый для помощи другим [находить ваш компонент на npm](https://www.npmjs.com/search?q=keywords:astro-component,withastro) и в любых других каталогах поиска.
