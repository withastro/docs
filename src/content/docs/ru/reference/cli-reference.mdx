...
Ссылка на вашу базу данных, размещенную в Studio. Это необходимо для выполнения [команд Astro DB](/ru/guides/integrations-guide/db/#astro-db-cli-reference) для управления базой данных. Для привязки базы данных вам будет предложено выбрать существующую базу данных или создать новую.
