...
## Что такое сервис изображений? \{#what-is-an-image-service\}
...
## Разработка с использованием API сервисов изображений \{#building-using-the-image-services-api\}
...
### Локальные сервисы \{#local-services\}
...
#### getConfiguredImageService и imageConfig \{#getconfiguredimageservice--imageconfig\}
