...
В маршрутах, использующих [остальные параметры](/ru/guides/routing/#rest-parameters), `undefined` может использоваться для представления пути без параметров, передаваемых в URL:
