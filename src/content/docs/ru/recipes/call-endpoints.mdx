...
2. На любой странице Astro импортируйте метод `GET()` из эндпоинта. Вызовите его с помощью глобального объекта [`Astro`](/ru/reference/api-reference/#astro-global), чтобы предоставить контекст запроса, и используйте ответ на странице:
