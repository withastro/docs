...
Из вводного руководства по [созданию блога](/ru/tutorial/0-introduction/) вы узнали о [встроенной файловой маршрутизации](/ru/guides/routing/#static-routes) Astro: любой файл `.astro`, `.md` или `.mdx` в папке `src/pages/` автоматически становился страницей на вашем сайте.
