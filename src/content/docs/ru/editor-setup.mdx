...
- [Расширение VS Code на Open VSX](https://open-vsx.org/extension/astro-build/astro-vscode) <span style="margin: 0.25em;"><Badge variant="accent">Официальное</Badge></span> - Официальное расширение Astro VS Code, доступное в реестре Open VSX для открытых платформ, таких как [VSCodium](https://vscodium.com/)
