...
Установите опции [`site`](/en/reference/configuration-reference/#site) и [`base`](/en/reference/configuration-reference/#base) в `astro.config.mjs`.
...
Узнайте больше о [настройке значения `base`](/en/reference/configuration-reference/#base)
:::
...
<Steps>
1. Создайте в вашкм проекте новый файл с именем `.github/workflows/deploy.yml` и вставьте в него следующий YAML.
        ...
        steps:
          ...
          - name: Install, build, and upload your site
            ...
            # with:
              ...
              # node-version: 20 # Версия Node, которую следует использовать для сборки сайта. По умодчанию 20. (опционально)
...
2. (Опционально) Если вы передаёте переменные среды в свой проект Astro во время локальной разработки или превью-сборок, вам необходимо определить публичные переменные в файле `deploy.yml`, чтобы они были обработаны во время развёртывания на GitHub Pages. (Смотрите [документацию GitHub про установку секретов](https://docs.github.com/en/actions/writing-workflows/choosing-what-your-workflow-does/store-information-in-variables#creating-configuration-variables-for-a-repository) для добавления приватных переменных среды.)
