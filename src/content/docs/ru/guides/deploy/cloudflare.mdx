...
3. Войдите в панель управления Cloudflare и выберите вашу учётную запись в **Домашней странице учётной записи** > **Pages**.
4. Выберите **Создать новый проект** и опцию **Связать Git**.
5. Выберите проект Git, который вы хотите развернуть, и нажмите **Начать настройку**.
