...
### Удалены: `legacy.astroFlavoredMarkdown`.
...
Используйте [`Astro.glob()`](/ru/guides/imports/#astroglob) для получения файлов Markdown, или перейдите на [Коллекцию Контента](/ru/guides/content-collections/).
...
Astro v2.0 обновляется с Vite 3 до [Vite 4](https://vitejs.dev/), который выйдет в декабре 2022 года.
...
Обратитесь к официальному руководству [Vite Migration Guide](https://vitejs.dev/guide/migration.html), если у вас возникнут проблемы.
...
- [Предрендеринг отдельных страниц в статический HTML](/ru/guides/server-side-rendering/) при использовании SSR для повышения скорости и кэшируемости.
