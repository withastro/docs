...
- Устаревште script/style типы атрибутов: Смотрите [руководство по миграции на версию 0.26](/ru/guides/upgrade-to/v1/#new-default-script-behavior)

### Удалено: Partial shims for Web APIs in server code
...
### Удалено: pre-0.14 Shiki theme names
