...
Для этого вы можете создать файл `env.d.ts` в `src/`, чтобы [расширить глобальные типы](/ru/guides/typescript/#extending-global-types) и настроить `ImportMetaEnv` следующим образом:
