...
- содержимого внутри [встроенного компонента `<Code />`](/ru/reference/components-reference/#code-) (powered by Shiki).
- содержимое компонента [`<Prism />`](/ru/reference/components-reference/#prism-) (работает на Prism).
