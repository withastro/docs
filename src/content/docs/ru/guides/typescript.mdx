...
Вы можете получить тип [`Astro.params`](/ru/reference/api-reference/#params) с помощью `InferGetStaticParamsType` и тип [`Astro.props`](/ru/reference/api-reference/#props) с помощью `InferGetStaticPropsType`:
