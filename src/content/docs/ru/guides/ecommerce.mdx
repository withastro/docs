...
Lemon.js также предоставляет дополнительные возможности, такие как [программное открытие оверлеев](https://docs.lemonsqueezy.com/help/lemonjs/opening-overlays) и [обработка событий оверлеев](https://docs.lemonsqueezy.com/help/lemonjs/opening-overlays).
...
2. Настройте `window.SnipcartSettings` с любыми [доступными настройками Snipcart](https://docs.snipcart.com/v3/setup/installation#setting2), чтобы контролировать поведение и внешний вид вашей корзины.
