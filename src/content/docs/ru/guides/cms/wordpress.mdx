...
- `slug` - Содержит [slug](https://docs.astro.build/ru/reference/api-reference/#slug) поста. (Это позволит создать ссылку на динамически создаваемые отдельные страницы динозавров.)
