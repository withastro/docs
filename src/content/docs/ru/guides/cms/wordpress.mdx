...
## Интеграция с Astro \{#integrating-with-astro\}
...
## Создание блога с помощью WordPress и Astro \{#building-a-blog-with-wordpress-and-astro\}
...
### Отображение списка постов WordPress \{#displaying-a-list-of-wordpress-posts\}
...
### Использование WordPress API для генерации страниц \{#using-the-wordpress-api-to-generate-pages\}
...
### Возврат встроенных ресурсов \{#returning-embedded-resources\}
...
### Публикация вашего сайта \{#publishing-your-site\}
...
## Сайты в производстве \{#production-sites\}
