...
## Инициализация Turso в Astro \{#initializing-turso-in-astro\}
...
### Установка клиента LibSQL \{#install-libsql-client\}
...
### Инициализация нового клиента \{#initialize-a-new-client\}
...
## Запрос к вашей базе данных \{#querying-your-database\}
...
### SQL Заполнители \{#sql-placeholders\}
