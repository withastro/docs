...
В этом случае вы можете использовать утилиту [`CollectionEntry`](/ru/reference/api-reference/#collection-entry-type) для корректного задания свойств компонента с помощью TypeScript.  Эта утилита принимает строковый аргумент, соответствующий имени схемы вашей коллекции, и наследует все свойства схемы этой коллекции.
