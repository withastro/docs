...
Astro включает команду `astro add` для автоматизации установки официальных интеграций. При желании вы также можете [установить интеграции вручную](/ru/guides/integrations-guide/mdx/#manual-install).
