...
<ReadMore>Узнайте, как [добавить аутентификацию с помощью Supabase](/en/guides/backend/supabase/#adding-authentication-with-supabase) или [добавить аутентификацию с помощью Firebase](/en/guides/backend/google-firebase/#adding-authentication-with-firebase) в наших специальных руководствах по этим бэкэнд-сервисам.</ReadMore>
