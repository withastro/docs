...
<ReadMore>Узнайте, как [добавить аутентификацию с помощью Supabase](/ru/guides/backend/supabase/#adding-authentication-with-supabase) или [добавить аутентификацию с помощью Firebase](/ru/guides/backend/google-firebase/#добавление-аутентификации-с-помощью-firebase) в наших специальных руководствах по этим бэкэнд-сервисам.</ReadMore>
