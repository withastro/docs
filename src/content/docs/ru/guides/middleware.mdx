...
Это тот же самый объект [`context`](/ru/reference/api-reference/#контекст-конечной-точки), который используется в API роутах.
...
Низкоуровненый API для создания [`APIContext`](/ru/reference/api-reference/#контекст-конечной-точки), который может использоваться внутри middleware Astro.
