...
## 使用本地字体文件 \{#using-a-local-font-file\}
...
## 在 Tailwind 中注册字体 \{#register-fonts-in-tailwind\}

如果你使用的是 [Tailwind 集成](/zh-cn/guides/integrations-guide/tailwind/)，则可以使用此页面的前述方法之一来安装字体，并进行一些修改。你也可以使用[`@font-face` 语句注册本地字体](#using-a-local-font-file)，或使用 [Fontsource 的 `import` 策略](#using-fontsource)去安装你的字体。
