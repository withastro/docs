...
[`@astrojs/rss` 包](https://github.com/withastro/astro/tree/main/packages/astro-rss) 提供了使用 [API 端点](/zh-cn/basics/endpoints/#静态文件端点) 生成 RSS 摘要的帮助程序。这使得静态构建和使用 [SSR 适配器](/zh-cn/guides/server-side-rendering/) 时的按需生成都成为可能。
