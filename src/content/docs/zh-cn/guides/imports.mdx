...
此外，你可以扩展 Astro 以添加对不同 [UI 框架](/zh-cn/basics/framework-components/)的支持，如 React、Svelte 和 Vue 组件。你还可以安装 [Astro MDX 集成](/zh-cn/guides/integrations-guide/mdx/)并在项目中使用 `.mdx` 文件。
