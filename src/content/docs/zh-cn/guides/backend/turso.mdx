...
## 在 Astro 中初始化 Turso \{#initializing-turso-in-astro\}
...
### 安装 LibSQL 客户端 \{#install-libsql-client\}
...
### 初始化一个新客户端 \{#initialize-a-new-client\}
...
## 查询你的数据库 \{#querying-your-database\}
