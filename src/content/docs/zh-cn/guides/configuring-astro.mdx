...
Vite 特定的 `import.meta` 属性，如 <code>{'import.meta.env'}</code> 或 `import.meta.glob`，*无法*在你的配置文件中访问。我们推荐使用 [dotenv](https://github.com/motdotla/dotenv) 或 [fast-glob](https://github.com/mrmlnc/fast-glob) 作为替代方案。
:::
