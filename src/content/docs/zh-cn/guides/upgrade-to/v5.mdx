...
<ReadMore>了解有关 [Astro 的官方集成](/zh-cn/guides/integrations/) 的更多信息。</ReadMore>
...
<ReadMore>了解有关在 [适配器中指定支持的 Astro 功能](/zh-cn/reference/adapter-reference/#astro-特性)的更多信息。</ReadMore>
