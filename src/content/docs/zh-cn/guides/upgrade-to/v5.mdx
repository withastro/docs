...
- `contentLayer`（请参阅 [将现有内容集合升级](#遗留v20-内容集合-api) 到新的首选 Content Layer API 的指南。）
...
<ReadMore>阅读有关 [Astro 中的 Vite 配置设置](/zh-cn/reference/configuration-reference/#vite)</ReadMore>
...
<ReadMore>阅读有关 [使用 `params` 创建动态路由](/zh-cn/guides/routing/#静态-ssg-模式)</ReadMore>
...
请查看 [GitHub 上的 Astro's issues](https://github.com/withastro/astro/issues/) 以了解任何已报告的问题，或自行提交问题。
