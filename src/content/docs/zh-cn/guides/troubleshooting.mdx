...
请参阅 [Astro 的集成指南](/zh-cn/guides/integrations/)，了解关于向 Astro 添加框架渲染器、CSS 工具和其他包的说明。
...
你还可以访问 [路线图讨论](https://github.com/withastro/roadmap/discussions/)，看看你是否发现了 Astro 的已知限制，并检查是否有与你的使用情况相关的提案。
