...
- `_astro/`: 向客户端提供所有静态资源，包括 CSS 文档、打包的客户端脚本、优化后的图像和任何 Vite 资产。
- `_server_islands/`: 为延迟渲染的 [服务器群岛](/zh-cn/reference/configuration-reference/#experimentalserverislands) 动态组件提供服务。
