...
3. 构建站点并部署到服务商
    ...
    其他服务商会要求你在[在本地构建站点](#building-your-site-locally)并用命令行节目部署。
</Steps>

## 在本地构建站点 \{#building-your-site-locally\}
...
## 添加 SSR 适配器 \{#adding-an-adapter-for-ssr\}
