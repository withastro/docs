...
任何 Astro 样式方法都可以用于 [Markdown 布局组件](/zh-cn/core-concepts/layouts/#markdownmdx-布局)。但是不同的方式可能会对你的页面产生不同的样式效果。
...
你也可以添加包括 [Tailwind](/zh-cn/guides/integrations-guide/tailwind/) 在内的 [CSS 集成](#css-集成)。如果你使用 Tailwind，[typography 插件](https://tailwindcss.com/docs/typography-plugin) 可以用于样式化 Markdown。
