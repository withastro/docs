...
- 配置为 [按需渲染](/zh-cn/guides/server-side-rendering/) 的新的或现有的 Astro 项目。
- [一个免费的 Prepr 账户](https://signup.prepr.io/)
...
你可以从你的 Prepr 账户设置中找到你的 `YOUR_PREPR_API_URL` 值：
...
- 查看 [将 Prepr CMS 连接到 Astro](https://docs.prepr.io/connecting-front-end-apps/astro) 以了解 Astro 和 Prepr CMS 资源的概览。
