...
2. **一个 WordPress 站点** - 你的站点的 REST API 是 `[YOUR_SITE]/wp-json/wp/v2/`，并在任何WordPress站点上都是默认提供的。你也可以在[本地环境上安装 WordPress](https://wordpress.org/support/article/installing-wordpress-on-your-own-computer/)。
