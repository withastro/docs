...
[Tina CMS](https://tina.io/) 是一个基于 Git 的无头内容管理系统（CMS）。
...
4. 通过编辑 `.tina/config.ts` 中的 `schema.collections` 属性来设置你的 Tina 集合。
    ...
    在 [Tina文档](https://tina.io/docs/reference/collections/) 中了解更多关于Tina集合的信息。
...
-  由 Tom Bennet 创建的 [Astro Tina Starter](https://github.com/tombennet/astro-tina-starter/tree/main)。