...
## 与Astro集成 \{#integration-with-astro\}
...
### 安装 Front Matter CMS 扩展 \{#install-the-front-matter-cms-extension\}
...
#### 内容类型配置 \{#content-type-configuration\}
...
### 使用 Markdoc 与 Front Matter CMS \{#using-markdoc-with-front-matter-cms\}
