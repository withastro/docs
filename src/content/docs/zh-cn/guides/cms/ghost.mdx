...
此页面 `src/pages/post/[slug].astro` 将为每一篇文章[动态生成一个页面](/zh-cn/basics/routing/#动态路由)。
...
- [Ghost CMS & Astro 教程](https://matthiesen.xyz/blog/tutorial-ghost-cms-astro) 由 Adam Matthiesen 提供
