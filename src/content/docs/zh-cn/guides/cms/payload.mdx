...
### 为你的 PayloadCMS 集合配置 Astro \{#configuring-astro-for-your-payloadcms-collection\}
...
## 使用 PayloadCMS 和 Astro 创建博客 \{#building-a-blog-with-payloadcms-and-astro\}
...
### 使用 PayloadCMS API 生成页面 \{#using-the-payloadcms-api-to-generate-pages\}

创建一个页面 `src/pages/post/[slug].astro` 为每一篇文章[动态生成一个页面](/zh-cn/guides/routing/#dynamic-routes)。
