...
## 单元和集成测试 \{#unit-and-integration-tests\}
...
#### Vitest 和容器 API \{#vitest-and-container-api\}
...
#### 创建你的第一个 Playwright 测试 \{#create-your-first-playwright-test\}
...
#### 运行你的 Playwright 测试 \{#running-your-playwright-tests\}
...
##### 进阶：在测试期间启动开发 Web 服务器 \{#advanced-launching-a-development-web-server-during-the-tests\}
...
#### 创建你的第一个 Cypress 测试 \{#create-your-first-cypress-test\}
...
#### 运行你的 Cypress 测试 \{#running-your-cypress-tests\}
...
#### 创建你的第一个 Nightwatch 测试 \{#create-your-first-nightwatch-test\}
...
#### 运行你的 NightwatchJS 测试 \{#running-your-nightwatchjs-tests\}
