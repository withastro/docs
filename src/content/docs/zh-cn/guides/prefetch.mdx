...
- 如果访问者使用 [数据保护模式](https://developer.mozilla.org/zh-CN/docs/Web/API/NetworkInformation/saveData) 或者有 [慢速连接](https://developer.mozilla.org/en-US/docs/Web/API/NetworkInformation/effectiveType)，则预获取将被关闭。
- 快速悬停或滚动链接不会预获取它们。
...
`prefetch()` API 包括相同的 [数据保护模式](https://developer.mozilla.org/zh-CN/docs/Web/API/NetworkInformation/saveData) 和 [慢速连接](https://developer.mozilla.org/en-US/docs/Web/API/NetworkInformation/effectiveType) 检测，因此只有在需要时才预获取。
