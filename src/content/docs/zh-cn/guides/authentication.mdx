...
<ReadMore>查看我们的专门指南，了解如何 [使用 Supabase 添加认证](/zh-cn/guides/backend/supabase/#adding-authentication-with-supabase) 或 [使用 Firebase 添加认证](/zh-cn/guides/backend/google-firebase/#adding-authentication-with-firebase)，以获取这些后端服务的详细信息。</ReadMore>
