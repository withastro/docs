...
你可以手动或使用 [`Astro.redirect`](/zh-cn/reference/api-reference/#astroredirect) 来通过按需渲染，直接从任何页面返回一个 [Response](https://developer.mozilla.org/zh-CN/docs/Web/API/Response) 对象。
