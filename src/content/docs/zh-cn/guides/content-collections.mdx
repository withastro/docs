...
:::tip
探索 [GitHub 上博客教程演示代码](https://github.com/withastro/blog-tutorial-demo/tree/content-collections/src/pages) 的 `src/pages/` 文件夹，或 [在 StackBlitz 中打开它](https://stackblitz.com/github/withastro/blog-tutorial-demo/tree/content-collections?file=src/pages/blog.astro)，以此来学习如何利用博客的内容集合功能，创建页面的完整示例，例如博客文章列表、标签页面等！
:::
