...
- 你正在使用需要实时更新的 API。内容集合仅在构建时更新，因此如果你需要实时数据，请使用其他方法 [导入文件](/zh-cn/guides/imports/#import-statements) 或 使用 [按需渲染](/zh-cn/guides/on-demand-rendering/) 来 [请求数据](/zh-cn/guides/data-fetching/)。
