...
## S3 静态网站托管 \{#s3-static-website-hosting\}
...
## S3 与 CloudFront \{#s3-with-cloudfront\}
...
:::note
当连接 CloudFront 到一个 S3 静态网站端点时，你需要依赖 S3 桶策略进行访问控制。请参阅 [S3 静态网站托管](/zh-cn/guides/deploy/aws/#s3-static-website-hosting) 部分，以了解更多关于桶策略的信息。
:::

## 使用 GitHub Actions 实现持续部署 \{#continuous-deployment-with-github-actions\}
