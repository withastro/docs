...
如果你希望将你的应用程序提供给他人使用，你可以使用 [公共路由](https://deta.space/docs/en/use/space-apps/using-apps#private-and-public-routes) 来使应用程序的某些部分对公众可见。或者，你也可以创建一个 [发布](https://deta.space/docs/en/publish/releasing#releases)，让他人将你的应用程序安装到他们自己的个人云中。
