...
[Clever Cloud](https://clevercloud.com) 是一个欧洲云平台，它提供自动化、可扩展的服务。
...
6. 除非你正在使用数据库或 Keycloak，否则请跳过 [将 **Add-ons（附加组件）** 连接到 Clever 应用程序](https://www.clevercloud.com/developers/doc/addons/)。
...
## 官方资源
- [用于部署 Node.js 应用程序的 Clever Cloud 文档](https://www.clevercloud.com/developers/doc/applications/nodejs/)
- [用于将 Astro 部署为静态应用程序的 Clever Cloud 文档](https://www.clevercloud.com/developers/guides/astro/)
