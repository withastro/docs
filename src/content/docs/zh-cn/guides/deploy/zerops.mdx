...
## 在 Zerops 上部署 Astro 静态站点 \{#astro-static-site-on-zerops\}

### 创建 Astro 静态站点的项目和服务 \{#creating-a-project-and-a-service-for-astro-static\}
...
### 部署你的 Astro 静态站点 \{#deploying-your-astro-static-site\}
...
现在你可以 [使用 Zerops CLI 触发构建和部署流水线](#trigger-the-pipeline-using-zerops-cli-zcli)，或者通过服务详情内部将 `app` 服务与你的 [GitHub](https://docs.zerops.io/references/github-integration/) / [GitLab](https://docs.zerops.io/references/gitlab-integration) 存储库连接。

## 在 Zerops 上部署 Astro SSR 站点 \{#astro-ssr-site-on-zerops\}

### 创建 Astro SSR（Node.js）的项目和服务 \{#creating-a-project-and-a-service-for-astro-ssr-nodejs\}
可以通过 [`Project add`](https://app.zerops.io/dashboard/project-add) 向导或使用 yaml 结构导入项目和服务：
...
### 部署你的 Astro SSR 站点 \{#deploying-your-astro-ssr-site\}
...
## 使用 Zerops CLI 触发流水线（zcli） \{#trigger-the-pipeline-using-zerops-cli-zcli\}
