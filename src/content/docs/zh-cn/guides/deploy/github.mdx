...
## 为 GitHub Pages 配置 Astro \{#configure-astro-for-github-pages\}

### 部署到 `github.io` 网址 \{#deploying-to-a-githubio-url\}
...
### 在 GitHub Pages 上使用自定义域名 \{#using-github-pages-with-a-custom-domain\}
...
## 配置 GitHub Action \{#configure-a-github-action\}
