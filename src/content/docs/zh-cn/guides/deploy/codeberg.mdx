...
4. 在文件夹中添加 `astro.yaml` 文件，文件代码示例如下：
```
...
5. 在 `public` 目录下新建 `.domains` 文件，输入 `分支.仓库名.用户名.codeberg.page`，这就是你的默认域名。如果要添加自定义域名，请查看[这篇文章](https://codeberg.org/Codeberg/pages-server/src/branch/main/README.md)。
