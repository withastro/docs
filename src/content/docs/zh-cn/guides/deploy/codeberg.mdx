...
你可以使用 [Codeberg Pages](https://codeberg.page/) 直接从 [Codeberg](https://codeberg.org) 上的仓库托管 Astro 网站。
...
<Steps>
  <ol>
    ...
    <li>
      ...
      （示例格式：<code>分支.仓库名.用户名.codeberg.page</code>）。如需添加自定义域名，请参考 Codeberg Pages 的文档：[在这里](https://codeberg.org/Codeberg/pages-server/src/branch/main/README.md)。
    </li>
