...
你可以使用 `InferGetStaticParamsType` 和 `InferGetStaticPropsType` 来获取 [`Astro.params`](/zh-cn/reference/api-reference/#params) 和 [`Astro.props`](/zh-cn/reference/routing-reference/#props) 的类型。
