...
要转换其他类型的网站，如作品集或文档网站，请参阅 [astro.new](https://astro.new) 上的更多官方入门模板。你会找到每个项目的 GitHub 仓库的链接，以及在 Firebase Studio、StackBlitz 和 CodeSandbox 在线开发环境中一键打打开一个工作项目的链接。
