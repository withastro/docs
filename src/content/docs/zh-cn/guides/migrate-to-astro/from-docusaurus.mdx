...
- Astro 和 Docusaurus 都使用[基于文件的路由](/zh-cn/basics/routing/)自动为位于`src/pages`的任何MDX文件生成页面路由。在 Astro 中为你现有的内容和添加新页面使用文件结构应该会感到熟悉。
...
- Docusaurus 是一个基于React的单页应用程序(SPA)。Astro 站点是使用[`.astro`组件](/zh-cn/basics/astro-components/)构建的多页应用程序，但也可以支持[React, Preact, Vue.js, Svelte, SolidJS, AlpineJS, Lit](/zh-cn/basics/framework-components/)和原始 HTML 模板。
