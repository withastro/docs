...
- Gridsome 是一个基于 Vue的单页应用程序（SPA）。而 Astro 站点是多页应用程序，它们使用[`.astro` 组件](/zh-cn/basics/astro-components/)构建，但也可以支持 [React, Preact, Vue.js, Svelte, SolidJS, AlpineJS, Lit](/zh-cn/basics/framework-components/) 和原生HTML模板。
