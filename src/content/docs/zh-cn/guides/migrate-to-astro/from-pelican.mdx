...
与 Pelican 一样，Astro也有许多可拓展其功能的插件。探索 [官方集成列表](/zh-cn/guides/integrations-guide/) 以添加诸如支持 MDX 的功能，并在 [Astro 集成目录](https://astro.build/integrations/) 中，中找到数百个由社区维护的集成。你甚至可以使用 [Astro 集成 API](/zh-cn/reference/integrations-reference/) 来构建自己的自定义集成，以扩展项目功能。
