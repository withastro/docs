...
## WordPress 和 Astro 之间的主要相似之处 \{#key-similarities-between-wordpress-and-astro\}

WordPress 和 Astro 在以下方面有一些相似之处，这将有助于你迁移项目：

- 无论是 WordPress 还是 Astro，都非常适合用于制作[内容驱动的网站](/zh-cn/concepts/why-astro/#content-driven)，比如博客，并支持使用 Markdown 编写内容（在 WordPress 中需要使用插件）。虽然在 Astro 中添加新内容的过程不同，但如果你已经在 WordPress 编辑器中使用过 Markdown 语法，那么在 Astro 博客中 [编写 Markdown 文件](/zh-cn/guides/markdown-content/)应该会感觉很熟悉。 
...
## WordPress 和 Astro 之间的主要区别 \{#key-differences-between-wordpress-and-astro\}
...
## 从 WordPress 切换到 Astro \{#switch-from-wordpress-to-astro\}
...
或者，你可以从 [GitHub 上任何现有的 Astro 存储库开始一个新项目](/zh-cn/install-and-setup/#use-a-theme-or-starter-template)
