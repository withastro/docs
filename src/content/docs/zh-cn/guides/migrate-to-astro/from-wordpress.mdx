...
- [无头 WordPress 通过 Astro – 使用 Tailwind CSS 从头开始​​构建一个简单的博客](https://fullstackdigital.io/blog/headless-wordpress-with-astro-build-a-simple-blog/)
...
- 📺 [WordPress Headless with Astro - 安装 Astro 并使用 WP-GraphQL 获取文章](https://www.youtube.com/watch?v=2PSqABrME28)
