...
- WordPress 网站使用在线仪表盘进行编辑。而在 Astro 中，你将使用 [代码编辑器](/zh-cn/editor-setup/) 和开发环境来维护你的网站。你可以在本地机器上进行开发，也可以选择云编辑器（或开发环境），比如 Firebase Studio、StackBlitz 和 CodeSandbox。
...
<CardGrid>
  <LinkCard title="再见 Wordpress，你好 Astro！" href="https://trib.tv/posts/2025/wordpress-to-astro/" />
  <LinkCard title="我是如何从 WordPress 迁移到 Astro 的" href="https://itsthatlady.dev/blog/migrate-from-wordpress-to-astro/" />
  <LinkCard title="我是如何以及为何将博客从 WordPress 迁移到 Astro 和 Markdown 的" href="https://levelup.gitconnected.com/how-and-why-i-moved-my-blog-from-wordpress-to-astro-and-markdown-3549672d5a86" />
  <LinkCard title="我是如何从 WordPress 迁移到 Astro 的：页面速度评分提升至 100% 并节省 100% 托管成本" href="https://devaradise.com/wordpress-to-static-website-astro/" />
  <LinkCard title="WordPress 站点迁移至 Astro 平台" href="https://share.transistor.fm/s/d86496cd" />
  <LinkCard title="如何将 WordPress 博客转换为 Astro 静态站点" href="https://blog.okturtles.org/2024/10/convert-wordpress-to-static-site/" />
  <LinkCard title="为何我从 WordPress 转向 Astro" href="https://dev.to/fratzinger/why-i-switched-from-wordpress-to-astro-5ge" />
  <LinkCard title="为何我放弃 WordPress 转投 Astro" href="https://vbartalis.xyz/en/blog/why-i-ditched-wordpress-for-astro-js/" />
  <LinkCard title="DeWP：在 Astro 项目中调用 WordPress 数据的实用工具" href="https://delucis.github.io/dewp/" />
  <LinkCard title="Astro vs. WordPress：现代网页的渲染模式" href="https://andrewkepson.com/blog/headless-wordpress/astro-vs-wordpress-rendering-patterns/" />
</CardGrid>

:::note[有想要分享的资源吗？]
如果你找到（或制作）了一个关于将 WordPress 网站转换为 Astro 的有用的视频或博客文章，请将其 [添加到这个列表中](https://github.com/withastro/docs/edit/main/src/content/docs/en/guides/migrate-to-astro/from-wordpress.mdx)！
:::
