...
- Eleventy 支持多种模板语言。Astro 支持[包含来自几个流行的JS框架（例如 React，Svelte，Vue，Solid）的组件](/zh-cn/basics/framework-components/)，但大部分页面模板都使用 [Astro布局，页面和组件](/zh-cn/basics/astro-components/)。
