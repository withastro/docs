...
你可以向 `create astro` 命令传递 `--template` 参数，以使用我们的官方启动器之一启动新的 Astro 项目。或者你可以[从 GitHub 上任何现有的 Astro 项目启动一个新项目](/zh-cn/install-and-setup/#use-a-theme-or-starter-template)。
...
许多现有的 HTML 页面内容都可以转换为 [Astro 页面](/zh-cn/basics/astro-pages/)，此外你还可以直接在 [HTML 模板中使用变量、类似 JSX 的表达式和组件导入](/zh-cn/basics/astro-syntax/#jsx-like-expressions)。
