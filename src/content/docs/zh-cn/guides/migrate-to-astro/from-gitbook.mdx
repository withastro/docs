...
## GitBook 和 Astro 的主要相似点 \{#key-similarities-between-gitbook-and-astro\}
...
## GitBook 和 Astro 的主要区别 \{#key-differences-between-gitbook-and-astro\}
...
## 从 GitBook 切换到 Astro \{#switch-from-gitbook-to-astro\}
...
你可以通过 `create astro` 命令传递一个 `--template` 参数来启动一个带有我们官方起始器的新 Astro 项目。或者，你可以[从 GitHub 上任何现有的 Astro 仓库开始一个新项目](/zh-cn/install-and-setup/#use-a-theme-or-starter-template)。
