...
当去转换其他类型的网站，例如作品集或文档网站，可以在 [astro.new](https://astro.new) 上找到更多官方的起始模板。你将会找到每个项目的 GitHub 存储库的链接，以及在 Firebase Studio、StackBlitz 和 CodeSandbox 在线开发环境中打开一个工作项目的一键链接。
