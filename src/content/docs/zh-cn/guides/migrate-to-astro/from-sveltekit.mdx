...
- Astro 有[一个使用Svelte组件的官方集成](/zh-cn/guides/integrations-guide/svelte/)，并支持[安装NPM包](/zh-cn/guides/imports/#npm-包)，包括一些用于 Svelte 的包。你将能够编写 Svelte UI 组件，并且可能做到保留部分或全部现有的组件和依赖项。
