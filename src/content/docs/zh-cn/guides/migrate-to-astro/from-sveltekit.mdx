...
- [组件](/zh-cn/basics/astro-components/)：SvelteKit 使用 [Svelte](https://svelte.dev)。Astro 页面使用 [`.astro` 组件](/zh-cn/basics/astro-components/) 构建，但也可以支持 [React、Preact、Vue.js、Svelte、SolidJS、AlpineJS、Lit](/zh-cn/basics/framework-components/) 和原始 HTML 模板。
