...
- 在 Astro 中直接使用你现有的 [UI 框架组件](/zh-cn/basics/framework-components/) 。
...
- 使用 [客户端 `<script>` 标签](/zh-cn/guides/client-side-scripts/) 或 [UI 框架组件](/zh-cn/basics/framework-components/)提供客户端互动性。

- 使用 Nano Stores 或者 local storage 管理[共享状态](/zh-cn/basics/sharing-state/)，而不是全局 hooks 或者包装类。
