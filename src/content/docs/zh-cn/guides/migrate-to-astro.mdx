...
## 为什么将你的网站迁移到 Astro？ \{#why-migrate-your-site-to-astro\}
...
## 我可以将哪些项目转换为 Astro？ \{#which-projects-can-i-convert-to-astro\}
...
## 我的项目设计应该如何改变？ \{#how-will-my-project-design-change\}

根据你现有的项目，你可能需要从不同方面进行思考：

- 使用 [Astro 群岛](/zh-cn/concepts/islands/#what-is-an-island)设计以避免向浏览器发送不必要的 JavaScript。
