...
此工具栏包含许多有用的工具，用于在开发过程中调试和检查你的网站，并且可以在集成目录中找到[更多开发者工具栏应用](#extending-the-dev-toolbar)进行扩展。你甚至可以使用 [开发者工具栏 API](/zh-cn/reference/dev-toolbar-app-reference/) [构建你自己的工具栏应用](/zh-cn/recipes/making-toolbar-apps/)！
...
## 扩展开发工具栏 \{#extending-the-dev-toolbar\}
...
## 禁用开发者工具栏 \{#disabling-the-dev-toolbar\}
