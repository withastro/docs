...
如果入口脚本是使用 npm 或 Yarn 构建的，你可能会在运行入口脚本时看到这个问题。这是一个[已知问题](https://github.com/withastro/astro/issues/4974)，并将在未来版本中修复。可以将 `“path-to-regexp”` 添加到 `noExternal` 数组来解决这个问题：
...
你还可以查看 [Astro 集成文档](https://docs.astro.build/zh-cn/guides/integrations-guide/) 了解更多关于集成的信息。
