...
Cloudflare Runtime 包括 [Cloudflare 绑定](https://developers.cloudflare.com/pages/platform/functions/bindings)、[环境变量](https://developers.cloudflare.com/pages/platform/functions/#environment-variables) 和 [cf 对象](https://developers.cloudflare.com/workers/runtime-apis/request/#incomingrequestcfproperties)。参阅有关 [访问 Cloudflare Runtime](#cloudflare-runtime) 的更多信息。
...
你可以访问 [环境变量](https://developers.cloudflare.com/pages/platform/functions/bindings/#environment-variables)。
