...
**[Astro 集成][astro-integration]** 允许你在Astro项目中启用 [Partytown](https://partytown.builder.io/)。

## 为什么是 Astro Partytown

Partytown 是一个延迟加载的库,可以帮助将资源密集型脚本转移到 [web worker](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API) 中, 并且从 [主线程](https://developer.mozilla.org/en-US/docs/Glossary/Main_thread) 中移除.
...
这体现了 [Partytown 配置对象](https://partytown.builder.io/configuration)。
...
如果不设置此选项，在[dev](/en/reference/cli-reference/#astro-dev) 或 [preview](/en/reference/cli-reference/#astro-preview) 模式下,`debug` 模式默认启用。
