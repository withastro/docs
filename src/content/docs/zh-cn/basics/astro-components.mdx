...
当你的 Astro 组件确实需要客户端交互性时，你可以添加 [标准 HTML `<script>` 标签](/zh-cn/guides/client-side-scripts/) 或 [UI 框架组件](/zh-cn/basics/framework-components/#激活组件)。
...
:::tip
命名插槽页可以传递给 [UI 框架组件](/zh-cn/basics/framework-components/) 的信息。
:::
...
- 它们只能[引用 `public/` 文件夹中的资产](/zh-cn/basics/project-structure/#public)。
...
<ReadMore>阅读更多关于如何在 Astro 项目中使用 [UI 框架组件](/zh-cn/basics/framework-components/) 的内容。</ReadMore>
