...
- Astro 支持 [**latest _Maintenance_ LTS** 版本的 Node.js](https://nodejs.org/en/about/previous-releases#release-schedule)。
- Astro 支持 [**current _Active_ LTS** 版本的 Node.js](https://nodejs.org/en/about/previous-releases#release-schedule)。
- Astro 也可以支持 Node.js 的奇数版本。
