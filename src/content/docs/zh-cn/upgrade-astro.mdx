...
- [不再维护的 v5.18.0 快照](https://v5.docs.astro.build/zh-cn/getting-started/)
- [不再维护的 v4.16.17 快照](https://v4.docs.astro.build/zh-cn/getting-started/)
- [不再维护的 v3.6.3 快照](https://web.archive.org/web/20231203051122/https://docs.astro.build/en/getting-started/)
- [不再维护的 v2.10.15 快照](https://web.archive.org/web/20230822134745/https://docs.astro.build/en/getting-started)
...
- 升级最低 **_Maintenance_ LTS**（在相同的主要版本范围内，例如，从 `22.14.*` 到 `22.20.*`）版本的 Node.js 可以在 Astro 的**次要**版本中发生。
