...
下面是一个更高级的 Dockerfile 示例，通过 Docker 的 [多层构建](https://docs.docker.com/build/building/multi-stage/) 功能，在源代码变化时仅重新安装 npm 依赖项，从而优化了站点的构建过程。这根据依赖项的大小从而节省几分钟甚至更多的构建时间。
