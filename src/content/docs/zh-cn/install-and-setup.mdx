...
或者，你可以[使用任何现有的主题或起始模板](#使用主题或起始模板)开始你的项目。
...
4. 现在你可以 [启动 Astro 开发服务器](#启动-astro-开发服务器) 并在自定义项目的同时查看实时预览！
</Steps>
...
8. 现在你可以[启动 Astro 开发服务器](#启动-astro-开发服务器) 并在构建项目的同时查看实时预览了！
...
在浏览器中查看你的网站时，你将能够访问 [Astro 开发工具栏](/zh-cn/guides/dev-toolbar/)。在你构建时，它将帮助你检查你的 [群岛](/zh-cn/concepts/islands/)，发现可访问性问题等。
...
要检查在构建时将创建的你的网站版本，请退出开发服务器（<kbd>Ctrl</kbd> + <kbd>C</kbd>）并在你的终端中运行适用于你的包管理器的相应构建命令：
...
请注意，这将预览你在最后一次运行构建命令时的代码状态。这旨在让你预览你的网站在 [部署到网络](#部署你的新网站) 时的外观。在构建后对代码进行的任何更改都**不会**在你预览网站时反映出来，直到你再次运行构建命令。
...
成功！你现在已经准备好开始使用 Astro 构建了！🥳

这里有一些我们推荐你接下来探索的事情。你可以按任何顺序阅读它们。你甚至可以暂时离开我们的文档，去玩你的新 Astro 项目代码库，每当你遇到问题或有疑问时再回到这里。
...
<CardGrid>
  ...
  />
   <LinkCard
    title="TypeScript"
    description="根据你的喜好配置 Astro 的内置 TypeScript 支持，可以严格或宽松！"
    href="/zh-cn/guides/typescript/"
  />
  <LinkCard
    title="导入别名"
    description="为你的文件导入创建方便的快捷方式。"
    href="/zh-cn/guides/aliases/"
  />
  <LinkCard
    title="环境变量"
    description="在你的项目中设置和使用环境变量。"
    href="/zh-cn/guides/environment-variables/"
  />
    <LinkCard
    title="开发工具栏"
    description="探索开发工具栏的有用功能。"
