...
```astro /(\w+)=\S+/ title="src/components/GreetingCard.astro"
---
...
```astro ins={2-5} title="src/components/GreetingHeadline.astro"
---
interface Props {
  name: string;
  greeting?: string;
...
```astro ins="= \"你好\"" ins="= \"宇航员\"" title="src/components/GreetingHeadline.astro"
---
...
```astro "<slot />" title="src/components/Wrapper.astro"
---
...
```astro {5-6} title="src/pages/fred.astro"
---
...
```astro /slot=".*?"/ title="src/pages/fred.astro"
---
import Wrapper from '../components/Wrapper.astro';
---
...
```astro {13} title="src/components/Wrapper.astro"
---
import Header from './Header.astro';
import Logo from './Logo.astro';
import Footer from './Footer.astro';
