...
社区中有丰富的资源可以帮助你学习和使用 Astro 构建项目！以下是由 Astro 社区创建和维护的教育内容。

请注意，所有链接都指向外部网站，且可能基于 Astro 的早期版本。在使用任何社区内容时，建议您检查其发布日期，并根据项目需求进行相应调整。

想了解更多 Astro 教育内容，请访问 [Astro 博客](https://astro.build/blog/) 或订阅 [官方 Astro 新闻通讯](https://astro.build/newsletter/signup)，我们会在每个月回顾最佳社区内容。
...
[Astro 方案](/en/recipes/) 是一系列简洁明了的操作指南，它们通过分步骤的说明，帮助读者完成特定任务。如果你想为你的 Astro 项目添加新功能或行为，方案是一个非常实用的参考资源！
