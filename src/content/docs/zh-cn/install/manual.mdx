...
如果你想集成像 React、Svelte 这样的[UI 框架组件](/zh-cn/basics/framework-components/)或是使用其他类似 Tailwind 或 Partytown 这样的工具，你可以在[手动导入并配置集成](/zh-cn/guides/integrations-guide/)章节内获取更多信息。
