...
8. 为你的博客文章描述添加一个时间更长的淡入效果。
    ...
    📚了解更多关于不同的[过渡指令](/en/guides/view-transitions/#transition-directives)和[自定义动画](/en/guides/view-transitions/#customizing-animations)的信息。
...
教程到此结束，但还有很多内容等待你的探索！如果你感兴趣，可以查看我们的[完整视图过渡指南](/en/guides/view-transitions/)，了解更多关于视图过渡的用法。
