...
## 在你的 Astro 项目中添加 Preact \{#add-preact-to-your-astro-project\}
...
## 添加一个 Preact 欢迎横幅 \{#include-a-preact-greeting-banner\}
...
- [在 Astro 中使用 UI 框架组件](/zh-cn/guides/framework-components/#using-framework-components)
- [Astro client 指令参考](/zh-cn/reference/directives-reference/#client-directives)
