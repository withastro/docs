...
## 创建一个页脚组件 \{#create-a-footer-component\}
...
### 导入并使用 `Footer.astro` \{#import-and-use-footerastro\}
...
## 自己试一试 - 个性化你的页脚 \{#try-it-yourself---personalize-your-footer\}
...
## 创建一个社交媒体组件 \{#create-a-social-media-component\}
...
### 在你的页脚中导入并使用 `Social.astro` \{#import-and-use-socialastro-in-your-footer\}
...
## 给你的社交媒体组件添加样式 \{#style-your-social-media-component\}
...
- [Astro 组件中的组件参数](/zh-cn/basics/astro-components/#component-props)
