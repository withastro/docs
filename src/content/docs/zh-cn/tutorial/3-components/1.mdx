...
现在你的 Astro 站点的多个页面上都有相同的 HTML 代码，让我们用一个可复用的 Astro 组件替换这些重复的内容！
...
2. 将任意页面顶部的导航链接复制并粘贴到你的新文件 `Navigation.astro` 中：
    ...
    ```
    :::tip
    如果你的 `.astro` 文件的 Frontmatter 中没有任何内容，你可以不写任何代码块。当你需要时，你可以随时添加它们。
    :::

### 导入并使用 Navigation.astro

1. 回到 `index.astro`，在代码中导入你的新组件：
...
- [Astro 组件概述](/zh-cn/core-concepts/astro-components/#component-structure)
