...
:::note
如果你已经熟悉 git 并拥有自己的工作流程，请使用你喜欢的方法为你的项目创建一个新的 GitHub 仓库。 跳到下一页：[“将站点部署到网上”](/cn/tutorial/1-setup/5/)。
:::
...
3. 你将看到一些选项，但无需更改任何默认设置。 向下滚动并单击按钮以<kbd>Create Repository</kbd>。
...
7. 你可能会看到一条消息，告诉你没有`staged`提交，并询问你是否要暂存它们。 单击<kbd>Always</kbd> 并继续。
...
- <p>[在 VS Code 中使用 Git 源代码管理`Source control`](https://code.visualstudio.com/docs/sourcecontrol/overview#_git-support) <Badge>external</Badge></p>
