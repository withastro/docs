...
## 定义和使用变量 \{#define-and-use-a-variable\}
...
## 在 Astro 中编写 JavaScript 表达式 \{#write-javascript-expressions-in-astro\}
...
## 条件渲染元素 \{#conditionally-render-elements\}
...
- [Astro 中的动态表达式](/zh-cn/basics/astro-syntax/#jsx-like-expressions)
