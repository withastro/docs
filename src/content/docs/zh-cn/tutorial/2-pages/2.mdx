...
- [Markdown 指南中的 Markdown 备忘单](https://www.markdownguide.org/cheat-sheet/) <Badge>external</Badge>

- [什么是浏览器开发者工具？ MDN](https://developer.mozilla.org/en-US/docs/Learn/Common_questions/What_are_browser_developer_tools) <Badge>external</Badge>
