...
## 创建一个新的 `.astro` 文件 \{#create-a-new-astro-file\}
...
## 动手尝试一下：增加一个博客页面 \{#try-it-yourself---add-a-blog-page\}
...
## 将你的修改发布到网络上 \{#publish-your-changes-to-the-web\}
