...
一个对象，用于提供回调函数与 [开发工具栏](/zh-cn/refers/reference/dev-toolbar-app-reference/) 进行交互：
...
**原因：**获取 SSR 清单（manifest），这在插件或集成中创建自定义 SSR 构建时很有用。
...
**类型：**<code>Map\<<a href="#integrationroutedata-type-reference">IntegrationRouteData</a>, URL\></code><br />
<Since v="2.7.0" />
</p>
