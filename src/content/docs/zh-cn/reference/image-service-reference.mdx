...
## 什么是图像服务？ \{#what-is-an-image-service\}
...
## 使用图像服务 API 构建 \{#building-using-the-image-services-api\}
...
#### getConfiguredImageService 和 imageConfig \{#getconfiguredimageservice--imageconfig\}
