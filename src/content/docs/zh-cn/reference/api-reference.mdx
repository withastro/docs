...
```astro {3} title="./src/components/Heading.astro"
---
...
```astro /title=".+"/ /date=".+"/ title="./src/pages/index.astro"
---
...
一个可用于 URL 的简短标识。默认情况下，它是 `id`，但可以通过在文件的 frontmatter 中设置 [`slug`属性](/zh-cn/guides/content-collections/#defining-custom-slugs) 来覆盖。  
