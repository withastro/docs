...
- [**InvalidRewrite404**](/zh-cn/reference/errors/invalid-rewrite404/)<br/>You attempted to rewrite a 404 inside a static page, and this isn't allowed.
...
- [**EnvInvalidVariable**](/zh-cn/reference/errors/env-invalid-variable/)<br/>Invalid Environment Variable
- [**EnvUnsupportedGetSecret**](/zh-cn/reference/errors/env-unsupported-get-secret/)<br/>Unsupported astro:env getSecret
