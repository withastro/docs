...
- **[Server-first](/fr/basics/rendering-modes/)** : Déplace le rendu coûteux sur les appareils de vos visiteurs.
...
1. [Axé sur le contenu](#content-driven) : Astro a été conçu pour les sites Web riches en contenu.
2. [Server-first](#server-first) : Les sites Web s'exécutent plus rapidement lorsqu'ils rendent le HTML sur le serveur.
3. [Rapide par défaut](#fast-by-default) : Il devrait être impossible de construire un site Web lent dans Astro.
4. [Facile à utiliser](#easy-to-use) : Vous n'avez pas besoin d'être un expert pour construire quelque chose avec Astro.
5. [Axé pour les développeurs](#developer-focused) : Vous devez disposer des ressources nécessaires pour réussir.


## Axé sur le contenu \{#content-driven\}
...
## Rapide par défaut \{#fast-by-default\}
...
### Axé pour les développeurs \{#developer-focused\}
