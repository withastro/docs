...
:::tip
Si votre projet se situe dans le deuxième camp des "applications", Astro n'est peut-être pas le bon choix... **et ce n'est pas grave !** Consultez [Next.js](https://nextjs.org/) pour une alternative à Astro plus axée sur les applications.
:::
