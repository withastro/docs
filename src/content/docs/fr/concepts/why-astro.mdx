...
**Astro est un framework web tout-en-un**. Il comprend tout ce dont vous avez besoin pour créer un site web, de manière intégrée. Des centaines d'[intégrations](https://astro.build/integrations/) et de [hooks d'API](/fr/reference/integrations-reference/) sont également disponibles pour personnaliser un projet en fonction de vos besoins et de votre cas d'utilisation.

En voici quelques exemples :

- **[Îles](/fr/concepts/islands/)** : Une architecture web basée sur des composants optimisée pour les sites web axés sur le contenu.
...
2. [Priorité au serveur](#priorité-au-serveur) : Les sites Web s'exécutent plus rapidement lorsqu'ils rendent le HTML sur le serveur.
