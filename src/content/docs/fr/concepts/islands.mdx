...
## Qu'est-ce qu'un îlot ? \{#what-is-an-island\}
...
## Créer une île \{#creating-an-island\}
...
## Quels sont les avantages des îles ? \{#what-are-the-benefits-of-islands\}
