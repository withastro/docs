...
Ajoutez la directive [`server:defer`](/fr/reference/directives-reference/#server-directives) à n'importe quel composant Astro de votre page pour le transformer en son propre îlot de serveur :
