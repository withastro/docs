...
Lorsque vous visualisez votre site dans le navigateur, vous avez accès à la [boîte à outil de dev d'Astro](/fr/reference/configuration-reference/#dev-toolbar-options). Au fur et à mesure de la construction, elle vous aidera à inspecter vos [îlots](/fr/concepts/islands/), à repérer les problèmes d'accessibilité, et bien d'autres choses encore.
