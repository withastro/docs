...
Si vous souhaitez inclure des [composants de Framework](/fr/basics/framework-components/) comme React, Svelte, etc... ou utiliser d'autres outils tels que Tailwind ou Partytown dans votre projet, c'est ici qu'il faudra [importer et configurer ces intégrations](/fr/guides/integrations-guide/).
