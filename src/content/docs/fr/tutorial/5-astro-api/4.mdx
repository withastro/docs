...
## Installez le package RSS d'Astro \{#install-astros-rss-package\}
...
## Créez un document `.xml` de flux \{#create-an-xml-feed-document\}
...
- [Génération d'éléments RSS dans Astro](/fr/guides/rss/#using-glob-imports)
