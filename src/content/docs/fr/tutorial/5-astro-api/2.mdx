...
## Routage dynamique des pages \{#dynamic-page-routing\}
...
## Créez des pages dynamiquement \{#create-pages-dynamically\}
...
## Utilisation des props dans les routes dynamiques \{#use-props-in-dynamic-routes\}
...
### Analysez le modèle \{#analyze-the-pattern\}
...
## JavaScript avancé : Générer des pages à partir de balises existantes \{#advanced-javascript-generate-pages-from-existing-tags\}
...
- [Routage dynamique des pages dans Astro](/fr/guides/routing/#static-ssg-mode)
