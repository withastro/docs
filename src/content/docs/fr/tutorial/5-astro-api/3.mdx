...
Pour utiliser les props (valeurs passées) d'un article de blog en Markdown dans votre mise en page, comme les balises, vous devez préfixer la valeur avec un certain mot.
