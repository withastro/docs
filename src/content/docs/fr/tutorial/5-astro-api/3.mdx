...
## Utilisez le modèle de routage `/pages/dossier/index.astro` \{#use-the-pagesfolderindexastro-routing-pattern\}
...
## Essayez par vous-même - Créer une page répertoriant les étiquettes \{#try-it-yourself---make-a-tag-index-page\}
...
## Créez un tableau d'étiquettes \{#create-an-array-of-tags\}
...
## Créez votre liste de balises \{#create-your-list-of-tags\}
...
## Ajoutez des styles à votre liste d'étiquettes \{#add-styles-to-your-tag-list\}
...
### Validation du code \{#code-check-in\}
...
## Ajoutez cette page à votre navigation \{#add-this-page-to-your-navigation\}
...
## Défi : Inclure les étiquettes dans la mise en page de vos articles de blog \{#challenge-include-tags-in-your-blog-post-layout\}
...
Suivez les étapes ci-dessous, puis vérifiez votre travail en le comparant à l'[exemple de code final](#code-check-in-markdownpostlayout).
<Steps>
...
### Validation du code : MarkdownPostLayout \{#code-check-in-markdownpostlayout\}
...
- [Routage statique dans Astro](/fr/guides/routing/#static-routes)
