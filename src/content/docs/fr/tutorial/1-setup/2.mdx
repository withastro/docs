...
## Lancez l'assistant de configuration Astro \{#launch-the-astro-setup-wizard\}
...
## Ouvrez votre projet dans VS Code \{#open-your-project-in-vs-code\}
...
## Exécutez Astro en mode dev \{#run-astro-in-dev-mode\}
...
### Démarrez le serveur de dev \{#start-the-dev-server\}
...
## Visualisez un aperçu de votre site web \{#view-a-preview-of-your-website\}
