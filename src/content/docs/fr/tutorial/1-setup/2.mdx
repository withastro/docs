...
3. À la question, "Where would you like to create your new project?" ("Où souhaitez-vous créer votre nouveau projet ?") saisissez le nom d'un dossier pour créer un nouveau répertoire pour votre projet, par exemple `./tutorial`.
