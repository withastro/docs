...
7. Le projet de blog du tutoriel génère également dynamiquement une page pour chaque étiquette à l'aide de `src/pages/tags/[tag].astro` et affiche une liste des étiquettes dans `src/pages/tags/index.astro`.
        ...
        <Box icon="puzzle-piece">
          ...
          Importez et utilisez `getCollection` pour récupérer les étiquettes utilisées dans les articles de blog sur `src/pages/tags/index.astro`, en suivant les [mêmes étapes que ci-dessus](#remplacez-importmetaglob-par-getcollection).
