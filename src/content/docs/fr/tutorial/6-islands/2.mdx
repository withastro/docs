...
## Ajoutez et stylisez une icône de bascule de thème \{#add-and-style-a-theme-toggle-icon\}
...
## Ajoutez des styles CSS pour un thème sombre \{#add-css-styling-for-a-dark-theme\}
...
## Ajoutez de l'interactivité côté client \{#add-client-side-interactivity\}
