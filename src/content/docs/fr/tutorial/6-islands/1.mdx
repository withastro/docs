...
## Ajoutez Preact à votre projet Astro \{#add-preact-to-your-astro-project\}
...
## Incluez une bannière de salutation Preact \{#include-a-preact-greeting-banner\}
...
- [Utilisation de composants de framework UI dans Astro](/fr/guides/framework-components/#using-framework-components)
