...
Ce composant recevra un tableau de messages de salutation en tant que prop et affichera le premier comme message de bienvenue. L'utilisateur peut cliquer sur un bouton pour obtenir un nouveau message aléatoire.
...
3. Importez et utilisez ce composant sur votre page d'accueil `index.astro`.
    ...
    Vérifiez l'aperçu dans votre navigateur : vous devriez voir un message de bienvenue, mais le bouton ne fonctionnera pas !
...
- [Guide des intégrations Astro](/fr/guides/integrations/)
