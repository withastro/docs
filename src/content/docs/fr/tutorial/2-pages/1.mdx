---
type: tutorial
title: Créer votre première page Astro
description: |-
...
Maintenant que vous savez que les fichiers `.astro` sont responsables des pages de votre site web, il est temps d'en créer un !
...
Ajoutez une troisième page `blog.astro` à votre site, en suivant les [mêmes étapes que ci-dessus](#créer-un-nouveau-fichier-astro).
...
<Steps>
1. Créez un nouveau fichier `src/pages/blog.astro`.
...
- [Routage basé sur les fichiers dans Astro](/fr/basics/astro-pages/#routage-basé-sur-les-fichiers)
