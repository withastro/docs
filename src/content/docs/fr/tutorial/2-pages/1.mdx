...
## Créez un nouveau fichier `.astro` \{#create-a-new-astro-file\}
...
## Modifiez votre page \{#edit-your-page\}
...
## Ajoutez des liens de navigation \{#add-navigation-links\}
...
## Essayez par vous-même - Ajoutez une page Blog \{#try-it-yourself---add-a-blog-page\}
...
## Publiez vos modifications sur le web \{#publish-your-changes-to-the-web\}
