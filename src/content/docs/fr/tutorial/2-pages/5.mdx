...
## Ajoutez une feuille de style globale \{#add-a-global-stylesheet\}
...
## Essayez par vous-même - Importez votre feuille de style globale \{#try-it-yourself---import-your-global-stylesheet\}
...
### Analysez le motif \{#analyze-the-pattern\}
...
- [Comparaison entre la syntaxe d'Astro et JSX](/fr/basics/astro-syntax/#differences-between-astro-and-jsx)
