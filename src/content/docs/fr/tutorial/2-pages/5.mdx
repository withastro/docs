...
description: |-
  ...
  Créez une feuille de style globale pour le stylage de l'ensemble du site
i18nReady: true
---
...
Vous avez vu que la balise `<style>` d'Astro est **par défaut restreinte à la portée**, ce qui signifie qu'elle n'affecte que les éléments de son propre fichier.
...
- Les styles des deux méthodes de stylisation sont-ils appliqués ? 
...
- [Balise `<style>` Astro](/fr/guides/styling/#stylage
