...
## Définir et utiliser une variable \{#define-and-use-a-variable\}
...
## Écrire des expressions JavaScript dans Astro \{#write-javascript-expressions-in-astro\}
...
## Rendre des éléments de manière conditionnelle \{#conditionally-render-elements\}
...
- [Expressions dynamiques dans Astro](/fr/basics/astro-syntax/#jsx-like-expressions)
