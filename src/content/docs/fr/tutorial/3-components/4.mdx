...
## Construire un composant Hamburger \{#build-a-hamburger-component\}
...
## Rédigez votre première balise de script \{#write-your-first-script-tag\}
...
### Importation d'un fichier `.js` \{#importing-a-js-file\}
