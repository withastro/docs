...
## Créez un composant Footer \{#create-a-footer-component\}
...
### Importez et utilisez `Footer.astro` \{#import-and-use-footerastro\}
...
## Essayez par vous-même - Personnalisez votre pied de page \{#try-it-yourself---personalize-your-footer\}
...
### Point de contrôle du code \{#code-check-in\}
...
## Créez un composant Social Media \{#create-a-social-media-component\}
...
### Importez et utilisez `Social.astro` dans votre Footer \{#import-and-use-socialastro-in-your-footer\}
...
## Stylisez votre composant Social Media \{#style-your-social-media-component\}
...
- [Props de composants dans Astro](/fr/basics/astro-components/#component-props)
