...
**Réfactorisez** vos autres pages (`blog.astro` and `about.astro`) pour qu'elles utilisent votre nouveau composant `<BaseLayout>` pour afficher les éléments de page communs.
