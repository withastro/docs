...
description: >-
  ...
  Créez une mise en page de billet de blog pour vos fichiers Markdown et transmettez-y 
  les valeurs du frontmatter en tant que props
i18nReady: true
---
...
## Ajoutez une mise en page à vos billets de blog \{#add-a-layout-to-your-blog-posts\}
...
## Essayez par vous-même - Personnalisez la mise en page de votre billet de blog \{#try-it-yourself---customize-your-blog-post-layout\}
...
- [Props de mise en page Markdown](/fr/basics/layouts/#propriétés-de-mise-en-page-markdown)

- [Introduction à YAML](https://dev.to/paulasantamaria/introduction-to-yaml-125f) 
 <Badge class="neutral-badge" text="externe" />
