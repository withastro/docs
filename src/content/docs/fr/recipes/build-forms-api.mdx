...
## Prérequis
- Un projet avec [SSR](/fr/guides/server-side-rendering/) (`output: 'server'` ou `'hybrid'`) activé
- Un projet avec l'[intégration Framework UI](/fr/basics/framework-components/) installé
