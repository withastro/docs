...
Cette méthode est dépréciées pour toutes les versions d'Astro depuis la version 2.1.0, et ne peut pas être utilisée dans les projets modernes.
:::
...
La propriété `content` contient le contenu complet de l'article en HTML. Cela vous permet de mettre l'intégralité du contenu de votre article à la disposition des lecteurs de flux RSS.
