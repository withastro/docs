...
La page suivante attend (`await`) des données dans son frontmatter. Astro attendra que tous les appels `fetch` soient résolus avant d'envoyer du HTML au navigateur.
