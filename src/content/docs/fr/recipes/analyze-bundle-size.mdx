...
Il est important de comprendre ce qui constitue une partie d'un paquet Astro pour améliorer les performances du site. La visualisation du paquet peut donner des indications sur les modifications à apporter à votre projet pour réduire la taille du paquet.
