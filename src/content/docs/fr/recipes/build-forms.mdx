...
:::tip[Créer des formulaires avec les actions d'Astro]
Dans la version 4.15, Astro a ajouté des actions offrant plusieurs avantages par rapport aux formulaires HTML classiques, notamment la validation des données du formulaire et la mise à jour de l'interface utilisateur après envoi du formulaire. Pour utiliser cette méthode pour créer des formulaires, consultez notre [guide des actions](/fr/guides/actions/) pour en savoir plus sur ces fonctionnalités.
:::
