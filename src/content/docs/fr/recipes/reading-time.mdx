...
4. Afficher le temps de lecture
    ...
    Si vous utilisez une [mise en page Markdown](/fr/guides/markdown-content/#mises-en-page-markdown), utilisez la propriété `minutesRead` du frontmatter de `Astro.props` dans votre template.
