...
Pour créer votre premier test Playwright, suivez les instructions pour le reste du processus Playwright dans le [Astro Testing Guide](/fr/guides/testing/#créer-votre-premier-test-playwright).
