...
Cette recette calcule le temps en fonction de l'historique Git de votre dépôt et celui-ci peut ne pas être précis sur certaines plateformes de déploiement. Votre hébergeur peut effectuer des **clones superficiels** qui ne récupèrent pas l'historique Git complet.
:::
