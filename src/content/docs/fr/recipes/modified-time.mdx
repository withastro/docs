...
4. Afficher l'heure de la dernière modification
   ...
   Si vous utilisez la [mise en page Markdown](/fr/basics/layouts/#pages-markdown), utilisez la propriété du frontmatter `lastModified` de `Astro.props` dans votre modèle de mise en page.
