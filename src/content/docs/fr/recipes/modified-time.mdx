...
1. Installer les paquets d'aide
   ...
   Installez [`@astrojs/markdown-remark`](https://www.npmjs.com/package/@astrojs/markdown-remark) pour utiliser le [processeur `unified()`](/fr/guides/markdown-content/#utilisation-des-modules-dextension-remark-et-rehype) :
