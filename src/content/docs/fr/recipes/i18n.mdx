...
Si vous préférez que la langue par défaut ne soit pas visible dans l'URL contrairement aux autres langues, vous trouverez [des instructions pour masquer la langue par défaut](/fr/recipes/i18n/#hide-default-language-in-the-url) ci-dessous.
