---
title: Xata & Astro
description: Ajoutez une base de données serverless avec recherche plein texte à votre projet avec Xata
sidebar:
  label: Xata
type: backend
logo: xata
...
[Xata](https://xata.io) est une **plateforme de données serverless** qui combine les fonctionnalités d'une base de données relationnelle, d'un moteur de recherche et d'un moteur d'analyse en exposant une seule API REST.
...
```ini title=".xatarc"
{
  "databaseUrl": "https://url-de-votre-base-de-donnees"
}
```
