...
```
cUne fois que vous avez configuré votre `sourceMapsUploadOptions` et ajouté votre `dsn`, le SDK capturera et enverra automatiquement les erreurs et les événements de performance à Sentry.
