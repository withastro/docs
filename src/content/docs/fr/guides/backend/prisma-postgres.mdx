...
## Connexion avec d'autres ORM et librairies

Vous pouvez vous connecter à Prisma Postgres via TCP direct en utilisant n'importe quel autre ORM, librairie de base de données, ou l'outil de votre choix. Pour commencer, créez une chaîne de connexion directe dans votre console Prisma.
