...
## Initialisation de Firebase dans Astro \{#initializing-firebase-in-astro\}
...
### Ajouter les informations d'identification Firebase \{#adding-firebase-credentials\}
...
## Ajouter l'authentification avec Firebase \{#adding-authentication-with-firebase\}
...
### Créer les points de terminaison du serveur d'authentification \{#creating-auth-server-endpoints\}
...
### Création des pages \{#creating-pages\}
...
### Ajout des fournisseurs OAuth \{#adding-oauth-providers\}
...
## Connexion à Firestore Database \{#connecting-to-firestore-database\}
...
### Création des points de terminaison serveur \{#creating-the-server-endpoints\}
...
### Création des pages \{#creating-pages-1\}
...
#### Ajouter une nouvelle entrée \{#add-a-new-record\}
...
#### Modifier ou supprimer une entrée \{#edit-or-delete-a-record\}
...
#### Afficher une entrée individuelle \{#display-an-individual-record\}
...
#### Affiche une liste d'entrées avec un bouton d'édition \{#display-a-list-of-records-with-an-edit-button\}
