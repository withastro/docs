...
- Le [Turso CLI](https://docs.turso.tech/reference/turso-cli) installé et connecté
...
:::attention
N'utilisez pas le préfixe `PUBLIC_` lors de la création de ces [variables d'environnement](/en/guides/environment-variables/) privées. Cela exposerait ces valeurs côté client.
:::
