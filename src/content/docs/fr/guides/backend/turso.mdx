...
- La [CLI de Turso](https://docs.turso.tech/reference/turso-cli) installée et connectée
...
La méthode `execute()` peut accepter [un objet pour transmettre des variables à l'instruction SQL](https://docs.turso.tech/libsql/client-access/javascript-typescript-sdk#positional-placeholders), tel que le `slug` ou la pagination.
