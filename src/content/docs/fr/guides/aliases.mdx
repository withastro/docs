...
Dans cet exemple, un développeur devra comprendre la relation arborescente entre `src/pages/about/company.astro`, `src/components/controls/Button.astro`, et `src/assets/logo.png`. Et si le fichier `company.astro` devait être déplacé, ces importations devraient également être mises à jour.
