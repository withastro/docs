...
description: 'Apprenez à utiliser React, Svelte, etc.. avec Astro'
...
## Intégrations officielles de Framework UI \{#official-ui-framework-integrations\}

Astro supporte un large choix de Frameworks comme [React](https://react.dev/), [Preact](https://preactjs.com/), [Svelte](https://svelte.dev/), [Vue](https://vuejs.org/), [SolidJS](https://www.solidjs.com/), [AlpineJS](https://alpinejs.dev/) et [Lit](https://lit.dev/) avec des intégrations officielles..
...
## Installation d'intégrations \{#installing-integrations\}
...
## Utilisation des composants de Framework \{#using-framework-components\}
...
## Hydratation des composants interactifs \{#hydrating-interactive-components\}

Un composant du framework peut être rendu interactif (hydraté) à l'aide d'une directive [`client:*`](/fr/reference/directives-reference/#client-directives). Il s'agit d'attributs de composant qui déterminent quand le JavaScript de votre composant doit être envoyé au navigateur.
...
### Directives d'hydratation disponibles \{#available-hydration-directives\}
...
<ReadMore>Allez voir notre [page de référence des directives](/fr/reference/directives-reference/#client-directives) pour une description complète de ces directives, et de leur utilisation.</ReadMore>

## Mixer des Frameworks \{#mixing-frameworks\}
...
## Transmettre des Props aux composants du framework \{#passing-props-to-framework-components\}

Les composants Astro peuvent transmettre des propriétés (Props) aux composants du framework :
...
## Passer des Enfants à des Composants de Framework \{#passing-children-to-framework-components\}
...
De plus, vous pouvez utiliser les ["Slots" Nommés](/fr/basics/astro-components/#named-slots) pour grouper des enfants spécifiques ensemble.
...
## Imbriquer des composants de Framework \{#nesting-framework-components\}
...
## Puis-je utiliser les composants Astro à l'intérieur des composants de mon framework ? \{#can-i-use-astro-components-inside-my-framework-components\}
...
Vous pouvez cependant utiliser [le modèle Astro `<slot />`](/fr/basics/astro-components/#slots) pour passer du contenu statique généré par des composants Astro en tant qu'enfants à vos composants framework **à l'intérieur d'un composant `.astro`**.
...
## Puis-je hydrater des composants Astro ? \{#can-i-hydrate-astro-components\}
