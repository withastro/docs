...
- Les Transitions de Vue pour des transitions de page animées et des îlots persistants. Consultez [les modifications cassantes liées à l'API des Transitions de Vue et les conseils de mise à niveau](#mettre-à-niveau-les-transitions-de-vue-vers-la-v3) si vous utilisiez cette option expérimentale.
...
## Changements avec rupture de compatibilité dans Astro v3.0

Astro v3.0 inclut quelques modifications majeures, ainsi que la suppression de certaines fonctionnalités précédemment obsolètes. Si votre projet ne fonctionne pas comme prévu après la mise à niveau vers la version 3.0, consultez ce guide pour un aperçu de toutes les modifications avec rupture de compatibilité et des instructions sur la façon de mettre à jour votre base de code.
...
Si vous utilisiez auparavant des transitions de vue expérimentales, des modifications cassantes peuvent survenir lorsque vous mettez à niveau votre projet Astro à partir d'une version antérieure.
