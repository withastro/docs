...
<ReadMore>En savoir plus sur les [règles d'ordre de priorité des routes](/fr/guides/routage/#ordre-de-priorité-des-routes).</ReadMore>
...
<ReadMore>En savoir plus sur [TypeScript configuration in Astro](/fr/guides/typescript/#configuration).</ReadMore>
...
<ReadMore>Voir la [Référence API pour `IntegrationRouteData`](/fr/reference/integrations-reference/#référence-du-type-integrationroutedata).</ReadMore>
