...
Vous pouvez également [mettre à niveau manuellement vos intégrations Astro](/fr/guides/integrations/#manual-upgrading) si nécessaire, et vous devrez peut-être aussi mettre à niveau d'autres dépendances de votre projet.
