...
Vous pouvez également [mettre à jour manuellement vos intégrations Astro](/fr/guides/integrations-guide/#mise-à-niveau-manuelle) si nécessaire, et vous devrez peut-être aussi mettre à jour d'autres dépendances de votre projet.
