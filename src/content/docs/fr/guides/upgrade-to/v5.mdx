...
Vous pouvez également [mettre à niveau manuellement vos intégrations Astro](/fr/guides/integrations/#mise-à-niveau-manuelle) si nécessaire, et vous devrez peut-être aussi mettre à niveau d'autres dépendances de votre projet.
...
<ReadMore>En savoir plus sur les [intégrations officielles d'Astro](/fr/guides/integrations/).</ReadMore>
...
<ReadMore>En savoir plus sur l'[utilisation de modules d'extension pour les processeurs Markdown dans Astro](/fr/guides/markdown-content/#modules-dextension-pour-les-processeurs-markdown).</ReadMore>
