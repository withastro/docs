...
Besoin de voir la documentation de la v3 ? Visitez cette [ancienne version du site de documentation (instantané de la v3.6 non maintenu)](https://web.archive.org/web/20231203051122/https://docs.astro.build/fr/getting-started/).
...
Si vous avez besoin de vous référer à la documentation d'un projet v3.x, vous pouvez parcourir cet [instantané (non maintenu) de la documentation datant d'avant la sortie de la v4.0](https://web.archive.org/web/20231203051122/https://docs.astro.build/fr/getting-started/).
