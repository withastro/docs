...
Astro v4.0 inclut [des modifications potentiellement non rétrocompatibles](#changements-non-rétrocompatibles), ainsi que la [suppression de certaines fonctionnalités précédemment obsolètes](#fonctionnalités-précédemment-obsolètes-désormais-supprimées).
