...
La fonction [`middleware()`](/fr/reference/modules/astro-i18n/#middleware) crée manuellement le middleware i18n d'Astro. Cela vous permet d'étendre le routage i18n d'Astro plutôt que de le remplacer complètement. 
...
- Le fichier `/about.astro` créera l'URL `https://example.com/about`.
