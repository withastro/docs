...
- Article de blog : [Hugo Vs Astro - Quel générateur de site statique choisir en 2023](https://onebite.dev/hugo-vs-astro-which-static-site-generator-to-choose-in-2023/) (en).
- Article de blog : [L'histoire de la migration d'Elio Struyf de Hugo vers Astro](https://www.eliostruyf.com/migration-story-hugo-astro/) (en)
