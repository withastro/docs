...
- Hugo et Astro vous permettent tous deux de [rédiger votre contenu en Markdown](/fr/guides/content/#en-utilisant-markdown). Cependant, Hugo inclut plusieurs propriétés spéciales de frontmatter et vous permet d'écrire du frontmatter en YAML, TOML ou JSON. Même si beaucoup de vos propriétés Hugo frontmatter existantes ne seront pas "spéciales" dans Astro, vous pouvez continuer à utiliser vos fichiers Markdown existants et vos valeurs YAML frontmatter.
...
- Blog Post : [Hugo Vs Astro - Quel générateur de site statique choisir en 2023](https://onebite.dev/hugo-vs-astro-which-static-site-generator-to-choose-in-2023/).
