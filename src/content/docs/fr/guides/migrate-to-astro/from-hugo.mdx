...
<CardGrid>
  ...
  <LinkCard title="Leçons tirées d'une migration assistée par l'IA vers Astro (Anglais)" href="https://tomscarnivores.com/tech/lessons-from-ai-assisted-migration-to-astro/" />
