...
## Principales similitudes entre SvelteKit et Astro \{#key-similarities-between-sveltekit-and-astro\}
...
- Astro possède [une intégration officielle pour l'utilisation des composants Svelte](/fr/guides/integrations-guide/svelte/) et supporte [l'installation des paquets NPM](/fr/guides/imports/#npm-packages), dont plusieurs pour Svelte. Vous serez en mesure d'écrire des composants d'interface utilisateur Svelte, et pourrez peut-être conserver tout ou partie de vos composants et dépendances existants.
...
## Principales différences entre SvelteKit et Astro \{#key-differences-between-sveltekit-and-astro\}
...
- [Axé sur le contenu](/fr/concepts/why-astro/#content-driven) : Astro a été conçu pour mettre en valeur votre contenu et vous permettre d'opter pour l'interactivité uniquement en cas de besoin. Une application SvelteKit existante peut être conçue pour une forte interactivité côté client. Astro a des capacités intégrées pour travailler avec votre contenu, comme la génération de pages, mais peut nécessiter des techniques Astro avancées pour inclure des éléments qui sont plus difficiles à reproduire en utilisant les composants `.astro`, comme les tableaux de bord.
...
## Passer de SvelteKit à Astro \{#switch-from-sveltekit-to-astro\}
