...
- Astro et Gridsome vous permettent tous deux d'utiliser un [CMS headless, des APIs ou des fichiers Markdown pour les données](/fr/guides/data-fetching/). Vous pouvez continuer à utiliser votre système préféré de [création de contenu](/fr/guides/content/) et conserver votre contenu existant.
