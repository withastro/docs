...
- Astro et Eleventy vous permettent tous deux d'utiliser un [headless CMS, APIs ou fichiers Markdown pour les données](/fr/guides/data-fetching/). Vous pouvez continuer à utiliser votre système préféré de [création de contenu](/fr/guides/content/) et conserver votre contenu existant.
