...
## Principales similitudes entre Eleventy (11ty) et Astro \{#key-similarities-between-eleventy-11ty-and-astro\}
...
## Principales différences entre Eleventy (11ty) et Astro \{#key-differences-between-eleventy-11ty-and-astro\}
...
- Dans Eleventy, le regroupement des fichiers CSS, JavaScript et autres actifs doit être configurés manuellement. [Astro s'en charge dès le départ](/fr/concepts/why-astro/#easy-to-use).

## Passer d'Eleventy à Astro \{#switch-from-eleventy-to-astro\}
