...
Voici quelques concepts clés et stratégies de migration pour vous aider à démarrer. Utilisez le reste de nos documents et notre [communauté Discord](https://astro.build/chat) pour continuer !
...
Convertissez tous les composants Next `<Image />` en [composant d'image propre à Astro](/fr/guides/images/#image--astroassets) dans les fichiers `.astro` ou `.mdx`, ou en code [HTML/JSX standard avec la balise `<img />`](/fr/guides/images/#images-dans-les-composants-framework-ui) selon les besoins dans vos composants React.

Le composant `<Image />` d'Astro fonctionne uniquement dans les fichiers `.astro` et `.mdx`. Consultez la [liste complète de ses attributs de composants](/fr/guides/images/#propriétés) et notez que plusieurs différeront des attributs de Next.
...
- Vidéo : [NextJS to Astro: more control = faster sites](https://www.youtube.com/watch?v=PSzCtdM20Fc).

- Vidéo : [How Astro made my site 100x faster](https://www.youtube.com/watch?v=cOxA3kMYtkM).

- Article de blog : [Migrating from Next.js to Astro](https://johnzanussi.com/posts/nextjs-to-astro-migration).

- Article de blog : [From NextJS to Astro](https://vanntile.com/blog/next-to-astro).
- Article de blog : [Converting Next.js to Astro](https://ericclemmons.com/blog/converting-nextjs-to-astro).
