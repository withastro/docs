...
- vos [fichiers Markdown/MDX](/fr/guides/markdown-content/), avec un [processeur Markdown configurable](/fr/guides/markdown-content/#processeurs-markdown) qui prend en charge les modules d'extension.
