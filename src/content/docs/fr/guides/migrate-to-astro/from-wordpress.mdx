...
Vous pouvez continuer à [utiliser votre blog WordPress existant comme CMS pour Astro](/fr/guides/cms/wordpress/), ce qui signifie que vous continuerez à utiliser votre tableau de bord WordPress pour rédiger vos articles. Vos contenus seront gérés par WordPress, mais tous les autres aspects de votre site Astro seront construits dans votre environnement d'édition de code, et vous [déployerez votre site Astro](/en/guides/deploy/) séparément de votre site WordPress. (Assurez-vous de mettre à jour votre domaine chez votre hébergeur pour conserver la même URL de site web !)
