...
## Principales similitudes entre Docusaurus et Astro \{#key-similarities-between-docusaurus-and-astro\}

Docusaurus et Astro partagent certaines similitudes qui vous aideront à migrer votre projet :

- Astro et Docusaurus sont tous deux des créateurs de sites modernes, basés sur JavaScript (Jamstack) et destinés aux [sites web axés sur le contenu](/fr/concepts/why-astro/#content-driven), comme les sites de documentation.
...
- Astro supporte [l'installation de paquets NPM](/fr/guides/imports/#npm-packages), dont plusieurs pour React. Vous pouvez conserver tout ou partie de vos composants et dépendances React existants.

- La [syntaxe JSX d'Astro](/fr/basics/astro-components/#the-component-template) devrait vous sembler familière si vous avez l'habitude d'écrire React.

## Principales différences entre Docusaurus et Astro \{#key-differences-between-docusaurus-and-astro\}
...
## Passer de Docusaurus à Astro \{#switch-from-docusaurus-to-astro\}
