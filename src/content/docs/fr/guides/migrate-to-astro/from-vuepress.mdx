...
## Principales similitudes entre VuePress et Astro \{#key-similarities-between-vuepress-and-astro\}
...
- Astro et VuePress sont tous deux conçus pour les [sites web axés sur le contenu](/fr/concepts/why-astro/#content-driven), avec un excellent support intégré pour les fichiers Markdown. L'écriture en Markdown vous sera familière et vous pourrez conserver votre contenu existant.

- Astro possède [une intégration officielle pour l'utilisation des composants Vue](/fr/guides/integrations-guide/vue/) et prend en charge [l'installation des paquets NPM](/fr/guides/imports/#npm-packages), dont plusieurs pour Vue. Vous serez en mesure d'écrire des composants d'interface utilisateur Vue et pourrez conserver tout ou partie de vos composants et dépendances Vue existants.


## Principales différences entre VuePress et Astro \{#key-differences-between-vuepress-and-astro\}
...
## Passer de VuePress à Astro \{#switch-from-vuepress-to-astro\}
