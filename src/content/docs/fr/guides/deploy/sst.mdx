...
1. Il devrait détecter que vous utilisez Astro et vous demander de confirmer.
1. Une fois que vous êtes prêt pour le déploiement, vous pouvez lancer `npx sst deploy --stage=production`
