...
Vous pouvez également utiliser des composants SST supplémentaires omme les Cron Jobs, les Buckets, les Queues, etc. tout en préservant la sûreté du typage.
