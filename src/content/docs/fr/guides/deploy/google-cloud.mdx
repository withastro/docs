...
### Cloud Storage (statique uniquement) \{#cloud-storage-static-only\}
...
### Cloud Run (SSR et statique) \{#cloud-run-ssr-and-static\}
...
#### Préparer le service \{#prepare-the-service\}
...
#### Créer un fichier Dockerfile et composer le Container \{#create-dockerfile--build-the-container\}
...
#### Déployer le conteneur \{#deploying-the-container\}
