...
## Configurer Astro pour les pages GitHub \{#configure-astro-for-github-pages\}

### Déployer vers une URL `github.io` \{#deploying-to-a-githubio-url\}
...
### Utiliser les pages GitHub avec un domaine personnalisé \{#using-github-pages-with-a-custom-domain\}
...
## Configurer une action GitHub \{#configure-a-github-action\}
