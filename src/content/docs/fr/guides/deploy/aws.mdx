...
Pour déployer votre projet sur AWS, vous devez utiliser la [console AWS](https://aws.amazon.com/console/). (La plupart de ces actions peuvent également être effectuées à l'aide de [AWS CLI](https://aws.amazon.com/cli/)). Ce guide vous guidera à travers les étapes pour déployer votre site sur AWS en utilisant [AWS Amplify](https://aws.amazon.com/amplify/), [Hébergement de sites web statiques S3](https://aws.amazon.com/s3/), et [CloudFront](https://aws.amazon.com/cloudfront/).
