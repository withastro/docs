...
## Hébergement de sites web statiques S3 \{#s3-static-website-hosting\}
...
## S3 avec CloudFront \{#s3-with-cloudfront\}
...
:::note
Lorsque vous connectez CloudFront à un point d'extrémité de site web statique S3, vous vous appuyez sur les politiques de S3 Bucket pour le contrôle d'accès. Voir la section [Hébergement de sites web statiques S3](/fr/guides/deploy/aws/#s3-static-website-hosting) pour plus d'informations sur les politiques des Bucket.
:::

## Déploiement continu avec GitHub Actions \{#continuous-deployment-with-github-actions\}
