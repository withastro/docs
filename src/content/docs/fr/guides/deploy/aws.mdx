...
the function you created in the previous step.
...
2. Créez une réponse d'erreur personnalisée pour les erreurs 403 avec les valeurs suivantes :
  ...
  :::tip
  Pour une meilleure expérience utilisateur, vous pouvez [créer une page 404 personnalisée](/fr/core-concepts/astro-pages/#page-derreur-404-personnalisée) dans votre projet et définir le **Response page path** à `/404.html`.
  :::
