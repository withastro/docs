...
### Déploiement via l'interface utilisateur du site web \{#website-ui-deployment\}
...
3. Assurez-vous que les paramètres suivants sont saisis, puis appuyez sur le bouton <kbd>Deploy</kbd> :
 ...
 #### Le fichier `netlify.toml` \{#netlifytoml-file\}
...
### Définir une version de Node.js \{#set-a-nodejs-version\}
...
## Utilisation des fonctions Netlify \{#using-netlify-functions\}
