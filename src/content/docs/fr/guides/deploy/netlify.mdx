...
Si vous utilisez une ancienne [image de la compilation (Anglais)](https://docs.netlify.com/configure-builds/get-started/#build-image-selection) (Xenial) sur Netlify, assurez-vous que votre version de Node.js est définie. Astro nécessite `v22.12.0` ou une version plus récente.
