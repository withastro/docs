...
Pour pousser un site Astro dans sur Space, assurez-vous d'abord que :
...
Ceci lancera le processus de construction et créera une nouvelle [instance Space](https://deta.space/docs/en/build/fundamentals/development/builder-instance#for-testing) où vous pourrez accéder à votre application Astro.
