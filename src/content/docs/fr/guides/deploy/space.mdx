...
:::note
Les instructions suivantes ne fonctionneront pas pour les projets Astro v3.0+ car Space ne supporte actuellement que [Node.js 16](https://deta.space/docs/en/build/quick-starts/node/).
:::
