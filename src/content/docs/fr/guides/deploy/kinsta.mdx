...
## Configurer votre projet Astro \{#configuring-your-astro-project\}

### Hébergement statique \{#static-hosting\}
...
### Configurer une nouvelle application Kinsta \{#configuring-a-new-kinsta-application\}
