...
## Site Astro Static sur Zerops \{#astro-static-site-on-zerops\}

### Création d'un projet et d'un service pour Astro Static \{#creating-a-project-and-a-service-for-astro-static\}
...
### Déploiement de votre site Astro Static \{#deploying-your-astro-static-site\}
...
Maintenant, vous pouvez [déclencher le pipeline de construction et de déploiement en utilisant le CLI Zerops](#trigger-the-pipeline-using-zerops-cli-zcli) ou en connectant le service `app` à votre dépôt [GitHub](https://docs.zerops.io/references/github-integration/) / [GitLab](https://docs.zerops.io/references/gitlab-integration) depuis le détail du service.

## Site Astro SSR sur Zerops \{#astro-ssr-site-on-zerops\}

### Création d'un projet et d'un service pour Astro SSR (Node.js) \{#creating-a-project-and-a-service-for-astro-ssr-nodejs\}
Les projets et les services peuvent être ajoutés soit par un assistant [`Project add`](https://app.zerops.io/dashboard/project-add), soit importés en utilisant une structure yaml :
...
### Déploiement de votre site Astro SSR \{#deploying-your-astro-ssr-site\}
...
## Déclencher le pipeline en utilisant Zerops CLI (zcli) \{#trigger-the-pipeline-using-zerops-cli-zcli\}
