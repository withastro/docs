...
[Clever Cloud](https://www.clever.cloud) est une plateforme cloud européenne qui fournit des services automatisés et évolutifs.
...
6. Ignorez [la connexion des **modules complémentaires** à votre application Clever](https://www.clever.cloud/developers/doc/addons/) sauf si vous utilisez une base de données ou Keycloak.
