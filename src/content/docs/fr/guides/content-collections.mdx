...
Lorsque les chargeurs en direct fournissent des [indications de cache](/fr/reference/content-loader-reference/#live-loaders), `getLiveEntry()` et `getLiveCollection()` renvoient un objet `cacheHint`. Cela vous permet de contrôler le [comportement de mise en cache](/fr/guides/caching/) de vos routes sans définir manuellement les en-têtes.
