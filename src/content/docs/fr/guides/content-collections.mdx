...
### Filtrage des requêtes de collection
...
Vous pouvez [créer une collection](#définition-de-collections) à chaque fois que vous disposez d'un groupe de données ou de contenus associés qui partagent une structure commune.
...
[Définissez vos données](#définition-de-collections) comme une collection lorsque :
