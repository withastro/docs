...
:::note
Il s'agit d'un [paramètre spécifique à Vite](https://vite.dev/config/ssr-options.html#ssr-noexternal) qui n'a _pas_ de rapport avec (ou ne nécessite pas) [Astro SSR](/fr/guides/server-side-rendering/).
:::
