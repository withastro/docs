...
## Applications intégrées \{#built-in-apps\}
...
## Améliorer la barre d'outils de développement \{#extending-the-dev-toolbar\}
...
## Désactivation de la barre d'outils dev \{#disabling-the-dev-toolbar\}
