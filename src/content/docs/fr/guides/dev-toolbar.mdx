...
Installez les intégrations supplémentaires de la barre d'outils de développement dans votre projet comme n'importe quelle autre [intégration Astro](/fr/guides/integrations/) en suivant ses propres instructions d'installation.
