...
L'application Paramètres vous permet de configurer les options de la barre d'outils de développement, telles que la journalisation verbeuse, la désactivation des notifications et l'ajustement de son emplacement sur l'écran.
