...
Pour désactiver la barre d'outils de dévelopement dans tous les projets Astro pour un utilisateur sur la machine courante, ajoutez le drapeau `--global` lors de l'exécution de `astro-preferences` :
