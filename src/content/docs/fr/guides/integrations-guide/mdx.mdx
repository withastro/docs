...
Pour inclure des fichiers MDX dans une collection de contenus, assurez-vous que votre [chargeur de collection](/fr/guides/collections de contenus/#defining-the-collection-loader) est configuré pour charger du contenu à partir de fichiers `.mdx` :
