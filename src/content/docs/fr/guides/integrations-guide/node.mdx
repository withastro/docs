...
Cet adaptateur permet à Astro de déployer votre [site rendu `hybrid` ou `server`](/fr/core-concepts/rendering-modes/#rendu-à-la-demanded) vers des cibles Node.

Si vous utilisez Astro comme [constructeur de site statique](/fr/core-concepts/rendering-modes/#pré-rendu), vous n'avez pas besoin d'adaptateur.
