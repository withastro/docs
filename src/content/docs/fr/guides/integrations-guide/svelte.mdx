...
Cette **[intégration Astro][astro-integration]** permet le rendu côté serveur et l'hydratation côté client pour vos 5 composants [Svelte](https://svelte.dev/). Pour le support de Svelte 3 et 4, installez `@astrojs/svelte@5` à la place.
