...
Pour plus de personnalisation, vous pouvez passer des options dans [le plugin Vue DevTools Vite](https://devtools-next.vuejs.org/guide/vite-plugin#options) supporte. (Note : `appendTo` n'est pas supporté).
