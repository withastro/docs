...
Vous pouvez activer [Vue DevTools](https://devtools-next.vuejs.org/) dans le développement en passant un objet avec `devtools : true` à votre configuration d'intégration `vue()` :
