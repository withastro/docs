...
Cette **[intégration Astro][astro-integration]** apporte les classes CSS utilitaires de [Tailwind](https://tailwindcss.com/) à chaque fichier `.astro` et [composant de framework](/fr/basics/framework-components/) de votre projet, ainsi que le support du fichier de configuration de Tailwind.
...
[astro-ui-frameworks]: /fr/basics/framework-components/#utilisation-des-composants-de-framework
