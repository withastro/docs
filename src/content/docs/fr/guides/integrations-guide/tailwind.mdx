...
Cette **[integration Astro][astro-integration]** apporte les classes CSS utilitaires de [Tailwind](https://tailwindcss.com/) aux fichiers `.astro` et aux [composants de framework](/en/core-concepts/framework-components/) de votre projet, ainsi que le support du fichier de configuration de Tailwind.
