...
Cette **[intégration Astro][astro-integration]** apporte les classes CSS utilitaires de [Tailwind](https://tailwindcss.com/) à chaque fichier `.astro` et [composant de framework](/en/core-concepts/framework-components/) de votre projet, ainsi que le support du fichier de configuration de Tailwind.
...
Vous pouvez maintenant [importer votre propre `base.css` comme feuille de style locale](/#import-a-local-stylesheet).
