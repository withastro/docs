...
Une union de valeurs valides permettant de spécifier la fréquence de mise à jour d'une entrée.
...
Spécifie l'URL absolue de la page pour la langue spécifiée.
