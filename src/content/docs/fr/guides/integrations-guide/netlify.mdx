...
Cet adaptateur utilise le [Netlify Image CDN](https://docs.netlify.com/image-cdn/) pour transformer les images à la volée sans impacter le temps de construction.
Il est implémenté en utilisant un [Service d'images](/fr/reference/image-service-reference/) sous le capot.
