...
- **`cloudflare-binding` :** Utilise la [liaison Cloudflare Images](https://developers.cloudflare.com/images/transform-images/bindings/) pour la transformation d'images. Ce module est automatiquement configuré lors du déploiement.
