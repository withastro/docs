...
Si vous utilisez Astro en tant que [constructeur de site statique](/fr/core-concepts/modes de rendu/#pré-rendu), vous n'avez pas besoin d'adaptateur.
...
📚 **[Lire le guide de déploiement complet ici.](/fr/guides/deploy/vercel/)**
