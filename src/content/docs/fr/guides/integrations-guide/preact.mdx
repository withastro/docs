...
Consultez ["Apprendre Preact en 10 minutes"](https://preactjs.com/tutorial), un tutoriel interactif sur leur site web.
...
Vous pouvez activer [Preact devtools](https://preactjs.github.io/preact-devtools/) dans le développement en passant un objet avec `devtools : true` à votre configuration d'intégration `preact()` :
