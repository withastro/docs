...
L'exemple suivant crée un widget pour autoriser les transferts non signés en transmettant un [préréglage de transfert] non signé(https://cloudinary.com/documentation/upload_presets):
