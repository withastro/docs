...
- `_server_islands/`: Servir les composants dynamiques différés dans une [Île de serveur](/fr/reference/configuration-reference/#experimentalserverislands);
- `_actions/`: Serves any defined [actions](/fr/guides/actions/).
