...
Pour les routes rendues à la demande, un seul paramètre reste utilisant la notation de propagation peut être utilisé dans le nom de fichier (par exemple `src/pages/[locale]/[...slug].astro` ou `src/pages/[...locale]/[slug].astro`, mais pas `src/pages/[...locale]/[...slug].astro`).
