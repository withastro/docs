...
L'exemple suivant vérifie si un utilisateur peut accéder à un tableau de bord avant d'exécuter le pipeline d'Astro, et ajoute un en-tête personnalisé à la réponse une fois qu'Astro a terminé l'exécution :
