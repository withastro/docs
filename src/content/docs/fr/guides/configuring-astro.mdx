...
Astro est un framework flexible et neutre qui vous permet de configurer votre projet de multiples façons. Cela signifie que le démarrage d'un nouveau projet peut sembler difficile : il n'y a pas de « meilleure façon » de configurer votre projet Astro !
