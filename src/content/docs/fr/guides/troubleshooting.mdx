...
- Votre import a-t-il le même nom que le composant importé ? (Vérifiez le nom de votre composant et qu'il [respecte la syntaxe `.astro`](/fr/reference/astro-syntax/#diff%C3%A9rences-entre-astro-et-jsx).)
