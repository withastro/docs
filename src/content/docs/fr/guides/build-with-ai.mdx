...
Un fichier de verrouillage (`.astro/dev.json`) est créé au démarrage du serveur de développement, enregistrant l'URL, le port et le PID du serveur. Cela empêche le démarrage de serveurs en double pour un même projet.
