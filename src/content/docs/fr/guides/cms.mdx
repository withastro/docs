...
<ReadMore> Explorez une [liste de plus de 100 systèmes de gestion de contenu headless](https://jamstack.org/headless-cms/) <Badge variant="accent">Externe</Badge> où vous pouvez filtrer par type (par exemple, basé sur Git, orienté API) et par licence (open-source ou closed-source).</ReadMore>

## Puis-je utiliser Astro sans un CMS ?

Oui ! Astro fournit des moyens intégrés pour [rédiger du contenu](/fr/guides/content/), y compris le support des pages Markdown.
