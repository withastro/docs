...
De plus, vous pouvez étendre Astro pour ajouter le support de différents [Frameworks UI](/fr/basics/framework-components/) comme React, Svelte et Vue. Vous pouvez également installer l'[intégration Astro MDX](/fr/guides/integrations-guide/mdx/) et utiliser les fichiers `.mdx` dans votre projet.
