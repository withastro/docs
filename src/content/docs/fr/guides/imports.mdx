...
Un [framework d'interface utilisateur](/fr/guides/framework-components/) approprié ([React](/fr/guides/integrations-guide/react/), [Preact](/fr/guides/integrations-guide/preact/) ou [Solid](/fr/guides/integrations-guide/solid-js/)) est requis pour restituer les fichiers JSX/TSX.
