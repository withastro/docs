...
<img src="/assets/cats/ginger.jpg" alt="Un chat roux dort sur un lit.">
```
...
{/* Cet exemple utilise Astro, mais vous pouvez utiliser les modules CSS avec n'importe quel framework. */}
<div class={styles.error}>Votre message d'erreur</div>
```
...
<p>
  Jetez un oeil à mon article préféré, <a href={myFeaturedPost.url}
