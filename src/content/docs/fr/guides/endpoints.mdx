...
## Points de terminaison des fichiers statiques \{#static-file-endpoints\}
...
## Points de terminaison du serveur (Routes API) \{#server-endpoints-api-routes\}
...
:::note
Veillez à [activer le mode de rendu à la demande](/fr/guides/server-side-rendering/) avant d'essayer ces exemples, et ne pas utiliser le pré-rendu en mode "hybrid".
:::
