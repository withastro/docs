...
:::note
Veillez à [activer le mode de rendu à la demande](/fr/guides/on-demand-rendering/) avant d'essayer ces exemples, et ne pas utiliser le pré-rendu en mode "hybrid".
:::
