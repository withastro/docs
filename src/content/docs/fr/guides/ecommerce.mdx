...
Lemon.js propose également des fonctions supplémentaires telles que [l'ouverture programmatique de fenêtres superposées](https://docs.lemonsqueezy.com/help/lemonjs/opening-overlays) et [la gestion des événements de la fenêtres superposée](https://docs.lemonsqueezy.com/help/lemonjs/handling-events).
