...
## Traitement des paiements \{#payment-processing-overlays\}
...
#### Utilisation de base \{#basic-usage-1\}
...
## Solutions complètes d'e-commerce \{#full-featured-e-commerce-solutions\}
...
#### Utilisation de base \{#basic-usage-2\}
...
#### Snipcart JavaScript SDK \{#snipcart-javascript-sdk\}
