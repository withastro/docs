...
## Guide de déploiement \{#deployment-guides\}

<DeployGuidesNav />

## Options de déploiement rapide \{#quick-deploy-options\}
...
### Interface d'un hébergeur \{#website-ui\}
...
### Déploiement via une CLI \{#cli-deployment\}
...
3. Construisez votre site et déployez-le sur votre hébergeur
    ...
    D'autres hébergeurs vont vous demander de [construire votre site localement](#building-your-site-locally) et déployer en utilisant la CLI.
</Steps>

## Construire votre site localement \{#building-your-site-locally\}
...
## Ajouter un Adapteur pour du SSR \{#adding-an-adapter-for-ssr\}
