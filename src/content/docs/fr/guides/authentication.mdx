...
<ReadMore>Voir comment [ajouter une authentification avec Supabase](/fr/guides/backend/supabase/#adding-authentication-with-supabase) ou [ajouter une authentification avec Firebase](/fr/guides/backend/google-firebase/#adding-authentication-with-firebase) dans nos guides dédiés à ces services backend.</ReadMore>
