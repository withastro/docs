...
Astro utilise le support intégré de Vite pour les variables d'environnement, qui sont remplacés statiquement au moment de la construction, et vous permet [d'utiliser n'importe laquelle de ses méthodes](https://vitejs.dev/guide/env-and-mode.html) pour travailler avec elles.
