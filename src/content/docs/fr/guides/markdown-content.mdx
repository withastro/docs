...
Astro est doté d'un support intégré pour [Shiki](https://shiki.matsu.io/) (via [Shikiji](https://github.com/shikijs/shiki)) et [Prism](https://prismjs.com/). Cela permet de mettre en évidence la syntaxe pour :
