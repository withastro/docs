...
### Le frontmatter `layout`

Astro fourni aux pages Markdown et MDX une propriété spéciale `layout` frontmatter qui peut spécifier un chemin relatif (ou [alias](/fr/guides/aliases/)) à un [composant de mise en page Astro](/fr/core-concepts/layouts/#mises-en-page-markdownmdx).
...
Les propriétés frontmatter sont disponibles pour la mise en page via `Astro.props` :
...
📚 En savoir plus à propos des [mises en page Markdown](/fr/core-concepts/layouts/#mises-en-page-markdownmdx).
