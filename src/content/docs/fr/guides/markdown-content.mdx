...
- Vous souhaitez tirer parti de son vaste écosystème de modules d'extension [remark](https://remark.js.org/) ou [rehype](https://github.com/rehypejs/rehype), ou si vous avez besoin de [modules d'extension recma dans vos fichiers MDX](/fr/guides/integrations-guide/mdx/#recmaplugins).
