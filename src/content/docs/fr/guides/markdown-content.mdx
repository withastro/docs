...
<ReadMore>Voir le [Type des entrées de collection](/fr/reference/modules/astro-content/#type-des-entrées-de-collection) complet.</ReadMore>
...
- dans le [composant `<Code />` intégré](/fr/reference/components-reference/#code-) (alimenté par Shiki).
- dans le composant [`<Prism />`](/fr/reference/components-reference/#prism-) (alimenté par Prism).
