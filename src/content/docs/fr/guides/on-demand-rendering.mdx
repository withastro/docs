...
Tout d’abord, [ajouter une intégration d’adaptateur](#ajouter-un-adaptateur) pour l’exécution de votre serveur pour activer le rendu du serveur à la demande dans votre projet Astro.
