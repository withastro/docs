...
Astro fournit une [prise en charge intégrée des fournisseurs de polices les plus populaires](/fr/reference/font-provider-reference/#built-in-providers) : Adobe, Bunny, Fontshare, Fontsource, Google, Google Icons et NPM, ainsi que la possibilité d’utiliser vos propres fichiers de polices locaux. De plus, vous pouvez [personnaliser davantage votre configuration de police](#configuration-granulaire-des-polices) pour optimiser les performances et l'expérience des visiteurs.
...
Astro prend en charge [plusieurs fournisseurs de polices](/fr/reference/font-provider-reference/#built-in-providers) dès son installation, y compris la prise en charge de [Fontsource](https://fontsource.org/) qui simplifie l'utilisation de Google Fonts et d'autres polices open-source.
