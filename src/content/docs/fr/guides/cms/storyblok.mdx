...
Si vous utilisez la génération de site statique par défaut d'Astro, vous utiliserez les [routes dynamiques](/fr/basics/routing/#routes-dynamiques) et la fonction `getStaticPaths` pour générer les pages de votre projet.
