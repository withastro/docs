...
Si vous avez [opté pour le mode SSR](/fr/guides/on-demand-rendering/), vous utiliserez des routes dynamiques pour récupérer les données des pages de Storyblok.
