...
:::tip
Si vous démarrez un projet à partir de zéro, vous pouvez utiliser le [modèle Sendit de CloudCannon pour Astro](https://cloudcannon.com/templates/sendit/?ssg=astro) contenant les fonctionnalités de CloudCannon couramment utilisées pour réduire le temps de configuration.
:::
...
Utilisez l'API des collections de contenu d'Astro pour [interroger et afficher vos articles et collections](/fr/guides/content-collections/#interroger-les-collections-créées-au-moment-de-la-compilation), comme vous le feriez dans n'importe quel projet Astro.
