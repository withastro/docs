...
i18nReady: true
featuredListing:
  tagline: CMS reposant sur Git, conçu pour la rapidité, la sécurité et une utilisation sans tracas.
---
...
:::tip
Si vous démarrez un projet à partir de zéro, vous pouvez utiliser le [modèle de démarrage de composant Astro de CloudCannon](https://astro-component-starter.cc) avec plus de 40 composants préconfigurés pour l'édition visuelle avec CloudCannon afin de réduire le temps de configuration.
:::
...
2. Un projet Astro existant, sauvegardé localement ou sur l'un des fournisseurs Git pris en charge par CloudCannon : GitHub, GitLab ou Bitbucket. Si vous n'avez pas de projet existant, vous pouvez utiliser le [modèle de démarrage de composants Astro](https://astro-component-starter.cc) de CloudCannon.
...
5. Configurez l'apparence et le comportement de CloudCannon pour les éditeurs en ajoutant des paramètres à votre fichier de configuration CloudCannon. Vous pouvez effectuer des modifications à l'aide du [mode de configuration](https://cloudcannon.com/documentation/articles/what-is-configuration-mode/) de CloudCannon, ou vous pouvez ajouter la configuration manuellement vous-même dans un éditeur de code.
6. Désactivez le mode de configuration pour revenir à l'interface d'édition destinée aux créateurs de contenu. Votre fichier de configuration sera enregistré dans votre dépôt avec le reste de vos fichiers.

</Steps>

Vous pouvez désormais explorer le tableau de bord de votre site pour consulter les fichiers de contenu de votre site Astro et les modifier à l'aide de l'[éditeur de contenu](https://cloudcannon.com/documentation/articles/what-is-the-content-editor/) (par exemple `.md`, `.mdx`), de l'[éditeur de données](https://cloudcannon.com/documentation/articles/what-is-the-data-editor/) (par exemple `.yml`, `.json`) et de l'[éditeur visuel](https://cloudcannon.com/documentation/articles/what-is-the-visual-editor/) (par exemple `.astro`), selon le cas.
...
[CloudCannon propose un hébergement web gratuit](https://cloudcannon.com/documentation/articles/what-is-web-hosting/) compris dans tous ses forfaits, qui utilise Cloudflare sous le capot. Cependant, vous pouvez utiliser presque n'importe quel fournisseur d'hébergement capable de déployer à partir d'un dépôt Git.
...
## Compétences d'agent pour CloudCannon

CloudCannon a publié un [ensemble de compétences open-source pour les agents IA de codage](https://github.com/CloudCannon/agent-skills). Elles gèrent les nouvelles migrations de sites Astro pour vous : audit de votre contenu, écriture de la configuration, ajout de l'édition visuelle avec des zones éditables et vérification de la compilation. Les compétences sont composables, vous pouvez donc choisir d'exécuter une migration complète ou d'intégrer uniquement une partie, comme l'ajout de l'édition visuelle à un site Astro utilisant déjà CloudCannon.

<Steps>

1. Exécutez `npx skills add CloudCannon/agent-skills --all` à la racine de votre projet

2. Ouvrez votre projet dans votre agent IA de codage

3. Demandez à l'agent de migrer votre site vers CloudCannon :
...
- [Démarreur de composants Astro](https://astro-component-starter.cc/)
- [Modèle Jetstream pour Astro](https://cloudcannon.com/templates/jetstream/?ssg=astro)
- [Modèle Sendit pour Astro (Anglais)](https://cloudcannon.com/templates/sendit/?ssg=astro)
- [Compétences d'agent pour Astro et CloudCannon](https://github.com/CloudCannon/agent-skills)
- Vidéo : [Premiers pas avec Astro et CloudCannon CMS : blog WYSIWYG (Anglais)](https://www.youtube.com/watch?v=VCbZV-SCr20)
- Vidéo : [Utilisation du mode de configuration de CloudCannon (Anglais)](https://www.youtube.com/watch?v=3OOyYcPD46Y)
- Vidéo : [Modifiez visuellement votre site Astro (Anglais)](https://www.youtube.com/watch?v=RMbPsyJ5Gms)
