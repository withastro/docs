...
1. **Un projet Astro** - Si vous souhaitez démarrer avec un nouveau projet Astro, lisez le [guide d'installation](/fr/install-and-setup/). Ce guide utilise [Tailwind CSS](https://tailwindcss.com/) pour la mise en forme.
...
Dans « Settings » > « webhooks », ajoutez l'URL du point de terminaison de Vercel et sélectionnez le type d'objet que vous souhaitez déclencher le webhook. Cliquez sur « Add webhook » pour le sauvegarder.
