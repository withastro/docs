...
### Configurer Astro pour votre collection PayloadCMS \{#configuring-astro-for-your-payloadcms-collection\}
...
### Récupérer des données \{#fetching-data\}
...
## Créer un blog avec PayloadCMS et Astro \{#building-a-blog-with-payloadcms-and-astro\}
...
### Utiliser l'API PayloadCMS pour générer des pages \{#using-the-payloadcms-api-to-generate-pages\}

Créer une page `src/pages/posts/[slug].astro` pour [générer dynamiquement une page](/fr/guides/routing/#dynamic-routes) pour chaque post.
