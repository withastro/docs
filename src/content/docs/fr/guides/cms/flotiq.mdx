...
Ce guide permet d'utiliser l'API Flotiq headless CMS avec un projet Astro pour afficher du contenu sur votre site web.
...
Tout d'abord, vous devez définir un exemple de [Content Type Definition](https://flotiq.com/docs/panel/content-types/) dans Flotiq pour stocker des données.
