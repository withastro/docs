...
1. **Un projet Astro affiché à la demande** avec l'[adaptateur Node.js](https://docs.astro.build/fr/guides/integrations-guide/node/) installé et `output : 'server'` configuré - Si vous n'avez pas encore de projet Astro, notre [guide d'installation](/fr/install/auto/) vous permettra d'être opérationnel en un rien de temps.
