...
## Intégration avec Astro \{#integration-with-astro\}
...
### Installer l'extension Front Matter CMS \{#install-the-front-matter-cms-extension\}
...
### Initialisation du projet \{#project-initialization\}
...
#### Configuration du type de contenu \{#content-type-configuration\}
...
### Prévisualiser vos articles dans l'éditeur \{#preview-your-articles-in-the-editor\}
...
### Créer de nouveaux articles \{#create-new-articles\}
...
### Utilisation de Markdoc avec Front Matter CMS \{#using-markdoc-with-front-matter-cms\}
