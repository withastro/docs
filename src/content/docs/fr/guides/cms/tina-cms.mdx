---
title: TinaCMS & Astro
description: Ajouter du contenu à votre projet Astro en utilisant Tina en tant que CMS
sidebar:
  label: TinaCMS
type: cms
stub: false
...
[TinaCMS](https://tina.io/) est un système de gestion de contenu headless soutenu par Git.
