...
[Interrogez et affichez vos articles et collections](/fr/guides/content-collections/#interroger-les-collections-créées-au-moment-de-la-compilation), comme vous le feriez dans n'importe quel projet Astro.
