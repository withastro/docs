...
## Créer un blog avec Astro et Hashnode \{#making-a-blog-with-astro-and-hashnode\}
...
### Récupération des données \{#fetching-data\}
...
### Affichage d'une liste d'articles \{#displaying-a-list-of-posts\}
...
<Steps>
1. Créez la page `src/pages/post/[slug].astro` pour [générer dynamiquement une page](/fr/guides/routing/#dynamic-routes) pour chaque post.
