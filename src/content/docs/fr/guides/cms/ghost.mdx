...
## Créer un blog avec Astro et Ghost \{#making-a-blog-with-astro-and-ghost\}
...
1. A blog Ghost 
2.  Un projet Astro intégré à l'[API de contenu Ghost](https://www.npmjs.com/package/@tryghost/content-api) - Voir [intégration avec Astro](#integrating-with-astro) pour plus de détails sur la façon de configurer un projet Astro avec Ghost.
...
### Afficher une liste d'articles \{#displaying-a-list-of-posts\}
...
### Génération des pages \{#generating-pages\}

La page `src/pages/post/[slug].astro` [génère dynamiquement une page](/fr/guides/routing/#dynamic-routes) pour chaque post.
