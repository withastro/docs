...
Dans Astro, cela peut être fait avec des routes rendues à la demande dans votre projet configuré avec [la sortie `server` ou `hybrid`](/fr/guides/on-demand-rendering/) activé.
