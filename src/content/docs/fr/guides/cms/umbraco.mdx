...
## Intégrer avec Astro \{#integrating-with-astro\}
...
### Configuration de l'API de diffusion de contenu \{#setting-up-the-content-delivery-api\}
...
## Créer un blog avec Umbraco et Astro \{#building-a-blog-with-umbraco-and-astro\}
...
### Créer des articles de blog dans Umbraco \{#creating-blog-posts-in-umbraco\}
...
### Afficher une liste d'articles de blog dans Astro \{#displaying-a-list-of-blog-posts-in-astro\}
...
### Générer des articles de blog individuels \{#generating-individual-blog-posts\}

Créez le fichier `[...slug].astro` à la racine du répertoire `/pages/`. Ce fichier sera utilisé pour [générer dynamiquement les pages individuelles du blog](/fr/guides/routing/#dynamic-routes).
...
## Publier votre site \{#publishing-your-site\}
...
## Développement local, HTTPS et certificats SSL auto-signés \{#local-dev-https-and-self-signed-ssl-certificates\}
