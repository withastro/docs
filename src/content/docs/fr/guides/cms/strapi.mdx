...
[Strapi](https://strapi.io/) est open-source, personnalisable et un CMS headless.
...
3. En utilisant les données du tableau `articles` renvoyé par l'API, affichez les articles de votre blog Strapi dans une liste. Ces articles seront liés à leurs propres pages individuelles, que vous créerez à l'étape suivante.
