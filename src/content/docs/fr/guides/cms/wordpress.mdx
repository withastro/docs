...
## Créer un blog avec WordPress et Astro \{#building-a-blog-with-wordpress-and-astro\}
...
### Affichage d'une liste d'articles WordPress \{#displaying-a-list-of-wordpress-posts\}
...
### Utiliser l'API de WordPress pour générer des pages \{#using-the-wordpress-api-to-generate-pages\}

La page `src/pages/dinos/[slug].astro` [génère dynamiquement une page](/fr/guides/routing/#dynamic-routes) pour chaque dinosaure.
...
### Retour des ressources intégrées \{#returning-embedded-resources\}
...
### Publier votre site web \{#publishing-your-site\}
...
## Sites web en production \{#production-sites\}
