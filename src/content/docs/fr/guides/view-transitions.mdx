...
<ReadMore>Envisagez d’activer la [politique de sécurité du contenu](/fr/reference/configuration-reference/) d’Astro pour vous protéger contre les risques de script intersite (XSS) si vous utilisez la saisie des utilisateurs avec l’API `navigate()`.</ReadMore>
