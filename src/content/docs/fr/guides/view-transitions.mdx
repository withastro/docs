...
Vous pouvez surcharger ce comportement avec `transition:persist-props`. L'ajout de cette directive conservera les props existants d'une île (sans les rendre avec de nouvelles valeurs) en plus de maintenir son état existant.
