...
1. [En installant un paquet d'intégration npm](#installation-d-un-paquets-npm).
...
#### Installation d'un paquets NPM

Installez une intégration de paquetage NPM en utilisant un gestionnaire de paquets, puis mettez à jour `astro.config.mjs` manuellement.
