...
1. [En installant un paquet d'intégration npm](#installing-an-npm-package).
...
#### Installation d'un paquet NPM \{#installing-an-npm-package\}
...
### Activer/Désactiver une intégration \{#toggle-an-integration\}
...
## Mise à jour des intégrations \{#upgrading-integrations\}
...
### Mise à jour automatique \{#automatic-upgrading\}
...
## Supprimer une Intégration \{#removing-an-integration\}
...
## Trouver d'autres intégrations \{#finding-more-integrations\}
...
## Construire votre propre intégration \{#building-your-own-integration\}
