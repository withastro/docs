...
Ces API sont expérimentales et leur signature peut changer. Toute mise à jour sera mentionnée dans le [Astro changelog](https://github.com/withastro/astro/blob/main/packages/astro/CHANGELOG.md) et les informations ci-dessous montreront toujours les informations actuelles et à jour.
...
Similaire à [`astro build`](#astro-build), il construit votre site pour le déployer.
