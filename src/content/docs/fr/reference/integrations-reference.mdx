...
<ReadMore>Consultez la [référence de l'adaptateur](/fr/reference/adapter-reference/#custom-prerenderer) pour plus de détails sur la mise en œuvre d'un prérendu personnalisé.</ReadMore>
...
Décrit un [prérendu personnalisé](/fr/reference/adapter-reference/#custom-prerenderer) que les adaptateurs peuvent fournir pour contrôler le prérendu des pages.
...
Une fonction qui fournit les paramètres optionnels de la route, les interpole avec le modèle de route et renvoie le nom du chemin de la route.
