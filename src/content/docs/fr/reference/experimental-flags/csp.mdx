...
Lors de la compilation, les ressources des directives `img-src` et `default-src` pour la page `index.html` sont fusionnées et dédupliquées pour créer les en-têtes appropriés.
