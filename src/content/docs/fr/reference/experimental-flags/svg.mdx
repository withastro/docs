---
title: Composants SVG expérimentaux
sidebar:
...
Pour une présentation complète et pour donner votre avis sur cette API expérimentale, consultez le [SVG feature RFC](https://github.com/withastro/roadmap/pull/1035).
