...
Si vous [utilisez directement le module d'extension `rehypeHeadingIds`](/fr/guides/markdown-content/#id-des-titres-et-plugins), activez le mode de compatibilité lorsque vous transmettez le module d'extension dans votre configuration Astro :
