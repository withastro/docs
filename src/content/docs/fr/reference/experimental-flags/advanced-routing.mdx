...
Déclenche une [réécriture](/fr/guides/routing/#rewrites) vers une autre route. Le `payload` peut être un chemin sous forme de chaîne de caractères (`'/autre-page'`), une URL ou un objet `Request` :
