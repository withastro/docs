...
Un objet permettant de transmettre des options spécifiques au fournisseur. Il est typé automatiquement en fonction du [fournisseur](#fournisseur) de la famille de polices :
