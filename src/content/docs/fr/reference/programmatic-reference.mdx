...
Les utilitaires suivants peuvent être [importés depuis `astro/config`](/fr/reference/modules/astro-config/#imports-from-astroconfig) et utilisés pour manipuler ou valider la configuration avant de la transmettre aux commandes CLI.
...
- La [commande Astro en cours d'exécution](/fr/reference/cli-reference/#astro-commands) (p. ex. `build`, `dev`, `sync`)
