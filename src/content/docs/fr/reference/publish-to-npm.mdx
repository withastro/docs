...
## Création d'un Paquet \{#creating-a-package\}
...
Nous recommandons d'ajouter `astro-component` ou `withastro` comme mot-clé spécial pour maximiser sa découverte dans l'écosystème Astro.
...
:::tip
Les mots-clés sont également utilisés par notre [bibliothèque d'intégration](https://astro.build/integrations)! [Voir ci-dessous](#integrations-library) pour une liste complète des mots-clés que nous utilisons dans NPM.
:::
...
#### Exemple : Utilisation des importations nommées \{#example-using-named-imports\}
...
#### Exemple : Utilisation des importations de Namespace (Espace de Noms) \{#example-using-namespace-imports\}
...
#### Exemple : Utilisation des importations individuelles \{#example-using-individual-imports\}
...
## Développement de votre Paquet \{#developing-your-package\}
...
## Tester votre composant \{#testing-your-component\}
...
## Publier votre composant \{#publishing-your-component\}
...
## Bibliothèque d'intégrations \{#integrations-library\}
...
### Données du fichier `package.json` \{#packagejson-data\}
