...
<ReadMore>En savoir plus sur la façon dont les [Mises en page Markdown et MDX](/fr/guides/markdown-content/#propriété-du-layout-frontmatter) gèrent les propriétés.</ReadMore>
