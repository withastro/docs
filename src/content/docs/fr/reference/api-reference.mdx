...
L'attribut [`meta`](https://shiki.style/guide/transformers#meta) permet de passer des options aux transformateurs à l'aide d'une chaine spéciale.

Le code ci-dessous surligne les lignes 1 et 3:
...
<Code
  ...
  <style is:global>
    pre .line.highlighted {
      background-color: oklch(60% 0.3 0deg / 50%);
    }
  </style>
```
