...
:::tip
Lorsque vous utilisez TypeScript, utilisez l'utilitaire de type [`GetStaticPaths`](/fr/guides/typescript/#infer-getstaticpaths-types) pour garantir la sûreté du typage de `params` et `props`.
:::
