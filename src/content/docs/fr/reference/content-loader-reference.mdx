...
Vous pouvez ensuite utiliser ces indications dans vos pages. Si vous avez configuré un [fournisseur de cache](/fr/guides/caching/#configure-caching), transmettez directement les indications de cache à [`Astro.cache.set()`](/fr/reference/api-reference/#cacheset) :
...
<ReadMore>Consultez le guide des collections de contenu pour apprendre à [utiliser les indications de cache au niveau des entrées](/fr/guides/content-collections/#entry-level-cache-hints).</ReadMore>
...
<ReadMore>Consultez le guide des collections de contenu pour apprendre à [utiliser les indications de cache au niveau des collections](/fr/guides/content-collections/#collection-level-cache-hints).</ReadMore>
