...
Vous pouvez ensuite utiliser ces indications dans vos pages. Si vous avez activé la [mise en cache des routes](/fr/guides/caching/), transmettez directement les indications de cache à `Astro.cache.set()` :
