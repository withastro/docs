...
## Qu'est-ce qu'un service d'images ? \{#what-is-an-image-service\}
...
## Construire à l'aide de l'API d'un service d'image \{#building-using-the-image-services-api\}
...
#### getConfiguredImageService & imageConfig \{#getconfiguredimageservice--imageconfig\}
