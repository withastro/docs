...
Une [`EventTarget`](https://developer.mozilla.org/fr/docs/Web/API/EventTarget) standard avec quelques [aides pour les événements côté client](#sur-le-client) supplémentaires qui peuvent être utilisés pour envoyer et recevoir des événements depuis la barre d'outils Dev.
