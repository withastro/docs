...
Découvrez [comment migrer](/fr/guides/upgrade-to/v6/#deprecated-createexports-and-start-adapter-api).
:::
...
:::caution[Dépréciée]
Cette propriété est obsolète et sera supprimée dans une future version majeure. Apprenez comment [mettre à jour votre adaptateur avec `entrypointResolution: "auto"`](/fr/guides/upgrade-to/v6/#deprecated-createexports-and-start-adapter-api).
:::
