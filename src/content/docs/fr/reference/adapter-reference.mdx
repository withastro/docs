...
**Type :** <code>(manifest: <a href="/fr/reference/integrations-reference/#ssrmanifest">SSRManifest</a>, options: any) => Record\<string, any\></code>
</p>
