...
## Qu'est-ce qu'un adaptateur ? \{#what-is-an-adapter\}
...
## Construire un adaptateur \{#building-an-adapter\}
...
### Point d'entrée du serveur \{#server-entrypoint\}
...
## Autoriser l'installation via `astro add` \{#allow-installation-via-astro-add\}
...
## Fonctionnalités d'Astro \{#astro-features\}
...
## Fonctionnalités de l'adaptateur \{#adapter-features\}
...
#### Environnements sans serveur \{#serverless-environments\}
