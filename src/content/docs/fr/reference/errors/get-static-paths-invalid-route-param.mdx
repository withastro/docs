...
Dans les routes utilisant les [paramètres REST](/fr/guides/routing/#rest-parameters), `undefined` peut être utilisé pour représenter un chemin sans paramètres passés dans l'URL :
