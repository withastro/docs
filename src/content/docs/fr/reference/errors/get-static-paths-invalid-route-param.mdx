...
Dans les routes utilisant les [paramètres REST](/fr/basics/routing/#paramètres-rest), `undefined` peut être utilisé pour représenter un chemin sans paramètres passés dans l'URL :
