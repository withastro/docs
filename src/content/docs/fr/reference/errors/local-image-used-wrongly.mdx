...
Pour les images locales des collections de contenu, vous pouvez utiliser l'aide [image() schema helper](/fr/guides/images/#images-dans-les-collections-de-contenu) pour résoudre les images.
