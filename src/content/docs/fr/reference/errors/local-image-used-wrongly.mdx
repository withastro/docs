...
Pour les images locales des collections de contenu, vous pouvez utiliser l'aide [image() schema helper](/fr/guides/images/#images-dans-les-collections-de-contenus) pour résoudre les images.
