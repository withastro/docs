...
**Quand :** Lors de l'initialisation, avant que les configurations de [Vite](https://vitejs.dev/config/) ou d'[Astro config](/fr/reference/configuration-reference/) ne soient résolues.
