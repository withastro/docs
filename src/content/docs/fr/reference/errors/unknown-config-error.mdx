...
Si vous parvenez à reproduire cette erreur de manière fiable, nous vous serions reconnaissants si vous pouviez [créer un ticket GitHub](https://astro.build/issues/).
