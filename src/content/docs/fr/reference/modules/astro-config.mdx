...
<p>
**Type :** <code>(config?: <a href="/fr/reference/cache-provider-reference/#memorycache-options">MemoryCacheProviderOptions</a>) => <a href="/fr/reference/cache-provider-reference/#cacheproviderconfig">CacheProviderConfig\<MemoryCacheProviderOptions\></a></code>
</p>

Voir [`memoryCache()` dans la référence du fournisseur de cache](/fr/reference/cache-provider-reference/#built-in-memory-cache-provider).
