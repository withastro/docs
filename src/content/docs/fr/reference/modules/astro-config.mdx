...
{/* TODO(armand): add back a missing link to the config reference */}
Décrit le [fournisseur intégré](/fr/reference/font-provider-reference/#built-in-providers) utilisé pour récupérer la police configurée.
...
Décrit le [pilote intégré](/fr/reference/session-driver-reference/#built-in-drivers) utilisé [pour le stockage de sessions](/fr/reference/configuration-reference/#options-des-sessions).
