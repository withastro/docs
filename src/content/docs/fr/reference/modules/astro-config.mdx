...
Décrit le [fournisseur intégré](/fr/reference/font-provider-reference/#built-in-providers) utilisé [pour récupérer la police configurée](/fr/reference/configuration-reference/#fontprovider).
