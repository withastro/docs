...
<ReadMore>Consultez le [guide des sessions avancées](/fr/guides/actions/#avancépersistance-des-résultats-daction-avec-une-session) pour un exemple d'implémentation à l'aide de Netlify Blob.</ReadMore>
