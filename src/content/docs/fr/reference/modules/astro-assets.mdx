...
La [variable CSS (`cssVariable`)](/fr/reference/configuration-reference/#fontcssvariable) enregistrée dans votre configuration d'Astro :
...
Il n'est pas toujours souhaitable de précharger tous les liens de police, car cela peut bloquer le chargement d'autres ressources importantes ou télécharger des polices inutiles pour la page actuelle.
