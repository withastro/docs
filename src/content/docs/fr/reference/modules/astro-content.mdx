...
<ReadMore>Découvrez les [chargeurs de collections au moment de la compilation](/fr/guides/content-collections/#chargeurs-de-collections-appelés-lors-de-la-compilation) avec des explications guidées et des exemples d'utilisation.</ReadMore>
...
<ReadMore>Apprenez à [interroger les collections générées au moment de la compilation](/fr/guides/content-collections/#interroger-les-collections-consommées-lors-de-la-compilation) avec des explications guidées et des exemples d'utilisation.</ReadMore>
