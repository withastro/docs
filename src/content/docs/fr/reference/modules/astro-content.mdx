...
Si vous avez activé la [mise en cache expérimentale des routes](/fr/reference/route-caching/), transmettez directement l'indication de cache à `Astro.cache.set()` :
