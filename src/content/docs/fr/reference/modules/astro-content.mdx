...
**Type :** <code>() => Promise&lt;Array&lt;\{ id: string, [key: string]: any }&gt; | Record&lt;string, Record&lt;string, any&gt;&gt;&gt; | <a href="/fr/reference/content-loader-reference/#api-du-chargeur">Loader</a></code>
<Since v="5.0.0" />
</p>
...
if (!entry) {
   // Manipuler l'erreur, par exemple :
