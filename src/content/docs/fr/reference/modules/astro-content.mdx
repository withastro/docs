...
**Type :** <code>() => Promise&lt;Array&lt;\{ id: string, [key: string]: any }&gt; | Record&lt;string, Record&lt;string, any&gt;&gt;&gt; | <a href="/fr/reference/content-loader-reference/#loader-api">Loader</a></code>
<Since v="5.0.0" />
</p>
...
[Consultez le guide « Collection de contenu »](/en/guides/content-collections/#définir-le-loader-de-collection) pour un exemple d'utilisation.
...
[Consultez le guide Collections de contenu](/fr/guides/content-collections/#définition-le-schéma-de-collection) pour un exemple d'utilisation.
...
- `headings` - Une liste générée de titres, [reflétant l'utilitaire `getHeadings()` d'Astro](/en/guides/markdown-content/#available-properties) sur les importations Markdown et MDX.
- `remarkPluginFrontmatter ` - L'objet frontmatter modifié après que tous les [plugins Remark ou Rehype ont été appliqués](/en/guides/markdown-content/#modifying-frontmatter-programmatically). Définit sur le type `any`.
...
[Consultez le guide collections de contenu](/en/guides/content-collections/#rendering-body-content) pour un exemple d'utilisation.
