...
<ReadMore>Apprenez-en davantage sur [l'interrogation des collections consommée lors de la compilation](/fr/guides/content-collections/#interroger-les-collections-consommées-lors-de-la-compilation) grâce à des explications guidées et des exemples d'utilisation.</ReadMore>
...
Le chemin d'accès à une entrée relative à votre répertoire de projet. Cette valeur n'est disponible que pour les entrées locales.
...
L'exemple suivant accède à l'entrée demandée dans une collection en direct nommée `produits` et à toute erreur, et redirige vers la page 404 si une erreur existe :
