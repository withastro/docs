...
import {
  ...
  /* Les éléments suivants ont été dépréciés dans la version 6 : */
...
Les importations suivantes sont dépréciées depuis la version 6 et seront supprimées dans la version 7. Vous pouvez toujours les utiliser dans votre projet, mais il est conseillé de mettre à jour votre code dès maintenant. [Découvrez comment effectuer la mise à niveau](/fr/guides/upgrade-to/v6/#dépréciation-code-interne-exposé-dans-astrotransitions).
...
:::caution[Dépréciée]
Cette fonction est dépréciée depuis la v6 et sera supprimée dans la v7. Vous pouvez toujours l'utiliser dans votre projet, mais vous préférerez peut-être mettre à jour votre code maintenant.
:::
...
:::caution[Dépréciée]
Cette constante est dépréciée depuis la v6 et sera supprimée dans la v7. Vous pouvez toujours l'utiliser dans votre projet, mais vous préférerez peut-être mettre à jour votre code maintenant.
:::
