...
Utilisez les mots clés appropriés lorsque vous [publiez votre adaptateur sur NPM](/fr/guides/integrations/#categories) afin que votre adaptateur soit répertorié dans notre [catalogue des intégrations](https://astro.build/integrations/).
:::
