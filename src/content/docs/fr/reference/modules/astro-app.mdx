...
Utilisez les mots clés appropriés lorsque vous [publiez votre adaptateur sur NPM](/fr/reference/publish-to-npm/#categories) afin que votre adaptateur soit répertorié dans notre [catalogue des intégrations](https://astro.build/integrations/).
:::
