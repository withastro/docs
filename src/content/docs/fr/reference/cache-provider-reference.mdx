...
Lors de la création d'un fournisseur CDN, Astro fournit des [utilitaires partagés](#cache-provider-utilities) pour créer des en-têtes de contrôle de cache et des étiquettes d'invalidation reposant sur les chemins.
