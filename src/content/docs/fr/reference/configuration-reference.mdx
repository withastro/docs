...
Pour l'activer, définissez un [mode de sortie (`output`) permettant le rendu à la demande côté serveur](/fr/guides/on-demand-rendering/) avec un adaptateur, et ajoutez le drapeau `serverIslands` à l'objet `experimental` :
