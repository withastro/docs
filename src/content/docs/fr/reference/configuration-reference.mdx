...
:::caution[Dépréciée]
Transmettez `remarkPlugins` à `unified({ remarkPlugins })` importée depuis `@astrojs/markdown-remark` et définissez-la plutôt dans `markdown.processor`. Sera supprimée dans une prochaine mise à jour majeure.
:::
...
:::caution[Dépréciée]
Transmettez `rehypePlugins` à `unified({ rehypePlugins })` importée depuis `@astrojs/markdown-remark` et définissez-la plutôt dans `markdown.processor`. Sera supprimée dans une prochaine mise à jour majeure.
:::
...
:::caution[Dépréciée]
Transmettez plutôt `remarkRehype` à `unified({ remarkRehype })` importée depuis `@astrojs/markdown-remark` et définissez-la dans `markdown.processor`. Sera supprimée dans une prochaine mise à jour majeure.
:::
...
`@astrojs/markdown-satteri`, le pipeline Markdown natif d'Astro.
