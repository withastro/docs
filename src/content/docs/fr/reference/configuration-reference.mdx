...
Configure le processeur Markdown utilisé pour le rendu des fichiers `.md`. Par défaut, il s'agit de `unified()` importée de
`@astrojs/markdown-remark` (le pipeline remark/rehype).
