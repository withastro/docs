...
- Shiki n'est actuellement pas pris en charge. De par sa conception, les fonctions Shiki utilisent des styles incorporés incompatibles avec l'implémentation CSP d'Astro. Envisagez [d'utiliser `<Prism />`](/en/guides/syntax-highlighting/#prism-) lorsque votre projet nécessite à la fois CSP et la coloration syntaxique.
...
Les [paramètres de variation](https://developer.mozilla.org/en-US/docs/Web/CSS/@font-face/font-variation-settings) de police :
