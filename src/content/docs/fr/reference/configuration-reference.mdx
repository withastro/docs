...
La référence suivante couvre toutes les options de configuration prises en charge dans Astro. Pour en savoir plus sur la manière de configurer Astro, consultez notre guide dédié à la [configuration d'Astro](/fr/guides/configuration-d-astro/).
