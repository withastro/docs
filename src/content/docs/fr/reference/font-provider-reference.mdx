...
Le fournisseur est livré avec les options suivantes et spécifiques à la famille qui peuvent être ajoutées dans l'[objet `font.options`](/fr/reference/configuration-reference/#fontoptions).
