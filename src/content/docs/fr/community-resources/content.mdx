...
### Tutoriels d'introduction
  ...
  - [The Valley of Code - Astro](https://thevalleyofcode.com/astro) par Flavio Copes
  - [Learn Astro 3 from Scratch: Course for Beginners + Astro Application (SPANISH)](https://www.youtube.com/watch?v=RB5tR_nqUEw) par @midudev
  - [Introduction au framework web Astro](https://www.udemy.com/course/introduction-to-the-astro-web-framework/) (payant) par Tech Razor sur Udemy
...
- [Comment construire un compteur de vues avec Astro DB](https://www.vorillaz.com/astro-views)
