...
:::tip[La version 2 d'Astro est là !]
**Quoi de neuf dans Astro v2 ?** [Découvrez-le dans le billet de blog d'annonce](https://astro.build/blog/astro-2/).  
**Prêt à mettre à niveau ?** [Suivez notre guide de mise à niveau](/fr/guides/upgrade-to/v2/).
:::
