...
Les routes de pages sont créées pour votre site en ajoutant des [types de fichiers](/fr/basics/astro-pages/#supported-page-files) pris en charge à ce répertoire.
...
Le répertoire `src/content/` est réservé au stockage des [collections de contenu](/fr/guides/content-collections/) et d'un fichier de configuration. Aucun autre fichier n'est autorisé dans ce répertoire.
