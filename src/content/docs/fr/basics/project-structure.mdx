...
- [Des composants Frontend (React, etc...)](/fr/basics/framework-components/)
...
**Les composants** sont, généralement, du code réutilisable pour vos pages HTML. Ils peuvent être des [composants Astro](/fr/basics/astro-components/), ou des [composants d'interface utilisateur de framework](/fr/basics/framework-components/) comme React ou Vue. Il est commun de regrouper et d'organiser tous les composants de votre projet dans ce dossier.
...
[Les composants Pages](/fr/basics/astro-pages/) sont un type de composant particulier utilisé pour créer de nouvelles pages sur votre site. Une Page peut être un composant Astro (`.astro`) ou un fichier Markdown (`.md`) qui représente une page de contenu pour votre site.
