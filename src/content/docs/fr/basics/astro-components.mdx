...
Lorsque votre composant Astro nécessite une interactivité côté client, vous pouvez ajouter des [balises HTML `<script>` standard](/fr/guides/client-side-scripts/) ou des [composants de Framework](/fr/basics/framework-components/#hydratation-des-composants-interactifs).
...
:::tip
Les emplacements nommés peuvent aussi être passés aux [composants de framework](/fr/basics/framework-components/) !
:::
...
<ReadMore>Apprendre comment utiliser les [composants de framework JavaScript](/fr/basics/framework-components/) dans votre projet Astro.</ReadMore>
