...
La syntaxe des composants Astro est un surensemble de HTML. Elle a été [conçue pour être familière à toute personne ayant l'habitude d'écrire du HTML ou du JSX](#differences-between-astro-and-jsx), et elle permet d'inclure des composants et des expressions JavaScript.


## Expressions type JSX \{#jsx-like-expressions\}
...
### Attributs dynamiques \{#dynamic-attributes\}
...
### Balises Dynamiques \{#dynamic-tags\}
...
- **Les directives d'hydratation ne sont pas prises en charge.** Lorsque vous utilisez [les directives d'hydratation `client:*`](/fr/guides/framework-components/#hydrating-interactive-components), Astro doit savoir quels composants regrouper pour la production, et le modèle de balise dynamique empêche cela de fonctionner.
...
### Différences entre Astro et JSX \{#differences-between-astro-and-jsx\}
...
#### Éléments Multiples \{#multiple-elements\}
