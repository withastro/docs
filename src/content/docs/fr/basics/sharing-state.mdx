...
- L'écriture d'un store à partir d'un fichier `.astro` ou [composant non hydraté](/fr/basics/framework-components/#hydratation-des-composants-interactifs) n'affectera *pas* la valeur reçue par les [composants côté client](/fr/reference/directives-reference/#directives-client).
