...
12. Le tutoriel du projet de blog génère aussi dynamiquement une page pour chaque tag en utilisant `src/pages/tags/[tag].astro` et affiche une liste de tag dans `src/pages/tags/index.astro`. 
        ...
        <Box icon="puzzle-piece">
          ### Essayez vous-même - Mettez à jour la requête dans la page Tag Index
           ...
           Importez et utilisez `getCollection` pour récupérer les tags utilisés dans les articles du blog sur `src/pages/tags/index.astro`, en suivant les [mêmes étapes que ci-dessus](#remplcer-astroglob-avec-getcollection).
