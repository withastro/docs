...
## Autres éditeurs de code \{#other-code-editors\}
...
## Éditeur de code "In-Browser" \{#in-browser-editors\}
...
[Prettier](https://prettier.io/) est un formateur populaire pour JavaScript, HTML, CSS, et plus encore. Si vous utilisez [Astro VS Code Extension](https://marketplace.visualstudio.com/items?itemName=astro-build.astro-vscode) ou [le serveur de langage Astro dans un autre éditeur](#other-code-editors), le formatage du code avec Prettier est inclus.
