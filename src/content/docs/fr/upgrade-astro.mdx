...
- Exception de sécurité : Si une faille de sécurité dans Node.js qui **affecte Astro** est divulguée et corrigée, l'équipe Core peut augmenter la version minimale de **_Maintenance_ LTS** dans une version **patch**.
