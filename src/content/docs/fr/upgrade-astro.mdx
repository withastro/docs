...
- La mise à jour de la version minimale **_Maintenance_ LTS** (dans la même gamme majeure, par exemple de `v18.14.*` à `v18.20.*`) de Node.js peut se produire dans une version **minor** d'Astro.
