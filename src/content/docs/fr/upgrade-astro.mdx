...
- [instantané non maintenu de la v5.18.0](https://v5.docs.astro.build/fr/getting-started/)
- [instantané non maintenu de la v4.16.17](https://v4.docs.astro.build/fr/getting-started/)
- [instantané non maintenu de la v3.6.3](https://web.archive.org/web/20231203130826/https://docs.astro.build/fr/getting-started/)
- [instantané non maintenu de la v2.10.15](https://web.archive.org/web/20230822134745/https://docs.astro.build/en/getting-started)
...
- La mise à niveau de la version minimale **_Maintenance_ LTS** (dans la même plage majeure, par exemple de `22.14.*` à `22.20.*`) de Node.js peut se produire dans une version **mineure** d'Astro.
