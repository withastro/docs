...
Vous pouvez trouver une liste exhaustive de tous les changements dans [le changelog d'Astro](https://github.com/withastro/astro/blob/main/packages/astro/CHANGELOG.md), et des instructions importantes pour la mise à niveau vers chaque nouvelle [version majeure](#major-changes) dans nos [guides de mise à niveau](#upgrade-guides).


## Mise à jour vers la dernière version \{#upgrade-to-the-latest-version\}
...
### Mise à jour manuelle \{#manual-upgrading\}
...
### Installer un numéro de version spécifique \{#install-a-specific-version-number\}
...
### Guides de mise à niveau \{#upgrade-guides\}

Après chaque [version majeure](#major-changes), vous trouverez un **guide de mise à niveau** contenant des informations sur les changements importants et des instructions pour mettre à jour le code de votre projet.
...
### Anciennes documentations (non maintenues) \{#older-docs-unmaintained\}
...
- [snapshot v2.10.15 non maintenu](https://deploy-preview-4405--astro-docs-2.netlify.app/en/getting-started/)
...
### Changements au niveau des correctifs \{#patch-changes\}
...
Les versions majeures incluront des changements importants au moins dans une partie du code existant. Ces changements sont toujours documentées dans un guide ["Mise à niveau vers vX"](#upgrade-guides) dans Astro.
...
### Politiques de support et de mise à jour de Node.js \{#nodejs-support-and-upgrade-policies\}
...
### Maintenance prolongée \{#extended-maintenance\}
