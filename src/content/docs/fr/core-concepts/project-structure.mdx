...
**Les composants** sont, généralement, du code réutilisable pour vos pages HTML. Ils peuvent être des [composants Astro](/fr/core-concepts/astro-components/), ou des [composants d'interface utilisateur de framework](/fr/core-concepts/framework-components/) comme React ou Vue. Il est commun de regrouper et d'organiser tous les composants de votre projet dans ce dossier.
