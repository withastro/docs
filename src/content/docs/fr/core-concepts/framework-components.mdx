...
```astro title="src/pages/MyAstroPage.astro"
---
...
De plus, vous pouvez utiliser les ["Slots" Nommés](/fr/core-concepts/astro-components/#les-emplacements-nommés) pour grouper des enfants spécifiques ensemble.
...
```jsx title="src/components/MySidebar.jsx"
...
```jsx title="src/components/MySidebar.svelte"
<aside>
