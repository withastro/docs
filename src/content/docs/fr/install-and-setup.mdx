...
4. Vous pouvez maintenant [démarrer le serveur de développement d'Astro](#démarrer-le-serveur-de-développement-dastro) et visualiser un aperçu en direct de votre projet pendant que vous le construisez !
</Steps>
