...
8. Vous pouvez maintenant [démarrer le serveur de développement d'Astro](/fr/develop-and-build/#start-the-astro-dev-server) et visualiser un aperçu en direct de votre projet pendant que vous le construisez !
