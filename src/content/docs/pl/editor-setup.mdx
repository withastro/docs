...
- [Rozszerzenie Nova](https://extensions.panic.com/extensions/sciencefidelity/sciencefidelity.astro/) <span style="margin: 0.25em;"><Badge variant="neutral">Społeczności</Badge></span> - Zapewnia podświetlanie składni i uzupełnianie kodu Astro w edytorze Nova
