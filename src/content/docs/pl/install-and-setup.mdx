...
1. Uruchom poniższe polecenie w swoim terminalu, żeby zainicjalizować projekt:
    ...
    Możesz uruchomić polecenie `create astro` w dowolnym miejscu na swoim komputerze, więc nie więc tworzyć nowego, pustego katalogu dla Twojego projektu przed rozpoczęciem. Jeżeli nie masz jeszcze pustego folderu na Twój nowy projekt, asystent inicjalizacji stworzy go automatycznie.
