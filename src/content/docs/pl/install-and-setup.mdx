...
1. Uruchom poniższe polecenie w swoim terminalu, żeby zainicjalizować projekt:
    ...
    <PackageManagerTabs>
      ...
      <Fragment slot="bun">
      ```shell
      # stwórz nowy projekt przy użyciu Bun
...
2. Zainstaluj Astro
    ...
    :::note[Ważne]
    Astro musi zostać zainstalowane lokalnie, nie globalnie. Upewnij się, że *nie* uruchamiasz polecenia `npm install -g astro`, `pnpm add -g astro`, `bun add -g astro` lub `yarn add global astro`.
    :::
