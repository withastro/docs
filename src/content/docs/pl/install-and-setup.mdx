...
Astro jest budowane przy użyciu bundlera Vite, który domyślnie generuje kod dla przeglądarek obsługujących współczesny JavaScript. Aby uzyskać pełne informacje, możesz sprawdzić [listę przeglądarek aktualnie wspieranych przez Vite](https://vitejs.dev/guide/build.html#browser-compatibility).
