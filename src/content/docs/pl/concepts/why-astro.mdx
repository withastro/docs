...
1. [Skoncentrowane na treści](#content-driven): Astro jest zaprojektowane dla stron bogatych w treść.
2. [Server-first](#server-first): Strony działają szybciej, kiedy HTML jest renderowany na serwerze.
3. [Domyślnie szybki](#fast-by-default): Zbudowanie wolnej strony za pomocą Astro powinno być niemożliwe.
4. [Łatwy w użyciu](#easy-to-use): Nie musisz być ekspertem, żeby budować z Astro.
5. [Skupiony na developerach](#developer-focused): Dostęp do zasobów, dzięki którym zdobędziesz sukces, powinien być łatwy.
