...
- **[Serwer jako pierwszy](/en/guides/on-demand-rendering/):** Przenosi kosztowne renderowanie z urządzeń twoich odwiedzających.
- **[Zero JS, domyślnie](/en/basics/astro-components/):** Mniej klienckiego JavaScriptu, który spowalnia twoją stronę.
- **[Kolekcje treści](/en/guides/content-collections/):** Organizuj, waliduj i dostarczaj  Organize, validate, and provide TypeScript type-safety for your Markdown content.
