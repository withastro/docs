...
Dlaczego wybrać Astro, a nie inny webowy framework? Oto pięć głównych projektowych zasad, które pomogą wytłumaczyć dlaczego zbudowaliśmy Astro, problemy, które rozwiązuje, i dlaczego Astro może być najlepszym wyborem dla Twojego projektu lub zespołu:
...
Dobra wydajność zawsze jest ważna, lecz dla stron opartych o treści jest *wyjątkowo* krytyczna. To, że niska wydajność negatywnie wpływa na zaangażowanie, konwersje i traci pieniądze, zostało dobrze sprawdzone. Na przykład:
...
Magia Astro bierze się z połączenia dwóch wartości opisanych powyżej — skupieniu na treści oraz bazującej na serwerze architekturze MPA — pozwala to podejmować decyzje i dostarczać funkcjonalności, których nie są w stanie dostarczyć inne frameworki. Rezultatem jest niesamowita wydajność dla każdej strony, prosto z pudełka. Naszym celem jest: **Zbudowanie wolnej strony przy użyciu Astro powinno być prawie niemożliwe.**
...
**Celem Astro jest przystępność dla każdego web developera.** Astro zostało zaprojektowane tak, by być znajome i dostępne, niezależnie od poziomu umiejętności, czy poprzednich doświadczeń z web developmentem. 
