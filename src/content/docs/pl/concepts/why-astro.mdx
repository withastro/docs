...
**Astro** to framework webowy do budowy stron internetowych **skupiających się na dostarczaniu treści**, takich jak blogi, strony marketingowe i e-commerce. Astro jest najbardziej znane z bycia pionierem w nowej [architekturze frontendowej](/pl/concepts/islands/), której celem jest zmniejszenie narzutu JavaScriptu i kompleksowości, w porównaniu z innymi frameworkami. Jeśli potrzebujesz strony, która ładuje się szybko i ma świetne SEO, to Astro jest dla Ciebie.

## Cechy

**Astro to wszechstronny framework webowy.** Wszystko, co jest potrzebne do stworzenia strony internetowej jest wbudowane. Są także dostępne setki różnych [integracji](https://astro.build/integrations/) oraz [hooków API](/pl/reference/integrations-reference/) do dostosowania projektu do Twoich dokładnych przypadków użycia i potrzeb.
...
- **[Agnostyczne podejście do UI](/en/guides/framework-components/):** Wspiera React, Preact, Svelte, Vue, Solid, HTMX, web components i więcej.
- **[Server-first](/en/guides/on-demand-rendering/):** Przenosi kosztowne renderowanie z urządzeń twoich odwiedzających.
- **[Zero JS, domyślnie](/en/basics/astro-components/):** Mniej klienckiego JavaScriptu, który spowalnia twoją stronę.
- **[Kolekcje treści](/en/guides/content-collections/):** Organizuj, waliduj i dostarczaj bezpieczne typowanie TypeScript dla twoich treści Markdown.
- **[Konfigurowalne](/en/guides/integrations-guide/):** Partytown, MDX i setki integracji do wyboru.

## Reguły projektowe

Oto pięć rdzennych reguł projektowych, które wyjaśnią, dlaczego zbudowaliśmy Astro, do rozwiązania jakich problemów istnieje i dlaczego może być najlepszym wyborem dla twojego projektu lub zespołu.
...
5. [Skupiony na developerach](#skupiony-na-developerach): Dostęp do zasobów, dzięki którym zdobędziesz sukces, powinien być łatwy.

### Skoncentrowany na treści

**Astro zostało zaprojektowane do budowania stron bogatych w treść.** Należą do nich większość stron marketingowych, wydawniczych, dokumentacje, blogi, portfolia, landingi, strony społeczności oraz strony e-commerce. Jeśli masz treści do przekazania, muszą szybko dotrzeć do twojego czytelnika.

W przeciwieństwie do tego, większość współczesnych frameworków została zaprojektowana w celu budowania *aplikacji webowych*. Te frameworki sprawdzają się najlepiej przy tworzeniu bardziej zaawansowanych, przypominających aplikacje stron, na przykład: panele admina, skrzynki odbiorcze, serwisy społecznościowe, listy zadań, a nawet aplikacje podobne do natywnych jak [Figma](https://figma.com/) lub [Ping](https://ping.gg/). Z taką zawiłością mogą jednak mieć problem z zapewnieniem świetnej wydajności przy dostarczaniu twoich treści. 

Astro od swoich początków jako kreator statycznych
