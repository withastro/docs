...
<ReadMore>Przeczytaj więcej o zaawansowanych przypadkach użycia importu CSS, takich jak bezpośrednie odwołanie URL do pliku CSS lub importowanie CSS jako ciągu znaków w [przewodniku po stylizacji](/pl/guides/styling/#zaawansowane).</ReadMore>
