...
W wersji v1.x zasoby były budowane do wielu lokacji - `assets/`, `chunks/` i do 
...
- [Prerenderowanie pojedynczych stron do statycznego HTML](/pl/guides/server-side-rendering/#hybrid-rendering) przy użyciu SSR w celu poprawy szybkości i możliwości cachowania.
