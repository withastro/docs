...
Aby kontynuować oznaczanie niektórych stron w projekcie jako robocze, [przenieś się do kolekcji treści](/pl/guides/content-collections/) i ręcznie odfiltruj strony z właściwością frontmatter `draft: true`.
