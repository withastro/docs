...
Możesz również [zaktualizować integracje Astro manualnie](/pl/guides/integrations/#manual-upgrading), jeśli to konieczne, i być może będziesz musiał zaktualizować inne zależności w swoim projekcie.
