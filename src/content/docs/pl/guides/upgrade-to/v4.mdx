...
Aby kontynuować oznaczanie niektórych stron w projekcie jako robocze, [przenieś się do kolekcji treści](/pl/guides/content-collections/#updating-existing-collections) i [ręcznie odfiltruj strony](/pl/guides/working-with-collections/#filtering-collection-queries) z właściwością frontmatter `draft: true`.
