...
Projekt [Fontsource](https://fontsource.org/) upraszcza używanie Google Fonts i innych czcionek open-source. Dostarcza moduły npm, które możesz zainstalować dla czcionek, których chcesz używać.
...
2. Zainstaluj pakiet dla wybranej czcionki.
    ...
    :::tip
    Poprawną nazwę paczki znajdziesz w sekcji „Quick Installation” na stronie każdej czcionki w witrynie Fontsource. Zaczyna się od `@fontsource/` lub `@fontsource-variable/` i nazwy czcionki.
    :::
