...
:::tip
Rozważ utworzenie [kolekcji treści](/pl/guides/content-collections/) zamiast stron dla katalogów powiązanych plików Markdown, które mają podobną strukturę, takich jak posty na blogu czy elementy produktów..
:::
