...
Możesz zdefiniować zmienne lokalne JavaScript w środku skryptu modułu frontmatter pomiędzy dwiema furtkami kodu komponentu Astro (`---`). Możesz wstrzyknąć te zmienne do szablonu HTML komponentu za pomocą wyrażeń JSX-o podobnych!
