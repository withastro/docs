...
Oto kilka rzeczy, które warto teraz poznać. Możesz je czytać w dowolnej kolejności – albo na chwilę zostawić dokumentację i poeksperymentować w swoim projekcie Astro. W razie pytań czy problemów zawsze możesz tu wrócić.
