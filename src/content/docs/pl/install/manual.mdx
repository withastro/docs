...
Ten przewodnik przeprowadzi Cię przez kroki niezbędne do ręcznej instalacji i konfiguracji nowego projektu Astro, jeśli nie chcesz używać [automatycznego narzędzia CLI](/[pl]/install/auto/).
