...
W edytorze tekstu utwórz nowy plik w swoim katalogu pod adresem `public/robots.txt`. `robots.txt` jest prostym plikiem, który zawiera większość stron, aby powiedzieć botom wyszukiwarek, takim jak Google, jak mają traktować Twoją stronę.
