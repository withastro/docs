...
Jeśli podążałeś za tym przewodnikiem, możesz przejść bezpośrednio do [Krok 2: Uruchom Astro](/pl/install/auto/#2-start-astro-), aby kontynuować i dowiedzieć się jak uruchomić Astro po raz pierwszy.
