...
Il comando `create astro` è il modo più rapido per iniziare un nuovo progetto di Astro partendo da zero. Ti guiderà attraverso ogni passo per impostare il tuo nuovo progetto di Astro. Ti permette di scegliere tra diversi template ufficiali già pronti oppure puoi [usare qualunque progetto esistente su GitHub con l'argomento `--template`](#template-di-partenza).
