...
Se vuoi includere [componenti di framework UI](/it/basics/framework-components/) come quelli di React, Svelte, ecc. o usare altri strumenti come Tailwind o Partytown nel tuo progetto, qua è dove [importi e configuri manualmente le integrazioni](/it/guides/integrations-guide/).
