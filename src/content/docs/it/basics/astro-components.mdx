...
Quando il tuo componente Astro necessita di interattività lato client, puoi aggiungere [tag HTML standard `<script>`](/it/guides/client-side-scripts/) o [componenti UI Framework](/it/basics/framework-components/#componenti-interattivi-idratanti).
...
:::tip
Gli slot con nome possono anche essere passati a [componenti di altri framework UI](/it/basics/framework-components/)!
:::
...
📚 Scopri come utilizzare i [componenti di framework UI](/it/basics/framework-components/) nel tuo progetto Astro.
