...
- Emacs - Consulta le instruzioni per [Configurare Emacs ed Eglot](https://medium.com/@jrmjrm/configuring-emacs-and-eglot-to-work-with-astro-language-server-9408eb709ab0) <span style="margin: 0.25em;"><Badge variant="neutral">Community</Badge></span> per lavorare con Astro
- [Evidenziazione della sintassi di Astro per Sublime Text](https://packagecontrol.io/packages/Astro) <span style="margin: 0.25em;"><Badge variant="neutral">Community</Badge></span> - Il pacchetto Astro per Sublime Text, disponibile sul gestore di pacchetti di Sublime Text.
