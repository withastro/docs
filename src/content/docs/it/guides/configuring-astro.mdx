...
## Il file di configurazione di Astro  \{#the-astro-config-file\}
...
## Tipi di file configurazione supportati \{#supported-config-file-types\}
...
## Risoluzione del file di configurazione \{#config-file-resolving\}
...
## IntelliSense nella configurazione \{#config-intellisense\}
...
## Riferimento ai file relativi \{#referencing-relative-files\}
...
## Cambiare il nome dei file di output \{#customising-output-filenames\}
...
## Referenze  \{#configuration-reference\}
