...
Astro include un comando `astro add` per automatizzare la configurazione delle integrazioni ufficiali. Se preferisci, puoi [installare le integrazioni manualmente](/it/guides/integrations-guide/mdx/#installazione-manuale).
