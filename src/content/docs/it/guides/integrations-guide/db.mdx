...
##### 1. Installa l'integrazione da npm tramite un gestore di pacchetti \{#1-install-the-integration-from-npm-via-a-package-manager\}
...
##### 2. Aggiungi l'integrazione a `astro.config.mjs` \{#2-add-the-integration-to-astroconfigmjs\}
...
##### 3. Configura il tuo database  \{#3-configure-your-database\}
...
## Riferimento alla configurazione delle tabelle \{#table-configuration-reference\}
...
## Riferimento per la CLI di Astro DB \{#astro-db-cli-reference\}
...
## Riferimento delle utility di Astro DB \{#astro-db-utility-reference\}
