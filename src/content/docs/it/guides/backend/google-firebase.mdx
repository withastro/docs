...
- Un progetto Astro con [server-side rendering (SSR)](/it/guides/on-demand-rendering/) abilitato.
...
:::caution
Firebase consente solo l'utilizzo di [un cookie, e deve essere denominato `__session`](https://firebase.google.com/docs/hosting/manage-cache#using_cookies). Eventuali altri cookie inviati dal client non saranno visibili all'applicazione.
:::
...
- [Astro e Firebase SSR app di esempio](https://github.com/kevinzunigacuellar/astro-firebase)
- [Utilizzare Firebase Realtime Database in Astro con Vue: una guida passo passo](https://www.launchfa.st/blog/vue-astro-firebase-realtime-database-it)
