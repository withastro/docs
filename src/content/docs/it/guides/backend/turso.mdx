...
## Inizializzare Turso in Astro \{#initializing-turso-in-astro\}
...
### Configura le variabili di ambiente \{#configure-environment-variables\}
...
### Installa il Client di LibSQL \{#install-libsql-client\}
...
### Inizializzare un nuovo client \{#initialize-a-new-client\}
...
## Esegui query sul Database \{#querying-your-database\}
...
## Risorse per Turso \{#turso-resources\}
