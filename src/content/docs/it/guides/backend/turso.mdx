...
Non usare il prefisso `PUBLIC_` quando crei queste [variabili d'ambiente](/en/guides/environment-variables/) private. Facendolo, esponi questi valori sul client.
:::
