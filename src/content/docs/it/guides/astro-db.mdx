...
<ReadMore>Vedi il [riferimento alla configurazione delle tabelle](/it/guides/integrations-guide/db/#table-configuration-reference) per un riferimento completo delle opzioni delle tabelle.</ReadMore>
...
<ReadMore>Consulta il [riferimento delle colonne delle tabelle](/it/guides/integrations-guide/db/#table-configuration-reference) per ulteriori dettagli.</ReadMore>
...
Vedi il [riferimento CLI](/it/guides/integrations-guide/db/#astro-db-cli-reference) per un elenco completo dei comandi.
