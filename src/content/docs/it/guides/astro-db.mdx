...
Il portale web di Astro Studio ti permette di connetterti e gestire i tuoi database Astro DB ospitati in remoto attraverso un'interfaccia web o utilizzando [comandi CLI](/it/reference/cli-reference/#astro-studio-cli).
