...
- uno [**`<slot />`**](/it/core-concepts/astro-components/#slot) per specificare dove deve essere inserito il contenuto della singola pagina.
...
📚 Scopri di più sugli [slot](/it/core-concepts/astro-components/#slot).
...
2. Uno [`<slot />`](/it/core-concepts/astro-components/#slot) predefinito per indicare dove deve essere visualizzato il contenuto Markdown/MDX della pagina.
