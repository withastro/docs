...
I layout di pagina sono particolarmente utili per le [pagine Markdown e MDX](/it/guides/markdown-content/#pagine-markdownmdx) che altrimenti non avrebbero alcuna formattazione della pagina.
