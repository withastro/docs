...
Tuttavia, [la sintassi del modello del componente Astro](/it/core-concepts/astro-syntax/) supporta anche le **espressioni JavaScript**, Astro [`<style>`](/it/guides/styling/#styling-in -astro) e tag [`<script>`](/it/guides/client-side-scripts/#using-script-in-astro), **componenti importati** e [**direttive speciali Astro** ](/it/reference/directives-reference/). I dati e i valori definiti nello script del componente possono essere utilizzati nel modello del componente per produrre HTML creato dinamicamente.
