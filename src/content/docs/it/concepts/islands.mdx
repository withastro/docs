...
**Isole Astro** (noto anche come Isole di componenti) sono un modello di architettura web sviluppato da Astro. L'idea di "architettura delle isole" è stata coniata per la prima volta dalla sviluppatrice frontend di Etsy, [Katie Sylor-Miller](https://twitter.com/ksylor), nel 2019, ed è stata approfondita in [questo articolo](https://jasonformat.com/islands-architecture/) dal creatore di Preact, Jason Miller.
...
Con le Isole Astro, la stragrande maggioranza del tuo sito rimane in HTML e CSS. Nell'esempio sopra, hai appena aggiunto uns singola **isola di interattività**, isolata dal resto della pagina, senza modificare anche il resto della pagina.
