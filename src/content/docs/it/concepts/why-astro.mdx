...
- **[Server-first](/it/basics/rendering-modes/):** Sposta il rendering dispendioso fuori dai dispositivi dei visitatori.
...
1. **[Orientato al contenuto](#content-driven):** Astro è stato progettato per siti web ricchi di contenuti.
2. **[Server-first](#server-first):** I siti web sono più veloci quando renderizzano l'HTML sul server.
3. **[Veloce di default](#fast-by-default):** Dovrebbe essere impossibile creare un sito web lento con Astro.
4. **[Facile da usare](#easy-to-use):** Non devi essere un esperto per creare qualcosa con Astro.
5. **[Focalizzato sullo sviluppatore](#developer-focused):** Dovresti avere le risorse necessarie per avere successo.

### Orientato al contenuto \{#content-driven\}
...
### Veloce di default \{#fast-by-default\}
...
### Focalizzato sullo Sviluppatore \{#developer-focused\}
