...
- **[UI-agnostic](/it/core-concepts/framework-components/):** Supporta React, Preact, Svelte, Vue, Solid, Lit, HTMX, componenti web e altro ancora.
- **[Server-first](/it/core-concepts/rendering-modes/):** Sposta il rendering dispendioso fuori dai dispositivi dei visitatori.
- **[Zero JS, di default](/it/core-concepts/astro-components/):** Meno JavaScript lato client per rallentare il tuo sito.
