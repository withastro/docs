...
- Un progetto con [SSR](/en/guides/server-side-rendering/) (output: 'server') abilitato
...
2. Su qualunque pagina Astro, importa il metodo `GET()` dall'endpoint. Chiamalo con il [`Astro` global](/en/reference/api-reference/#astro-global) per fornire il contesto della richiesta, e usa la risposta sulla pagina:
