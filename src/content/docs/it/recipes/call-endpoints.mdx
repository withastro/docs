...
2. Su qualunque pagina Astro, importa il metodo `GET()` dall'endpoint. Chiamalo con il [`Astro` global](/it/reference/api-reference/#astro-global) per fornire il contesto della richiesta, e usa la risposta sulla pagina:
