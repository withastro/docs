...
Gli [endpoints del server](/en/core-concepts/endpoints/#server-endpoints-api-routes) possono essere utilizzati come endpoint API REST per eseguire funzioni come autenticazioni, accesso al database e verifiche senza esporre dati sensibili al client.
