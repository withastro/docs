...
2. Controlla l'anteprima del tuo browser su `http://localhost:4321/posts/post-1`. Ora dovresti vedere il contenuto renderizzato da:
...
3. Nota che il titolo della tua pagina è ora visualizzato due volte, una volta da ciascun layout.
...
4. Controlla di nuovo l'anteprima del tuo browser su `http://localhost:4321/posts/post-1` e verifica che questa riga non sia più visualizzata e che il tuo titolo sia visualizzato solo una volta. Apporta qualsiasi altra modifica necessaria per assicurarti di non avere contenuti duplicati.
</Steps>
...
- [Nidificare Layout in Astro](/it/basics/layouts/#nesting-layouts)
