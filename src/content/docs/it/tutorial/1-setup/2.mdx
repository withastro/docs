...
4. Quando il prompt ti chiede se installare o meno le dipendenze, digita o seleziona `y`.

5. Quando il prompt ti chiede se inizializzare o meno un nuovo repository git, digita o seleziona `y`.
</Steps>
...
<Steps>
6. Apri VS Code. Ti verrà richiesto di aprire una cartella. Scegli la cartella che hai creato durante la procedura guidata di installazione.
...
8. Assicurati che il terminale sia visibile e di poter vedere il prompt dei comandi, come ad esempio:
...
<Steps>
9. Esegui il comando per avviare il server dev di Astro digitando nel terminale di VS Code:
...
<Steps>
10. Clicca sul link `localhost` nella finestra del tuo terminale per vedere un'anteprima live del tuo nuovo sito web Astro!
