...
## Codice Tutorial per Creare un Blog \{#build-a-blog-tutorial-code\}
...
## Pagine Vs Collezioni \{#pages-vs-collections\}
...
### Testa la tua conoscenza \{#test-your-knowledge\}
...
## Estendere il blog di tutorial con le collezioni di contenuti \{#extending-the-blog-tutorial-with-content-collections\}
...
### Aggiorna le dipendenze \{#upgrade-dependencies\}
...
### Crea una collezione per i post del tuo blog \{#create-a-collection-for-your-blog-posts\}
...
### Genera le pagine da una collezione \{#generate-pages-from-a-collection\}
...
### Rimpiazza `Astro.glob()` con `getCollection()` \{#replace-astroglob-with-getcollection\}
...
13. Il blog di tutorial genera anche dinamicamente una pagina per ogni tag usando `src/pages/tags/[tag].astro` e visualizza un elenco di tag su `src/pages/tags/index.astro`.
        ...
        <Box icon="puzzle-piece">
          ### Prova tu - Aggiorna la query nella pagina dell'indice dei tag \{#try-it-yourself---update-the-query-in-the-tag-index-page\}
...
### Aggiorna ogni valore di frontmatter per corrispondere allo schema \{#update-any-frontmatter-values-to-match-your-schema\}
...
### Aggiorna la funzione RSS \{#update-rss-function\}
