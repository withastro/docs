...
एक अवयव के `<slot/>` प्लेसहोल्डर में `<div>` लपेटे बगैर  एकाधिक HTML तत्वों को पास करने के लिए, [Astro के `<Fragment/>` अवयव](/hi/basics/astro-syntax/#fragments) पर `slot=""` विशेषता का उपयोग करें:
