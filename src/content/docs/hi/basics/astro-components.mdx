...
:::note
HTML अवयव के अंदर एक [`<slot />` तत्व](/hi/basics/astro-components/#slots) उसी तरह काम करेगा जैसे वह एस्ट्रो अवयव में काम करेगा। इसके बजाय [HTML वेब अवयव स्लॉट](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot) तत्व का उपयोग करने के लिए, अपने `<slot>` तत्व में is:inline जोड़ें।
:::
