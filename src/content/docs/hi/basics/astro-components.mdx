...
## अवयव संरचना \{#component-structure\}
...
### अवयव स्क्रिप्ट \{#the-component-script\}
...
### अवयव टेम्पलेट \{#the-component-template\}
...
## अवयव-आधारित डिज़ाइन \{#component-based-design\}
...
एक अवयव के `<slot/>` प्लेसहोल्डर में `<div>` लपेटे बगैर  एकाधिक HTML तत्वों को पास करने के लिए, [Astro के `<Fragment/>` अवयव](/hi/reference/api-reference/#fragment-) पर `slot=""` विशेषता का उपयोग करें:
...
### स्लॉट्स के लिए फ़ॉलबैक कंटेंट \{#fallback-content-for-slots\}
...
### स्लॉट स्थानांतरित करना \{#transferring-slots\}
...
:::note
HTML अवयव के अंदर एक [`<slot />` तत्व](/hi/basics/astro-components/#slots) उसी तरह काम करेगा जैसे वह Astro अवयव में काम करेगा। इसके बजाय [HTML वेब अवयव स्लॉट](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot) तत्व का उपयोग करने के लिए, अपने `<slot>` तत्व में is:inline जोड़ें।
:::
