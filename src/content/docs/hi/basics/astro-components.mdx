...
हालाँकि, [Astro का अवयव टेम्पलेट सिंटैक्स](/hi/reference/astro-syntax/) **JavaScript अभिव्यक्तियों**, Astro [`<style>`](/hi/guides/styling/#styling-in-astro) और [`<script>`](/hi/guides/client-side-scripts/) टैग, **आयातित अवयवों** और [**विशेष Astro निर्देशों**](/hi/reference/directives-reference/) का भी समर्थन करता है। अवयव स्क्रिप्ट में परिभाषित डेटा और मानों का उपयोग गतिशील रूप से निर्मित HTML का उत्पादन करने के लिए अवयव टेम्पलेट में किया जा सकता है।
...
एक अवयव के `<slot/>` प्लेसहोल्डर में `<div>` लपेटे बगैर  एकाधिक HTML तत्वों को पास करने के लिए, [Astro के `<Fragment/>` अवयव](/hi/reference/astro-syntax/#fragments) पर `slot=""` विशेषता का उपयोग करें:
