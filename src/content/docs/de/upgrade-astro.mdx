...
- [nicht gewarteter v6.4.8 Snapshot](https://v6.docs.astro.build/de/getting-started/)
- [nicht gewarteter v5.18.0 Snapshot](https://v5.docs.astro.build/de/getting-started/)
...
- Eine Aktualisierung der niedrigsten **_Maintenance_ LTS**-Version (innerhalb des selben Major-Bereichs, z.&nbsp;B. von `v22.14.*` auf `v22.20.*`) von Node.js kann in einem **Minor**-Release von Astro geschehen.
