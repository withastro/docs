...
- Eine Aktualisierung der niedrigsten **_Maintenance_ LTS**-Version (innerhalb des selben Major-Bereichs, z.&nbsp;B. von `v22.14.*` auf `v22.22.*`) von Node.js kann in einem **Minor**-Release von Astro geschehen.
