...
- **[UI-agnostisch](/de/guides/framework-components/):** Unterstützt React, Preact, Svelte, Vue, Solid, Lit, HTMX, Webkomponenten und mehr.
- **[Server-first](/de/basics/rendering-modes/):** Verschiebt das teure Rendering von den Geräten deiner Besucher.
