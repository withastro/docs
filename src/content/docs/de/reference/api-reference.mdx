...
[Ein Beispiel für die Verwendung findest du in der Anleitung für `Inhaltssammlungen`](/de/guides/working-with-collections/#querying-collections).
...
[Siehe die Anleitungs für Inhaltssammlungen](/de/guides/working-with-collections/#rendering-body-content) für ein Anwendungsbeispiel.
