...
Eine Callback-Funktion, um Routen in ein Astro-Projekt zu injizieren. Injizierte Routen können [`.astro`-Seiten](/de/core-concepts/astro-pages/) oder [`.js` und `.ts`-Routenhandler](/en/core-concepts/endpoints/#static-file-endpoints) sein.
