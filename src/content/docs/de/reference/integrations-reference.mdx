...
Eine Callback-Funktion, um Routen in ein Astro-Projekt zu injizieren. Injizierte Routen können [`.astro`-Seiten](/de/basics/astro-pages/) oder [`.js` und `.ts`-Routenhandler](/de/basics/endpoints/#endpunkte-für-statische-dateien) sein.
