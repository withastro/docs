...
description: Schau dir geführte Beispiele für die Erstellung von Funktionen in Astro an.
---

import RecipesNav from '~/components/RecipesNav.astro';

Schau dir geführete Beispiele für das Hinzufügen von Funktionen zu deinem Astro-Projekt an.
...
Füge hier deine eigene hinzu! Weitere Informationen findest du in unserem [recipes contributing guide](https://github.com/withastro/docs/blob/main/contributor-guides/submitting-a-recipe.md).
