...
Füge eine dritte Seite `blog.astro` zu deiner Website hinzu, indem du [die gleichen Schritte wie oben](#erstelle-eine-neue-astro-datei) befolgst.
...
Wenn du unserem Setup in Einheit 1 gefolgt bist, kannst du deine Änderungen über Netlify auf deiner Live-Website veröffentlichen.
