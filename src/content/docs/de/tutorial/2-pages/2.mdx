...
4. Überprüfe in der Browser-Vorschau, ob alle Links zu Post 1, Post 2 und Post 3 auf funktionierende Seiten führen.  
...
- [Markdown-Cheatsheet vom Markdown-Guide (englischsprachig)](https://www.markdownguide.org/cheat-sheet/) <Badge class="neutral-badge" text="external" />

- [Was sind Entwickler-Tools im Browser? – MDN (maschinellübersetzt)](https://developer.mozilla.org/de/docs/Learn/Common_questions/What_are_browser_developer_tools) <Badge class="neutral-badge" text="external" />

- [YAML-Frontmatter (englischsprachig)](https://assemble.io/docs/YAML-front-matter.html) <Badge class="neutral-badge" text="external" />
