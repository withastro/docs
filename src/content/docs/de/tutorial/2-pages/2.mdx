...
- [Markdown-Cheatsheet vom Markdown-Guide](https://www.markdownguide.org/cheat-sheet/) <Badge class="neutral-badge" text="external" />

- [Was sind Entwickler-Tools im Browser? – MDN](https://developer.mozilla.org/de/docs/Learn/Common_questions/What_are_browser_developer_tools) <Badge class="neutral-badge" text="external" />
