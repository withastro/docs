...
description: |-
  ...
  Füge ein Astro-Style-Tag für seitenbezogene Stile hinzu
i18nReady: true
---
...
<Steps>
 1. Aktualisiere das `<style>`-Tag auf deiner About-Seite so, dass es wie unten aussieht: 
...
- [Astro-`<style>`-Tag](/de/guides/styling/#styles-stile-in-astro)
- [CSS-Variablen in Astro](/de/guides/styling/#css-variablen)
