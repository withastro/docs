...
Du kannst über ein lokales Kommandozeilen&shy;programm deines Betriebssystems auf die Kommandozeile zugreifen. Übliche Anwendungen sind **Terminal** (macOS/Linux), **Eingabe&shy;aufforderung** (Windows) und **Termux** (Android). Eines davon ist wahrscheinlich bereits auf deinem Gerät installiert.
