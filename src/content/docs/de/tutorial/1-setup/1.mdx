...
Damit Astro auf deinem System läuft, musst du außerdem eine kompatible Version von [**Node.js**](https://nodejs.org/en/) installiert haben. Astro unterstützt **gerade** Node.js-Versionen. Die aktuell minimal unterstützte Version ist `v22.12.0`. Ungerade Versionsnummern wie etwa `v23` werden nicht unterstützt.
