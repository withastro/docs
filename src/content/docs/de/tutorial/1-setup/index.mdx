...
head:
  - tag: title
    content: 'Blog-Tutorial: Einheit 1 – Einrichtung | Docs'
---
...
In dieser Einheit lernst du, wie du deine Entwicklungsumgebung einrichtest und deine Seite auf Netlify veröffentlichst. Überspringe diese Einheit und fahre mit [Einheit 2](/de/tutorial/2-pages/) fort, wenn du dich mit deiner Umgebung und deinem Workflow bereits wohlfühlst.
...
<details>
<summary>Mit Google IDX: Befolge diese Schritte und gehe dann direkt zu Einheit 2!</summary>
...
Wenn du deine Seite auf Netlify veröffentlichen möchtest, um eine live veröffentlichte Version deiner Website zu haben, fahre in Einheit 1 mit [Deine Website im Web veröffentlichen](/de/tutorial/1-setup/5/) fort.

Andernfalls kannst du diese Einheit überspringen und mit [Einheit 2](/de/tutorial/2-pages/) weitermachen, um mit Astro zu bauen!

</details>

{/* StackBlitz instructions 
<details>
<summary>Mit StackBlitz: Befolge diese Schritte und gehe dann direkt zu Einheit 2!</summary>
