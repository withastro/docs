...
<Steps>
1. Erstelle ein kostenloses Konto bei [Netlify (EN)](https://netlify.com), falls du noch keines hast.

    Notiere dir deinen Benutzernamen. Du kannst dein Dashboard und alle erstellten Websites unter `https://app.netlify.com/teams/username` (EN) ansehen.

2. Klicke auf <kbd>Add new site</kbd> > <kbd>Import an existing project</kbd>.
...
- <p>[Eine Schritt-für-Schritt-Anleitung zum Veröffentlichen auf Netlify (EN)](https://www.netlify.com/blog/2016/09/29/a-step-by-step-guide-deploying-on-netlify/) <Badge class="neutral-badge" text="external" /></p>
