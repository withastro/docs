...
- <p>[Git-Quellcodeverwaltung in VS Code verwenden](https://code.visualstudio.com/docs/sourcecontrol/overview#_git-support) <Badge class="neutral-badge" text="external" /></p>
