...
title: 'Check-in: Einheit 3 – Komponenten'
description: |-
...
head:
  - tag: title
    content: 'Tutorial zum Erstellen eines Blogs: Einheit 3 – Komponenten | Dokumentation'
---
...
In dieser Einheit lernst du, wie du **Astro-Komponenten** erstellst, um Code für häufig genutzte Elemente deiner Website effektiv wiederzuverwenden.
...
- Eine interaktive Hamburger-Menü-Komponente für die Navigation auf Mobilgeräten
