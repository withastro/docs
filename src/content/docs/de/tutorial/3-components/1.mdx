...
<PreCheck>
  ...
  - Ersetze den bestehenden HTML-Code durch eine neue, wiederverwendbare 
</PreCheck>
...
2. Kopiere deine Links für die Navigation zwischen den Seiten aus dem oberen Bereich einer beliebigen Seite und füge sie in deine neue Datei `Navigation.astro` ein:
    ...
    ```
    :::tip
    Wenn im Frontmatter deiner `.astro-Datei` nichts steht, musst du die Code-Abgrenzungen nicht schreiben. Du kannst sie jederzeit wieder hinzufügen, wenn du sie brauchst.
    :::
</Steps>
...
<Steps>
1. Gehe zurück zu `index.astro` und importiere deine neue Komponente innerhalb der Code-Abgrenzungen:
...
2. TErsetze dann darunter die vorhandenen Navigations-HTML-Link-Elemente durch die neu importierte Navigationskomponente:
...
Vergiss nicht,
- eine Import-Anweisung am Anfang des Komponenten-Skripts, innerhalb der Code-Abgrenzungen, hinzuzufügen.
