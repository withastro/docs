...
- [Komponentenbasiertes Design](https://www.droptica.com/blog/component-based-design/) <Badge class="neutral-badge" text="external" />

- [Semantische HTML-Tags](https://www.dofactory.com/html/semantics) <Badge class="neutral-badge" text="external" />
