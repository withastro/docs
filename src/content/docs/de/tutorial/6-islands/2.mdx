...
Lass uns ein klickbares Symbol bauen, mit dem deine Nutzer:innen zwischen Hell- und Dunkelmodus umschalten können – mithilfe eines weiteren `<script>`-Tags für Interaktivität … ganz ohne Framework-JavaScript im Browser.

<PreCheck>
  - Erstelle einen interaktiven Theme-Toggle nur mit JavaScript und CSS
  - Sende so wenig JavaScript wie möglich an den Browser!
</PreCheck>
