...
description: |-
  ...
  Verwende einen Preact-Komponent, um deine Besuchende mit einer zufällig ausgewählten Begrüßung zu empfangen
i18nReady: true
---
...
3. Importiere und verwende diese Komponente auf deiner Startseite `index.astro`.
    ...
    <BaseLayout pageTitle={pageTitle}>
      ...
      <!-- need help on how to translate howdy, maybe even hey -->
      <Greeting messages={["Hey!", "Hallo!", "Howdy?", "Na?"]} />
    </BaseLayout>
    ```
