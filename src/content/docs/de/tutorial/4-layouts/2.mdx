---
type: tutorial
title: Erstelle ein individuelles Blog-Layout und übergebe Daten
description: >-
  Tutorial: Erstelle deinen ersten Astro-Blog —
  Erstelle ein Blog-Beitrags-Layout für deine Markdown-Dateien und übergebe Frontmatter-Werte als Props
i18nReady: true
---
...
<PreCheck>
  - Erstelle ein neues Blog-Beitrags-Layout für deine Markdown-Dateien
  - Übergib YAML-Frontmatter-Werte als Props an die Layout-Komponente
</PreCheck>
...
5. Füge dieselbe Layout-Eigenschaft zu deinen beiden anderen Blog-Beiträgen `post-2.md` und `post-3.md` hinzu. Überprüfe im Browser, dass das Layout auch auf diese Beiträge angewendet wird.
</Steps>
...
- [Einführung in YAML](https://dev.to/paulasantamaria/introduction-to-yaml-125f) <Badge class="neutral-badge" text="external" />
