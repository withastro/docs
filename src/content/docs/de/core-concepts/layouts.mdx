...
```astro title="src/layouts/MeinLayout.astro"
---
---
<html>
  <head>
...
```astro {3} /</?MeinLayout>/ title="src/pages/index.astro"
---
...
```astro /frontmatter(?:.\w+)?/ title="src/layouts/BlogBeitragsLayout.astro"
---
...
```astro {3} /</?BasisLayout>/ title="src/layouts/BlogBeitragsLayout.astro"
---
