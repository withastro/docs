---
title: Status zwischen Astro-Inseln teilen
description: Lerne, wie du den Status von Komponenten - und Frameworks! - mit Nano Stores teilst.
i18nReady: true
type: recipe
---
...
Wenn du eine Astro-Website mit [Insel-Architektur / Partielle Hydratation](/de/concepts/islands/) aufbaust, bist du vielleicht schon auf dieses Problem gestoßen: **Ich möchte den Status zwischen meinen Komponenten teilen

UI-Frameworks wie React oder Vue nutzen ["Kontext"-Anbieter](https://reactjs.org/docs/context.html) die von anderen Komponenten konsumiert werden können. Bei der [partiellen Hydratation von Komponenten](/de/core-concepts/framework-components/#hydrating-interactive-components) in Astro oder Markdown kannst du diese Kontext-Wrapper jedoch nicht verwenden.
...
Die [Nano Stores](https://github.com/nanostores/nanostores) Bibliothek ermöglicht es dir, Stores zu erstellen, mit denen jede Komponente interagieren kann. Wir empfehlen Nano Stores, weil:
...
- [Solide signals](https://www.solidjs.com/docs/latest) außerhalb eines Komponentenkontextes
...
- Das Schreiben in einen Store aus einer `.astro`-Datei oder einer [nicht-hydratatierten Komponente](/de/core-concepts/framework-components/#hydrating-interactive-components) hat _keine_ Auswirkung auf den Wert, der von [Client-seitigen Komponenten](/de/reference/directives-reference/#client-directives) empfangen wird.
...
Jetzt exportieren wir einen `addCartItem`-Helper, den unsere Komponenten verwenden können.
...
[**Probiere das fertige Beispiel**](https://github.com/withastro/astro/tree/main/examples/with-nanostores) auf deinem Rechner oder online über Stackblitz!
