...
Diese **[Astro integration][astro-integration]** erlaubt dir, [Tailwinds](https://tailwindcss.com) CSS Hilfsklassen in jeder `.astro` Datei und [UI-Framework-Komponenten](/de/guides/framework-components/) deines Projekts zu verwenden.
...
[Autoprefixer](https://github.com/postcss/autoprefixer) wird auch automatisch eingerichtet, wenn du im Entwicklungsmodus arbeitest, sowie in Productions-Builds gearbeitet wird, sodass Tailwind-Klassen in älteren Browsern funktionieren.

## Konfiguration

### Tailwind konfigurieren

Wenn du die automatische Installation verwendet hast und jede Aufforderung mit Ja beantwortet hast, siehst du in deinem Projekt&shy;stammverzeichnis eine `tailwind.config.mjs` Datei. In dieser Datei kannst du Änderungen an deiner Tailwind-Konfiguration vornehmen. Du kannst [in der Tailwind Dokumentation](https://tailwindcss.com/docs/configuration) lernen, wie man Tailwind konfiguriert.
...
:::caution
Es wird nicht empfohlen, eine andere Datei zu verwenden, da dies zu Problemen mit anderen Werkzeugen führen kann, die dir bei der Arbeit mit Tailwind behilflich sein können, wie zum Beispiel der offiziellen Tailwind-VSCode-Erweiterung, führen kann.
:::
...
Weitere Informationen zu Integrationen findest du in der [Astro-Integration-Dokumentation][astro-integration].
