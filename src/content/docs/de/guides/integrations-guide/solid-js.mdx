...
Astro verfügt über einen `astro add`-Befehl, der das Setup offizieller Integrationen automatisiert. Wenn du möchtest, kannst du die [Integrationen auch manuell installieren](#manual-install).
...
### Kombination mehrerer JSX-Frameworks \{#devtools\}
...
### devtools \{#combining-multiple-jsx-frameworks\}
...
### Suspense-Grenzen \{#suspense-boundaries\}
