...
Um eine Integration zu entfernen, deinstalliere die Integration zunächst aus deinem Projekt.
...
Als Nächstes entfernst du die Integration aus deiner Datei `astro.config.*`:
