---
title: Veröffentliche deine Astro-Site mit Flightcontrol auf AWS
description: Wie du deine Astro-Website mit Flightcontrol auf AWS veröffentlichst
type: deploy
i18nReady: true
---

Du kannst eine Astro-Site mit [Flightcontrol](https://www.flightcontrol.dev?ref=astro) veröffentlichen, das vollautomatische Bereitstellungen in deinem AWS-Konto ermöglicht.

Unterstützt sowohl statische als auch SSR-Astro-Sites.
