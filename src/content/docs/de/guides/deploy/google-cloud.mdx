...
#### Dockerfile erstellen & Container bauen

Bevor du deine Astro-Website in Cloud Run bereitstellen kannst, musst du ein Dockerfile erstellen, mit dem du den Container bauen kannst. Weitere Informationen über [wie du Docker mit Astro verwendest](/de/recipes/docker/#creating-a-dockerfile) findest du in unseren Beispielen.
...
```bash
# Baue deinen Container
docker build .

docker tag SOURCE_IMAGE HOSTNAME/PROJECT-ID/TARGET-IMAGE:TAG

# Push dein Image in ein Registry
...
- `TARGET-IMAGE`: Der Name für das Image, wenn es in das Registry gespeichert wird.
...
**Ein anderes Werkzeug verwenden**:
...
**Baue mit [Cloud Build](https://cloud.google.com/build)**:
...
Die Bereitstellung kann manuell in deinem Terminal [mit `gcloud`](https://cloud.google.com/run/docs/deploying#service) oder automatisch mit [Cloud Build](https://cloud.google.com/build) oder einem anderen CI/CD-System erfolgen.

:::note[Du brauchst öffentlichen Zugang?]
