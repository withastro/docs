...
Deine veröffentlichte Astro-Website ruft Daten **einmalig während des Erstellungsvorgangs** ab. Während der Entwicklung wirst du aber bei jeder Komponentenaktualisierung einen Datenabruf sehen. Wenn du einen mehrfachen clientseitigen Datenabruf benötigst, nutze eine [Framework-Komponente](/de/basics/framework-components/) oder ein [clientseitiges Skript](/de/basics/astro-components/#clientseitige-skripte) in einer Astro-Komponente.
:::


## `fetch()` in Framework-Komponenten

Die `fetch()`-Funktion ist auch global in jeder [Framework-Komponente](/de/basics/framework-components/) verfügbar:
...
Astro-Komponenten könnten Daten von deinem CMS abrufen und in deinen Seiteninhalt rendern. Mit [dynamischen Routen](/de/basics/routing/#dynamische-routen) können Komponenten sogar Seiten auf der Basis deiner CMS-Inhalte generieren.
