...
Außerdem kannst du mit [`new URL("/api", Astro.url)`](/de/reference/api-reference/#url) eine URL zu den Seiten und Endpunkten deines Projekts konstruieren, die bei Bedarf auf dem Server gerendert werden.
