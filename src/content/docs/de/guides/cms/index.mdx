...
Beachte, dass viele dieser Seiten **Platzhalter** sind: Sie sind Sammlungen von Ressourcen, die auf deinen Beitrag warten!
...
Einige Headless CMS, wie Storyblok, bieten eine Astro-[Integration](/de/guides/integrations/) an, die hilft, Inhalte speziell für eine Astro-Website abzurufen. Andere bieten ein JavaScript-SDK — eine Bibliothek, die du installierst und nutzt, um Inhalte aus der Ferne abzurufen.
...
Ja! Astro bietet integrierte Unterstützung für [Markdown](/de/guides/markdown-content/).
