...
Bei Bedarf kannst du deine Astro-Integrationen auch [manuell aktualisieren](/de/guides/integrations-guide/#manual-upgrading). Möglicherweise musst du auch andere Abhängigkeiten in deinem Projekt aktualisieren.
