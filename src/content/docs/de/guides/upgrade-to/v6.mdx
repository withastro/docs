...
<ReadMore>Ausführliche Anweisungen für die Aktualisierung von älteren Collections auf die neue Content Layer API findest du im [Astro v5-Aktualisierungs-Leitfaden](/de/guides/upgrade-to/v5/#legacy-v20-content-collections-api).</ReadMore>
