...
import { middleware } from "astro:i18n"; // Astros eigenes Internationalisierungs-Routingkonfiguration
...
### Geändert: Endpunkte mit einer Dateiendung können nicht mit einem nachstehenden Schrägstrich abgerufen werden
