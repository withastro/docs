...
Astro v6.0 enthält [möglicherweise kompatibilitätsbeeinträchtigende Änderungen](#inkompatible-änderungen) sowie die Entfernung und Abkündigung einiger Funktionen.
