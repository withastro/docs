...
Wenn du ein Adapter-Autor mit einem öffentlichen Repository bist und [das Schlüsselwort `astro-adapter` in deine `package.json` einfügst](/de/guides/integrations/#categories), wird das Astro-Core versuchen, direkt einen PR an dein Repository zu senden, um dir bei der Migration deines Codes zu helfen, falls du die folgenden Schritte noch nicht befolgt hast.
