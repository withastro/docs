...
Mit Astro v2.0 kannst du jetzt [jede verfügbare Markdown-Konfigurationsoption](/en/reference/configuration-reference/#markdown-options) (außer `drafts`) einzeln in deiner MDX-Integrationskonfiguration einstellen.
