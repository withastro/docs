...
In Astro v3.0 wurde das Paket `@astrojs/markdown-component` vollständig entfernt. Der <Markdown />-Komponente von Astro wird nicht mehr in deinem Projekt funktionieren.
