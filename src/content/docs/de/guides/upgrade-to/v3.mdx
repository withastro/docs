...
Du findest eine [Schritt für Schritt Anleitung zum Entfernen der alten Bildintegration](/de/guides/images/#remove-astrojsimage) in unserem Bilder-Guide.
...
Andernfalls lösche alle Verweise auf den Import des Astro `<Markdown />`-Komponents und den Komponenten selbst in deinen `.astro`-Dateien. Du musst deinen Inhalt dann direkt als HTML umschreiben oder [Markdown importieren](/de/guides/markdown-content/#importieren-von-markdown) von einer `.md`-Datei.
...
Du kennst eine gute Quelle für Astro v3.0? [Bearbeite diese Seite](https://github.com/withastro/docs/edit/main/src/content/docs/en/guides/upgrade-to/v3.mdx) und füge unten einen Link hinzu!
