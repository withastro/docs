...
Astro v4.0 enthält [potenziell bahnbrechende Änderungen](#bahnbrechende-änderungen) sowie die [Entfernung einiger zuvor veralteter Funktionen](#zuvor-veraltete-funktionen-werden-nun-entfernt). 
...
Bitte sieh dir den v3 Migrationsleitfaden zum [Aktualisieren dieser veralteten Middleware-Eigenschaften](/de/guides/upgrade-to/v3/#deprecated-buildexcludemiddleware-and-buildsplit) mit Adapterkonfigurationen an.
