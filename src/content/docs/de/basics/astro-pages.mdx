...
Beachte, dass die Verwendung eines `<head>`-Tags wie jedes andere HTML-Tag funktioniert: Es wird nicht an den Anfang der Seite verschoben. Wir empfehlen, `<head>` und seinen Inhalt in dein Top-Level-Layout zu schreiben.
