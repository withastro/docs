...
Um eine benutzerdefinierte 500-Fehlerseite für Seiten anzuzeigen, die [bei Bedarf gerendert](/de/guides/on-demand-rendering/) wird, erstelle die Datei `src/pages/500.astro`. Diese benutzerdefinierte Seite ist nicht für vorgerenderte Seiten verfügbar.
...
Partielle Seiten bieten in Kombination mit einer Rendering-Bibliothek eine Alternative zu [Astro Islands](/de/concepts/islands/) und [`<script>`-Tags](/de/guides/client-side-scripts/), um dynamische Inhalte in Astro zu erstellen.
