...
Dateien mit der Dateierweiterung `.html` können im Verzeichnis `src/pages/` abgelegt und direkt als Seiten auf deiner Website verwendet werden. Beachte, dass einige wichtige Astro-Funktionen in [HTML-Komponenten](/de/basics/astro-components/#html-component) nicht unterstützt werden.
