...
Um eine benutzerdefinierte 500-Fehlerseite für Seiten anzuzeigen, die [bei Bedarf gerendert](/de/guides/server-side-rendering/#enable-on-demand-server-rendering) wird, erstelle die Datei `src/pages/500.astro`. Diese benutzerdefinierte Seite ist nicht für vorgerenderte Seiten verfügbar und kann nicht vorgerendert werden.
