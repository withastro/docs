...
:::tip
Benannte Slots können auch an [UI-Framework-Komponenten](/de/basics/framework-components/) übergeben werden.
:::
...
📚 Erfahre mehr über die Verwendung von [JavaScript-Framework-Komponenten](/de/basics/framework-components/) in deinem Astro-Projekt.
