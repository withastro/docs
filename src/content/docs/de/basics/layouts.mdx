...
<ReadMore>Lerne mehr über die Verwendung von [Slots](/de/basics/astro-components/#slots).</ReadMore>

## TypeScript mit Layouts verwenden

Jedes Astro-Layout kann angepasst werden, um Typsicherheit und Autovervollständigung einzuführen, indem du die Typen für deine Requisiten bereitstellst:
