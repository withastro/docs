...
:::tip[Astro Version 2 ist da!]
**Was gibt es Neues in Astro v2?** [Erfahre es im Ankündigungs-Blogpost](https://astro.build/blog/astro-2/).  
**Bereit fürs Upgrade?** [Folge unserer Upgrade-Anleitung](/de/guides/upgrade-to/v2/).
:::
