...
<CardGrid>
  ...
  <!-- This last card is additional content in the German translation to clarify how we phrase gender-neutrality -->

  <SplitCard title="Hinweis zur sprachlichen Formulierung" icon="heart" color="30a46c">
