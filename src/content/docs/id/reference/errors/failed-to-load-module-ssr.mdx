...
This message can also appear when a type is imported without specifying that it is a [type import](/id/guides/typescript/#type-imports).

**See Also:**
-  [Type Imports](/id/guides/typescript/#type-imports)
