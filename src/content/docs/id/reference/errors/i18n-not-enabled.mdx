...
For more information on internationalization support in Astro, see our [Internationalization guide](/id/guides/internationalization/).

**See Also:**
-  [Internationalization](/id/guides/internationalization/)
-  [`i18n` Configuration Reference](/id/reference/configuration-reference/#i18n)
