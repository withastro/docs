...
<Steps>
1. Atualize `Navigation.astro` com a classe CSS para controlar seus links de navegação. Envolva os links de navegação existentes em uma `<div>` com a classe `nav-links` e o atributo id definido como `main-menu`.
