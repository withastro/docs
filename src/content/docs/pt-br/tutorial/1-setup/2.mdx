...
## Inicie o assistente de instalação do Astro \{#launch-the-astro-setup-wizard\}
...
## Abra seu projeto no VS Code \{#open-your-project-in-vs-code\}
...
## Execute Astro no modo de desenvolvimento \{#run-astro-in-dev-mode\}
...
## Veja uma pré-visualização do seu website \{#view-a-preview-of-your-website\}
