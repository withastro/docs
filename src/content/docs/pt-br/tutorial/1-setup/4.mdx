...
1. Entre no GitHub.com em um navegador e clique no <kbd>+</kbd> no lado superior direito da tela para fazer um novo repositório. 
...
7. Você pode ver uma mensagem te dizendo que você não tem commits "preparados", e te pedindo se você gostaria de prepará-las. Clique <kbd>Sempre</kbd> e continue.
