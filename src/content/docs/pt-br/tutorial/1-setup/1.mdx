...
Para que o Astro execute no seu sistema, você também irá precisar ter o [**Node.js**](https://nodejs.org/pt-br/) instalado, versão `v16.12.0` ou superior.
...
Se o comando retorna um número de versão maior que `v16.12.0`, você está pronto para continuar!

Se o comando retorna uma mensagem de erro como `Command 'node' not found`, ou um número de versão inferior a `v16.12.0`, então você precisa [instalar uma versão compatível do Node.js](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm).
