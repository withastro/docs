...
## Utilize o padrão de roteamento `/pages/pasta/index.astro` \{#use-the-pagesfolderindexastro-routing-pattern\}
...
## Tente você mesmo - Faça uma página de Índice de Tags \{#try-it-yourself---make-a-tag-index-page\}
...
## Crie um array de tags \{#create-an-array-of-tags\}
...
## Crie sua lista de tags \{#create-your-list-of-tags\}
...
## Adicione estilos a sua lista de tags \{#add-styles-to-your-tag-list\}
...
### Check In de Código \{#code-check-in\}
...
## Adicione essa página à sua navegação \{#add-this-page-to-your-navigation\}
...
## Desafio: Inclua tags em seu layout de postagem do blog \{#challenge-include-tags-in-your-blog-post-layout\}
...
Siga as etapas abaixo, e então cheque seu trabalho o comparando com a [amostra de código final](#code-check-in-markdownpostlayout).
<Steps>
...
### Check In de Código: MarkdownPostLayout \{#code-check-in-markdownpostlayout\}
...
- [Roteamento Estático no Astro](/pt-br/guides/routing/#rotas-estáticas)
