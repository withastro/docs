...
3. Procure por essa página na pré-visualização do seu navegador adicionando `/postagens/post-1` ao fim da sua URL de pré-visualização existente. (e.x. `localhost:4321/postagens/post-1`)
...
2. Verifique a pré-visualização do seu navegador novamente em `http://localhost:4321/postagens/post-1`. Você deve agora ver conteúdo nessa página.
