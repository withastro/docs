...
2. Verifique a pré-visualização do seu navegador novamente em `http://localhost:4321/postagens/post-1`. Você deve agora ver conteúdo nessa página. O conteúdo pode não estar propriamente formatado, mas não se preocupe, você vai atualizar isso depois durante o tutorial!
