...
Agora que você tem uma página Sobre com conteúdo sobre você, vamos estilizá-la!
...
2. Adicione o nome de classe `habilidade` aos elementos `<li>` gerados em sua página Sobre, para que possamos estilizá-los. Seu código deve se parecer com isso:
