...
description: |-
  ...
  Utilize variáveis e renderização condicional em seus páginas Astro
i18nReady: true
---
...
3. Faça commit das suas mudanças antes de seguir em frente. Faça isso sempre que quiser salvar o seu trabalho e atualiazr seu website ao vivo.

:::tip
A syntax de template do Astro é similar a sintaxe do JSX. Se você estiver se perguntando como utilizar seu script no seu HTML, então pesquisar em como é feito no JSX é provavelmente um bom início!
:::
