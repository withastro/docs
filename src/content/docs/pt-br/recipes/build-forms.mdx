...
## Pré-requisitos
- Um projeto com [SSR](/pt-br/guides/server-side-rendering/) (`output: 'server'`) ativado
...
3. Use [atributos de validação](https://developer.mozilla.org/pt-BR/docs/Learn/Forms/Form_validation#using_built-in_form_validation) para fornecer validação básica no lado do cliente, mesmo que o JavaScript esteja desativado.
