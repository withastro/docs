...
2. Configure `src/pages/index.astro` para redirecionar para a língua padrão.
    ...
    <StaticSsrTabs>
      ...
      <Fragment slot="ssr">
        Se você está utilizando um adaptador SSR, você pode usar [`Astro.redirect`](/pt-br/basics/routing/#redirecionamentos-dinâmicos) para redirecionar para a linguagem padrão no servidor.
...
3. Use [rotas dinâmicas](/pt-br/basics/routing/#rotas-dinâmicas) para buscar e renderizar conteúdo baseado em parâmetros `lang` e `slug`.
    ...
    📚 Leia mais sobre [roteamento dinâmico](/pt-br/basics/routing/#rotas-dinâmicas).
