...
:::
Esse exemplo serve cada língua em seu próprio subcamiinho, como `example.com/en/blog` para inglês e `example.com/fr/blog` para francês.
...
3. Use [rotas dinâmicas](/pt-br/guides/routing/#rotas-dinâmicas) para buscar e renderizar conteúdo baseado em parâmetros `lang` e `slug`.
    ...
    <StaticSsrTabs>
      ...
      <Fragment slot="ssr">
        ...
        const dataFormatada = page.data.dia.toLocaleString(lang);
