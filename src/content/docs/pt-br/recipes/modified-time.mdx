...
4. Exiba o horário da última modificação
   ...
   Se você estiver usando um [layout Markdown](/pt-br/basics/layouts/#markdown-layouts), utilize a propriedade `lastModified` do frontmatter a partir de `Astro.props` no seu modelo de layout.
