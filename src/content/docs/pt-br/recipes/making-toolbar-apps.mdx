...
## Crie um aplicativo de barra de ferramentas de desenvolvimento motivacional \{#build-a-motivational-dev-toolbar-app\}
...
### Criando a integração do Astro \{#creating-the-astro-integration\}
...
### Criando o aplicativo \{#creating-the-app\}
...
## Criando aplicativos com um framework de UI \{#building-apps-with-a-ui-framework\}
...
:::note 
Independentemente da sua escolha de criar o aplicativo da barra de ferramentas de desenvolvimento, usando JavaScript ou um framework de UI, você ainda precisará [criar a integração](#creating-the-astro-integration) que adiciona seu aplicativo à barra de ferramentas de desenvolvimento.
:::

### Sem uma etapa de build \{#without-a-build-step\}
...
### Com uma etapa de build \{#with-a-build-step\}
