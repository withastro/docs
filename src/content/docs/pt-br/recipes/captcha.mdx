...
[Endpoints do servidor](/pt-br/guides/endpoints/#server-endpoints-api-routes) podem ser usados como endpoints de API REST para executar funções como autenticação, acesso a banco de dados e verificações sem expor dados sensíveis ao cliente.
