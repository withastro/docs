...
### Diretivas Customizadas do Cliente

Desde o Astro 2.5.0, integrações também podem adicionar diretivas customizadas do cliente através da [API experimentao `addClientDirective`](/pt-br/reference/integrations-reference/#opcao-addclientdirective). Você pode usar diretivas `client:*` customizadas para alterar como e quanto os componentes devem ser hidratados.

Visite a página da [API `addClientDirective`](/pt-br/reference/integrations-reference/#opcao-addclientdirective) para aprender mais sobre criar uma diretiva customizada do cliente.
