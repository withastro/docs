...
O método aceita um argumento `requisicao` obrigatório e dois outros argumentos opicionais: [`routeData`](/pt-br/reference/integrations-reference/#referência-do-tipo-routedata) e [`locals`](/pt-br/guides/middleware/#locals).
