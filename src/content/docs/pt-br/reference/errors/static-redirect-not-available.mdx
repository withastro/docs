...
> **StaticRedirectNotAvailable**: Redirecionamentos só estão disponíveis ao utilizar `output: 'server'`. Atualize sua configuração do Astro se você precisa de funcionalidades de SSR.
