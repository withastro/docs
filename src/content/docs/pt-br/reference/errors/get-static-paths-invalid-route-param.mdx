...
Em rotas utilizando [parâmetros rest](/pt-br/basics/routing/#parâmetros-rest), `undefined` pode ser utilizado para representar um caminho sem parâmetros passados para a URL:
