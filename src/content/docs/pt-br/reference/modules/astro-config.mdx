...
- [`i18n`](/pt/reference/configuration-reference/#i18n)
- [`trailingSlash`](/pt/reference/configuration-reference/#trailingslash)
- [`base`](/pt/reference/configuration-reference/#base)
- [`build.format`](/pt/reference/configuration-reference/#buildformat)
- [`site`](/pt/reference/configuration-reference/#site)
...
- [`base`](/pt/reference/configuration-reference/#base)
- [`build.format`](/pt/reference/configuration-reference/#buildformat)
- [`build.client`](/pt/reference/configuration-reference/#buildclient)
- [`build.server`](/pt/reference/configuration-reference/#buildserver)
- [`build.serverEntry`](/pt/reference/configuration-reference/#buildserverentry)
- [`build.assetsPrefix`](/pt/reference/configuration-reference/#buildassetsprefix)
- [`site`](/pt/reference/configuration-reference/#site)
- [`srcDir`](/pt/reference/configuration-reference/#srcdir)
- [`cacheDir`](/pt/reference/configuration-reference/#cachedir)
- [`outDir`](/pt/reference/configuration-reference/#outdir)
- [`publicDir`](/pt/reference/configuration-reference/#publicdir)
- [`root`](/pt/reference/configuration-reference/#root)
