...
Uma função de callback para injetar rotas em um projeto Astro. Rotas injetadas podem ser [páginas `.astro`](/pt-br/basics/astro-pages/) ou [handlers de rotas `.js` e `.ts`](/pt-br/basics/endpoints/#endpoints-de-arquivos-estáticos).
