...
Adiciona uma [diretiva customizada do cliente](/pt-br/reference/directives-reference/#diretivas-customizadas-do-cliente) para ser usada em arquivos `.astro`.
...
Para uma integração projetada para ser instalada em outros projetos, utilize o nome do seu pacote para referenciar a entrypoint da rota.
