...
**Padrão:** `'astro/assets/services/squoosh'`<br />
<Since v="2.1.0" />
</p>

Defina que serviço de imagem será usado para o suporte experimental de assets do Astro.

O valor deve ser um especificador de módulo para o serviço de imagem a ser utilizado:
seja um dos serviços integrados do Astro ou uma implementação de terceiros.
