...
Você pode customizar o [codigo de status de redirecionamento](https://developer.mozilla.org/pt-BR/docs/Web/HTTP/Status#mensagens_de_redirecionamento) usando um objeto na configuração de redirecionamento:
