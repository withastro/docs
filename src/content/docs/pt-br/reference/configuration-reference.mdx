...
você pode adotar o [roteamento no lado do cliente](/pt-br/guides/client-side-routing/) por página usando esse componente
e habilita animações com a diretiva `transition:animate`.
