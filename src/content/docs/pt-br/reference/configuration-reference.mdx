...
Define uma lista de domínios de fonte de imagem permitidos para otimização de imagem local. Nenhuma outra imagem remote vai ser otimizada pelo Astro.
...
`pathname`:
  - Termine com '/**' para permitir todos as sub-rotas ('começa com').
