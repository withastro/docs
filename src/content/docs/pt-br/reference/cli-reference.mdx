...
Quando você segue as instruções para [instalar o Astro manualmente](/pt-br/install/manual/#2-instale-astro), você é instruido a adicionar esses scripts você mesmo. Você também pode adicionar mais scripts para essa lista manualmente para qualquer comando que você usa frequentemente.
