...
<ReadMore>Leia mais sobte [checagem de tipos no Astro](/pt-br/guides/typescript/#checagem-de-tipos).</ReadMore>
...
Autenticar com o Astro Studio. Isso é necessário para executar todos os comandos de gerenciamento de banco de dados, incluindo [`astro link`](#astro-link).

### `astro link`

Link para seu banco de dados hospedado no Studio. Isso é necessário para executar [comandos do Astro DB](/pt-br/guides/integrations-guide/db/#astro-db-cli-reference) para o gerenciamento do banco de dados. Para vincular um banco de dados, você será solicitado a selecionar um banco de dados existente ou criar um novo.

### `astro logout`

Faça logout do Astro Studio e remova todas as chaves de autenticação armazenadas localmente.
