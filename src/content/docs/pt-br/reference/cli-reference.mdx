...
<ReadMore>Leia mais sobre [checagem de tipos no Astro](/pt-br/guides/typescript/#type-checking).</ReadMore>
...
Gera tipos do TypeScript para todos os módulos do Astro. Ele configura um [arquivo `src/env.d.ts`](/pt-br/guides/typescript/#setup) para inferência de tipos e define módulos para funcionalidades que dependam de topos gerados:
