...
:::tip
Ao usar TypeScript, use a utilidade de tipo [`GetStaticPaths`](/pt-br/guides/typescript/#infer-getstaticpaths-types) para garantir acesso seguro de tipos de seus `params` e `props`.
:::
