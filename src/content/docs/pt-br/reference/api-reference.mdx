...
`Astro.props` é um objeto contendo quaisquer valores que foram passados como [atributos do componente](/pt-br/basics/astro-components/#component-props). Componentes de Layout para arquivos `.md` e `.mdx` recebem valores frontmatter como props.
...
📚 Aprenda mais sobre como adicionar [definições de tipo do TypeScript para suas props](/pt-br/guides/typescript/#component-props).
