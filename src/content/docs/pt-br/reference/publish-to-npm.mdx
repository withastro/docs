...
:::tip
Você precisa de alguma ajuda para construir sua integração, ou quer apenas conhecer outros construtores de integrações? Temos um canal `#integrations` dedicado no nosso [servidor Discord](https://astro.build/chat). Entre e diga oi!
:::
...
Em adição a palavra-chave obrigatória `astro-component` ou `withastro`, palavras-chave especiais são utilizadas para organizar pacotes automaticamente. A inclusão de qualquer uma das palavras-chave abaixo irá adicionar sua integração à categoria correspondente em nossa biblioteca de integrações. 
...
Pacotes que não incluem qualquer palavra-chave correspondente a uma categoria serão mostrados como `Sem Categoria`.
