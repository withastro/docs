...
[Considere ativar o modo `server` ou `hybrid`](/pt-br/guides/server-side-rendering/#habilitando-o-ssr-em-seu-projeto) em seu projeto Astro se você precisar do seguinte:
