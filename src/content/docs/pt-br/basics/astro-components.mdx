...
Quando seu componente Astro realmente precisar de interatividade no lado do cliente, você pode adicionar [tags `<script>` tradicionais do HTML](/pt-br/guides/client-side-scripts/) ou [componentes de um Framework de UI](/pt-br/basics/framework-components/#hidratando-componentes-interativos).
...
:::tip
Slots nomeados também podem ser passados para [componentes de frameworks de UI](/pt-br/basics/framework-components/)!
:::
...
📚 Aprenda sobre como utilizar [componentes de frameworks JavaScript](/pt-br/basics/framework-components/) em seu projeto Astro.
