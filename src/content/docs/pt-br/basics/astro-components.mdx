...
## Estrutura do Componente \{#component-structure\}
...
### O Script do Componente \{#the-component-script\}
...
### O Template do Componente \{#the-component-template\}
...
## Design baseado em componente \{#component-based-design\}
...
## Props do Componente \{#component-props\}
...
### Conteúdo de Fallback para Slots \{#fallback-content-for-slots\}
...
### Transferindo slots \{#transferring-slots\}
