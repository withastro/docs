...
- [`.html`](#páginas-html)
- [`.js`/`.ts`] (como [endpoints](/pt-br/basics/endpoints/))
...
Um único arquivo também pode gerar múltiplas páginas utilizando [roteamento dinâmico](/pt-br/basics/routing/#rotas-dinâmicas). Isso te permite criar páginas mesmo que seu conteúdo esteja fora do diretório especial `/pages/`, como em uma [coleção de conteúdo](/pt-br/guides/content-collections/) ou em um [CMS](/pt-br/guides/cms/).

📚 Leia mais sobre [Roteamento no Astro](/pt-br/basics/routing/).
...
[Coleções de conteúdo de páginas Markdown ou MDX](/pt-br/guides/content-collections/) em `src/content/` podem ser utilizados para [gerar páginas dinamicamente](/pt-br/basics/routing/#rotas-dinâmicas).
