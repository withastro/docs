...
- [Componentes de frameworks de UI (React, etc.)](/pt-br/basics/framework-components/)
...
**Componentes** são pedaços reutilizáveis de código para suas páginas HTML. Eles podem ser [componentes Astro](/pt-br/basics/astro-components/) ou [componentes de frameworks de UI](/pt-br/basics/framework-components/) como React ou Vue. É comum agrupar e organizar todos os componentes do seu projeto nesta pasta.
