...
O diretório `public/` é para arquivos e assets em seu projeto que não precisam ser processados durante o processo de build do Astro. Arquivos nessa pasta serão copiados para a pasta da build intocados, e então será feito a build to seu site.
