...
2. Instale Astro
    ...
    :::note[Importante]
    Astro deve ser instalado localmente, não globalmente. Certifique-se de que você **não** está executando `npm install -g astro` `pnpm add -g astro` `bun add -g astro` ou `yarn add global astro`.
    :::
