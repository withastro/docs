...
Agora, vamos rastrear os itens dentro de seu carrinho. Para evitar duplicações e continuar reestreando a "quantidade," nós podemos armazenar seu carrinho como um objeto com o ID do item como uma chave. Nós iremos utilizar um [Map](https://github.com/nanostores/nanostores#maps) para isso.
