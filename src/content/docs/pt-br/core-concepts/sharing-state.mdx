...
```js title="StoreCompartilhada.js"
...
<UIFrameworkTabs>
<Fragment slot="preact">
```jsx title="src/components/ToggleFlyoutCarrinho.jsx"
...
<UIFrameworkTabs>
<Fragment slot="preact">
```jsx title="src/components/FlyoutCarrinho.jsx"
import { useStore } from '@nanostores/preact';
import { isCarrinhoAberto } from '../storeCarrinho';
...
<UIFrameworkTabs>
<Fragment slot="preact">
```jsx title="src/components/FormAdicionarAoCarrinho.jsx"
