...
Você pode especificar um mapeamento de redirecionamentos permanentes na sua configuração do Astro com o valor 
de `redirects`. Para a maioria dos redirecionamentos, isto é um mapeamento de uma rota antiga para uma nova rota:
