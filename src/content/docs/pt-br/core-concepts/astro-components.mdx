...
```astro "Astro.props" title="src/components/TituloSaudacao.astro"
---
...
```astro /(\w+)=\S+/ title="src/components/CartaoSaudacoes.astro"
---
...
```astro ins={3-6} title="src/components/TituloSaudacao.astro"
---
...
```astro ins="= \"Olá\"" ins="= \"Astronauta\"" title="src/components/TituloSaudacao.astro"
---
...
```astro "<slot />" title="src/components/Involucro.astro"
---
...
```astro {14} title="src/components/Involucro.astro"
---
import Cabecalho from './Cabecalho.astro';
import Logo from './Logo.astro';
import Rodape from './Rodape.astro';
