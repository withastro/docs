...
O pasta [`src/assets`](/pt-br/guides/assets/) é a pasta recomendada para armazenar arquivos (e.x. imagens) para serem processados pelo Astro. Isso não é obrigatório e ela não é uma pasta especial reservada.
...
A pasta `src/content/` é reservada para armazenar [coleções de conteúdo](/pt-br/guides/content-collections/) e um arquivo opicional de configuração das coleções de conteúdo.
