...
Astro component syntax is a superset of HTML. The syntax was [designed to feel familiar to anyone with experience writing HTML or JSX](#diferenças-entre-astro-e-jsx), and adds support for including components and JavaScript expressions.
...
See below for more examples of [differences between Astro and JSX](#diferenças-entre-astro-e-jsx).
:::
...
- **Hydration directives are not supported.** When using [`client:*` hydration directives](/pt-br/core-concepts/framework-components/#hydrating-interactive-components), Astro needs to know which components to bundle for production, and the dynamic tag pattern prevents this from working.
