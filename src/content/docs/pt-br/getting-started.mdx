...
:::tip[A versão 2 do Astro está aqui!]
**O que tem de novo no Astro v2?** [Descubra na postagem de anúncio no blog](https://astro.build/blog/astro-2/).  
**Pronto para atualizar?** [Siga nosso guia de atualização](/pt-br/guides/upgrade-to/v2/).
:::
