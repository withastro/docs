...
Para fazer mudanças, primeiro abra o seu projeto num editor de código. Rodando o seu projeto no modo desenvolvimento, te permite ter atualizações em tempo real, assim que você edita o seu código.
...
### Trabalhando no modo desenvolvimento
...
Visualizando o seu site no navegador, você terá acesso ao [Astro dev toolbar](/pt-br/guides/dev-toolbar/). Durante o desenvolvimento ela ajudará você a inspecionar as [ilhas](/pt-br/concepts/islands/), mostrando problemas de acessibilidade, e mais.
...
Use (<kbd>Ctrl</kbd> + <kbd>C</kbd>) para sair do modo de pré-visualização, assim que reiniciar o ambiente de dev, você estará [trabalhando no modo desenvolvimento](#trabalhando-no-modo-desenvolvimento) que atualizará a pré-visualização a medida que você edita o seu código.
