...
Use (<kbd>Ctrl</kbd> + <kbd>C</kbd>) para sair do modo de pré-visualização, assim que reiniciar o ambiente de dev, você estará [trabalhando no modo de desenvolvimento](#trabalhando-no-modo-desenvolvimento) que atualizará a pré-visualização a medida que você edita o seu código.
