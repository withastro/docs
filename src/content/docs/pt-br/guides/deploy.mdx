...
## Guias de Deploy \{#deployment-guides\}

<DeployGuidesNav />

## Opções de Deploy Rápido \{#quick-deploy-options\}
...
### Deploy por Interface de Linha de Comando \{#cli-deployment\}
...
3. Faça build e então deploy do seu site para seu host
    ...
    Outros hosts vão precisar que você [faça build do seu site localmente](#building-your-site-locally) e então faça o deploy utilizando a linha de comando.
</Steps>

## Fazendo Build do Seu Site Localmente \{#building-your-site-locally\}
...
## Adicionando um Adaptador para SSR \{#adding-an-adapter-for-ssr\}
