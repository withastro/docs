...
## Por que migrar seu site para o Astro? \{#why-migrate-your-site-to-astro\}
...
## Quais projetos posso converter para o Astro? \{#which-projects-can-i-convert-to-astro\}
...
## Como o design do meu projeto vai mudar? \{#how-will-my-project-design-change\}

Dependendo do seu projeto existente, você pode precisar pensar de forma diferente sobre:

- Projetar com [Ilhas Astro](/pt-br/concepts/islands/#what-is-an-island) para evitar enviar JavaScript desnecessário ao navegador.
