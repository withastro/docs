...
Esta **[integração Astro][astro-integration]** traz as classes de utilitário CSS do [Tailwind](https://tailwindcss.com/) para todos os arquivos `.astro` e [componentes de framework](/pt-br/core-concepts/framework-components/) em seu projeto, juntamente com suporte para o arquivo de configuração do Tailwind.
