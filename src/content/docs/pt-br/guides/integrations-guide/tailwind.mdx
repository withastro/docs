...
Esta **[integração Astro][astro-integration]** traz as classes CSS utilitárias do [Tailwind](https://tailwindcss.com/) para todos os arquivos `.astro` e [componentes de framework](/pt-br/basics/framework-components/) em seu projeto, juntamente com suporte para o arquivo de configuração do Tailwind.
...
[astro-ui-frameworks]: /pt-br/basics/framework-components/#usando-componentes-de-frameworks
