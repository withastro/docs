...
Primeiro, certifique-se de que você **importou o componente** no [script do seu componente `.astro`](/pt-br/basics/astro-components/#the-component-script) ou no [arquivo `.mdx`](/pt-br/guides/markdown-content/#usando-componentes-no-mdx).
