...
Para ajudar na depuração de seus componentes Astro, o Astro fornece um componente embutido [`<Debug />`](/pt-br/guides/troubleshooting/#astro-debug--component) que renderiza qualquer valor diretamente em seu modelo HTML de componente. Isso é útil para depuração rápida no navegador sem precisar alternar entre o terminal e o navegador.
