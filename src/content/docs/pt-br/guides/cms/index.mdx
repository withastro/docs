...
Alguns CMSes headless, como o Storyblok, oferecem uma [integração](/pt-br/guides/integrations/) Astro que te ajuda a buscar o conteúdo especificadamente para um site Astro. Outros oferecem um SDK JavaScript, uma biblioteca que você instala e utiliza para buscar seu conteúdo remoto.
