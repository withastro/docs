...
Veja como converter um exemplo básico de blog de `src/pages/posts/` para `src/content/posts` em nosso [tutorial passo a passo](/pt-brtutorial/6-islands/4/) que utiliza o código-fonte do [projeto final do tutorial Construa um Blog](https://github.com/withastro/blog-tutorial-demo).
