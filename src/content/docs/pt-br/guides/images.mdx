...
Siga o [Guia de Assets (Experimental)](/pt-br/guides/images/) para começar a usar a nova solução de imagens do Astro hoje mesmo!
...
Se você não consegue manter suas imagens em `public/`, nós recomendamos habilitar o [suporte experimental para assets](/pt-br/guides/images/), ou utilizar o formato de arquivo `.mdx`, que permite que você combine componentes importados com sintaxe estilo Markdown. Use a [integração MDX](/pt-br/guides/integrations-guide/mdx/) para adicionar suporte a MDX no Astro.
...
Veja o guia [Assets (Experimental)](/pt-br/guides/images/) para habilitar o uso experimental da pasta `/assets/`.
