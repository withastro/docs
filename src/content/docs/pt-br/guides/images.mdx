...
import imagemLocal from '../assets/logo.png';
const imagemRemota = 'https://docs.astro.build/assets/full-logo-light.png';
---
...
<Image src={import('../assets/galaxia.png')} alt="Espaço sideral."/>
...
<Picture src={logo} widths={[200, 400, 800]} aspectRatio={16/9} sizes="(max-width: 800px) 100vw, 800px" alt="O logotipo Astro completo." />
```
