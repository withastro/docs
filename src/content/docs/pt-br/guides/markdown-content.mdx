...
Astro fornece páginas Markdown e MDX com a propriedade frontmatter especial `layout`, que pode especificar o caminho relativo (ou [atalho](/pt-br/guides/imports/#aliases)) para um [componente de layout](/pt-br/basics/layouts/#layouts-markdown) Astro.
...
📚 Aprenda mais sobre [Layouts Markdown](/pt-br/basics/layouts/#layouts-markdown).
...
- conteúdo dentro do [componente `<Code />` nativo](/pt-br/guides/syntax-highlighting/#code-) (oferecido por Shiki).
- conteúdo dentro do [componente `<Prism />`](/pt-br/guides/syntax-highlighting/#prism-) (oferecido por Prism).
