...
- conteúdo dentro do [componente `<Code />` nativo](/pt-br/reference/components-reference/#code-) (oferecido por Shiki).
- conteúdo dentro do [componente `<Prism />`](/pt-br/reference/components-reference/#prism-) (oferecido por Prism).
