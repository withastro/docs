...
:::note
Se você está usando [coleções de conteúdo](/pt-br/guides/content-collections/), por favor veja ["Modificando Frontmatter com Remark"](/pt-br/guides/content-collections/#modifying-frontmatter-with-remark).
:::
