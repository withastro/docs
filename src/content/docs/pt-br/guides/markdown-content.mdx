...
📚 Leia mais sobre o [roteamento baseado em arquivos](/pt-br/basics/routing/) do Astro ou opções para criar [rotas dinâmicas](/pt-br/basics/routing/#rotas-dinâmicas).
...
Ao invés de colocar seus arquivos Markdown/MDX no diretório `src/pages/` para criar rotas, você pode [gerar páginas dinamicamente](/pt-br/basics/routing/#rotas-dinâmicas).
