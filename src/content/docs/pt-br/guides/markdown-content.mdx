...
Essa funcionalidade não suporta coleções de conteúdo, entretanto você pode utilizar um [filtro de consulta de coleção](/en/guides/content-collections/#filtrando-consultas-de-coleção) para filtrar seus rascunhos de postagens.
:::
