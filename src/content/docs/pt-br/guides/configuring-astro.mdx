...
## O Arquivo de Configuração Astro \{#the-astro-config-file\}
...
## Tipos de Arquivo de Configuração Suportados \{#supported-config-file-types\}
...
## Resolução do Arquivo de Configuração \{#config-file-resolving\}
...
## IntelliSense da Configuração \{#config-intellisense\}
...
## Referenciando Arquivos Relativos \{#referencing-relative-files\}
...
## Customizando Nomes de Arquivos Finais \{#customising-output-filenames\}
