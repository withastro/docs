...
O exemplo abaixo implementa um compomente totalmente tipado e polimófico que pode renderizar como qualquer elemento HTML. O tipo [`HTMLTag`](#built-in-html-attributes) é usado para garantir que a prop `as` é um elemento HTML válido.
