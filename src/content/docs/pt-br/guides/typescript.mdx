...
O servidor de desenvolvimento do Astro não executará nenhuma checagem de tipo, mas você pode usar um [script separado](#type-checking) para checar erros de tipo pela linha de comando.
