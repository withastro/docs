...
Você pode obter o tipo de [`Astro.params`](/pt-br/reference/api-reference/#astroparams) com `InferGetStaticParamsType` e o tipo de [`Astro.props`](/pt-br/reference/api-reference/#props) com `InferGetStaticPropsType`:
