...
1. Encontre a fonte que você quer utilizar no [catálogo do Fontsource](https://fontsource.org/fonts). Esse exemplo vai usar [Twinkle Star](https://fontsource.org/fonts/twinkle-star).
