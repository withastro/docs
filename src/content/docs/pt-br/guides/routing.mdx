...
No exemplo a seguir, um parâmetro rest (`[...slug]`) e a funcionalidade [`props`](/pt-br/reference/routing-reference/#passagem-de-dados-com-props) de `getStaticPaths()` geram páginas para slugs de diferentes profundidades.
