...
A invalidação baseada em tags remove todas as entradas em cache cujas tags incluem qualquer uma das tags fornecidas. A invalidação baseada em caminho é de correspondência exata apenas (sem [padrões glob](/pt-br/guides/imports/#padrões-glob) ou caracteres curinga).
