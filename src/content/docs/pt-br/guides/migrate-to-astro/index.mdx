...
Astro te permite escolher entre um site gerado estaticamente e [renderização no lado do servidor (SSR)](/pt-br/guides/on-demand-rendering/), o fazendo um ótimo substituto para SSGs ou para sites que precisam buscar dados da página no momento.
