...
<ReadMore>Explore uma [lista de mais de 100 sistemas de gerenciamento de conteúdo headless](https://jamstack.org/headless-cms/) <Badge variant="accent">Externo</Badge>, onde você pode filtrar por tipo (por exemplo, baseado em Git, orientado por API) e licença (código aberto ou fechado).</ReadMore>

## Posso utilizar Astro sem um CMS?

Sim! O Astro oferece formas integradas de [escrever conteúdo](/pt-br/guides/content/), incluindo suporte para páginas Markdown.
