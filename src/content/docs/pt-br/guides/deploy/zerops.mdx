...
Agora você pode [ativar a pipeline de build & deploy usando a CLI Zerops](#trigger-the-pipeline-using-zerops-cli-zcli) ou conectar o serviço `app` ao seu repositório [GitHub](https://docs.zerops.io/references/github-integration/) / [GitLab](https://docs.zerops.io/references/gitlab-integration) a partir do detalhe do serviço.
