...
1. Selecione sua "Config Type" desejada:
    ...
    - `flightcontrol.json` (opção "infrastructure as code" onde toda a configuração está no seu repositório) onde você irá selecionar uma configuraçaõ para Astro de exemplo e então adicioná-la a sua base de código como `flightcontrol.json`
