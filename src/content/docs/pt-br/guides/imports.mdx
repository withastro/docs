...
Um [UI Framework](/en/guides/framework-components/) apropriado ([React](/pt-br/guides/integrations-guide/react/), [Preact](/pt-br/guides/integrations-guide/preact/), ou [Solid](/pt-br/guides/integrations-guide/solid-js/)) é exigido para interpretar arquivos JSX/TSX.
...
<ReadMore>Leia mais sobre casos de uso de CSS avançados como referência direta de URL para um arquivo CSS, ou importar CSS como string no [guia de estilização](/pt-br/guides/styling/#advanced).</ReadMore>
