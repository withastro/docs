...
```js del={5} ins={6} title="astro.config.mjs"
...
```js del={6} title="astro.config.mjs"
import { defineConfig } from 'astro/config';
...
```js del={6} ins={7-8} title="astro.config.mjs"
import { defineConfig } from 'astro/config';
...
```js del={8} title="astro.config.mjs"
import { defineConfig } from 'astro/config';
...
```js del={8} ins={9-11} title="astro.config.mjs"
import { defineConfig } from 'astro/config';
import mdx from '@astrojs/mdx';
...
```js ins={3, 8, 10} title="src/pages/rss.xml.js"
import rss, {
  pagesGlobToRssItems
} from '@astrojs/rss';
...
```js del={3-5} title="astro.config.mjs"
export default defineConfig({
	legacy: {
