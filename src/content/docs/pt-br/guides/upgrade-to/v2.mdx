...
- [Pré-renderizar páginas individuais para HTML estático](/pt-br/guides/server-side-rendering/#hybrid-rendering) ao utilizar SSR para melhorar a velocidade e cacheabilidade.
