...
Você também pode [atualizar suas integrações do Astro manualmente](/en/guides/integrations-guide#manual-upgrade) se preferir, e você pode precisar atualizar outras dependências no seu projeto.
