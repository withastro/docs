...
Você também pode [atualizar suas integrações do Astro manualmente](/pt-br/guides/integrations-guide/#upgrade-manual) se preferir, e você pode precisar atualizar outras dependências no seu projeto.
...
Astro v4.0 inclui [mudanças potencialmente radicais](/pt-br/guides/upgrade-to/v4/#mudanças-radicais), assim como [remoção de funcionalidades anteriormente descontinuadas](/en/guides/upgrade-to/v4/#funcionalidades-previamente-descontinuadas-agora-removidas).
...
Essas funcionalidades agora estão disponíveis no Astro v4.0.
