...
## `fetch()` em Componentes de Frameworks \{#fetch-in-framework-components\}
...
### Consultas GraphQL \{#graphql-queries\}
...
## Busque de um CMS Headless \{#fetch-from-a-headless-cms\}
...
## Conteúdo feitos pela comunidade \{#community-resources\}
