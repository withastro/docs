...
:::tip
Quer uma solução Snipcart pré-pronta? Confira [`astro-snipcart`](https://astro-snipcart.vercel.app/), um modelo da comunidade Astro totalmente funcional, incluindo um sistema de design opcional, pronto para integração com sua conta Snipcart.
:::
...
- [ Modelo Astro `@lloydjatkinson/astro-snipcart`](https://astro-snipcart.vercel.app/): Este modelo Astro inclui um sistema de design opcional para uma solução completa de e-commerce. Saiba mais em sua própria documentação extensa, incluindo [a motivação por trás da criação do `astro-snipcart`](https://astro-snipcart.vercel.app/motivation), como uma forma conveniente e nativa de Astro interagir com a API Snipcart.
