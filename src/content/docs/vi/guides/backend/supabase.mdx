...
- An Astro project with [`output: 'server'` for on-demand rendering](/vi/guides/on-demand-rendering/) enabled.
...
:::tip
Read more about [environment variables](/vi/guides/environment-variables/) and `.env` files in Astro.
:::
