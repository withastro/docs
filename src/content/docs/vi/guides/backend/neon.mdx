...
- An Astro project with [on-demand rendering (SSR)](/vi/guides/on-demand-rendering/) enabled
...
<ReadMore>Learn more about [environment variables](/vi/guides/environment-variables/) and `.env` files in Astro.</ReadMore>
