...
Đặt các tùy chọn [`site`](/en/reference/configuration-reference/#site) và [`base`](/en/reference/configuration-reference/#base) trong `astro.config.mjs`.
...
- URL ngẫu nhiên được tạo tự động cho [trang riêng tư của GitHub Organization](https://docs.github.com/en/enterprise-cloud@latest/pages/getting-started-with-github-pages/changing-the-visibility-of-your-github-pages-site): `https://<random-string>.pages.github.io/`
...
Xem thêm về [cấu hình giá trị `base`](/en/reference/configuration-reference/#base)
:::
...
Điều này sẽ triển khai trang web của bạn tại domain tùy chỉnh thay vì `user.github.io`. Đừng quên [cấu hình DNS cho nhà cung cấp domain](https://docs.github.com/en/pages/configuring-a-custom-domain-for-your-github-pages-site/managing-a-custom-domain-for-your-github-pages-site#configuring-a-subdomain).   
:::
