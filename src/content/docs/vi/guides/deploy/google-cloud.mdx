...
Trước khi triển khai trang web Astro lên Cloud Run, bạn cần tạo Dockerfile để build container. Tìm thêm thông tin về [cách sử dụng Docker với Astro](/en/recipes/docker/#creating-a-dockerfile) trong phần recipes.
