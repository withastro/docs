...
To deploy with SSR support, make sure you first set up the [`@astrojs/node`](/vi/guides/integrations-guide/node/) adapter. Then, follow the steps above, choosing the appropriate configurations for Astro SSR.
