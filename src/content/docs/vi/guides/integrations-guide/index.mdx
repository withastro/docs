...
- Mở khóa React, Vue, Svelte, Solid và các UI framework phổ biến khác với [renderer](/en/guides/framework-components/).
- Bật rendering theo yêu cầu với [SSR adapter](/en/guides/on-demand-rendering/).
...
Nếu bạn thấy cảnh báo như `Cannot find package '[package-name]'` sau khi thêm Integrations, package manager của bạn có thể chưa cài đặt [peer dependencies](https://nodejs.org/en/blog/npm/peer-dependencies/) cho bạn. Để cài đặt các packages bị thiếu này, chạy lệnh sau:
...
Xem tài liệu tham khảo [Integration API](/en/reference/integrations-reference/) để tìm hiểu tất cả các cách khác nhau mà bạn có thể viết Integrations.
...
Xem tài liệu tham khảo [Integration API](/en/reference/integrations-reference/) để tìm hiểu Integrations có thể làm gì và cách tự viết một Integrations.