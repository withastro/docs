...
Nếu tùy chọn này không được đặt, chế độ `debug` sẽ bật mặc định trong chế độ [dev](/en/reference/cli-reference/#astro-dev) hoặc [preview](/en/reference/cli-reference/#astro-preview).
