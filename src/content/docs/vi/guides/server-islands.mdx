...
Một server island là một [component Astro](/en/basics/astro-components/) được render trên server bình thường được chỉ dẫn để trì hoãn việc render cho đến khi nội dung của nó có sẵn.
...
Với [adapter được cài đặt](/en/guides/on-demand-rendering/#server-adapters) để thực hiện việc render trì hoãn, thêm [directive `server:defer`](/en/reference/directives-reference/#server-directives) vào bất kỳ component nào trên trang để biến nó thành island riêng của nó:
...
Những component này có thể làm [bất cứ điều gì bạn thường làm trong trang được render theo yêu cầu](/en/guides/on-demand-rendering/#on-demand-rendering-features) khi sử dụng adapter, chẳng hạn như fetch nội dung và truy cập cookies:
...
Trong hầu hết các trường hợp, component server island của bạn có thể lấy thông tin về trang render nó bằng cách [truyền props](/en/basics/astro-components/#component-props) như trong các component bình thường.
