...
This message can also appear when a type is imported without specifying that it is a [type import](/vi/guides/typescript/#type-imports).

**See Also:**
-  [Type Imports](/vi/guides/typescript/#type-imports)
