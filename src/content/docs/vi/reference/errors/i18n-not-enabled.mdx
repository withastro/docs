...
For more information on internationalization support in Astro, see our [Internationalization guide](/vi/guides/internationalization/).

**See Also:**
-  [Internationalization](/vi/guides/internationalization/)
-  [`i18n` Configuration Reference](/vi/reference/configuration-reference/#i18n)
