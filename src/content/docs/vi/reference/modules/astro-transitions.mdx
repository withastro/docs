...
For features and usage examples, [see our View Transitions guide](/vi/guides/view-transitions/).
...
See more about how to [control the router](/vi/guides/view-transitions/#router-control) and [add transition directives](/vi/guides/view-transitions/#transition-directives) to page elements and components.
...
See the guide on [Fallback control](/vi/guides/view-transitions/#fallback-control) for how to choose and configure the fallback behavior.
...
These can be useful when [building a custom swap function](/vi/guides/view-transitions/#building-a-custom-swap-function).
...
Marks scripts in the new document that should not be executed. Those scripts are already in the current document and are not flagged for re-execution using [`data-astro-rerun`](/vi/guides/view-transitions/#data-astro-rerun).
...
Read more about how to use this event on the [View Transitions guide](/vi/guides/view-transitions/#astrobefore-preparation).
...
Read more about how to use this event on the [View Transitions guide](/vi/guides/view-transitions/#astroafter-preparation).
...
Read more about how to use this event on the [View Transitions guide](/vi/guides/view-transitions/#astrobefore-swap).
...
Read more about [building a custom swap function](/vi/guides/view-transitions/#building-a-custom-swap-function) in the View Transitions guide.
