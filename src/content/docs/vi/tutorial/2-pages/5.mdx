...
### Resources
- [Astro syntax vs JSX - comparison](/vi/reference/astro-syntax/#differences-between-astro-and-jsx)

- [Astro `<style>` tag](/vi/guides/styling/#styling-in-astro)

- [CSS variables in Astro](/vi/guides/styling/#css-variables)
