...
This unit shows you how to set up your development environment and deploy to Netlify. Skip ahead to [Unit 2](/vi/tutorial/2-pages/) if you are already comfortable with your environment and workflow.
...
If all goes well, you should see the code for the file `src/pages/index.astro` opened in split screen with a live preview of the website. Follow the instruction to ["Write your first line of Astro"](/vi/tutorial/1-setup/3/) to make a change to this file.
