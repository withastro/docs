...
- [Astro Integrations Guide](/vi/guides/integrations-guide/)

- [Using UI Framework Components in Astro](/vi/guides/framework-components/#using-framework-components)

- [Astro client directives reference](/vi/reference/directives-reference/#client-directives)
