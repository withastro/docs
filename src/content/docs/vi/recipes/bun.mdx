...
:::tip
You may also [create a new Astro project from any existing Astro GitHub repository](/vi/install-and-setup/#install-from-the-cli-wizard) using the `--template` flag:
```bash
...
Since Bun features [Node.js API compatibility](https://bun.sh/docs/runtime/nodejs-apis), you can use any Astro adapter for [on-demand rendering](/vi/guides/on-demand-rendering/) with your Astro project:
...
For the rest of the configuration and to start your first test, follow the rest of Cypress process in the [Astro Testing Guide](/vi/guides/testing/#configuration).
...
To create your first Playwright test, follow the instructions for the rest of the Playwright process in the [Astro Testing Guide](/vi/guides/testing/#create-your-first-playwright-test).
