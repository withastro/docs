...
You can use [Tailwind](https://tailwindcss.com)'s Typography plugin to style rendered Markdown from sources such as Astro's [**content collections**](/vi/guides/content-collections/).
...
An Astro project that:
	...
	- has [Tailwind's Vite plugin](/vi/guides/styling/#tailwind) installed.
	- uses Astro's [content collections](/vi/guides/content-collections/).
