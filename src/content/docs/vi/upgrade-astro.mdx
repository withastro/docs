...
banner:
  content: |
    Astro v5 đã có mặt! <a href="/vi/guides/upgrade-to/v5/">Tìm hiểu cách nâng cấp trang web của bạn</a>
---
...
- [Nâng cấp lên v5](/vi/guides/upgrade-to/v5/)
- [Nâng cấp lên v4](/vi/guides/upgrade-to/v4/)
- [Nâng cấp lên v3](/vi/guides/upgrade-to/v3/)
- [Nâng cấp lên v2](/vi/guides/upgrade-to/v2/)
- [Nâng cấp lên v1](/vi/guides/upgrade-to/v1/)
...
- [snapshot v4.16.17 không được duy trì](https://v4.docs.astro.build/vi/getting-started/)
- [snapshot v3.6.3 không được duy trì](https://docs-git-v3-docs-unmaintained-astrodotbuild.vercel.app/)
- [snapshot v2.10.15 không được duy trì](https://deploy-preview-4405--astro-docs-2.netlify.app/vi/getting-started/)
...
- Astro hỗ trợ [phiên bản **_Maintenance_ LTS** mới nhất của Node.js](https://nodejs.org/vi/about/previous-releases#release-schedule).
- Astro hỗ trợ [phiên bản **_Active_ LTS** hiện tại của Node.js](https://nodejs.org/vi/about/previous-releases#release-schedule)
