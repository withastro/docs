...
これにより、動作しているもののプロジェクト全体にわたって重複しているコードを使って素早く開始することができます。こうして、サイトの外観を変更することなく、既存のコードの設計を段階的に改善することができます。
:::
...
- [Astroコンポーネントの概要](/ja/core-concepts/astro-components/#component-structure)
