...
## フッターコンポーネントを作成する \{#create-a-footer-component\}
...
### `Footer.astro`をインポートして使用する \{#import-and-use-footerastro\}
...
## やってみよう - フッターをカスタマイズする \{#try-it-yourself---personalize-your-footer\}
...
## ソーシャルメディアコンポーネントを作成する \{#create-a-social-media-component\}
...
### `Social.astro`をフッターにインポートして使用する \{#import-and-use-socialastro-in-your-footer\}
...
## ソーシャルメディアコンポーネントにスタイルを適用する \{#style-your-social-media-component\}
...
- [Astroにおけるコンポーネントprops](/ja/basics/astro-components/#component-props)
