...
## やってみよう - 新しいヘッダーコンポーネントを作成する \{#try-it-yourself---build-a-new-header-component\}
...
## やってみよう - ページを更新する \{#try-it-yourself---update-your-pages\}
...
## レスポンシブスタイルを追加する \{#add-responsive-styles\}
