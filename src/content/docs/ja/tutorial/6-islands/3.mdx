...
<div style="display: flex; flex-wrap: wrap; gap: 0.5rem;">
  ...
  <Button link='https://bsky.app/intent/compose?text=Astroブログの作成方法を学び終えました！%20Astroブログの作成方法を学び終えました！%20https://docs.astro.build/%20をチェックしてみてください！%0A%40astro.build%20より'>Blueskyで共有</Button>
</div>

## 次のステップ

このプロジェクトの完成コードをチュートリアル拡張のいずれかでさらに充実させるか、次のAstroプロジェクトを始めましょう！
<CardGrid>
  <LinkCard
