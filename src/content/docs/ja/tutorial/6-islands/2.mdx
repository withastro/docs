...
## テーマを切り替えるアイコンを追加してスタイルを設定する \{#add-and-style-a-theme-toggle-icon\}
...
## ダークテーマのためのCSSスタイルを追加する \{#add-css-styling-for-a-dark-theme\}
...
## クライアントサイドのインタラクティブな機能を追加する \{#add-client-side-interactivity\}
