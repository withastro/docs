...
## AstroプロジェクトにPreactを追加する \{#add-preact-to-your-astro-project\}
...
## Preactの挨拶用バナーを追加する \{#include-a-preact-greeting-banner\}
...
- [AstroでUIフレームワークコンポーネントを使う](/ja/guides/framework-components/#フレームワークコンポーネントを利用)
