...
## Astroのセットアップウィザードを起動する \{#launch-the-astro-setup-wizard\}
...
## VS Codeでプロジェクトを開く \{#open-your-project-in-vs-code\}
...
## Astroをdevモードで実行する \{#run-astro-in-dev-mode\}

作業中にプロジェクトファイルをウェブサイトとしてプレビューするには、Astroを開発（dev）モードで実行する必要があります。

### devサーバーを起動する \{#start-the-dev-server\}
...
## ウェブサイトのプレビューを確認する \{#view-a-preview-of-your-website\}
