...
TODO: 一方`MarkdownPostLayout.astro`は、`title`や`date`など、ブログ記事に共通するプロパティに対応するテンプレートを提供しますが、ブログ記事ページはサイトの他のページとは異なる見た目になってしまっています。**レイアウトを入れ子にする**と、両者の見た目を揃えることができます。
