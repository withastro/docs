...
1. 以下のJavaScriptをフロントマタースクリプト、**コードフェンス**の間に追加します。
...
2. HTMLに加えて、Astro構文に含めることができるのは？
...
- [Astroにおける動的な式](/ja/core-concepts/astro-syntax/#jsx-like-expressions)
