...
3. プレビュー用URLの末尾に`/posts/post-1`を追加して、このページをブラウザで確認します。（たとえば`localhost:4321/posts/post-1`）
...
2. `localhost:4321/posts/post-1`でブラウザのプレビューを再度確認します。今度はこのページにコンテンツが表示されるはずです。
