...
[Stylelint](https://stylelint.io/)はCSSための人気のリンターです。[コミュニティが管理するStylelintの構成](https://github.com/ota-meshi/stylelint-config-html)は、Astro向けのサポートを提供します。

インストール手順、エディターの統合、および追加情報は、プロジェクトのREADMEに記載されています。
