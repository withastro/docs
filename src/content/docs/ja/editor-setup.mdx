...
[Zed](https://zed.dev/)は高性能なオープンソースのコードエディタです。IDEの「拡張機能」タブから[Astro extension](https://github.com/zed-extensions/astro)をインストールできます。この拡張機能には、構文のハイライト、コード補完、フォーマットなどの機能が含まれています。
