...
`code`に適用する[Shiki transformers](https://shiki.style/packages/transformers#shikijs-transformers)の配列です。Astro v4.14.0以降では、[Shikiの`meta`属性](https://shiki.style/guide/transformers#meta)を文字列で渡してtransformersにオプションを指定することもできます。
