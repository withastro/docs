...
:::tip
[GitHubのブログチュートリアルデモコード](https://github.com/withastro/blog-tutorial-demo/tree/content-collections/src/pages) または [StackBlitzで開く](https://stackblitz.com/github/withastro/blog-tutorial-demo/tree/content-collections?file=src/pages/blog.astro) の `src/pages/` フォルダを探せば、ブログ記事のリストやタグページなど、コレクションからページを作成する完全な例を見ることができます！
:::
