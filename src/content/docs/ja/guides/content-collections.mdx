...
[ブログ作成チュートリアルの完成プロジェクト](https://github.com/withastro/blog-tutorial-demo)のコードベースを使用する[ステップバイステップのチュートリアル](/jatutorial/6-islands/4/)で、基本的なブログの例を`src/pages/posts/`から`src/content/posts`に変換する方法を確認してください。
