...
http://localhost:4321/posts/astro-is-amazing/にアクセスすると動的ルーティングが動作していることが分かります！
...
もしエントリーが見つからない場合は、 [`Astro.redirect`](/ja/core-concepts/routing/)を使ってユーザーを404ページにリダイレクトできます。

{/* TODO: ルーティングページが更新されたらビルド対象からエントリーを除外のリンク先を /ja/core-concepts/routing/#dynamic-redirects にする */}
