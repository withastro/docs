...
If your adapter does not support Astro's built-in Sharp image optimization, you can [configure a no-op image service](/ja/guides/images/#configure-no-op-passthrough-service) to allow you to use the `<Image />` and `<Picture />` components.
...
<ReadMore>Read more about [configuring your default image service](/ja/guides/images/#default-image-service).</ReadMore>
...
<ReadMore>Read more about the [route priority order rules](/ja/guides/routing/#route-priority-order).</ReadMore>
...
<ReadMore>Read more about [using `script` tags in Astro](/ja/guides/client-side-scripts/#using-script-in-astro).</ReadMore>
...
<ReadMore>Read more about [TypeScript configuration in Astro](/ja/guides/typescript/#setup).</ReadMore>
...
<ReadMore>Read more about the [`compiledContent()` function](/ja/guides/markdown-content/#importing-markdown) for returning compiled Markdown.</ReadMore>
...
<ReadMore>Read more about [Markdown layouts](/ja/basics/layouts/#markdown-layouts).</ReadMore>
...
<ReadMore>Read more about [using Markdown plugins in Astro](/ja/guides/markdown-content/#markdown-plugins).</ReadMore>
...
<ReadMore>Read more about [`build` configuration options in Astro](/ja/reference/configuration-reference/#build-options).</ReadMore>
...
<ReadMore>Read more about [pagination in Astro](/ja/guides/routing/#pagination).</ReadMore>
...
<ReadMore>Read more about [using HTML attributes in Astro](/ja/reference/astro-syntax/#dynamic-attributes).</ReadMore>
...
<ReadMore>See more about [storing data in `context.locals`](/ja/guides/middleware/#storing-data-in-contextlocals).</ReadMore>
...
<ReadMore>Read more about [creating dynamic routes with `params`](/ja/guides/routing/#static-ssg-mode).</ReadMore>
...
<ReadMore>See the [Adapter API reference for `renderOptions`](/ja/reference/adapter-reference/#renderoptions).</ReadMore>
...
<ReadMore>Read more about [specifying supported Astro features in an adapter](/ja/reference/adapter-reference/#astro-features).</ReadMore>
