...
- Astroはマルチページアプリケーション（MPA）をデフォルトとする一方、SvelteKitはSPAs（シングルページアプリケーション）を基本としつつ、MPAやSSRも組み合わせて構築できます。
- [コンポーネント](/ja/basics/astro-components/)：SvelteKitはSvelteコンポーネントを使用しますが、Astroでは[`.astro`コンポーネント](/ja/basics/astro-components/)でページを構築します。また、[React, Preact, Vue, Svelte, Solid, AlpineJS](/ja/guides/framework-components/)といったフレームワークや、生のHTMLテンプレートにも対応しています。
