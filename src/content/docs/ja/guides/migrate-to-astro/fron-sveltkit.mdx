...
- Astroは[Svelteコンポーネントの公式インテグレーション](/ja/guides/integrations-guide/svelte/)を備え、Svelte用のNPMパッケージを[インストールして使用](/ja/guides/imports/#npmパッケージ)できます。既存のSvelte UIコンポーネントや依存関係をそのまま使える可能性があります。
