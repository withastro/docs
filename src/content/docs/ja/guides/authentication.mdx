...
<ReadMore>バックエンドサービスごとの専用ガイド: [Supabaseで認証を追加](/ja/guides/backend/supabase/#adding-authentication-with-supabase)、[Firebaseで認証を追加](/ja/guides/backend/google-firebase/#adding-authentication-with-firebase)</ReadMore>
