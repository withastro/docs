...
アプリを他の人に公開したい場合は、[Public Routes](https://deta.space/docs/en/reference/spacefile#public_routes)を使ってアプリの一部を公開できます。または、[Release](https://deta.space/docs/en/publish/releasing#releases)を作成すれば、他の人があなたのアプリを自分専用のクラウドにインストールできます。
