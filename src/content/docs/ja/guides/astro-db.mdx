...
{/* TODO: cli-referenceを更新し、「Astro Studio CLI」へのリンクを英語版の「/en/reference/cli-reference/#astro-studio-cli」と一致させる */}
1. [Astro Studio CLI](/ja/reference/cli-reference/)により、`astro login`を使用して認証し、`astro link`を使用して作成
