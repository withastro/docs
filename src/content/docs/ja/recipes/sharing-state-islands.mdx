...
- `.astro`ファイルや [ノンハイドレート コンポーネント](/ja/guides/framework-components/#インタラクティブなコンポーネント) からストアに書き込んでも、 [クライアントサイドコンポーネント](/ja/reference/directives-reference/#client-directives) が受け取る値には影響しません。
