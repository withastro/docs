...
Astroコンポーネントがクライアントサイドでインタラクティビティを必要とする場合は、[標準のHTML`<script>`タグ](/ja/guides/client-side-scripts/)や[UIフレームワークのコンポーネント](/ja/basics/framework-components/#インタラクティブなコンポーネント)を追加できます。
...
:::tip
名前付きスロットは、[UIフレームワークコンポーネント](/ja/basics/framework-components/)に渡すこともできます！
:::
...
📚 Astroプロジェクトでの[UIフレームワークコンポーネント](/ja/basics/framework-components/)の使用方法について学びます。
