...
[ビルトインドライバー](#ビルトインドライバー)はUnstorageと同じドライバーを提供します。より高度なカスタマイズが必要な場合は、任意の[Unstorageドライバー](https://unstorage.unjs.io/drivers)を基にして、[独自のドライバーを構築](#セッションドライバーの構築)できます。
