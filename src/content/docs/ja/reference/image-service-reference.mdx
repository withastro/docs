...
## 画像サービスとは？ \{#what-is-an-image-service\}
...
## 画像サービスAPIを使ったサービスの構築 \{#building-using-the-image-services-api\}
...
#### getConfiguredImageServiceとimageConfig \{#getconfiguredimageservice--imageconfig\}
