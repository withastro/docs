...
```astro "<slot />"  title="src/layouts/MySiteLayout.astro"
---
...
```astro /(?<!//.*){?frontmatter(?:\\.\w+)?}?/ "<slot />" title="src/layouts/BaseLayout.astro"
---
...
```astro "fancyJsHelper" "title" title="src/layouts/BaseLayout.astro"
---
...
```astro /{?title}?/ /Astro.props[.a-z]*/ title="src/components/MyLayout.astro"
---
...
```astro {3} /</?BaseLayout>/ /</?BaseLayout url={frontmatter.url}>/ title="src/layouts/BlogPostLayout.astro"
---
