...
Los sitios estáticos pueden incluir [islas de Astro](/es/concepts/islands/) para componentes UI interactivos (¡o incluso aplicaciones completas incrustadas renderizadas en el lado del cliente!) escritos en el [framework UI que elijas](/es/basics/framework-components/) en una página estática pre-renderizada.
