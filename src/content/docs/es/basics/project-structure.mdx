...
- [Componentes de frameworks (React, etc.)](/es/basics/framework-components/)
...
Los **componentes** son unidades reutilizables de código para tus páginas HTML. Estos componentes pueden ser [componentes de Astro](/es/basics/astro-components/) o [componentes de framework](/es/basics/framework-components/) como React o Vue. Es común agrupar y organizar todos tus componentes en una sola carpeta.
