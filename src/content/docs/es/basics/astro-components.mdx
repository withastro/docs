...
Cuando tu componente Astro necesite interactividad en el lado del cliente, puedes añadir [etiquetas HTML estándar `<script>`](/es/guides/client-side-scripts/) o [componentes UI Framework](/es/guides/framework-components/#hidratación-de-componentes-interactivos) como "islas cliente".
...
{/* TODO: add link to Astro.slots (/es/reference/astro-syntax/#astroslots) */}
<ReadMore>Consulta sobre funciones de utilidad `Astro.slots` para más formas de acceder y renderizar contenido de slots.</ReadMore>
