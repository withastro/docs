...
Cuando tu componente Astro necesite interactividad del lado del cliente, puedes agregar [etiquetas `<script>` HTML estándar](/es/guides/client-side-scripts/) o [componentes de UI Framework](/es/basics/framework-components/#hidratando-componentes-interactivos).
...
:::tip
Los slots con nombre también se pueden pasar a [componentes de framework](/es/basics/framework-components/) en archivos Astro.
:::
...
<ReadMore>Aprende sobre el uso de [componentes de frameworks UI](/es/basics/framework-components/) en tu proyecto Astro.</ReadMore>
