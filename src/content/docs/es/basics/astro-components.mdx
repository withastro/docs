...
<ReadMore>Consulta sobre [funciones de utilidad `Astro.slots`](/es/reference/astro-syntax/#astroslots) para más formas de acceder y renderizar contenido de slots.</ReadMore>
