...
Cuando tu componente Astro necesite interactividad del lado del cliente, puedes agregar [etiquetas `<script>` HTML estándar](/es/guides/client-side-scripts/) o [componentes de UI Framework](/es/guides/framework-components/#hydrating-interactive-components).

## Estructura de un componente \{#component-structure\}
...
### Script de un componente \{#the-component-script\}
...
### Maquetado del componente \{#the-component-template\}
...
Sin embargo, el [maquetado de componentes de Astro](/es/basics/astro-syntax/) también soporta **expresiones de JavaScript**, etiquetas [`<style>`](/es/guides/styling/#styling-in-astro) y [`<script>`](/es/guides/client-side-scripts/#usando-script-en-astro) de Astro, **componentes importados**, y [**directivas especiales de Astro**](/es/reference/directives-reference/). Los datos y valores definidos en el script del componente pueden ser usados en el maquetado del componente para producir HTML creado dinámicamente.
...
## Diseño basado en componentes \{#component-based-design\}
...
## Props de componentes \{#component-props\}
...
### Contenido alternativo para slots \{#fallback-content-for-slots\}
...
### Transferir slots \{#transferring-slots\}
...
## Componentes HTML \{#html-components\}
...
- Ellos solo pueden referenciar recursos que están en la carpeta [`public/`](/es/basics/project-structure/#astroconfigmjs).
