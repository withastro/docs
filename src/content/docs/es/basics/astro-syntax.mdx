...
- **No se admiten directivas de hidratación.** Cuando se usan las [directivas `client:*` de hidratación](/es/basics/framework-components/#hidratando-componentes-interactivos), Astro necesita saber qué componentes empaquetar para producción, y el patrón de etiquetas dinámicas impide que esto funcione.
