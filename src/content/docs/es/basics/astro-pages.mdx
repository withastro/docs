...
Los archivos de página que pueden exportar un valor para [`partial`](/es/reference/routing-reference/#parcial) (por ejemplo, `.astro`, `.mdx`, pero no `.md`) pueden ser marcados como parciales.
