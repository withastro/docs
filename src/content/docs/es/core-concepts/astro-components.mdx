...
Cuando tu componente Astro necesite interactividad del lado del cliente, puedes agregar [etiquetas `<script>` HTML estándar](/es/guides/client-side-scripts/) o [componentes de UI Framework](/es/core-concepts/framework-components/#hidratación-de-componentes-interactivos).
