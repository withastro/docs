...
:::note
La generación dinámica de un nombre de slot de Astro, tal como dentro de una función map, fué añadida en Astro v4.2.0. Para versiones anteriores de Astro, podría ser mejor generar estos slots dinámicos dentro del framework mismo.
:::
