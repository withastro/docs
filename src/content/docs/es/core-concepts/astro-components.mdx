...
:::note
Un nombre de slot de Astro no puede ser generado dinámicamente, tal como dentro de una función map. Si esta característica es necesaria dentro de componentes de framework UI, podría ser mejor generar estos slots dinámicos dentro del framework mismo.
:::
...
<ReadMore>Aprende sobre el uso de [componentes de framework de UI](/es/core-concepts/framework-components/) en tu proyecto Astro.</ReadMore>
