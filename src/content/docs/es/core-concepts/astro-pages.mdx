...
<ReadMore>Lee más sobre [enrutamiento en Astro](/es/core-concepts/routing/)</ReadMore>
...
<ReadMore>Lee más sobre [componentes de plantilla](/es/core-concepts/layouts/) en Astro.</ReadMore>
