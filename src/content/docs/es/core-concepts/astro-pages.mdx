...
Las páginas parciales, cuando se combinan con una biblioteca de renderizado, proporcionan una alternativa a [islas de Astro](/es/concepts/islands/) y [`<script>` tags](/es/guides/client-side-scripts/) para construir contenido dinámico en Astro.
