...
[Layouts](/en/core-concepts/layouts/) son componentes de Astro que definen la estructura de la UI compartida por una o más [páginas](/en/core-concepts/astro-pages/).
