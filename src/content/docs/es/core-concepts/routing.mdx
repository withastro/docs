...
- Las rutas con más segmentos de ruta tendrán prioridad sobre las rutas con menos parámetros. En el ejemplo anterior, `/posts/[page].astro` tiene prioridad sobre `/posts/[pid].astro`.
