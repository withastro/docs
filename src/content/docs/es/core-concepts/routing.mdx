...
Después de habilitar la bandera experimental `redirects: true`, puedes especificar un mapeo de redirecciones permanentes en la configuración de Astro. Para la mayoría de las redirecciones, esto es un mapeo de una ruta antigua a la nueva ruta:
