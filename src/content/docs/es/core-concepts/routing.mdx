...
Las redirecciones también siguen las mismas reglas, pero se priorizan en *último lugar*. Si existe una ruta basada en archivos y una redirección con la misma regla de ruta, se elige la ruta basada en archivos.
