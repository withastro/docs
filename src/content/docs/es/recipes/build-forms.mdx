---
title: Construye formularios HTML en páginas Astro
...
5. Valida los datos del formulario en el servidor. Esto debería incluir la misma validación realizada en el cliente para evitar envíos maliciosos a tu punto final y para admitir el raro navegador heredado que no tiene validación de formularios.

    También puede incluir validación que no se puede hacer en el cliente. Por ejemplo, este ejemplo verifica si el correo electrónico ya está en la base de datos.
