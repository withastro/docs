...
:::tip
También puedes [crear un nuevo proyecto de Astro a partir de cualquier repositorio de GitHub de Astro existente](/es/install-and-setup/#use-a-theme-or-starter-template) utilizando la bandera `--template`:
```bash
