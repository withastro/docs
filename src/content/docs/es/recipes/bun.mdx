...
- Bun instalado localmente en tu máquina. Consulta las [instrucciones de instalación](https://bun.sh/docs/installation) en la documentación oficial de Bun.
...
¿Usando Bun con Astro? ¡Agrega tu entrada de blog o video a esta página!
