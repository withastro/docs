...
Los [endpoints del servidor](/es/guides/endpoints/#server-endpoints-api-routes) se pueden utilizar como endpoints de API REST para ejecutar funciones como autenticaciones, acceso a bases de datos y verificaciones sin exponer datos sensibles al cliente.
