...
Los [endpoints del servidor](/es/basics/endpoints/#endpoints-del-servidor-rutas-de-api) se pueden utilizar como endpoints de API REST para ejecutar funciones como autenticaciones, acceso a bases de datos y verificaciones sin exponer datos sensibles al cliente.
