...
## Construir una aplicación de barra de herramientas para desarrollo motivacional \{#build-a-motivational-dev-toolbar-app\}
...
### Creando la integración con Astro \{#creating-the-astro-integration\}
...
### Creando la aplicación \{#creating-the-app\}
...
## Construyendo apps con un framework UI \{#building-apps-with-a-ui-framework\}
...
:::note
Como tu hayas escogido crear tu aplicación de barra de herramientas para desarrollo, usando JavaScript o un framework UI, necesitarás [crear la integración](#creating-the-astro-integration) que agrega tu aplicación a la barra de herramientas de desarrollo.
:::

### Sin un paso de construcción \{#without-a-build-step\}
...
### Con un paso de construcción \{#with-a-build-step\}
