...
Si prefieres que el idioma predeterminado no sea visible en la URL, a diferencia de otros idiomas, hay [instrucciones para ocultar el idioma predeterminado](/es/recipes/i18n/#hide-default-language-in-the-url) a continuación.

## Receta \{#recipe\}

### Configura páginas para cada idioma \{#set-up-pages-for-each-language\}
...
### Utiliza colecciones para el contenido traducido. \{#use-collections-for-translated-content\}
...
### Traducir strings de la UI \{#translate-ui-strings\}
...
### Permite a los usuarios cambiar entre idiomas. \{#let-users-switch-between-languages\}
...
### Ocultar el idioma predeterminado en la URL \{#hide-default-language-in-the-url\}
...
### Traducir Rutas \{#translate-routes\}
...
## Bibliotecas comunitarias \{#community-libraries\}
