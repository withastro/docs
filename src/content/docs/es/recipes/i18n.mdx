...
2. Configura `src/pages/index.astro` para redirigir al idioma predeterminado.
    ...
    <StaticSsrTabs>
      ...
      <Fragment slot="ssr">
        Si estás utilizando un adaptador SSR, puedes utilizar [`Astro.redirect`](/es/basics/routing/#redirecciones-dinámicas) para redirigir al idioma predeterminado en el servidor.
...
3. Utiliza [rutas dinámicas](/es/basics/routing/#rutas-dinámicas) para obtener y mostrar contenido basado en los parámetros `lang` y `slug`.
    ...
    <ReadMore>Lee más sobre [enrutamiento dinámico](/es/basics/routing/#rutas-dinámicas).</ReadMore>
