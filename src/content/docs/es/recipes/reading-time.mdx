...
4. Mostrar tiempo de lectura
   ...
   Si tus artículos de blog se almacenan en una [colección de contenido](/es/guides/content-collections/), accede a `remarkPluginFrontmatter` desde la función `entry.render()`. Luego, renderiza `minutesRead` en tu plantilla donde quieras que aparezca.
   ...
   Si estás usando una [plantilla de Markdown](/es/guides/markdown-content/#paginas-de-markdown-y-mdx), usa la propiedad de frontmatter `minutesRead` de `Astro.props` en tu plantilla de diseño.
