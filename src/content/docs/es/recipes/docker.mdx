...
Las imágenes y contenedores de Docker se pueden implementar en muchas plataformas diferentes, como AWS, Azure y [Google Cloud](/es/guides/deploy/google-cloud/#cloud-run-ssr-and-static). Esta guía no cubrirá cómo implementar tu sitio en una plataforma específica, pero te mostrará cómo configurar Docker para tu proyecto.
