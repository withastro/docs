---
title: Dinámicamente Importa Imágenes
description: Aprende a importar dinámicamente imágenes usando la función import.meta.glob de Vite
i18nReady: true
type: recipe
---
import FileTree from '~/components/FileTree.astro'

[Imágenes](/es/guides/images/) locales deben ser importadas en archivos `.astro` para poder mostrarlas. Habrá momentos en los que querrás o necesitarás importar dinámicamente las rutas de tus imágenes en lugar de importar explícitamente cada imagen individualmente.
...
2. Crea un nuevo componente Astro para tu tarjeta e importa el componente `<Image />`.
...
7. Importa y usa el componente de tarjeta dentro de una página Astro, pasando los valores de las `props`.
