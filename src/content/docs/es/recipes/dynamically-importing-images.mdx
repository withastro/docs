...
Dado que está accediendo al objeto `images` que tiene un tipo desconocido, también debería `throw` un error en caso de que se pase una ruta de archivo inválida como prop.
