...
- **[Agnostico a la UI](/es/basics/framework-components/):** Compatible con React, Preact, Svelte, Vue, Solid, Lit, HTMX, web components y más.
- **[Servidor primero](/es/basics/rendering-modes/):** Mueve la renderización costosa fuera de los dispositivos de tus visitantes.
