...
- **[Islas](/es/concepts/islands/):** A component-based web architecture optimized for content-driven websites.
- **[UI-agnostic](/es/core-concepts/framework-components/):** Compatible con React, Preact, Svelte, Vue, Solid, Lit, HTMX, web components y más.
- **[Servidor primero](/es/core-concepts/rendering-modes/):** Moves expensive rendering off of your visitors' devices.
- **[Cero JS por defecto](/es/core-concepts/astro-components/):** Less client-side JavaScript to slow your site down.
- **[Colecciones de contenido](/es/guides/content-collections/):** Organize, validate, and provide TypeScript type-safety for your Markdown content.
...
1. **[Orientado al contenido](#orientado-al-contenido):** Astro was designed to showcase your content.
2. **[Servidor primero](#servidor-primero):** Websites run faster when they render HTML on the server.
3. **[Rápido por defecto](#rápido-por-defecto):** It should be impossible to build a slow website in Astro.
4. **[Fácil de usar](#fácil-de-usar):** You don't need to be an expert to build something with Astro.
5. **[Centrado en el desarrollador](#centrado-en-el-desarrollador):** You should have the resources you need to be successful.
