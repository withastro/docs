...
1. **[Orientado al contenido](#content-driven):** Astro fue diseñado para destacar tu contenido.
2. **[Servidor primero](#server-first):** Los sitios web se ejecutan más rapido cuando renderizan el HTML en el servidor.
3. **[Rápido por defecto](#fast-by-default):** Debería ser imposible construir un sitio web lento en Astro.
4. **[Fácil de usar](#easy-to-use):** No necesitas ser un experto para construir algo con Astro.
5. **[Centrado en el desarrollador](#developer-focused):** Deberías tener los recursos que necesitas para tener éxito.

### Orientado al contenido \{#content-driven\}
...
### Rápido por defecto \{#fast-by-default\}
...
### Centrado en el desarrollador \{#developer-focused\}
