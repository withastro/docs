...
- **[Colecciones de contenido](/es/guides/content-collections/):** OOrganiza, valida y proporciona seguridad de tipos de TypeScript para tu contenido en Markdown.
...
3. **[Rápido por defecto](#rápido-por-defecto):** Debería ser imposible construir un sitio web lento en Asro.
...
Un buen rendimiento siempre es importante, pero es *especialmente* crítico para sitios web cuyo éxito depende de mostrar tu contenido. Ha quedado biend demostrado que un rendimiento deficiente lleva a una menor participación, conversiones y pérdida de ingresos. Por ejemplo:
