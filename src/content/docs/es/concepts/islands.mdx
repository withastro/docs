...
Una [**isla cliente**](#islas-del-cliente) es un componente de interfaz de usuario interactivo JavaScript que se hidrata por separado del resto de la página, mientras que una [**isla servidor**](#islas-del-servidor) es un componente de interfaz de usuario que renderiza en servidor su contenido dinámico por separado del resto de la página.
