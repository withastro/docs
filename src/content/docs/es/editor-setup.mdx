...
[Zed](https://zed.dev/) es un editor de código de código abierto que añadió soporte para Astro en la versión 0.123.2. Puedes instalar la [extensión de Astro](https://github.com/zed-extensions/astro) en la pestaña de Extensiones de la IDE. Esta extensión incluye funciones como resaltado de sintaxis, autocompletado y formateo de código.
...
3. Ejecuta el siguiente comando `prettier . --write` en tu terminal para formatear tus archivos.
