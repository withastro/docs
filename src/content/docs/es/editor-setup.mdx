...
[Zed](https://zed.dev/) es un editor de código multipropósito de alto rendimiento, optimizado para la velocidad y los proyectos de gran envergadura. Su [extensión para Astro](https://zed.dev/extensions/astro) incluye funciones como el resaltado de sintaxis para archivos `.astro`, autocompletado de código, formateo, diagnósticos y la función "ir a la definición".
