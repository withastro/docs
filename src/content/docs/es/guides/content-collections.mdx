...
Consulta cómo convertir un ejemplo básico de blog de `src/pages/posts/` a `src/content/posts` en nuestro [tutorial paso a paso](/estutorial/6-islands/4/) que utiliza la base de código del [proyecto terminado del tutorial Crear un Blog](https://github.com/withastro/blog-tutorial-demo).
