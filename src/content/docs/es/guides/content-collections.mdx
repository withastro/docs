...
## Migrando desde el Enrutamiendo Basado en Archivos
...
Consulta cómo convertir un ejemplo básico de blog de `src/pages/posts/` a `src/content/posts` en nuestro [tutorial paso a paso](/es/tutorials/add-content-collections/) que utiliza la base de código del [proyecto terminado del tutorial Construye un Blog](https://github.com/withastro/blog-tutorial-demo).
