...
Una API de bajo nivel que toma cualquier valor y trata de devolver una versión serializada (una string) de él. Si el valor no se puede serializar, la función lanzará un error en el runtime.
