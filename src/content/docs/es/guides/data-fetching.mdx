...
## `fetch()` en componentes de framework \{#fetch-in-framework-components\}
...
### Consultas en GraphQL \{#graphql-queries\}
...
## Fetching de datos desde un Headless CMS \{#fetch-from-a-headless-cms\}
