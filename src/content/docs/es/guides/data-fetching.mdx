...
Los componentes de Astro pueden obtener datos desde tu CMS favorito y luego renderizarlos como contenido en tu página. Usando [rutas dinámicas](/es/basics/routing/#rutas-dinámicas), los componentes pueden generar páginas basadas en el contenido obtenido del CMS.
