...
Las **Integraciones de Astro** agregan nuevas funcionalidades a su proyecto con solo unas pocas líneas de código. Tú mismo puedes escribir una integración personalizada, utilizar una integración oficial utilizar [integraciones desarrolladas por la comunidad](#finding-more-integrations) o también [Construir una integración personalizada por ti mismo](#building-your-own-integration). 
...
- Habilitar la renderización bajo demanda con un [adaptador SSR](/es/guides/server-side-rendering/).
...
## Integraciones oficiales \{#official-integrations\}

Las siguientes integraciones son mantenidas por Astro.

<IntegrationsNav />

## Configuración de integración automática \{#automatic-integration-setup\}

Astro incluye un comando `astro add` para automatizar la configuración de integraciones. Varios plugins de la comunidad también se pueden agregar utilizando este comando. Consulta la documentación de cada integración para ver si se admite `astro add`, o si debes [instalar manualmente](#manual-installation).
...
1. [Instala una integración de paquete NPM](#installing-an-npm-package).
...
#### Instalando un paquete NPM \{#installing-an-npm-package\}
...
### Opciones personalizadas \{#custom-options\}
...
### Activar una Integración \{#toggle-an-integration\}
...
## Actualizando integraciones \{#upgrading-integrations\}
...
### Actualización Automática \{#automatic-upgrading\}
...
## Eliminando una Integración \{#removing-an-integration\}
...
## Encontrar más integraciones \{#finding-more-integrations\}
...
## Construyendo tu propia integración \{#building-your-own-integration\}
