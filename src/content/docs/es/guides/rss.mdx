...
El RSS feed de Astro produce enlaces con una barra diagonal al final por defecto, sin importar el valor que hayas configurado para `trailingSlash`. Esto significa que los enlaces de tu RSS pueden no coincidir exactamente con las URLs de tus posts.
