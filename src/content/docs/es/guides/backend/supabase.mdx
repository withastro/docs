...
[Supabase](https://supabase.com/) es un alternativa de código abierto a Firebase. Proporciona una base de datos Postgres, autenticación, funciones de borde, suscripciones en tiempo real y almacenamiento.
...
- An Astro project with [server-side rendering (SSR)](/es/guides/server-side-rendering/) enabled.
...
Supabase proporciona autenticación fuera de la caja. Admite autenticación por correo electrónico/contraseña y autenticación OAuth con muchos proveedores, incluidos GitHub, Google y otros.
