...
## Inicializando Supabase en Astro \{#initializing-supabase-in-astro\}
...
### Agregar credenciales de Supabase \{#adding-supabase-credentials\}
...
### Instalar dependencias \{#installing-dependencies\}
...
## Agregar autenticación con Supabase \{#adding-authentication-with-supabase\}
...
- Un proyecto de Astro [inicializado con Supabase](#initializing-supabase-in-astro).
...
### Creando endpoints de servidor de autenticación \{#creating-auth-server-endpoints\}
...
### Crear páginas de autenticación \{#creating-auth-pages\}
...
### Agregar autenticación OAuth \{#adding-oauth-authentication\}
