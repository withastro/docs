...
- Un proyecto de Astro con [renderizado del lado del servidor (SSR)](/es/guides/server-side-rendering/#habilitando-ssr-en-tu-proyecto) enabled.
...
- Un proyecto Astro inicializado con Firebase según se describe en la sección [Inicializando Firebase en Astro](#inicializando-firebase-en-astro) section.
