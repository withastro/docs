...
## Inicializando Firebase en Astro \{#initializing-firebase-in-astro\}

### Prerrequesitos \{#prerequisites\}
...
### Agregando credenciales de Firebase \{#adding-firebase-credentials\}
...
## Agregando autenticación con Firebase \{#adding-authentication-with-firebase\}

### Prerrequesitos \{#prerequisites-1\}
...
### Creando endpoints del servidor de autenticación \{#creating-auth-server-endpoints\}
...
### Creando páginas \{#creating-pages\}
...
### Agregando proveedores de OAuth \{#adding-oauth-providers\}
...
## Conectando a la base de datos Firestore. \{#connecting-to-firestore-database\}

### Prerrequesitos \{#prerequisites-2\}

- Un proyecto Astro inicializado con Firebase según se describe en la sección [Inicializando Firebase en Astro](#initializing-firebase-in-astro).
...
### Creando los endpoints del servidor \{#creating-the-server-endpoints\}
...
### Creando páginas \{#creating-pages-1\}
...
#### Agrega un nuevo registro. \{#add-a-new-record\}
...
#### Editar o eliminar un registro. \{#edit-or-delete-a-record\}
...
#### Mostrar un registro individual \{#display-an-individual-record\}
...
#### Mostrar una lista de registros con un botón de edición \{#display-a-list-of-records-with-an-edit-button\}
