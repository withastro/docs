...
## Inicializando Turso en Astro \{#initializing-turso-in-astro\}
...
### Configura tus variables de entorno \{#configure-environment-variables\}
...
### Instala LibSQL Client \{#install-libsql-client\}
...
### Inicializa un nuevo cliente \{#initialize-a-new-client\}
...
## Consultando tu base de datos \{#querying-your-database\}
...
## Recursos de Turso \{#turso-resources\}
