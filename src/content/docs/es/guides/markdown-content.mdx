...
- el contenido dentro del [componente incorporado `<Code />`](/es/reference/components-reference/#code-) (con la tecnología de Shiki)
- el contenido dentro del [componente `<Prism />`](/es/reference/components-reference/#prism-) (con la tecnología de Prism).
