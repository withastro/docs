...
:::note
Si estás usando [colecciones de contenido](/es/guides/content-collections/), por favor ve ["Modificando el Frontmatter con Remark"](/es/guides/content-collections/#modifying-frontmatter-with-remark).
:::
