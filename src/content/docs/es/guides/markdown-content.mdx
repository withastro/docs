...
Puedes también [aplicar estilos al Markdown](/es/guides/styling/#markdown-styling) en tu componente plantilla.
...
Luego de instalar la integración con MDX, puedes importar y utilizar ambos [componentes de Astro components](/es/basics/astro-components/#component-props) y [componentes de frameworks UI](/es/guides/framework-components/#using-framework-components) en archivos MDX (`.mdx`) de la misma manera que los usarías en cualquier otro componente de Astro.
...
2. Agrega esta hoja de estilos a la [carpeta `public/` de tu proyecto](/es/basics/project-structure/#packagejson).
