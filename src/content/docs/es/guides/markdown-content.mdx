...
export default defineConfig({
  markdown: {
    shikiConfig: {
      ...
      wrap: true,
      // Agrega transformadores personalizados: https://shikiji.netlify.app/guide/transformers
      // Encuentra transformadores comunes: https://shikiji.netlify.app/packages/transformers
      transformers: [],
    },
  },
});
