...
Esta aplicación también incluye un botón «Copiar información de depuración» que ejecuta el comando [`astro info`](/es/reference/cli-reference/#astro-info) y copia el resultado en el portapapeles. Esto puede resultar útil a la hora de pedir ayuda o informar de problemas.
