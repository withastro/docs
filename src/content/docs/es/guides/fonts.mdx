...
## Usando un archivo de fuente local \{#using-a-local-font-file\}
...
## Usando Fontsource \{#using-fontsource\}
...
## Registrando fuentes con Tailwind \{#register-fonts-in-tailwind\}

Si estás usando la [integración de Tailwind](/es/guides/integrations-guide/tailwind/), puedes usar cualquiera de los métodos anteriores en esta página para instalar tu fuente, con algunas modificaciones. Puedes añadir una [declaración`@font-face` para una fuente local](#using-a-local-font-file) o usar [la estrategia `import` de Fontsource](#using-fontsource) para instalar tu fuente.
