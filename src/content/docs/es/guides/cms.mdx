...
<ReadMore> Explora una [lista de por lo menos 100 sistemas headless de manejo de contenido](https://jamstack.org/headless-cms/)<Badge text="Externo" /> donde puedes filtrar por tipo (por ejemplo basado en Git, manejado por API) y licencia (código abierto o código cerrado).</ReadMore>

## ¿Puedo usar Astro sin un CMS?

¡Sí! Astro proporciona formas integradas para crear contenido, incluyendo el soporte para páginas de Markdown.
