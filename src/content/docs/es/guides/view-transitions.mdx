...
- `astro-data-reload`: un atributo de la etiqueta `<a>` para [forzar una navegación de página completa](#evitar-la-navegación-del-lado-del-cliente).
...
### Evitar la navegación del lado del cliente
