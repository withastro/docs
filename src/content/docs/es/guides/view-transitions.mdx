...
Agrega este componente a un componente `.astro` reutilizable, como un encabezado común o un diseño, para lograr [transiciones animadas de página en todo tu sitio (modo SPA)](#transiciones-completas-de-vistas-en-todo-el-sitio-modo-spa).
...
- La opción de [impedir la navegación del lado del cliente para enlaces que no sean de página](#preventing-client-side-navigation).
...
## Agregando View Transitions a una Página
...
El ejemplo a continuación muestra cómo agregar las animaciones de navegación de página predeterminadas de Astro en todo el sitio, incluida la opción de control alternativo predeterminado para navegadores que no las admiten, importando y agregando este componente a un componente `<CommonHead />` de Astro:
