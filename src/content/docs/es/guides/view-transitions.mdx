...
Usa [directivas de transición](#directivas-de-transicion) o [anula la navegación del lado del cliente](#prevenir-la-navegación-en-el-cliente) en elementos individuales para un control más detallado.
...
Dependiendo del soporte del navegador, es posible que necesites establecer explícitamente en las [directivas de transición](#transition-directives) `name` o `animate` en los elementos que deseas animar para obtener una experiencia comparable en todos los navegadores:
