...
Instala la integración [`@astrojs/db`](/en/guides/integrations-guide/db/) usando el comando incorporado `astro add`:
...
<ReadMore>Consulta la [referencia de configuración de tablas](/en/guides/integrations-guide/db/#table-configuration-reference) para una referencia completa de las opciones de tabla.</ReadMore>
...
<ReadMore>Consulta la [referencia de columnas de tabla](/en/guides/integrations-guide/db/#table-configuration-reference) para más detalles.</ReadMore>
...
Puedes consultar tu base de datos desde cualquier [página de Astro](/en/basics/astro-pages/#astro-pages), [endpoint](/en/guides/endpoints/), o [acción](/en/guides/actions/) en tu proyecto usando el ORM `db` y el constructor de consultas proporcionados.
...
También puedes usar [acciones de Astro](/en/guides/actions/) para insertar datos en una tabla de Astro DB. El siguiente ejemplo inserta una fila en una tabla `Comment` usando una acción:
...
Consulta la [referencia de la CLI](/en/guides/integrations-guide/db/#astro-db-cli-reference) para una lista completa de comandos.

</ReadMore>

## Construyendo integraciones de Astro DB

Las [integraciones de Astro](/en/reference/integrations-reference/) pueden extender proyectos de usuario con tablas adicionales de Astro DB y datos de semilla.
