...
<button data-confetti-button>¡Celebra!</button>
...
- **Agrupación de importaciones:** Importa archivos locales o módulos de npm, que se agruparán juntos.
- **Módulo de tipo:** Los scripts procesados se convierten automáticamente en [`type="module"`](https://developer.mozilla.org/es/docs/Web/JavaScript/Guide/Modules).
...
<script>
  ...
  // La importación de scripts locales y packetes de npm funciona.
</script>
```
...
### Combinando scripts y UI frameworks
