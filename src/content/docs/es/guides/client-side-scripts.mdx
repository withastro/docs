...
En componentes Astro, el codigo en [el frontmatter](/es/basics/astro-components/#the-component-script) entre los cercos `---` se ejecuta en el servidor y no esta disponible en el navegador. Para mandar variables desde el servidor al cliente, necesitamos una manera de guardar nuestras variables y leerlas cuando JavaScript se ejecute en el navegador.
