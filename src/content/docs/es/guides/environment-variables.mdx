...
Astro usa el soporte integrado de Vite para las variables de entorno, que se reemplazan estáticamente en tiempo de compilación y te permite [usar cualquiera de sus métodos](https://vitejs.dev/guide/env-and-mode.html) para trabajar con ellas.
...
:::caution
Los archivos `.env` no son cargados dentro de [archivos de configuración](/es/guides/configuring-astro/#environment-variables).
:::

## Variables de entorno predeterminadas \{#default-environment-variables\}
...
## Configurando variables de entorno \{#setting-environment-variables\}

### Archivos `.env` \{#env-files\}
...
## Obteniendo variables de entorno \{#getting-environment-variables\}
...
## IntelliSense para TypeScript \{#intellisense-for-typescript\}
