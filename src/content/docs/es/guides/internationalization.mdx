...
Esta carácteristica tiene algunas restricciones:
...
- La carácteristica del adaptador [`functionPerRoute`](/es/reference/adapter-reference/#functionperroute) no es admitida.
