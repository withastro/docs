...
<ReadMore>Consulta como [agregar autenticación con Supabase](/es/guides/backend/supabase/#agregar-autenticación-con-supabase) o [agregar autenticación con Firebase](/es/guides/backend/google-firebase/#agregar-autenticación-con-firebase) en nuestras guías dedicadas para estos servicios de backend.</ReadMore>
...
Usa el comando `astro add` para tu gestor de paquetes preferido para agregar la integración `astro-auth`.
...
Para instalar `astro-auth` manualmente, instala el paquete requerido para tu gestor de paquetes:
