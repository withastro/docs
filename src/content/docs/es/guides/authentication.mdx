...
<ReadMore>Consulta como [agregar autenticación con Supabase](/es/guides/backend/supabase/#adding-authentication-with-supabase) o [agregar autenticación con Firebase](/es/guides/backend/google-firebase/#adding-authentication-with-firebase) en nuestras guías dedicadas para estos servicios de backend.</ReadMore>
