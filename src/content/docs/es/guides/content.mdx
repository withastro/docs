...
Si estás escribiendo tu contenido en un CMS, puedes obtener tus publicaciones y usar el [enrutamiento dinámico](/es/guides/routing/#rutas-dinámicas) para usar un archivo `.astro` para generar una ruta para cada publicación. En el modo estático predeterminado de Astro, estas rutas se generan en el momento de la compilación. Si optas por el [modo SSR](/es/guides/server-side-rendering/), respondes responde a una petición en tiempo de ejecución y obtienes el contenido a bajo petición.
