...
Puedes [obtener contenido Markdown de forma remota](/es/guides/markdown-content/#fetching-remote-markdown) desde una fuente fuera de tu proyecto. Esto requerirá tu propio analizador de Markdown, o una integración de la comunidad (por ejemplo, [`astro-remote`](https://github.com/natemoo-re/astro-remote)).
