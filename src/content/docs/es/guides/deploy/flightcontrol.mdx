...
### Configuración SSR \{#ssr-setup\}

Para desplegar tu proyecto como SSR, asegúrate de configurar primero el adaptador [`@astrojs/node`](/es/guides/integrations-guide/node/). Luego, siga los pasos anteriores para elegir las configuraciones apropiadas para Astro SSR.
