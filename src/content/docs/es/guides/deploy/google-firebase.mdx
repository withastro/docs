...
To enable SSR in your Astro project and deploy on Firebase add the [Node.js adapter](/es/guides/integrations-guide/node/). 
...
4. Inicializa el servicio de Hosteo de Firebase en tu proyecto. Esto creará un archivo `firebase.json` y `.firebaserc` en la raíz de tu proyecto.
...
5. Despliega tu sitio en el servicio de Hosteo de Firebase. Esto construirá tu sitio de Astro y lo desplegará en Firebase.
