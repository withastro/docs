...
2. Elige un proveedor de alojamiento que soporte **despliegue continuo** (p. ej. [Netlify](/en/guides/deploy/netlify/) o [Vercel](/en/guides/deploy/vercel/)) e importa tu repositorio Git como un nuevo sitio o proyecto.
...
{/* TODO: add link to: /es/reference/configuration-reference/#integraciones */}
