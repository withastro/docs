...
<ReadMore>Lee más sobre el [uso del entorno de ejecución de Cloudflare](/es/guides/integrations-guide/cloudflare/) en tu proyecto de Astro.</ReadMore>
## Requisitos previos
...
<ReadMore>Lee más sobre el uso de las [APIs del entorno de ejecución de Cloudflare](/es/guides/integrations-guide/cloudflare/) como los bindings.</ReadMore>
...
### APIs del entorno de ejecución de Node.js
