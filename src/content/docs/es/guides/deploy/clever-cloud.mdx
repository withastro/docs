...
[Clever Cloud](https://www.clever.cloud) es una plataforma de nube europea que proporciona servicios automatizados y escalables.
...
6. Omite [conectar **Add-ons** a tu aplicación de Clever](https://www.clever.cloud/developers/doc/addons/) salvo que uses una base de datos o Keycloak.
...
- [Documentación de Clever Cloud para desplegar una aplicación Node.js](https://www.clever.cloud/developers/doc/applications/nodejs/)
- [Documentación de Clever Cloud para desplegar Astro como una aplicación estática](https://www.clever.cloud/developers/guides/astro/)
