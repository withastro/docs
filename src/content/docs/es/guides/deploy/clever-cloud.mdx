...
6. Omite [conectar **Add-ons** a tu aplicación de Clever](https://www.clevercloud.com/developers/doc/addons/) salvo que uses una base de datos o Keycloak.
...
- [Documentación de Clever Cloud para desplegar una aplicación Node.js](https://www.clevercloud.com/developers/doc/applications/nodejs/)
- [Documentación de Clever Cloud para desplegar Astro como una aplicación estática](https://www.clevercloud.com/developers/guides/astro/)
