...
Ahora que has preparado un servicio Node.js en Zerops,  necesitarás crear un archivo `zerops.yml` en la raíz de tu proyecto para activar la canalización de construcción y despliegue en Zerops.
