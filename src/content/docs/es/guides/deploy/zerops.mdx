...
Para indicarle a Zerops cómo construir y ejecutar tu sitio usando el [adaptador oficial de Astro Node.js](/en/guides/integrations-guide/node/) en modo `standalone`, añade un archivo `zerops.yml` a tu repositorio:
