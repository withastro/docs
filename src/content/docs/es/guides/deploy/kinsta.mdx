...
## Configuración del proyecto Astro \{#configuring-your-astro-project\}


### Alojamiento estático \{#static-hosting\}
...
### Configurando una nueva aplicación en Kinsta \{#configuring-a-new-kinsta-application\}
