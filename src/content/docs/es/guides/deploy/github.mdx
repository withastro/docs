...
## Configura Astro para GitHub Pages \{#configure-astro-for-github-pages\}

### Desplegando a una URL `github.io` \{#deploying-to-a-githubio-url\}
...
### Usando GitHub pages con un dominio personalizado \{#using-github-pages-with-a-custom-domain\}
...
## Configurar una acción de GitHub \{#configure-a-github-action\}
