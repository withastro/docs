...
### Cloud Storage (solo estático) \{#cloud-storage-static-only\}
...
### Cloud Run (SSR y estático) \{#cloud-run-ssr-and-static\}
...
#### Prepara el servicio \{#prepare-the-service\}
...
#### Crea un Dockerfile y Compila el Contenedor \{#create-dockerfile--build-the-container\}
...
#### Desplegando el contenedor \{#deploying-the-container\}
