...
Para solucionarlo, añade **respuestas de error personalizadas** en **Configuración > Páginas de error** de tu distribución de CloudFront.
...
2. Crea una respuesta de error personalizada para errores 403 con los siguientes valores:
  ...
  :::tip
  Para obtener la mejor experiencia de usuario, puedes [crear una página 404 personalizada](/es/core-concepts/astro-pages/#página-de-error-404-personalizada) en tu proyecto y establecer la **ruta de la página de respuesta** a `/404.html`.
  :::
