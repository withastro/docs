...
## Alojando contenido estático en S3 \{#s3-static-website-hosting\}
...
## S3 y CloudFront \{#s3-with-cloudfront\}
...
:::note
Cuando conectas CloudFront a un endpoint de sitio web estático de S3, dependes de las políticas del bucket de S3 para el control de acceso. Consulta la sección de [Alojando contenido estático en S3](/es/guides/deploy/aws/#s3-static-website-hosting) para obtener más información sobre las políticas del bucket.
:::

## Despliegue continuo con GitHub Actions \{#continuous-deployment-with-github-actions\}
