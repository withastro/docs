...
:::note
Cuando conectas CloudFront a un endpoint de sitio web estático de S3, dependes de las políticas del bucket de S3 para el control de acceso. Consulta la sección de [hospedaje de sitio web estático de S3](/es/guides/deploy/aws/#s3-static-website-hosting) para obtener más información sobre las políticas del bucket.
:::
