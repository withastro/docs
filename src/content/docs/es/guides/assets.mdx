...
- Imágenes con optimizaciones automáticas en Markdown, [MDX](/es/guides/integrations-guide/mdx/), and [Markdoc](/es/guides/integrations-guide/markdoc/)
...
Habilitando el soporte para assets te permite acceder al modulo `astro:assets`. Este módulo expone las siguientes funcionalidades:
...
Cuando son usadas imagenes locales con su relación de aspecto original, `width` y `height` pueden ser opcionales e inferidas automáticamente por el archivo fuente. Sin embargo, ambas propiedades son requeridas por imágenes remotas.
