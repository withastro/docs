...
Actualiza tu configuración `vite` en `astro.config.mjs`:
...
Cualquier método de estilo en Astro está disponible para un [componente de diseño de Markdown](/es/basics/layouts/#plantillas-de-markdownmdx), pero métodos diferentes tendrán efectos de estilo diferentes en tu página.
