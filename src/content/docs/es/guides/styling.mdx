...
:::note
Esta es una [configuración específica de Vite](https://vite.dev/config/ssr-options.html#ssr-noexternal) que _no_ se relaciona con (ni requiere) [Astro SSR](/es/guides/server-side-rendering/).
:::
