...
## Opciones de despliegue rápido \{#quick-deploy-options\}
...
### Despliegue desde el CLI \{#cli-deployment\}
...
3. Crea tu proyecto y despliégalo en el host
    ...
    Otros proveedores de hosting requerirán que [construyas tu sitio localmente](#building-your-site-locally) y realizes el despliegue usando la línea de comandos.
</Steps>

## Construyendo tu proyecto localmente \{#building-your-site-locally\}
...
## Adición de un adaptador para SSR \{#adding-an-adapter-for-ssr\}
