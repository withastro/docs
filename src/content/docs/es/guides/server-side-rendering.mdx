...
Para la mayoría de los sitios estáticos configurados como `output: hybrid`, añade `export const prerender = false` a cualquier archivo que debería ser renderizado en el servidor:
