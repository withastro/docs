...
Ambos modos server e hybrid permiten renderizar páginas y endpoints en el servidor y todas las páginas se renderizarán de acuerdo a su comportamiento por defecto. Sin embargo, ambos modos permiten marcar una página individual para no utilizar este comportamiento por defecto.
