...
Puedes agregar cualquiera de los [adaptadores oficiales mantenidos por Astro](/es/guides/integrations-guide/#official-integrations) con el siguiente comando `astro add`. Esto instalará el adaptador y realizará los cambios apropiados en tu archivo `astro.config.mjs` en un solo paso.
