...
Por defecto, un [componente de framework no es hidratado en el cliente](/es/basics/framework-components/#hidratando-componentes-interactivos). Si no se provee una directiva `client:*`, su HTML es renderizado en la página sin JavaScript.
