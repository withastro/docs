...
Para ayudarte a depurar tus componentes de Astro, Astro proporciona un componente incorporado [`<Debug />`](/es/guides/troubleshooting/#astro-debug--component) que renderiza cualquier valor directamente en la plantilla HTML de tu componente. Esto es útil para depuración rápida en el navegador sin tener que alternar entre tu terminal y tu navegador.
