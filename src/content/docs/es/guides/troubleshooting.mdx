...
**Solución:** Actualiza tu CSP para incluir `script-src: 'unsafe-inline'` para permitir que los scripts en línea se ejecuten. Alternativamente, puedes utilizar una integración de terceros como [`astro-shield`](https://github.com/KindSpells/astro-shield) para generar los encabezados CSP por ti.
