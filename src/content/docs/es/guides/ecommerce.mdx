...
description: Una introducción para agregar opciones de comercio electrónico a tu sitio Astro
i18nReady: true
---
...
Algunos servicios de procesamiento de pagos (por ejemplo, [Lemon Squeezy](#lemon-squeezy), [Paddle](#paddle)) agregan un formulario de pago para permitir que su cliente compre en su sitio. Estos pueden ser superposiciones alojadas o incrustadas en una página de su sitio. Estos pueden ofrecer alguna personalización básica o marca del sitio, y pueden agregarse a su proyecto de Astro como scripts, botones o enlaces externos.
...
La sencilla [biblioteca JavaScript Lemon.js](https://docs.lemonsqueezy.com/help/lemonjs/what-is-lemonjs) te permite vender tus productos de Lemon Squeezy con un enlace de pago.
...
Lemon.js también proporciona comportamientos adicionales como [abrir superposiciones programáticamente](https://docs.lemonsqueezy.com/help/lemonjs/opening-overlays) y [manejar eventos de superposición](https://docs.lemonsqueezy.com/help/lemonjs/opening-overlays).
...
[Paddle.js](https://developer.paddle.com/paddlejs/overview) es una biblioteca JavaScript ligera que te permite construir experiencias de facturación de suscripción integradas utilizando Paddle.
...
:::tip
¿Quieres una solución preconstruida de Snipcart en su lugar? Echa un vistazo a [`astro-snipcart`](https://astro-snipcart.vercel.app/), una plantilla de la comunidad Astro completamente funcional que incluye un sistema de diseño opcional, lista para que la integres con tu cuenta de Snipcart.
:::
