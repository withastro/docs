...
También puedes [actualizar tus integraciones de Astro manualmente](/en/guides/integrations-guide/#manual-upgrading) si es necesario, y puede que también necesites actualizar otras dependencias en tu proyecto.
...
Astro v4.0 incluye [cambios potencialmente importantes](#breaking-changes), así como la [eliminación de algunas funciones obsoletas](#características-previamente-obsoletas-ahora-eliminadas).
