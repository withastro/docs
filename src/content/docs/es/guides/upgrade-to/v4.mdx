...
También puedes [actualizar tus integraciones de Astro manualmente](/en/guides/integrations-guide/#actualización-manual) si es necesario, y puede que también necesites actualizar otras dependencias en tu proyecto.
