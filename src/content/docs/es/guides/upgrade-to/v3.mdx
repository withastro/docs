...
Migrar a `astro:assets` también traerá algunas nuevas opciones y características de imágenes que es posible que desees utilizar. ¡Por favor, consulta el [Consejo de Actualización de Imágenes v3.0](/es/guides/images/#actualizar-a-la-v30-desde-la-v2x) completo para obtener todos los detalles!
