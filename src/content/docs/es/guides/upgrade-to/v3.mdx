...
En Astro v2.x, los [métodos de solicitud HTTP](/es/basics/endpoints/#métodos-http) se escribían utilizando nombres de funciones en minúsculas: `get`, `post`, `put`, `all` y `del`.
