...
Astro v2.0 actualiza de Vite 3 a [Vite 4](https://vite.dev/), lanzado en Diciembre de 2022.
...
Refierete a la [guía oficial de migración de Vite](https://vite.dev/guide/migration.html) si tienes problemas.
...
- [Prerenderizado individual de páginas a HTML estático](/es/guides/on-demand-rendering/) cuando se usa SSR para mejorar la velocidad y la caché.
