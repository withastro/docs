...
- Astro usa una [carpeta `public/` para activos estáticos](/es/basics/project-structure/#packagejson) que no necesitan ser procesados ni transformados durante la construcción.

- En Eleventy, el empaquetado de CSS, JavaScript y otros activos debe configurarse manualmente. [Astro lo maneja por ti de forma predeterminada](/es/concepts/why-astro/#easy-to-use).
