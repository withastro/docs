...
- Astro y Eleventy construyen [aplicaciones de múltiples páginas](/es/concepts/mpa-vs-spa/).
...
- En Eleventy, el empaquetado de CSS, JavaScript y otros activos debe configurarse manualmente. [Astro lo maneja por ti de forma predeterminada](/es/concepts/why-astro/#muchas-características-pero-flexible).

## Migrar de Eleventy a Astro

Para convertir un blog de Eleventy a Astro, comienza con nuestra plantilla de inicio de tema de blog, o explora más temas de blog de la comunidad en nuestra [mostrador de temas](https://astro.build/themes/).
