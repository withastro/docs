...
- [Enfocado en el contenido](/es/concepts/why-astro/): Astro fué diseñado para destacar en la creación de sitios web centrados en el contenido. Es posible que una aplicación de SvelteKit se haya construido para lograr una alta interactividad del lado del cliente y puede incluir páginas como paneles de control o utilizar características como las [acciones de formulario](https://kit.svelte.dev/docs/form-actions) de SvelteKit que son más difíciles de replicar en Astro.
...
Para migrar un blog de SvelteKit a Astro, empieza con nuestra plantilla inicial para blogs, o explora más temas de la comunidad para blogs en nuestro [mostrador de temas](https://astro.build/themes/).
