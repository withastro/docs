...
- Astro y SvelteKit te permiten usar un [headless CMS, APIs or archivos Markdown para los datos](/es/guides/data-fetching/). Podrás seguir utilizando tu sistema preferido de creación de contenido, y conservar tu contenido existente.
