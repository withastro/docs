...
Gran parte de tu contenido de página HTML existente se puede convertir en  [páginas de Astro](/es/core-concepts/astro-pages/), y además podrás [usar variables, expresiones similares a JSX e importaciones de componentes directamente en tu plantilla HTML](/es/core-concepts/astro-syntax/#jsx-like-expressions).
