...
Astro no tiene una propiedad `permalink` que acepte marcadores de posición. Es posible que debas leer más acerca del [enrutamiento de página en Astro](/es/basics/routing/) si deseas mantener tu estructura de URL existente. O bien, considera [configurar redireccionamientos en un host como Netlify](https://docs.netlify.com/routing/redirects/).
