...
Trae tus archivos Markdown existentes como contenido para [crear páginas en Markdown](/es/guides/markdown-content/), utilizando un [diseño de Markdown de Astro](/es/basics/layouts/#plantillas-de-markdown) en lugar de una plantilla Liquid template. 

Gran parte de tu contenido de página HTML existente se puede convertir en  [páginas de Astro](/es/basics/astro-pages/), y además podrás [usar variables, expresiones similares a JSX e importaciones de componentes directamente en tu plantilla HTML](/es/reference/astro-syntax/#expresiones-similares-a-jsx).
