...
4. Decide si también es necesario convertir a Astro los componentes importados. Con la integración oficial de React instalada, puedes utilizar los componentes de React existentes en tus archivos de Astro](/es/basics/framework-components/). Sin embargo, es posible que desees convertirlos en componentes `.astro`, ¡especialmente si no necesitan ser interactivos!
