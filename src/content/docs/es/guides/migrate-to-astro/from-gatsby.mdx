...
El componente `<Image />` de Astro funciona solo en archivos `.astro` y `.mdx`. Consulta una [lista completa de sus atributos de componente](/es/guides/images/#image-) y ten en cuenta que varios serán diferentes de los atributos de Gatsby.
