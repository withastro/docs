...
- Astro y Docusaurus usan el [enrutamiento basado en archivos](/es/basics/routing/) para generar rutas de de página automáticamente para cualquier archivo MDX ubicado en `src/pages`. El uso de la estructura de archivos de Astro para tu contenido existente y al agregar nuevas páginas debería ser familiar.
