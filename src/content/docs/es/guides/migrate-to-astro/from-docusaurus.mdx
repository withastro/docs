...
Docusaurus probablemente maneje gran parte del diseño y los metadatos de tu sitio por ti. Es posible que desees leer acerca de cómo [construir diseños en Astro como envoltorios de página para Markdown y MDX](/es/core-concepts/layouts/#plantillas-de-markdownmdx) para ver cómo administrar la plantilla por ti mismo en Astro, incluyendo la sección `<head>` de tu página.
