...
Para convertir un sitio de documentación de Docusaurus a Astro, empieza con nuestra plantilla oficial de inicio, o explora más temas de la comunidad en nuestro [catálogo de temas](https://astro.build/themes?search=&categories%5B%5D=docs). 
