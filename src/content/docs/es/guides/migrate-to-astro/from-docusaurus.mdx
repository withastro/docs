...
## Principales similitudes entre Docusaurus y Astro \{#key-similarities-between-docusaurus-and-astro\}

Docusaurus y Astro comparten algunas similitudes que te ayudarán a migrar tu proyecto:

- Astro y Docusaurus son constructores de sitios web modernos basados en JavaScript (Jamstack), [orientadas al contenido](/es/concepts/why-astro/#content-driven), como sitios de documentación. 
...
- [La sintaxis similar a JSX de Astro](/es/basics/astro-components/#the-component-template) debería resultarte familiar si estás acostumbrado a escribir en React.


## Principales diferencias entre Docusaurus y Astro \{#key-differences-between-docusaurus-and-astro\}
...
## Migrar de Docusaurus a Astro \{#switch-from-docusaurus-to-astro\}
