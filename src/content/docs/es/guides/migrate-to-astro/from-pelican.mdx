...
- Pelican y Astro son generadores de sitios estáticos, idealmente adecuados para [sitios web centrados en contenido](/es/concepts/why-astro/#enfocado-en-el-contenido) como blogs.

- Pelican y Astro tienen soport incorporado para [escribir Markdown](/es/guides/content/#autoría-mdx), incluyendo propiedades frontmatter YAML para metadatos de página. Sin embargo, Astro tiene muy pocas propiedades frontmatter reservadas en comparación con Pelican. Aunque muchas de tus propiedades frontmatter existentes en Pelican no serán "especiales" en Astro, puedes continuar usando tus archivos Markdown existentes y valores frontmatter.
...
- Pelican usa archivos HTML y sintaxis Jinja para la plantilla. [Astro syntax](/es/core-concepts/astro-components/) es un subconjunto de HTML similar a JSX. Todo el HTML válido es una sintaxis válida para `.astro`.
...
Para convertir un sitio de documentación de Pelican a Astro, comienza con nuestra plantilla de tema de blog oficial o explora más temas de blog de la comunidad en nuestro [catálogo de temas](https://astro.build/themes/).
