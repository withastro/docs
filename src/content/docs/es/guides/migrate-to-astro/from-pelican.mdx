...
- Pelican y Astro son generadores de sitios estáticos, idealmente adecuados para [sitios web orientados al contenido](/es/concepts/why-astro/#content-driven) como blogs.

- Pelican y Astro tienen soporte incorporado para [escribir Markdown](/es/guides/content/#mdx-authoring), incluyendo propiedades frontmatter YAML para metadatos de página. Sin embargo, Astro tiene muy pocas propiedades frontmatter reservadas en comparación con Pelican. Aunque muchas de tus propiedades frontmatter existentes en Pelican no serán "especiales" en Astro, puedes continuar usando tus archivos Markdown existentes y valores frontmatter.
...
Pelican puede haber manejado gran parte del diseño y los metadatos de tu sitio por ti. Puede que desees leer sobre [la construcción de diseños de Astro como envoltorios de páginas Markdown](/es/basics/layouts/#plantillas-de-markdown) para ver cómo administrar las plantillas tú mismo en Astro, incluido tu `<head>` de página.
