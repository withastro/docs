...
<ReadMore>Consulta cómo [crear una aplicación de una sola página (SPA) con Astro](https://logsnag.com/blog/react-spa-with-astro) <Badge variant="accent">Externo</Badge> utilizando React Router.</ReadMore>
