...
Mira más sobre [importaciones de archivos locales con `Astro.glob()`](/es/guides/imports/#astroglob), [consulta utilizando la API de Colecciones](/es/guides/content-collections/#querying-collections) o [obtención de datos remotos](/es/guides/data-fetching/).
