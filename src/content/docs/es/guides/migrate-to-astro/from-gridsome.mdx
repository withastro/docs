...
- Astro y Gridsome te permiten utilizar un [headless CMS, APIs o archivos Markdown para los datos](/es/guides/data-fetching/). Puedes seguir usando tu sistema preferido de creación de contenido, y podrás mantener todo tu contenido existente.
