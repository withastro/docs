...
- Astro cuenta con [una integración oficial para usar componentes Vue](/es/guides/integrations-guide/vue/) y soporta [la instalación de paquetes NPM](/es/guides/imports/#paquetes-npm), incluyendo varios para Vue. Podrás escribir componentes de UI de Vue y es posible que puedas conservar algunos o todos tus componentes y dependencias de Vue de Gridsome existentes.
