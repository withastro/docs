...
- Hugo y Astro son generadores modernos de sitios estáticos, idealmente adaptados para [sitios web orientados al contenido](/es/concepts/why-astro/#content-driven), como los blogs.

- Hugo y Astro permiten [crear tu contenido en Markdown](/es/guides/content/#markdown-authoring). Sin embargo, Hugo incluye varias propiedades especiales en el frontmatter y permite escribir este en YAML, TOML o JSON. Aunque muchas de las propiedades existentes de tu frontmatter de Hugo no serán "especiales" en Astro, puedes seguir utilizando tus archivos Markdown existentes y los valores del frontmatter en YAML.
