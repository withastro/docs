...
- Tanto Astro como Gitbook usan algún tipo de [enrutamiento basado en archivos](/es/basics/routing/). El uso de la estructura de archivos de Astro para tu contenido existente y al agregar nuevas páginas debería resultarte familiar.
