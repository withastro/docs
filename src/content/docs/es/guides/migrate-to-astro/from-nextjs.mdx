...
Convierte cualquier componente `<Image />` de Next a los [propios componentes de imagen de Astro](/es/guides/images/), o a un estándar HTML `<img>`. Consulta [la lista completa de los atributos de los componentes](/es/guides/images/) disponibles para los componentes `<Image />` y `<Picture />` de Astro, y ten en cuenta que varios difieren de los atributos de Next. 
