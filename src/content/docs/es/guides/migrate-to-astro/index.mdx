...
Astro te permite elegir entre un proyecto generado estáticamente y [en el servidor (SSR)](/es/guides/on-demand-rendering/), lo que lo convierte en un excelente reemplazo para los SSG o para los proyectos que necesitan obtener algunos datos de la página al vuelo.
