...
## Principales similitudes entre VuePress y Astro \{#key-similarities-between-vuepress-and-astro\}
...
- Astro y VuePress están diseñados para [sitios web orientados al contenido](/es/concepts/why-astro/#content-driven), con un excelente soporte incorporado para archivos Markdown. Escribir en Markdown te resultará familiar, y podrás mantener tu contenido existente.

- Astro tiene [una integración oficial para usar componentes Vue](/es/guides/integrations-guide/vue/) y admite [la instalación de paquetes NPM](/es/guides/imports/#npm-packages), incluyendo varios para Vue. Podrás escribir componentes de interfaz de usuario de Vue y es posible que puedas mantener algunos o todos tus componentes y dependencias de Vue existentes.


## Principales diferencias entre VuePress y Astro \{#key-differences-between-vuepress-and-astro\}
...
## Migrar de VuePress a Astro \{#switch-from-vuepress-to-astro\}
...
VuePress o cualquier tema instalado, probablemente se encargó de gran parte del diseño y los metadatos de tu sitio. Es posible que desees leer sobre [la construcción de diseños de Astro como envoltorios de páginas Markdown](/es/basics/layouts/#plantillas-de-markdown) para ver cómo administrar las plantillas tú mismo en Astro, incluida la etiqueta `<head>` de tu página.
