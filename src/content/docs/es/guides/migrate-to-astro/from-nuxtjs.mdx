...
[Astro admite los preprocedaores de CSS más populares](/es/guides/styling/#css-preprocessors) instalandolos como una dependencia de desarrollo. Por ejemplo, para usar SCSS:
