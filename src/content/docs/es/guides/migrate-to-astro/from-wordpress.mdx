...
## Principales similitudes entre WordPress y Astro \{#key-similarities-between-wordpress-and-astro\}

WordPress y Astro comparten algunas similitudes que te ayudarán a migrar tu proyecto:

- WordPress y Astro son ideales para [sitios web orientados al contenido](/es/concepts/why-astro/#content-driven) como blogs y te permiten escribir el contenido en Markdown (requiere un complemento en WordPress). Aunque el proceso para agregar nuevo contenido es diferente, [escribir en archivos Markdown](/es/guides/markdown-content/) para tu blog de Astro debería resultarte familiar si has utilizado la sintaxis Markdown en tu editor de WordPress.
...
## Principales diferencias entre WordPress y Astro \{#key-differences-between-wordpress-and-astro\}
...
## Migrar de WordPress a Astro \{#switch-from-wordpress-to-astro\}
