...
La integración oficial de Astro proporciona dos componentes de Astro diferentes para renderizar imágenes optimizadas: `<Image />` y `<Picture />`. Ambas son compatibles con sitios estáticos y [algunos hosts de server-side-rendering](/es/guides/integrations-guide/image/#instalación)
