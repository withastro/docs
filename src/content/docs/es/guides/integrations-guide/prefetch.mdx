...
> NOTA: `@astrojs/prefetch` es obsoleto. Utiliza la función `prefetch` en Astro 3.5 en su lugar. Consulta la [guía de migración](/es/guides/prefetch/#migrating-from-astrojsprefetch).
