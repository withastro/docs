...
Este adaptador permite a Astro desplegar tu sitio [`hybrid` o `server` renderizado](/es/core-concepts/rendering-modes/#renderizado-a-demanda) a objetivos de Node.
