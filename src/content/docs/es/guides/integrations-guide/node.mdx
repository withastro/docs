...
* El modo `standalone` compila un servidor que se inicia automáticamente cuando se ejecuta el módulo de entrada. Esto te permite desplegar más fácilmente tu compilación en un host sin necesidad de código adicional.
