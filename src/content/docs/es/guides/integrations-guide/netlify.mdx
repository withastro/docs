...
Este adaptador por defecto usa el [Netlify Image CDN](https://docs.netlify.com/image-cdn/overview/) para transformar imágenes al vuelo sin impactar los tiempos de compilación.
