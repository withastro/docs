...
Luego, agrega el adaptador y tu modo de renderizado [bajo demanda](/es/core-concepts/rendering-modes/#renderizado-bajo-demanda) deseado a tu archivo `astro.config.*`:
