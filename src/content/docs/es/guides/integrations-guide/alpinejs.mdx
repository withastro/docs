...
La mayoría de los gestores de paquetes también instalarán las dependencias pares asociadas. Sin embargo, si ves una advertencia como `Cannot find package 'alpinejs'` (o similar) al iniciar Astro, tendrás que instalar Alpine.js manualmente:
