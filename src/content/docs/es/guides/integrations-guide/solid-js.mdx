...
description: Aprende como usar la integración de @astrojs/solid-js para extender el soporte de componentes en tu proyecto Astro.
...
1.  (Opcionalmente) Instala todas las dependencias necesarias y dependencias de pares 
...
La mayoría de los gestores de paquetes instalarán las dependencias asociadas como pares también. Sin embargo, si ves un mensaje de advertencia que dice "No se puede encontrar el paquete 'solid-js'" (o similar) cuando inicias Astro, tendrás que instalar SolidJS:
