...
Los componentes [`client:only`][astro-client-only] que no se hidratan no se envuelven automáticamente en límites de suspenso.

Sientete libre de agregar límites de suspenso adicionales según tu preferencia.
