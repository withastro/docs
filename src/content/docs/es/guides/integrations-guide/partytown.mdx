...
## ¿Por qué Partytown? \{#why-astro-partytown\}
...
### Instalación rápida \{#manual-install\}

Astro incluye un comando `astro add` para automatizar la configuración de las integraciones oficiales. Si lo prefieres, puedes [instalar las integraciones manualmente](#usage) en su lugar.
