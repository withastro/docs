...
Esta **[integración de Astro][astro-integration]** trae las clases de CSS de utilidad de [Tailwind](https://tailwindcss.com/) a cada archivo `.astro` y [componente de framework](/es/basics/framework-components/) en tu proyecto, junto con el soporte para el archivo de configuración de Tailwind.
