...
Luego, aplica esta integración a tu archivo de configuración de Astro usando la propiedad `integrations`:
...
```js ins={3} "content: ['./src/**/*.{astro,html,js,jsx,md,mdx,svelte,ts,tsx,vue}']"
// tailwind.config.mjs
