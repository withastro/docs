...
Las variables de entorno y secretos de Cloudflare son compatibles con la [API `astro:env`](/en/guides/environment-variables/#type-safe-environment-variables).
