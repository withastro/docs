...
Consulta el repositorio de Cloudflare para obtener más información sobre el tipo [CF\_BINDING](https://github.com/cloudflare/workers-sdk/blob/eaa16db25103d26ef31499634a31b86caccdf7aa/packages/wrangler/src/api/startDevWorker/types.ts#L190-L219)
...
Lee más sobre [el tiempo de ejecución de Cloudflare](#runtime-de-cloudflare).
...
La propiedad `mode` define lo que quieres que el runtime soporte en `astro dev`:
...
Las páginas de Cloudflare no admiten un archivo de configuración.
