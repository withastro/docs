...
Te proporciona acceso a [variables de entorno](https://developers.cloudflare.com/pages/platform/functions/bindings/#environment-variables), y a las [vinculaciones de Cloudflare](https://developers.cloudflare.com/pages/platform/functions/bindings).

Las vinculaciones actualmente admitidas son:
