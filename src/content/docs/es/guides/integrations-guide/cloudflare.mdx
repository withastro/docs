...
Esta bandera opcional habilita el servidor de desarrollo de Astro para poblar las variables de entorno y el objeto de solicitud de Cloudflare, evitando la necesidad de Wrangler.

*   `local`: las variables de entorno están disponibles, pero el objeto de solicitud se rellena con un valor de marcador de posición estático. 
