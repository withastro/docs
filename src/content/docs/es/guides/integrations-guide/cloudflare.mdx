...
Te proporciona acceso a [variables de entorno](https://developers.cloudflare.com/pages/platform/functions/bindings/#environment-variables).
...
Esto permitirá a Cloudflare servir archivos y procesar redirecciones estáticas sin una invocar una función. La creación de un `_routes.json` personalizado anulará esta optimización automática. Consulta [la documentación de Cloudflare sobre la creación de un `routes.json` personalizado](https://developers.cloudflare.com/pages/platform/functions/routing/#create-a-_routesjson-file) para más detalles.
