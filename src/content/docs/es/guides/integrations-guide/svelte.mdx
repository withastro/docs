...
Esta **[integración de Astro][astro-integration]** permite el renderizado en el lado del servidor y la hidratación en el lado del cliente para tus componentes de [Svelte](https://svelte.dev/). Es compatible con Svelte 3, 4, y 5 (experimental).
