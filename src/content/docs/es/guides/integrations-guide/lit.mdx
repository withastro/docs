...
### Decoradores Experimentales \{#experimental-decorators\}
...
export class MyElement extends LitElement {
    ...
    override render() {
        return html`<p>¡Hola Mundo! Desde ${this.name}</p>`;
    }
}
```

### Polyfills y Hidratación \{#polyfills--hydration\}
...
### Globales del navegador \{#browser-globals\}
...
### Gestores de paquetes estrictos \{#strict-package-managers\}
