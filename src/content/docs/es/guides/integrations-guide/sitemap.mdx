...
Esta **[integración de Astro][astro-integration]** genera un Sitemap basado en tus rutas al construir tu proyecto Astro.
...
Con Astro Sitemap, no tienes que preocuparte por crear este archivo: construye tu sitio Astro como lo harías normalmente y la integración de Astro Sitemap rastreará tus rutas y creará el archivo del Sitemap.
...
APor defecto, todas las páginas se incluyen en tu sitemap. Al agregar una función `filter` personalizada, puedes filtrar las páginas incluidas según su URL.
...
*   La [plantilla del playground de integraciones](https://github.com/withastro/astro/tree/latest/examples/integrations-playground?on=github) viene con Astro Sitemap instalado. ¡Prueba añadir una ruta y construir el proyecto!
*   [¡Explora proyectos con Astro Sitemap en GitHub](https://github.com/search?q=%22@astrojs/sitemap%22+filename:package.json\&type=Code) para más ejemplos!
