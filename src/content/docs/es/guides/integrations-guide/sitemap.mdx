...
El valor establecido puede ser una ruta relativa a la URL de su `site` configurado para una hoja de estilos local, o puede ser un enlace URL absoluto a una hoja de estilos externa.
