...
ByDe forma predeterminada, las imágenes transformadas se almacenarán en caché en `./node_modules/.astro/image`. Esto se puede configurar en las opciones de configuración de la integración.
