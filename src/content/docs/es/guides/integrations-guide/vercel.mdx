...
description: Aprende como usar el adaptador SSR @astrojs/vercel para desplegar tu proyecto Astro.
...
Agrega el adaptador Vercel para habilitar SSR en tu proyecto Astro con el comando `astro add`. Esto instalará el adaptador y realizará los cambios apropiados en tu archivo `astro.config.mjs` en un solo paso.
...
Consulta el [CHANGELOG.md](https://github.com/withastro/astro/tree/main/packages/integrations/vercel/CHANGELOG.md) para un historial de cambios en esta integración.
