...
Este adaptador permite a Astro desplegar su [sitio renderizado `hybrid` o `server`](/es/core-concepts/rendering-modes/#renderizado-bajo-demanda) a [Vercel](https://www.vercel.com/).
