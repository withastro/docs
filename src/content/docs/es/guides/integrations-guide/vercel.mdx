...
Si utiliza Astro como [constructor de sitios estáticos](/es/core-concepts/rendering-modes/#pre-renderizado), no necesita un adaptador.

Aprenda a desplegar su sitio Astro en nuestra [guía de despliegue Vercel](/es/guides/deploy/vercel/).
...
A continuación, añada el adaptador y el [modo de renderizado bajo demanda](/es/core-concepts/rendering-modes/#renderizado-bajo-demanda) que desee a su archivo `astro.config.*`:
