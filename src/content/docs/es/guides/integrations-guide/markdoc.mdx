...
### Integración del editor VS Code \{#vs-code-editor-integration\}
...
## Pasa variables de Markdoc \{#pass-markdoc-variables\}
...
### Accede al frontmatter desde tu contenido Markdoc \{#access-frontmatter-from-your-markdoc-content\}
...
### Usa componentes Astro como etiquetas Markdoc \{#use-astro-components-as-markdoc-tags\}
...
### Utiliza los componentes de Astro desde paquetes npm y archivos TypeScript \{#use-astro-components-from-npm-packages-and-typescript-files\}
...
## Partials de Markdoc \{#markdoc-partials\}
...
### Configura el elemento HTML raíz \{#custom-markdoc-nodes--elements\}
...
## Nodos personalizados de Markdoc / elementos \{#custom-headings\}
...
### Encabezados personalizados \{#custom-image-components\}
...
### Componentes de imagen personalizados en Markdoc \{#override-markdocs-default-image-node\}
...
#### Anular el nodo de imagen predeterminado de Markdoc \{#create-a-custom-markdoc-image-tag\}
...
#### Crear una etiqueta de imagen personalizada de Markdoc \{#advanced-markdoc-configuration\}
...
## Configuración avanzada de Markdoc \{#set-the-root-html-element\}
...
### Configura el elemento HTML raíz \{#integration-config-options\}
...
## Opciones de configuración de integración \{#allowhtml\}
