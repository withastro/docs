...
##### 1. Instala la integración desde npm a través de un gestor de paquetes \{#1-install-the-integration-from-npm-via-a-package-manager\}
...
##### 2. Agrega la integración a `astro.config.mjs` \{#2-add-the-integration-to-astroconfigmjs\}
...
##### 3. Configura tu base de datos \{#3-configure-your-database\}
...
## Configuración de la tabla de referencia \{#table-configuration-reference\}
...
## Referencia de la CLI de Astro DB \{#astro-db-cli-reference\}
...
## Referencia de utilidad de Astro DB \{#astro-db-utility-reference\}
