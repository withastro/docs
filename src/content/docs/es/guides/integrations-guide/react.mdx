...
El compilador se aplica en cualquier lugar donde apliquen las [opciones `include` y `exclude`](#combining-multiple-jsx-frameworks) de la integración. Omite el renderizado en el servidor, las dependencias y los archivos `.astro`.
...
`@astrojs/react` v7.0.0 reemplaza Babel con [Oxc](https://oxc.rs/) para compilar JSX y habilitar Fast Refresh y se actualiza a `@vitejs/plugin-react` v6.
