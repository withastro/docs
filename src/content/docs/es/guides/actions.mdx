...
:::note
Las páginas deben renderizarse bajo demanda al llamar actions usando una acción de formulario. [Asegúrate de desactivar el prerenderizado en la página](/es/guides/on-demand-rendering/#habilitar-el-renderizado-bajo-demanda) antes de usar esta API.
:::
