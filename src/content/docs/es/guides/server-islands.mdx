...
Con [un adaptador instalado](/es/guides/on-demand-rendering/#server-adapters) para realizar la renderización diferida, agrega la [directiva `server:defer`](/es/reference/directives-reference/#server-directives) a cualquier componente de tu página para convertirlo en su propia isla:
