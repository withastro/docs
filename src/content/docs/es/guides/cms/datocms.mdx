...
Si tu proyecto está utilizando el modo estático predeterminado de Astro, necesitarás configurar un webhook para desencadenar una nueva construcción cuando tu contenido cambie. Si estás utilizando Netlify o Vercel como tu proveedor de alojamiento, puedes utilizar su función de webhook para desencadenar una nueva construcción cuando cambies el contenido en DatoCMS.
