...
## Creando un blog con Astro y Builder \{#making-a-blog-with-astro-and-builder\}

### Creación de un modelo para una entrada de blog \{#creating-a-model-for-a-blog-post\}
...
### Configuración de la vista previa \{#setting-up-the-preview\}
...
#### Configuración de la nueva ruta como la URL de vista previa \{#setting-the-new-route-as-the-preview-url\}
...
#### Prueba de la configuración de la URL de vista previa \{#testing-the-preview-url-setup\}
...
### Creación de una entrada de blog \{#creating-a-blog-post\}
...
### Mostrar una lista de entradas de blog \{#displaying-a-list-of-blog-posts\}
...
### Mostrar una entrada de blog individual \{#displaying-a-single-blog-post\}
...
### Publicación de tu sitio \{#publishing-your-site\}
...
#### Reconstrucción en cambios de Builder \{#rebuild-on-builder-changes\}
...
##### Agregar un webhook a Builder \{#adding-a-webhook-to-builder\}
