...
1. **Un proyecto de Astro** - Si aún no tienes un proyecto de Astro, nuestra [Guía de Instalación](/es/install/auto/)te ayudará a empezar en poco tiempo.
...
<Steps>
1. Crea la página `src/pages/post/[slug].astro` para [generar dinámicamente una página](/es/guides/routing/#dynamic-routes) para cada publicación.
