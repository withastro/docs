...
1. **Un proyecto de Astro** - Si aún no tienes un proyecto de Astro, nuestra [Guía de Instalación](/es/install/install-and-setup/)te ayudará a empezar en poco tiempo.
