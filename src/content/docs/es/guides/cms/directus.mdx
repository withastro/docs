...
Si encontraste (¡o creaste!) un video o publicación de blog útil sobre el uso de Directus con Astro, [agrégalo a esta lista](https://github.com/withastro/docs/edit/main/src/content/docs/en/guides/cms/directus.mdx).
:::
