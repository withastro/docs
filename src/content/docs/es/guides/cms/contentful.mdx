...
### Configurando credenciales \{#setting-up-credentials\}
...
:::tip
Si tienes un espacio de Contentful vacío, consulta [configurar un modelo de Contentful](#setting-up-a-contentful-model) para aprender cómo crear un modelo básico de blog para tu contenido.
:::

Puedes encontrar más opciones de consulta en la [documentación de Contentful](https://contentful.github.io/contentful.js/).

## Creando un blog con Astro y Contentful \{#making-a-blog-with-astro-and-contentful\}
 
Con la configuración de arriba, ahora puedes crear un blog que use Contentful como CMS.

### Prerequisitos \{#prerequisites-1\}
...
2. **Un proyecto Astro integrado con el [SDK de Contentful](https://github.com/contentful/contentful.js)** - Consulta [integrando con Astro](#integrating-with-astro) para obtener más detalles sobre cómo configurar un proyecto Astro con Contentful.

### Configurando un modelo de Contentful \{#setting-up-a-contentful-model\}
...
### Mostrando una lista de publicaciones de blog \{#displaying-a-list-of-blog-posts\}
...
### Generando publicaciones de blog individuales \{#generating-individual-blog-posts\}
...
#### Reconstrucción al cambiar contenido en Contentful \{#rebuild-on-contentful-changes\}
...
##### Agregando un webhook a Contentful \{#adding-a-webhook-to-contentful\}
