...
¡Selecciona la plantilla de Astro y estarás listo para [desplegar](#deploying-keystatic--astro)!
:::
...
## Agregar la integración de Astro \{#adding-the-astro-integration\}
...
## Crear un archivo de configuración de Keystatic \{#creating-a-keystatic-config-file\}
...
## Ejecutar Keystatic localmente \{#running-keystatic-locally\}
...
## Crear una nueva entrada \{#creating-a-new-post\}
...
## Renderizar contenido de Keystatic \{#rendering-keystatic-content\}
...
### Mostrar una lista de colecciones \{#displaying-a-collection-list\}
...
### Mostrar una entrada individual \{#displaying-a-single-entry\}
...
## Despliegue de Keystatic + Astro \{#deploying-keystatic--astro\}
