...
En Astro, esto se puede hacer con rutas renderizadas bajo demanda en tu proyecto configurado con [salida `servidor` o `híbrida`](/es/guides/server-side-rendering/#enable-on-demand-server-rendering ) activado.
