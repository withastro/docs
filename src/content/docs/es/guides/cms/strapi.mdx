...
### Agregando la URL de Strapi en el archivo `.env`. \{#adding-the-strapi-url-in-env\}
...
### Creando el wrapper de la API \{#creating-the-api-wrapper\}
...
### Opcional: Creando la interfaz Article \{#optional-creating-the-article-interface\}
...
### Mostrando una lista de artículos \{#displaying-a-list-of-articles\}
...
### Generando páginas de artículos. \{#generating-article-pages\}
...
#### Volver a compilar en caso de cambios \{#rebuild-on-changes\}
...
##### Agregando un webhook a Strapi \{#adding-a-webhook-to-strapi\}
