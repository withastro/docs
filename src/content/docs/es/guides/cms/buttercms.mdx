...
La interfaz refleja los tipos de campo. El campo WYSIWYG `description` se carga como una cadena de HTML y [`set:html`](/en/reference/directives-reference/#sethtml) te permite renderizarlo.
