...
Para crear una página por cada publicación de blog, ejecutarás una nueva consulta GraphQL en una página `.astro` de [enrutamiento dinámico](/es/guides/routing/#rutas-dinámicas-bajo-demanda). Esta consulta obtendrá un artículo específico por su slug y se creará una nueva página para cada publicación de blog individual.
