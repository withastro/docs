...
### Configuración del endpoint de Prepr \{#configuring-the-prepr-endpoint\}
...
#### Crea una consulta GraphQL para recuperar tus artículos de blog: \{#create-a-graphql-query-to-retrieve-your-blog-articles\}
...
3. Para mostrar una lista enlazada de tus publicaciones de blog en una página, importa y ejecuta tu consulta, incluyendo el endpoint de Prepr. Luego tendrás acceso a todos los títulos de tus publicaciones y sus slugs para renderizar en la página. (En el siguiente paso, [crearás páginas individuales para tus publicaciones de blog](#creating-individual-blog-post-pages).)
...
#### Creación de páginas individuales para publicaciones de blog \{#creating-individual-blog-post-pages\}
...
### Publicar tu sitio \{#publishing-your-site\}
