...
Para generar una página individual con contenido completo para cada publicación de blog, crea una [página de enrutamiento dinámico](/es/basics/routing/#rutas-dinámicas) en `src/pages/blog/[slug].astro`.
