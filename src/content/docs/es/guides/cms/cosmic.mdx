...
## Integrando Cosmic con Astro \{#integrating-cosmic-with-astro\}


### Instalando las Dependencias Necesarias \{#installing-necessary-dependencies\}
...
### Configurando Claves de API \{#configuring-api-keys\}
...
## Obteniendo Datos de Cosmic \{#fetching-data-from-cosmic\}
...
## Construyendo un Blog con Astro y Cosmic \{#building-a-blog-with-astro-and-cosmic\}
...
### Objetos de Contenido de Cosmic \{#cosmic-content-objects\}
...
### Mostrando una lista de publicaciones de blog en Astro \{#displaying-a-list-of-blog-posts-in-astro\}

Utilizando el mismo [método de obtención de datos](#fetching-data-from-cosmic) que se muestra anteriormente, importa la consulta `getAllPosts()` desde tu archivo de script y espera a que se obtengan los datos. Esta función proporciona metadatos sobre cada `post` que se pueden mostrar dinámicamente.
...
### Generando publicaciones individuales de blog con Astro \{#generating-individual-blog-posts-with-astro\}
...
#### Reconstruir en actualizaciones de contenido en Cosmic \{#rebuild-on-cosmic-content-updates\}
