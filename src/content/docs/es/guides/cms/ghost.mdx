...
La página `src/pages/post/[slug].astro` [genera dinámicamente una página](/es/core-concepts/routing/#rutas-dinámicas) para cada publicación.
...
- Andre Carrera escribió [un post de blog](https://andr.ec/posts/astro-ghost-blog/) que muestra cómo usar el SDK de Ghost para incrustar publicaciones y vistas previas en tu proyecto de Astro.
