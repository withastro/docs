...
### Configurando Storyblok \{#configuring-storyblok\}
...
### Conectando Bloks a los componentes de Astro \{#connecting-bloks-to-astro-components\}
...
## Creando un blog con Astro y Storyblok \{#making-a-blog-with-astro-and-storyblok\}
...
2. **Un proyecto de Astro integrado con Storyblok** - Consulta [la sección de integración con Astro](#integrating-with-astro) para obtener instrucciones sobre cómo configurar la integración.

### Creando una biblioteca blok \{#creating-a-blok-library\}
...
### Conectando Bloks a componentes \{#connecting-bloks-to-components\}
...
#### Generación de sitio estático \{#static-site-generation\}
...
#### Volver a compilar según los cambios en Storyblok \{#rebuild-on-storyblok-changes\}
...
##### Añadiendo un webhook a Storyblok \{#adding-a-webhook-to-storyblok\}
...
## Oficiales de la comunidad  \{#community-resources\}
