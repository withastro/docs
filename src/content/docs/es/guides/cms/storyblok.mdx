...
Para conectar Astro con tu espacio de Storyblok, instala la [integración oficial de Storyblok](https://github.com/storyblok/monoblok/tree/main/packages/astro) utilizando el siguiente comando según tu gestor de paquetes preferido:
...
3. `apiOptions` - Un objeto conteniendo las [opciones de la API de Storyblok](https://www.storyblok.com/docs/packages/storyblok-astro#api). 
...
Para generar páginas para todas tus publicaciones de blog, crea una página `.astro` que cree rutas dinámicas. Este enfoque varía dependiendo de si estás utilizando la **generación de sitios estáticos** (la opción predeterminada) o [renderizado bajo demanda](/es/guides/on-demand-rendering/).

#### Generación de sitio estático

Si estás utilizando la generación de sitios estáticos predeterminada de Astro, usarás [rutas dinámicas](/es/guides/routing/#dynamic-routes) y la función `getStaticPaths` para generar las páginas de tu proyecto.
...
- [Integración de Storyblok con Astro](https://www.storyblok.com/mp/announcing-storyblok-astro) para agregar Storyblok a tu proyecto.
- [Guía de Storyblok para Astro](https://www.storyblok.com/docs/guides/astro/)
- [Referencia del paquete Storyblok Astro](https://www.storyblok.com/docs/packages/storyblok-astro)
