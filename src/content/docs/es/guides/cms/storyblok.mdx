...
If you are using Astro's default static site generation, you will use [dynamic routes](/es/basics/routing/#rutas-dinámicas) and the `getStaticPaths` function to generate your project pages.
