...
Si has [optado por el modo de SSR](/es/guides/server-side-rendering/#habilitando-ssr-en-su-proyecto), utilizarás rutas dinámicas para obtener los datos de la página desde Storyblok.
