...
### Configurando Astro para tu colección de PayloadCMS \{#configuring-astro-for-your-payloadcms-collection\}
...
### Obteniendo los datos \{#fetching-data\}
...
## Construyendo un blog con PayloadCMS y Astro \{#building-a-blog-with-payloadcms-and-astro\}
...
### Usando la API de PayloadCMS para generar páginas \{#using-the-payloadcms-api-to-generate-pages\}
