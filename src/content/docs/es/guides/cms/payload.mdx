...
const res = await fetch("https://localhost:5000/api/posts") // https://localhost:4321/api/posts by default
...
const res = await fetch("http://localhost:5000/api/posts") // https://localhost:4321/api/posts by default
const posts = await res.json()
---
