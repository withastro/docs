...
## Integración con Astro \{#integrating-with-astro\}
...
### Configuración de la comunicación entre proyectos \{#setting-up-project-communication\}
...
### Instalación de dependencias \{#installing-dependencies\}
...
### Configuración de Astro \{#configuring-astro\}
...
### Conexión de widgets de ApostropheCMS a componentes de Astro \{#connecting-apostrophecms-widgets-to-astro-components\}
...
### Agregar tipos de página \{#adding-page-types\}
...
### Creación del componente [...slug.astro] y obtención de datos de Apostrophe \{#creating-the-slugastro-component-and-fetching-apostrophe-data\}
...
## Creación de un blog con Astro y ApostropheCMS \{#making-a-blog-with-astro-and-apostrophecms\}
...
2. **Un proyecto de Astro integrado con ApostropheCMS** - Para crear un proyecto desde cero, consulta [integración con Astro](#integrating-with-astro) para obtener instrucciones sobre cómo configurar la integración, o utiliza el proyecto de inicio [astro-frontend](https://github.com/apostrophecms/astro-frontend).

### Creación de un tipo de pieza de blog y un tipo de página de pieza \{#creating-a-blog-piece-and-piece-page-type\}
...
### Creación del esquema del blog \{#creating-the-blog-schema\}

En un proyecto de ApostropheCMS, los editores tienen un conjunto de campos de entrada para agregar contenido. Aquí tienes un ejemplo de una publicación de blog simple que agrega tres campos de entrada, un `authorName`, `publicationDate` y un área de `content` donde los administradores de contenido pueden agregar múltiples instancias de widgets. En este caso, estamos especificando que pueden agregar los widgets de imagen y texto enriquecido que creamos durante la [configuración de la integración](#connecting-apostrophecms-widgets-to-astro-components).
...
### Mostrando las publicaciones del blog \{#displaying-the-blog-posts\}
...
### Creación de publicaciones de blog \{#creating-blog-posts\}
...
### Despliegue de tu sitio \{#deploying-your-site\}
