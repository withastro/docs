...
1.  **Un proyecto Astro renderizado bajo demanda** con el [adaptador de Node.js](/en/guides/integrations-guide/node/) instalado y `output: 'server'` configurado - Si aún no tienes un proyecto Astro, nuestra [guía de instalación](/en/install-and-setup/) te ayudará a ponerte en marcha rápidamente.
...
2.  **Un proyecto Astro integrado con ApostropheCMS** - Para crear un proyecto desde cero, consulta [integración con Astro](#integrating-with-astro) para ver instrucciones sobre cómo configurar la integración, o usa el proyecto inicial [astro-frontend](https://github.com/apostrophecms/astro-frontend).
...
Para Astro, visita nuestras [guías de despliegue](/en/guides/deploy/) y sigue las instrucciones para tu proveedor de alojamiento preferido.
