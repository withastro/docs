...
### Instala la extensión de Front Matter CMS \{#install-the-front-matter-cms-extension\}
...
### Inicialización del proyecto \{#project-initialization\}
...
#### Configuración del tipo de contenido \{#content-type-configuration\}
...
### Previsualiza tus artículos en el editor \{#preview-your-articles-in-the-editor\}
...
### Crea nuevos artículos \{#create-new-articles\}
...
### Usando Markdoc con Front Matter CMS \{#using-markdoc-with-front-matter-cms\}
