...
### Configuración de credenciales \{#setting-up-credentials\}
...
Si deseas obtener [IntelliSense de TypeScript para estas variables de entorno](/es/guides/environment-variables/#intellisense-for-typescript), puedes crear un nuevo archivo `env.d.ts` en el directorio `src/` y configurar `ImportMetaEnv` de esta manera:
...
:::note
Lee más sobre [cómo obtener variables de entorno en Astro](/es/guides/environment-variables/#getting-environment-variables).
:::
...
### Obteniendo datos \{#fetching-data\}
...
## Creando un blog con Astro y Kontent.ai \{#making-a-blog-with-astro-and-kontentai\}
...
### Configurando el modelo de contenido \{#setting-up-content-model\}
...
### Creando contenido \{#creating-content\}
...
### Generando el modelo de contenido en TypeScript \{#generating-content-model-in-typescript\}
...
### Mostrando una lista de entradas de blog \{#displaying-a-list-of-blog-posts\}
...
### Generando entradas de blog individuales \{#generating-individual-blog-posts\}
...
### Publicando tu sitio \{#publishing-your-site\}
...
#### Recompila cuando cambie Kontent.ai \{#rebuild-on-kontentai-changes\}
...
#### Agregando un webhook a Kontent.ai \{#adding-a-webhook-to-kontentai\}
