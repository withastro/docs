...
## Integraciones oficiales de frameworks UI \{#official-ui-framework-integrations\}
...
## Instalando integraciones \{#installing-integrations\}
...
## Usando componente de framework \{#using-framework-components\}
...
## Hidratando componentes interactivos \{#hydrating-interactive-components\}
...
### Directivas de hidratación disponibles \{#available-hydration-directives\}
...
## Mezclando frameworks \{#mixing-frameworks\}
...
## Pasando props al componente de framework \{#passing-props-to-framework-components\}
...
## Pasando children a componentes de framework \{#passing-children-to-framework-components\}
...
Además, puedes usar [slots con nombre](/es/basics/astro-components/#named-slots) para agrupar hijos específicos.
...
## Anidando componentes de framework \{#nesting-framework-components\}
...
## ¿Puedo usar componentes de Astro dentro de mis componentes de framework? \{#can-i-use-astro-components-inside-my-framework-components\}
...
## ¿Puedo hidratar los componentes de Astro? \{#can-i-hydrate-astro-components\}
