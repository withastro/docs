...
## Endpoints de Archivos Estáticos \{#static-file-endpoints\}
...
### `params` y Enrutamiento Dinámico \{#params-and-dynamic-routing\}
...
## Endpoints del Servidor (Rutas de API) \{#server-endpoints-api-routes\}
...
:::note
Asegúrate de [habilitar el modo de renderizado bajo demanda](/es/guides/server-side-rendering/) antes de probar estos ejemplos y no optar por el prerenderizado en modo `hybrid`. 
:::
