...
:::note
Asegúrate de [habilitar el modo de renderizado bajo demanda](/es/guides/server-side-rendering/) antes de probar estos ejemplos y optar por el prerenderizado en modo `hybrid`. 
:::
