...
## Archivo de configuración de Astro \{#the-astro-config-file\}
...
## Tipos de archivo de configuración compatibles \{#supported-config-file-types\}
...
## Resolución del archivo de configuración \{#config-file-resolving\}
...
## Configurar Intellisense \{#config-intellisense\}
...
## Referenciando archivos relativos \{#referencing-relative-files\}
...
## Personalización de nombres de archivos compilados \{#customising-output-filenames\}
