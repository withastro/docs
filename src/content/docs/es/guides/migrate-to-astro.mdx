...
## ¿Por qué migrar tu proyecto a Astro? \{#why-migrate-your-site-to-astro\}
...
## ¿Qué proyectos puedo convertir a Astro? \{#which-projects-can-i-convert-to-astro\}
...
## ¿Cómo cambiará el diseño de mi proyecto? \{#how-will-my-project-design-change\}

Dependiendo de tu proyecto, es posible que debas pensar de manera diferente acerca de:

- Diseño con [Islas de Astro](/es/concepts/islands/#what-is-an-island) para evitar enviar JavaScript innecesario al navegador.
