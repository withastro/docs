...
- [Componentes de framework](/es/basics/framework-components/) directamente en Astro.
...
- Proporcionar interactividad del lado del cliente con [etiquetas `<script>`](/es/guides/client-side-scripts/) o [componentes de framework](/es/basics/framework-components/) .

- Administrar el [estado compartido](/es/basics/sharing-state/) con Nano Stores o almacenamiento local en lugar de hooks o contextos para toda la aplicación.
