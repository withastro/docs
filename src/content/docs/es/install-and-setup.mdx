...
2. Instala Astro
    ...
    :::note[Important]
    Astro debe ser instalado localmente, no globalmente. Asegúrate de *no* ejecutar `npm install -g astro`, `pnpm add -g astro`, `bun add -g astro` o `yarn add global astro`.
    :::
