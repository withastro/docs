...
Explora [todas los problemas abiertas en GitHub de Astro con las etiquetas `help wanted` y `good first issue`](https://github.com/search?q=org%3Awithastro+label%3A%22good+first+issue%22%2C%22help+wanted%22%2C+state%3Aopen&type=issues) en todos sus repositorios de código: el código de Astro, la documentación, Starlight, los sitios web de Astro, herramientas de lenguaje, GitHub Actions, bots, el compilador… ¡hay muchos lugares donde contribuir!
:::
