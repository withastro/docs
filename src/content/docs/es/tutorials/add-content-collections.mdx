...
## Código de Construir un Blog \{#build-a-blog-tutorial-code\}
...
## Páginas vs Colecciones \{#pages-vs-collections\}
...
### Prueba tu conocimiento \{#test-your-knowledge\}
...
## Extendiendo el tutorial del blog con colecciones de contenido. \{#extending-the-blog-tutorial-with-content-collections\}
...
### Actualiza las dependencias \{#upgrade-dependencies\}
...
### Crear una colección para tus publicaciones del blog. \{#create-a-collection-for-your-blog-posts\}
...
### Generando las páginas de una colección \{#generate-pages-from-a-collection\}
...
### Reemplaza `Astro.glob()` con `getCollection()` \{#replace-astroglob-with-getcollection\}
...
13. El tutorial del proyecto de blog también genera dinámicamente una página para cada etiqueta `src/pages/tags/[tag].astro` y muestra una lista de etiquetas `src/pages/tags/index.astro`. 
        ...
        <Box icon="puzzle-piece">
          ### Inténtalo tú mismo - Actualiza la consulta en la página de indexado de etiquetas. \{#try-it-yourself---update-the-query-in-the-tag-index-page\}

          Importa y utiliza `getCollection` para obtener las etiquetas en las publicaciones del blog en `src/pages/tags/index.astro` siguiendo [los mismos pasos de arriba](#replace-astroglob-with-getcollection).
...
### Actualiza cualquier valor del frontmatter para que coincida con tu esquema \{#update-any-frontmatter-values-to-match-your-schema\}
...
### Actualiza la función RSS \{#update-rss-function\}
