...
<PreCheck>
  ...
  - Pasar valores frontmatter YAML como propiedades al componente plantilla
</PreCheck>
...
- [Plantillas de Markdown en Astro](/es/guides/markdown-content/#frontmatter-layout-property)

- [Propiedades de plantillas Markdown](/es/basics/layouts/#propiedades-de-plantillas-markdown)
