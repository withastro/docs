---
type: tutorial
title: Crea y pasa datos a un diseño de blog personalizado
i18nReady: true
description: >-
  Tutorial: Crea tu primer blog Astro —

  Crea un diseño de entrada de blog para tus archivos Markdown y pásale los valores frontmatter
  como props
---
...
4. Comprueba de nuevo la vista previa de tu navegador en `localhost:3000/posts/post-1` y observa lo que la plantilla ha añadido a tu página. 
...
- [Diseños de Markdown en Astro](/es/guides/markdown-content/#layout-en-el-frontmatter)

- [Props de diseño para Markdown.](/es/core-concepts/layouts/#props-de-plantillas-markdown)
