...
:::note[evitar duplicados]
 Todo lo que se muestre en la plantilla **no** tiene que escribirse en la publicación del blog. Si observas alguna duplicación al comprobar la vista previa de tu navegador, asegúrete de eliminar el contenido de tu archivo Markdown.
 :::
