...
El `MarkdownPostLayout.astro` te proporciona algunas plantillas adicionales para las propiedades comunes de las publicaciones de tu blog, como `title` y `date`, pero las publicaciones de tu blog no tienen el mismo aspecto que el resto de páginas de tu sitio. Puedes adaptar el aspecto de las entradas de tu blog al resto de tu sitio **anidando diseños**.
