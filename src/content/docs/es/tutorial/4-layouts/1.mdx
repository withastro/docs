...
<PreCheck>
  ...
  - Utilizar el elemento `<slot />` de Astro para colocar el contenido de la página dentro de un diseño
  - Pasar valores específicos de la página como props a tu layout
</PreCheck>
