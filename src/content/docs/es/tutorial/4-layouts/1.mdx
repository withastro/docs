...
<PreCheck>
  ...
  - Utiliza un elemento Astro `<slot />` para colocar el contenido de la página dentro de un diseño
...
2. Para mostrar un título de página en la página, puede:
    ...
    <MultipleChoice>
      ...
      <Option>
        utilizar un componente plantilla en la página, pasando el título como atributo del componente (por ejemplo, `<BaseLayout title="Home Page" />` o `<BaseLayout title={pageTitle} />`)
      </Option>
      <Option isCorrect>
