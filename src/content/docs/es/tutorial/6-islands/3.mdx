...
Continúe con nuestra [guía para migrar este proyecto a colecciones de contenido](/es/guides/content-collections/#migrating-from-file-based-routing)

[Iniciar un nuevo proyecto Astro](/es/getting-started/)

[Únase a nosotros en Discord](https://astro.build/chat)
