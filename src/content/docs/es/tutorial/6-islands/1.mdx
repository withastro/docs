...
- [Guía de integraciones Astro](/en/guides/integrations-guide/)

- [Uso de componentes de UI Framework en Astro](/en/core-concepts/framework-components/#using-framework-components)

- [Referencia de las directivas del cliente Astro](/en/reference/directives-reference/#client-directives)
