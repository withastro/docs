...
- [Uso de componentes de UI Framework en Astro](/es/core-concepts/framework-components/#using-framework-components)

- [Referencia de las directivas del cliente Astro](/es/reference/directives-reference/#client-directives)
