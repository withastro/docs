...
## Añade Preact a tu proyecto de Astro \{#add-preact-to-your-astro-project\}
...
## Incluye un cartel de felicitación de Preact \{#include-a-preact-greeting-banner\}
...
- [Uso de componentes de UI Framework en Astro](/es/guides/framework-components/#using-framework-components)
