...
3. Visita la vista previa de tu navegador en `localhost:4321` para ver el icono ahora en todas tus páginas. Puedes intentar hacer clic en él, pero aún no has escrito un script para hacerlo interactivo.
...
2. Comprueba la vista previa de tu navegador en `localhost:4321` y haz clic en el icono del tema. Comprueba que puedes cambiar entre los modos claro y oscuro.
