...
## Añade y estiliza un icono de cambio de tema \{#add-and-style-a-theme-toggle-icon\}
...
## Añade estilos CSS para un tema oscuro \{#add-css-styling-for-a-dark-theme\}
...
## Añade interactividad en el lado del cliente \{#add-client-side-interactivity\}
