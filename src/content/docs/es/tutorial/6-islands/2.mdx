...
<PreCheck>
  - Crear un toggle interactivo con sólo JavaScript y CSS
...
3. Visita la vista previa de tu navegador en `localhost:3000` para ver el icono ahora en todas tus páginas. Puedes intentar hacer clic en él, pero aún no has escrito un script para hacerlo interactivo.
