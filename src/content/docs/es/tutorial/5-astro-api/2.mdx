...
Navega a `localhost:3000/tags/community` y verás una lista sólo de las entradas de tu blog con la etiqueta `comunidad`. Del mismo modo, `localhost:3000/tags/learn%20in%20public` debería mostrar una lista de las entradas del blog con la etiqueta `aprender en público`.
