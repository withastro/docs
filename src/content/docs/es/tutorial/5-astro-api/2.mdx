...
Navega a `http://localhost:4321/tags/community` y verás una lista sólo de las entradas de tu blog con la etiqueta `comunidad`. Del mismo modo, `http://localhost:4321/tags/learn%20in%20public` debería mostrar una lista de las entradas del blog con la etiqueta `aprender en público`.
