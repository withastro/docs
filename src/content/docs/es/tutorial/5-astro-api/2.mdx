...
2. Filtra tu lista de entradas, usando el soporte integrado de TypeScript de Astro, para incluir solo las entradas que contengan la etiqueta propia de la página.
...
2. Crea un array con todas las etiquetas existentes usando el soporte integrado de TypeScript de Astro
...
- [Enrutamiento dinámico de páginas en Astro](/es/guides/routing/#dynamic-routes)
