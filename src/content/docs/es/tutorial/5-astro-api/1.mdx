...
4. Vuelve a visitar la página de tu blog en la vista previa de tu navegador en `localhost:4321/blog` y busca una lista actualizada con cuatro elementos, incluida tu nueva entrada de blog
