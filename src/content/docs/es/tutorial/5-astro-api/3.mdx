...
## Utiliza el patrón de enrutamiento `/pages/folder/index.astro` \{#use-the-pagesfolderindexastro-routing-pattern\}
...
## Pruébalo tú mismo: crea una página de índice de etiquetas \{#try-it-yourself---make-a-tag-index-page\}
...
## Crea un array de etiquetas \{#create-an-array-of-tags\}
...
## Crea tu lista de etiquetas \{#create-your-list-of-tags\}
...
## Añade estilos a tu lista de etiquetas \{#add-styles-to-your-tag-list\}
...
### Registro de códigos \{#code-check-in\}
...
## Añade esta página a tu navegación \{#add-this-page-to-your-navigation\}
...
## Reto: Incluye etiquetas en la plantilla de las entradas del blog \{#challenge-include-tags-in-your-blog-post-layout\}
...
Sigue los pasos que se indican a continuación y comprueba tu trabajo comparándolo con la [muestra de código final](#code-check-in-markdownpostlayout).
...
### Registro de códigos: MarkdownPostLayout \{#code-check-in-markdownpostlayout\}
...
- [Enrutamiento estático en Astro](/es/guides/routing/#rutas-estáticas)
