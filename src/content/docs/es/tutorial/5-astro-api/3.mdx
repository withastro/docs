...
Siga los pasos que se indican a continuación y compruebe su trabajo comparándolo con la [muestra de código final](#code-check-in-markdownpostlayout).
...
- [Enrutamiento estático en Astro](/en/core-concepts/routing/#static-routes)
