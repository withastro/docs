...
<PreCheck>
  - Agregar una nueva página utilizando el patrón de enrutamiento `/my-folder/index.astro`
  - Muestra una lista de todas sus etiquetas únicas, con enlaces a cada página de etiquetas
