...
Para que Astro funcione en tu sistema, también necesitas tener instalada una versión compatible de [**Node.js**](https://nodejs.org/en/). Astro es compatible con las versiones **pares** de Node.js. La versión mínima compatible actualmente es `v22.12.0`. Las versiones impares como `v23` no son compatibles.
