...
:::note
Si ya estás familiarizado con git y tienes tu propio flujo de trabajo, crea un nuevo repositorio de GitHub para tu proyecto utilizando el método que prefieras. Pasa a la siguiente página: ["Despliegue de su sitio en la Web"](/es/tutorial/1-setup/5/).
:::
...
5. En la parte superior del panel de menú, habrá un lugar para introducir un **commit message** (descripción de los cambios de su archivo). Escribe `initial commit` y pulsa el botón <kbd>Commit</kbd> para confirmar los cambios.
