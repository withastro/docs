...
7. Puede que aparezca un mensaje diciéndote que no tienes "staged" commits, y preguntándote si quieres escanearlos. Haz clic en <kbd>Siempre</kbd> y continua.

8. Por último, la lista de archivos modificados debería sustituirse por un botón <kbd>Publicar</kbd>. Haz click en él para enviar los cambios confirmados a GitHub.
