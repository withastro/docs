...
3. Cuando el prompt te pregunte "Where would you like to create your new project?", escribe el nombre de una carpeta para crear un nuevo directorio para su proyecto, por ejemplo `./tutorial`

    :::note
    Un nuevo proyecto Astro sólo puede crearse en una carpeta completamente vacía, así que elige un nombre para tu carpeta que no exista.
    :::
...
7. Cuando el prompt te pregunte: "Would you like to initialize a new git repository?", escriba `y`.
...
1. Haz clic en el enlace `localhost` en la terminal para ver una vista previa en directo de tu nuevo sitio web Astro. 
...
Mientras el servidor Astro esté funcionando en modo de desarrollo, NO podrás ejecutar comandos en esa terminal. En su lugar, este panel te dará retroalimentación mientras previsualiza su sitio.
