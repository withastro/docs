...
## Inicia el asistente de configuración de Astro \{#launch-the-astro-setup-wizard\}
...
## Abre tu proyecto en VS Code \{#open-your-project-in-vs-code\}
...
## Ejecuta Astro en modo desarrollo \{#run-astro-in-dev-mode\}
...
### Inicia el servidor de desarrollo \{#start-the-dev-server\}
...
## Visualiza una vista previa de tu sitio web \{#view-a-preview-of-your-website\}
