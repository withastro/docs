...
6. Cuando el prompt te pregunte si planeas escribir TypeScript, escribe `n`. 

7. Cuando el prompt te pregunte: "Would you like to initialize a new git repository?", escribe `y`.
...
## Ver una vista previa de tu sitio web
...
Mientras el servidor Astro esté funcionando en modo de desarrollo, NO podrás ejecutar comandos en esa terminal. En su lugar, este panel te dará retroalimentación mientras previsualizas tu sitio.
