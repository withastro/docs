...
<PreCheck>
  - Realiza la primera edición de tu nuevo sitio web
</PreCheck>

## Edita tu página de inicio

1. En tu editor de código, navega en el panel de archivos del Explorador hasta `src/pages/index.astro` y haz clic en él para abrir el contenido del archivo en una pestaña editable.
...
2. Edita el contenido de tu página `<body>`.
    ...
    Escribe en el editor para cambiar el texto del encabezado de tu página y guarde el cambio.
