---
type: tutorial
unitTitle: Construcción y diseño con componentes Astro UI
title: 'Check in: Unidad 3 - Componentes'
description: |-
  Tutorial: Crea tu primer blog Astro —
  Cree componentes Astro para reutilizar el código de los elementos comunes de su sitio web.
---
...
Ahora que los archivos `.astro` y `.md` generan páginas enteras en tu sitio web, ¡vamos a crear y reutilizar fragmentos más pequeños de HTML con componentes Astro!
...
- Un componente de medios sociales, utilizado en el pie de página, que enlaza con las páginas de perfil.
