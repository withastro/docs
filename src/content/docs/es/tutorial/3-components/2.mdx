...
## Crea un componente de pie de página \{#create-a-footer-component\}
...
### Importa y utiliza `Footer.astro` \{#import-and-use-footerastro\}
...
## Pruébalo tu mismo - Personaliza tu pie de página \{#try-it-yourself---personalize-your-footer\}
...
## Crea un componente de redes sociales \{#create-a-social-media-component\}
...
### Importa y utiliza `Social.astro` en el pie de página \{#import-and-use-socialastro-in-your-footer\}
...
## Estiliza tu componente de redes sociales \{#style-your-social-media-component\}
...
- [Componentes props en Astro](/es/basics/astro-components/#component-props)