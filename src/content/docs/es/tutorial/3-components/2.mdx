...
<PreCheck>
  ...
  - Crear y pasar propiedades a un componente de redes sociales
</PreCheck>
...
<Steps>
1. Cambia el código en `src/components/Footer.astro` para importar, luego usa este nuevo componente tres veces, pasando diferentes **atributos de componente** como propiedades cada vez:
...
1. ¿Qué línea de código hay que escribir en el frontmatter de un componente Astro para recibir los valores de `title`, `author` y `date` como propiedades?
...
2. ¿Cómo **pasar valores como propiedades** a un componente Astro?
...
- [ ] Puedo pasar propiedades a un componente Astro.
</Checklist>
</Box>

### Recursos

- [Propiedades de componente en Astro](/es/basics/astro-components/#propiedades-de-componente)
