...
description: |-
  ...
  Crea un nuevo componente desde cero y añádalo a sus páginas
---
...
<PreCheck>
  ...
  - Crea y pasa props a un componente de medios sociales
</PreCheck>
...
3. En la vista previa de tu navegador, comprueba que puede ver el nuevo texto del pie de página en cada página.
...
## Crea un componente de medios sociales
...
2. Añade una etiqueta `<style>` a `src/components/Footer.astro` para mejorar el layout de tu contenido.
