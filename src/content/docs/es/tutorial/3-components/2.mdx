---
type: tutorial
title: Crear un pie de página para redes sociales
description: |-
  Tutorial: Crea tu primer blog Astro —
  Cree un nuevo componente desde cero y añádalo a sus páginas
---
...
<PreCheck>
  ...
  - Crear y pasar props a un componente de medios sociales
</PreCheck>

Ahora que ya has utilizado componentes Astro en una página, vamos a utilizar un componente dentro de otro componente.

## Crear un componente de pie de página

1. Crea un nuevo archivo en la ubicación `src/components/Footer.astro`.

2. Copie el siguiente código en su nuevo archivo, `Footer.astro`.
...
### Importar y utilizar `Footer.astro`
...
3. En la vista previa de su navegador, compruebe que puede ver el nuevo texto del pie de página en cada página.

<Box icon="puzzle-piece">

## Pruébelo usted mismo - Personalice su pie de página
...
## Crear un componente de medios sociales
...
### Importar y utilizar `Social.astro` en el pie de página
...
2. Compruebe la vista previa de su navegador, y debería ver su nuevo pie de página mostrando enlaces a estas tres plataformas en cada página.
...
2. Añade una etiqueta `<style>` a `src/components/Footer.astro` para mejorar el layout de su contenido.
...
3. Compruebe de nuevo la vista previa de su navegador y confirme que cada página muestra un pie de página actualizado.

<Box icon="question-mark">

### Ponte a prueba

1. ¿Qué línea de código hay que escribir en el frontmatter de un componente Astro para recibir los valores de `title`, `author` y `date` como props?
    ...
    <MultipleChoice>
      ...
      <Option>
        `<BlogPost title="Mi primer post" author="Juan" date="12 Aug 2022" />`
      </Option>
    </MultipleChoice>
...
- [ ] Puedo importar y utilizar componentes Astro dentro de otros componentes Astro.
- [ ] Puedo pasar props a un componente Astro.
</Checklist>
</Box>

### Recursos

- [Componentes props en Astro](/en/core-concepts/astro-components/#component-props)
