...
description: >-
  ...
  Añade interactividad del lado del cliente a tu navegación móvil con un script Astro
---
...
<PreCheck>
  ...
  - Escribe un `<script>` para que los visitantes de tu sitio puedan abrir y cerrar el menú de navegación
  - Mueve tu JavaScript a un archivo `.js`.
</PreCheck>
...
2. Comprueba de nuevo la vista previa del navegador en varios tamaños y verifique que el menú de navegación funciona, que es responsivo al tamaño de la pantalla y que responde a las entradas del usuario en esta página.
...
3. Comprueba de nuevo la vista previa del navegador a un tamaño más pequeño y verifique que el menú hamburguesa sigue abriendo y cerrando los enlaces de navegación. 


4. Añade el mismo `<script>` con import a tus otras dos páginas, `about.astro` y `blog.astro` y comprueba que tienes un header responsivo e interactivo en cada página.
...
:::note[takeaway]
Anteriormente había utilizado JavaScript para construir partes de tu sitio:
