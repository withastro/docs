...
Ahora que tienes el mismo HTML escrito en varias páginas de tu sitio Astro, ¡vamos a sustituir ese contenido duplicado por un componente de Astro reutilizable!
