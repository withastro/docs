---
type: tutorial
title: Constrúyelo tu mismo - Cabezera
i18nReady: true
description: >-
  Tutorial: Crea tu primer blog con Astro —
  Utiliza todo lo que has aprendido hasta ahora para construir una cabezera con navegación adaptable
---
...
<PreCheck>
  - Crear una cabezera para tu sitio que contenga el componente de navegación
...
1. En cada página, sustituye el componente `<Navigation/>` existente por tu nueva cabezera.
...
2. Comprueba la vista previa de tu navegador y verifica que tu cabezera se muestra en todas las páginas. Todavía no se verá diferente, pero si inspeccionas la vista previa con las herramientas de desarrollo, verás que ahora tienes elementos como `<header>` y `<nav>` alrededor de los enlaces de navegación.
...
Cambia el tamaño de la ventana y comprueba si se aplican diferentes estilos a diferentes anchos de pantalla. Tu cabezera es ahora **responsiva** al tamaño de la pantalla mediante el uso de consultas `@media`.
