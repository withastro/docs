...
<PreCheck>
  - Crear un header para tu sitio que contenga el componente de navegación
...
2. Copia los siguientes estilos CSS en `global.css`. Estos estilos:
    ...
    - Utilizan una consulta  `@media` para definir estilos diferentes para tamaños de pantalla mayores.
...
Cambia el tamaño de la ventana y comprueba si se aplican diferentes estilos a diferentes anchos de pantalla. Tu header es ahora **responsivo** al tamaño de la pantalla mediante el uso de consultas `@media`.
