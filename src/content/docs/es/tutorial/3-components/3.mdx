...
## Pruébalo tu mismo - Crea un nuevo componente Header \{#try-it-yourself---build-a-new-header-component\}
...
## Pruébalo tu mismo - Actualiza tus páginas \{#try-it-yourself---update-your-pages\}
...
## Añade estilos responsivos \{#add-responsive-styles\}
