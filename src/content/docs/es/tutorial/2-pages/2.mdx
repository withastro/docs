...
3. Busca esta página en la vista previa de tu navegador añadiendo `/posts/post-1` al final de tu URL de vista previa. (por ejemplo, `localhost:3000/posts/post-1`)
...
2. Comprueba de nuevo la vista previa de tu navegador en `localhost:3000/posts/post-1`. Ahora deberías ver el contenido de esta página.
