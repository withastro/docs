...
description: |-
  ...
  Crear una hoja de estilo global para el estilo de todo el sitio
---
...
Ahora que ya tienes una página "Acerca de" con estilo, vamos a añadir algunos estilos globales para el resto del sitio.

<PreCheck>
  - Aplicar estilos globalmente
</PreCheck>

## Añadir una hoja de estilo global

Has visto que la etiqueta Astro `<style>` tiene su propio **scope por defecto**, lo que significa que sólo afecta a los elementos de su propio archivo.
...
2. Copie el siguiente código en su nuevo archivo, `global.css`.
...
4. Compruebe la vista previa del navegador de su página Acerca de y ahora debería ver los nuevos estilos aplicados.

<Box icon="puzzle-piece">

## Pruébelo usted mismo - Importe su hoja de estilo global

Añada la línea de código necesaria a cada archivo `.astro` de su proyecto para aplicar sus estilos globales a cada página de su sitio.
...
Realice cualquier cambio o adición que desee en el contenido de su página Acerca de añadiendo elementos HTML a la plantilla de página, ya sea de forma estática o dinámica. Escriba cualquier JavaScript adicional en su script frontmatter para proporcionarle valores para usar en su HTML. Cuando estés satisfecho con esta página, confirma tus cambios en GitHub antes de pasar a la siguiente lección.

<Box icon="question-mark">
### Analizar el patrón

Su página Acerca de ahora tiene estilo usando *ambos* el archivo importado `global.css` *y* una etiqueta `<style>`.
...
### Recursos
- [Comparación entre la sintaxis Astro y JSX](/en/core-concepts/astro-syntax/#differences-between-astro-and-jsx)

- [Etiqueta Astro `<style>`.](/en/guides/styling/#styling-in-astro)

- [Variables CSS en Astro](/en/guides/styling/#css-variables)
