...
description: |-
  ...
  Utilice variables y renderización condicional en sus páginas Astro
---
...
Ahora que ya tienes un sitio web multipágina con contenido HTML, ¡vamos a añadir algo de HTML dinámico!

<PreCheck>
  - Defina el título de su página en frontmatter y utilícelo en su HTML
  - Visualización condicional de elementos HTML
  - Añade contenido sobre ti
</PreCheck>
...
Abra `about.astro` que debería tener este aspecto:
...
3. Actualice la vista previa en directo de su página `/about`.
...
1. Añade el siguiente JavaScript a tu frontmatter, entre las **vallas de código**:
      ...
      (Puede personalizar el código usted mismo, pero este tutorial utilizará el siguiente ejemplo.)
...
2. A continuación, añada el siguiente código a su plantilla HTML, debajo del contenido existente:
...
2. Añada las siguientes líneas debajo de los párrafos existentes.

    A continuación, compruebe la vista previa en directo en la pestaña de su navegador para ver lo que se muestra en la página:
...
3. Confirma tus cambios en GitHub antes de continuar. Haga esto cada vez que desee guardar su trabajo y actualizar su sitio web en vivo.
...
- [Expresiones dinámicas en Astro](/en/core-concepts/astro-syntax/#jsx-like-expressions)
