...
<PreCheck>
  - Define el título de tu página en el frontmatter y utilízalo en su HTML
...
- [Expresiones dinámicas en Astro](/es/core-concepts/astro-syntax/#jsx-like-expressions)
