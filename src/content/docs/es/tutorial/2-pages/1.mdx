...
## Crea un nuevo archivo `.astro` \{#create-a-new-astro-file\}
...
## Edita tu página \{#edit-your-page\}
...
## Añade enlaces de navegación \{#add-navigation-links\}
...
## Pruébalo tú mismo - Añadir una página de blog \{#try-it-yourself---add-a-blog-page\}
...
## Publica tus cambios en la web \{#publish-your-changes-to-the-web\}
