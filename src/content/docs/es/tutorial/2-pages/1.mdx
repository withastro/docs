...
<PreCheck>
  - Crea dos nuevas páginas en su sitio web: Acerca de y Blog
  - Añade enlaces de navegación a tus páginas
  - Despliega en la web una versión actualizada de tu sitio web
</PreCheck>
...
4. Añade `/about` al final de la URL de la vista previa de tu sitio web en la barra de direcciones y compruebe que puede ver una página cargada allí. (por ejemplo, `http://localhost:3000/about`)
...
Para cambiar o añadir más contenido a su página Acerca de, añade más etiquetas de elementos HTML que contengan contenido. Puedes copiar y pegar el código HTML siguiente entre las etiquetas `<body></body>` existentes, o crear las tuyas.
...
Ahora, vuelve a visitar tu página `/about` en la pestaña de tu navegador, y debería ver tu contenido actualizado.
...
Si has seguido nuestra configuración en la Unidad 1, puede publicar tus cambios en tu sitio web en vivo a través de Netlify.
...
- [Astro páginas HTML](/es/core-concepts/astro-pages/#páginas-de-astro)
