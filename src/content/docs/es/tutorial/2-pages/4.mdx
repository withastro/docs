...
2. Añade el nombre de clase `skill` a los elementos `<li>` generados en tu página Acerca de, para que podamos aplicarles estilo. Tu código debería tener este aspecto:
...
### Recursos
- [Comparación entre la sintaxis Astro y JSX](/es/core-concepts/astro-syntax/#differences-between-astro-and-jsx)
