...
## Estiliza una página individual \{#style-an-individual-page\}
...
## Utiliza tu primera variable CSS \{#use-your-first-css-variable\}
...
## Pruébalo tú mismo - Definir variables CSS \{#try-it-yourself---define-css-variables\}
