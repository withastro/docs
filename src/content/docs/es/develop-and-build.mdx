...
Tambien puedes [personalizar aspectos en tu ambiente de desarrollo](#configure-your-dev-environment) como configurar Typescript o instalar las extensiones de edición oficiales de Astro
...
Cuando estés viendo tu sitio en el navegador, vas a tener acceso a la [Barra de desarollo astro](/en/guides/dev-toolbar/). Mientras desarrolles, la barra te ayudará a inspeccionar tus [islas](/en/concepts/islands/), detectar problemas de accesibilidad, y más.
...
Desarrolla un blog en Astro totalmente funcional desde una página en blanco con nuestro [introductory tutorial](/en/tutorial/0-introduction/).
