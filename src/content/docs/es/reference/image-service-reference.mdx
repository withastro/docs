...
Los [assets](/es/guides/assets/) de Astro fueron diseñados para facilitar que cualquier servicio de optimización de imágenes construya un servicio sobre Astro.
