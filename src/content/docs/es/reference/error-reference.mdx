...
- [**PrerenderDynamicEndpointPathCollide**](/es/reference/errors/prerender-dynamic-endpoint-path-collide/) (E03026)<br/>Prerendered dynamic endpoint has path collision.
- [**ExpectedImage**](/es/reference/errors/expected-image/) (E03027)<br/>Expected src to be an image.
- [**ExpectedImageOptions**](/es/reference/errors/expected-image-options/) (E03028)<br/>Expected image options.
- [**MarkdownImageNotFound**](/es/reference/errors/markdown-image-not-found/) (E03029)<br/>Image not found.
- [**ResponseSentError**](/es/reference/errors/response-sent-error/) (E03030)<br/>Unable to set response.
- [**MiddlewareNoDataOrNextCalled**](/es/reference/errors/middleware-no-data-or-next-called/) (E03031)<br/>The middleware didn't return a response or call `next`.
- [**MiddlewareNotAResponse**](/es/reference/errors/middleware-not-aresponse/) (E03032)<br/>The middleware returned something that is not a `Response` object.
- [**LocalsNotAnObject**](/es/reference/errors/locals-not-an-object/) (E03033)<br/>Value assigned to `locals` is not accepted.
...
- [**CollectionDoesNotExistError**](/es/reference/errors/collection-does-not-exist-error/) (E09004)<br/>Collection does not exist
- [**MixedContentDataCollectionError**](/es/reference/errors/mixed-content-data-collection-error/) (E09005)<br/>Content and data cannot be in same collection.
- [**ContentCollectionTypeMismatchError**](/es/reference/errors/content-collection-type-mismatch-error/) (E09006)<br/>Collection contains entries of a different type.
- [**DataCollectionEntryParseError**](/es/reference/errors/data-collection-entry-parse-error/) (E09007)<br/>Data collection entry failed to parse.
- [**DuplicateContentEntrySlugError**](/es/reference/errors/duplicate-content-entry-slug-error/) (E09008)<br/>Duplicate content entry slug.
- [**UnsupportedConfigTransformError**](/es/reference/errors/unsupported-config-transform-error/) (E09008)<br/>Unsupported transform in content config.
