...
Una función callback para inyectar rutas a un proyecto de Astro. Las rutas inyectadas pueden ser [páginas `.astro`](/es/basics/astro-pages/) o [controladores de ruta `.js` y `.ts`](/es/guides/endpoints/#static-file-endpoints).
