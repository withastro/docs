...
Una función callback para inyectar rutas a un proyecto de Astro. Las rutas inyectadas pueden ser [páginas `.astro`](/es/basics/astro-pages/) o [handlers de ruta `.js` y `.ts`](/es/guides/endpoints/#endpoints-de-archivos-estáticos).
