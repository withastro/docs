...
En las rutas que usan [parámetros rest](/es/basics/routing/#parámetros-rest), `undefined` se puede usar para representar una ruta sin parámetros pasados en la URL:
