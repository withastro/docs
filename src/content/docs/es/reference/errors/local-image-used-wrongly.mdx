...
> **LocalImageUsedWrongly**: El parámetro `src` de `Image` y `getImage` debe ser una imagen importada o una URL, no puede ser una ruta de archivo. Se recibió `IMAGE_FILE_PATH`. (E03034)
