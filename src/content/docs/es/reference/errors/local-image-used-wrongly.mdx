...
Para imágenes locales de colecciones de contenido, puedes usar el [helper de esquema image()](/es/guides/images/#images-in-content-collections) para resolver las imágenes.
