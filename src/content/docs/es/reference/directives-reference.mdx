...
Desde Astro 2.5.0, las integraciones también pueden añadir directivas de cliente personalizadas a través de la [API experimental `addClientDirective`](/es/reference/integrations-reference/#opción-addclientdirective). Puedes utilizar directivas personalizadas `cliente:*` para cambiar cómo y cuándo deben hidratarse los componentes.
