...
**¡Astro no verifica automáticamente el valor!** Asegúrate que confía en el valor o verificarlo manualmente antes de pasarlo al maquetado. Olvidar hacer esto lo expondrá a ataques de [Cross Site Scripting (XSS)](https://owasp.org/www-community/attacks/xss/).
...
📚 Mira cómo funcionan los [scripts del lado del cliente](/es/guides/client-side-scripts/) en los componentes de Astro.
