...
El método acepta un argumento obligatorio `request` y otros dos opcionales: [`routeData`](/es/reference/integrations-reference/#referencia-del-tipo-routedata) y [`locals`](/es/reference/api-reference/#astrolocals).
