...
## ¿Qué es un adaptador? \{#what-is-an-adapter\}
...
## Construyendo un adaptador \{#building-an-adapter\}
...
## Permitir la instalación vía `astro add` \{#allow-installation-via-astro-add\}
...
## Características de Astro \{#astro-features\}
...
## Características del adaptador \{#adapter-features\}
...
#### Entornos serverless \{#serverless-environments\}
