...
`context.locals` es un objeto disponible **solo en las funciones de middleware**. Puedes utilizar este objeto para almacenar información arbitraria durante el ciclo de vida de una solicitud.
