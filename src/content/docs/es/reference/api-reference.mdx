...
Mira más acerca de cómo [controlar el enrutador](/es/guides/view-transitions/#control-de-enrutador) y [añadir directivas de transición](/es/guides/view-transitions/#directivas-de-transición) a elementos de página y componentes.
