...
## Opciones de la barra de herramientas de Astro Dev
...
Esta opción se aplica a todo el proyecto, para desactivar la barra de herramientas sólo para ti, ejecuta `npm run astro preferences disable devToolbar`. Para desactivar la barra de herramientas para todos tus proyectos Astro, ejecuta `npm run astro preferences disable devToolbar --global`.
...
Controla la estrategia de enrutamiento para determinar las URLs de tu sitio. Establézcalo en función de la configuración de la ruta de la carpeta/URL para tu idioma predeterminado.
...
antes de publicar.
Habilita la optimización del análisis de scripts elevados añadiendo la flag experimental:
