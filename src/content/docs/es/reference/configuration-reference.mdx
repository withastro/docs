...
Habilita el soporte de dominios para la [estrategia de enrutamiento `domains` experimental](/es/guides/internationalization/#domains) que te permite configurar el patrón de URL de uno o más idiomas admitidos para usar un dominio personalizado (o subdominio).
...
Ver la [Guía de Internacionalización](/es/guides/internationalization/#domains) para más detalles, incluyendo las limitaciones de esta característica experimental.
