...
Permite que las integraciones utilicen la [API experimental `addClientDirective`](/es/reference/integrations-reference/#opción-addclientdirective) en el hook `astro:config:setup` para añadir directivas de cliente personalizadas en los archivos de Astro.
