...
Da la misma prioridad a las redirecciones y las rutas inyectadas junto con las rutas del proyecto basadas en archivos, siguiendo las mismas [reglas de orden de prioridad de rutas](/es/core-concepts/routing/#orden-de-prioridad-de-rutas) para todas las rutas.
