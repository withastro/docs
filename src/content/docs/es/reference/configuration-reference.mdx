...
```
 ...
 :::caution[Es posible que se produzcan cambios incompatibles]
...
{/*TODO: add link to /es/guides/integrations-guide/node/#sesiones
/es/guides/integrations-guide/cloudflare/#sesiones /es/guides/integrations-guide/netlify/#sesiones */}
El driver de Unstorage que se utilizará para el almacenamiento de sesiones. Los adaptadores de Node, Cloudflare y
Netlify configuran automáticamente un driver predeterminado para ti,
