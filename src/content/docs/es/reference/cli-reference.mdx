...
Usa estas banderas para personalizar el comportamiento del servidor de desarrollo de Astro. Para banderas compartidas con otros comandos de Astro, puedes ver [banderas comunes](#banderas-comunes) más abajo.
