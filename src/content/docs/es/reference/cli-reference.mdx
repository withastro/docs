...
Cuando sigues las instrucciones para [instalar Astro manualmente](/es/install-and-setup/#manual-setup/), se te indica que agregues estos scripts tú mismo. También puedes agregar más scripts a esta lista manualmente para cualquier comando que uses con frecuencia.
