...
Enlaza tu base de datos alojada en Studio. Esto es necesario para ejecutar [comandos de Astro DB](/es/guides/integrations-guide/db/#astro-db-cli-reference) para la gestión de bases de datos. Para enlazar una base de datos, se te pedirá que selecciones una base de datos existente o que crees una nueva.
