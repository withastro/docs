...
`inferSize` puede obtener las dimensiones de una [imagen remota desde un dominio que no ha sido autorizado](/es/guides/images/#authorizing-remote-images), sin embargo, la imagen en sí permanecerá sin procesar.
