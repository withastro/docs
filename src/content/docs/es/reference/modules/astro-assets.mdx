...
`<Picture />` acepta todas las propiedades del [componente `<Image />`](#image-properties), incluidas las [propiedades de imagen responsiva](#propiedades-de-imagen-responsiva), además de las siguientes:
