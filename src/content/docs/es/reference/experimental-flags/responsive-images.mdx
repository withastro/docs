...
Con este flag habilitado, tienes acceso a [configuraciones de imagen responsiva](#configuraciones-de-imagen-responsiva) adicionales para controlar el comportamiento predeterminado de todas las imágenes procesadas y optimizadas por Astro:

- Imágenes locales y remotas utilizando [la sintaxis Markdown `![]()`](/es/guides/images/#imagenes-en-archivos-markdown).
