...
En JavaScript, establezca esta propiedad usando `cardStyle`.
...
En JavaScript, establezca esta propiedad utilizando la propiedad `toggleStyle`.
...
El estilo de lo destacado (`purple`, `gray`, `red`, `green`, `yellow`, `blue`).
