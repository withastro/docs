...
Indica el nivel de la notificación. Esto se utilizará para determinar el color y la forma (círculo rosa oscuro, triángulo dorado o cuadrado azul) del resaltado en el icono de la aplicación. Si esta propiedad no está especificada, se asumirá `'error'`.
