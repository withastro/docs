...
Puedes encontrar una lista detallada de todos los cambios en el [historial de cambios de Astro](https://github.com/withastro/astro/blob/main/packages/astro/CHANGELOG.md) e instrucciones importantes para actualizar a cada nueva [versión mayor](#major-changes) en nuestras [guías de actualización](#upgrade-guides).

## Actualizar a la última versión \{#upgrade-to-the-latest-version\}
...
### Actualización Manual \{#manual-upgrading\}
...
### Instalar una versión específica \{#install-a-specific-version-number\}
...
## Actualización de documentación \{#documentation-updates\}

Esta documentación está actualizada por cada [versión menor](#minor-changes) y [versión mayor](#major-changes). Cuando nuevas características son añadidas, o cambios existentes son hechos, la documentación se actualizará para reflejar el **comportamiento actual de Astro**. Si tu proyecto no está actualizado, podrías ver algunas funcionalidades que no corresponden con la documentación actualizada.
...
### Guías de actualización  \{#upgrade-guides\}

Cada [lanzamiento de una versión mayor](#major-changes), encontrarás una **guía de actualización** con información de los cambios importantes e instrucciones para actualizar el código de tu proyecto.
...
### Documentación antigua (sin mantenimiento) \{#older-docs-unmaintained\}
...
### Cambios de parche \{#patch-changes\}
...
Los cambios mayores incluyen cambios disruptivos que pueden afectar el código existente. Estos cambios importantes son siempre documentados en una [guía de "Actualizar a vX"](#upgrade-guides) en Astro.
...
### Soporte para Node.js y políticas de actualización \{#nodejs-support-and-upgrade-policies\}
...
### Mantenimiento extendido \{#extended-maintenance\}
