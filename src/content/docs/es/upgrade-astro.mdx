---
title: Actualizar Astro
description: Descubre cómo actualizar Astro 
i18nReady: true
---
...
- [Actualizar a la v7](/en/guides/upgrade-to/v7/)
...
- [versión v6.4.8 no mantenida](https://v6.docs.astro.build/es/getting-started/)
- [versión v5.18.0 no mantenida](https://v5.docs.astro.build/es/getting-started/)
- [versión v4.16.17 no mantenida](https://v4.docs.astro.build/es/getting-started/)
- [versión v3.6.3 no mantenida](https://web.archive.org/web/20231203051122/https://docs.astro.build/en/getting-started/)
- [versión v2.10.15 no mantenida](https://web.archive.org/web/20230822134745/https://docs.astro.build/en/getting-started)
...
- Astro soporta la [**última versión LTS en mantenimiento de Node.js**](https://nodejs.org/es/about/previous-releases#calendario-de-lanzamiento).
- Astro soporta la [**versión _Activa_ LTS de Node.js**](https://nodejs.org/es/about/previous-releases#calendario-de-lanzamiento).
