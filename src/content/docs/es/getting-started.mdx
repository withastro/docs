...
:::tip[¡La versión 2 de Astro ya está aquí!]
**¿Qué hay de nuevo en Astro v2?** [Descúbrelo en la publicación de blog del anuncio](https://astro.build/blog/astro-2/).
**¿Listo para actualizar?** [Sigue nuestra guía de actualización](/es/guides/upgrade-to/v2/).
:::
