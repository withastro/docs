...
If you support secrets, calling `getSecret()` until `setGetEnv()` is called will throw a runtime error. This is important to keep in mind if your environment variables are tied to the request:
