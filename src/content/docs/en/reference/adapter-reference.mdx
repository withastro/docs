...
:::tip[Astro 7.0 preview]
`entrypointResolution: "explicit"` is deprecated. `entrypointResolution: "auto"` will become the default behavior in Astro 7.0.
...
To provide your own entrypoint, configure `entrypointResolution: "auto"` and either set [`serverEntrypoint`](#serverentrypoint) or [`rollupOptions.input`](https://rollupjs.org/configuration-options/#input) with your custom entrypoint path.
