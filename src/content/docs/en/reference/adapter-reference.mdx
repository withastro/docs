...
The method accepts a mandatory `request` argument, and two other optionals arguments: [`routeData`](en/reference/integrations-reference/#routedata-type-reference) and [`locals`](/en/guides/middleware/#locals).
