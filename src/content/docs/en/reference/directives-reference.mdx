...
Optionally, pass a value to start hydrating the component JavaScript when a specified margin (in pixels) around the component enters the viewport, rather than the component itself.
```astro
