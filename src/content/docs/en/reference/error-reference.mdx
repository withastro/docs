...
- [**GetStaticPathsRequired**](/en/reference/errors/get-static-paths-required/)` function required for dynamic routes.
...
- [**AstroGlobUsedOutside**](/en/reference/errors/astro-glob-used-outside/) used outside of an Astro file.
- [**AstroGlobNoMatch**](/en/reference/errors/astro-glob-no-match/) did not match any files.
