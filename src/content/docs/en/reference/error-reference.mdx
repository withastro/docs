...
- [**CantUseAstroConfigModuleError**](/en/reference/errors/cant-use-astro-config-module-error/)<br/>Cannot use the `astro:config` module without enabling the experimental feature.
