...
If this field is provided, then [the `render()` function and `<Content />` component](/en/guides/working-with-collections/#rendering-body-content) are available to render the entry in a page.
