...
Indicates the level of the notification. This will be used to determine the color of the highlight on the app icon. If this property is not specified, `'error'` will be assumed.
