...
A subset of [`AstroRenderer`](#astrorenderer) with the following additional properties:
...
The base of the assets generated **by the user**. For example, scripts created by the user falls under this category. The value of this field comes from `vite.base`. We aren't usually this tight to vite in our code base, so probably this should be refactored somehow.
...
**Type:** `Map<string, { propagation: PropagationHint; containsHead: boolean; }>`
</p>
...
**Type:** `Map<string, ImportComponentInstance>`
</p>
...
**Type:** <code>() => Promise\<<a href="#astromiddlewareinstance">AstroMiddlewareInstance</a>\> | <a href="#astromiddlewareinstance">AstroMiddlewareInstance</a></code>
</p>
...
**Type:** `() => Promise<SSRActions> | SSRActions`
</p>
...
**Type:** [`ResolvedSessionConfig<any>`](#resolvedsessionconfig)
</p>
