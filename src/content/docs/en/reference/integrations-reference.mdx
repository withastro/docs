...
Adds a [custom dev overlay plugin](/en/reference/dev-overlay-plugin-reference/).
...
**When:** After a production build (for any [`output` configuration](/en/reference/configuration-reference/#output)) has completed.
