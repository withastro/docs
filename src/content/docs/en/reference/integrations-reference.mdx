...
interface AstroIntegration {
  ...
  hooks: {
    ...
    }: HookParameters<'astro:config:setup'>) => void | Promise<void>;
    'astro:config:done'?: (options: {
      config: AstroConfig;
      setAdapter: (adapter: AstroAdapter) => void;
      injectTypes: (injectedType: { filename: string; content: string }) => URL;
      logger: AstroIntegrationLogger;
    }: HookParameters<'astro:config:done'>) => void | Promise<void>;
    'astro:route:setup'?: (options: { route: RouteOptions; logger: AstroIntegrationLogger; }: HookParameters<'astro:route:setup'>) => void | Promise<void>;
    'astro:server:setup'?: (options: { server: vite.ViteDevServer; logger: AstroIntegrationLogger; }: HookParameters<'astro:server:setup'>) => void | Promise<void>;
    'astro:server:start'?: (options: { address: AddressInfo; logger: AstroIntegrationLogger; }: HookParameters<'astro:server:start'>) => void | Promise<void>;
    'astro:server:done'?: (options: { logger: AstroIntegrationLogger; }: HookParameters<'astro:server:done'>) => void | Promise<void>;
    'astro:build:start'?: (options: { logger: AstroIntegrationLogger; }: HookParameters<'astro:build:start'>) => void | Promise<void>;
    'astro:build:setup'?: (options: {
      vite: ViteConfigWithSSR;
      pages: Map<string, PageBuildData>;
      target: 'client' | 'server';
      logger: AstroIntegrationLogger;
    }: HookParameters<'astro:build:setup'>) => void | Promise<void>;
    'astro:build:generated'?: (options: { dir: URL; logger: AstroIntegrationLogger; }: HookParameters<'astro:build:generated'>) => void | Promise<void>;
    'astro:build:ssr'?: (options: {
        manifest: SerializedSSRManifest;
        entryPoints: Map<RouteData, URL>;
        logger: AstroIntegrationLogger;
    }: HookParameters<'astro:build:ssr'>) => void | Promise<void>;
    'astro:build:done'?: (options: { dir: URL; routes: RouteData[]; logger: AstroIntegrationLogger; }: HookParameters<'astro:build:done'>) => void | Promise<void>;
...
```ts
'astro:server:setup'?: (options: { server: vite.ViteDevServer }: HookParameters<'astro:server:setup'>) => void | Promise<void>;
```
...
```ts
'astro:server:start'?: (options: { address: AddressInfo }: HookParameters<'astro:server:start'>) => void | Promise<void>;
```
...
```ts
'astro:server:done'?: ({ logger }: HookParameters<'astro:server:done'>) => void | Promise<void>;
```
...
```ts
'astro:build:start'?: ({ logger }: HookParameters<'astro:build:start'>) => void | Promise<void>;
```
...
```ts
'astro:build:generated'?: (options: { dir: URL }: HookParameters<'astro:build:generated'>) => void | Promise<void>;
```
...
```ts
'astro:build:done'?: (options: { dir: URL; routes: RouteData[], pages: { pathname: string }[] }: HookParameters<'astro:build:done'>) => void | Promise<void>;
```
...
```ts
'astro:route:setup'?: (options: { route: RouteOptions }: HookParameters<'astro:route:setup'>) => void | Promise<void>;
```
