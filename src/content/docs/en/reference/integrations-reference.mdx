...
Adds a [custom client directive](/en/reference/directives-reference/#custom-client-directives) to be used in Astro files. As this is an experimental feature, you also need to enable the [`experimental.customClientDirectives` option](/en/reference/configuration-reference/#experimentalcustomclientdirectives) to use this API.
