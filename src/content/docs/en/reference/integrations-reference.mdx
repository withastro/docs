...
**Type**: [`PageData[]`](#pagedata-type-reference)

A list of all generated pages. It has one property `pathname` which is the finalized path of the page.

##### `PageData` type reference
