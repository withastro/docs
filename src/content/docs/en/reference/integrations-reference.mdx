...
**Type:** <code><a href="/en/reference/configuration-reference/#session-options">SessionConfig\<TDriver\></a> & \{ driverModule?: () => Promise\<\{ default: () => unstorage.Driver \}\>; }</code>
</p>
...
**Type:** [`ResolvedSessionConfig<any>`](#resolvedsessionconfig)<br />
<Since v="5.1.0" />
</p>
