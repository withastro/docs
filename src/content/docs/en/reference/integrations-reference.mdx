...
interface AstroIntegration {
  ...
  hooks: {
    ...
    'astro:route:setup'?: ({ route: RouteOptions; logger: AstroIntegrationLogger; }: HookParameters<'astro:route:setup'>) => void | Promise<void>;
    'astro:server:setup'?: ({ server: vite.ViteDevServer; logger: AstroIntegrationLogger; }: HookParameters<'astro:server:setup'>) => void | Promise<void>;
    'astro:server:start'?: ({ address: AddressInfo; logger: AstroIntegrationLogger; }: HookParameters<'astro:server:start'>) => void | Promise<void>;
    'astro:server:done'?: ({ logger: AstroIntegrationLogger; }: HookParameters<'astro:server:done'>) => void | Promise<void>;
    'astro:build:start'?: ({ logger: AstroIntegrationLogger; }: HookParameters<'astro:build:start'>) => void | Promise<void>;
    'astro:build:setup'?: ({
    ...
    'astro:build:generated'?: ({ dir: URL; logger: AstroIntegrationLogger; }: HookParameters<'astro:build:generated'>) => void | Promise<void>;
    'astro:build:ssr'?: ({
        manifest: SerializedSSRManifest;
        entryPoints: Map<RouteData, URL>;
        logger: AstroIntegrationLogger;
    }: HookParameters<'astro:build:ssr'>) => void | Promise<void>;
    'astro:build:done'?: ({ dir: URL; routes: RouteData[]; logger: AstroIntegrationLogger; }: HookParameters<'astro:build:done'>) => void | Promise<void>;
...
```ts
'astro:server:setup'?: ({ server: vite.ViteDevServer }: HookParameters<'astro:server:setup'>) => void | Promise<void>;
```
...
```ts
'astro:server:start'?: ({ address: AddressInfo }: HookParameters<'astro:server:start'>) => void | Promise<void>;
```
...
```ts
'astro:build:generated'?: ({ dir: URL }: HookParameters<'astro:build:generated'>) => void | Promise<void>;
```
...
```ts
'astro:build:done'?: ({ dir: URL; routes: RouteData[], pages: { pathname: string }[] }: HookParameters<'astro:build:done'>) => void | Promise<void>;
```
...
```ts
'astro:route:setup'?: ({ route: RouteOptions }: HookParameters<'astro:route:setup'>) => void | Promise<void>;
```
