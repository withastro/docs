...
> Don't forget to export the entrypoint file in the `package.json`. The above example would require you to define `"exports": {"./dashboard.astro": "./dashboard.astro"}` in the `package.json` of `@fancy/dashboard`.
