...
<span style="margin: 0.25em;"><Badge variant="accent">Experimental</Badge></span>
<Since v="2.5.0" />
...
Adds a [custom client directive](/en/reference/directives-reference/#custom-client-directives) to be used in Astro files. As this is an experimental feature, you also need to enable the [`experimental.customClientDirectives` configuration option](/en/reference/configuration-reference/#experimentalcustomclientdirectives) to use this API.
