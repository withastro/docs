...
- [x] overview
    - [x] desc
    - [x] advantages (unified API + optimizations)
    - [x] code
- [ ] usage guide
    - [ ] astro config
        - [ ] pick a provider (link to reference)
        - [ ] choose a font name (explain how to choose + link to reference)
        - [ ] set a css variable
        - [ ] extra properties
    - [ ] use the font component
        - [ ] where to do this
...
- [ ] reference
    ...
    - [ ] font component
        ...
        - [ ] preload
        - [ ] page specific fonts
        - [ ] use the css variable (refer to guide above)
