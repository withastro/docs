...
1. Register a provider for your font. You can choose from the list of [built-in remote providers](#available-remote-font-providers), build your own [custom font provider](#custom-font-providers), or use the [local provider](#local-font-families) to register local font files.
