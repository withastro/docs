...
This experimental feature allows you to use fonts from your filesystem and various providers (eg. Google, Fontsource, Bunny...) through a unified API.
...
For ease of use, `cssVariable` is strongly typed using the values from your Astro configuration.
