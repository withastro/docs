...
You can further customize the `<meta>` tag by enabling this feature with a configuration object that includes additional options.
...
These properties are added to all pages and **completeley override Astro's defaults**, not add to them. Therefore, you must explicitly specify any default values that you want to be included.
