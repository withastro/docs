...
**Type:** `string`<br />
**Default:** Auto-detected or guessed from family name
</p>

The npm package name. When not specified, the provider will try to find the font family in known font package patterns or guess based on Fontsource conventions:
