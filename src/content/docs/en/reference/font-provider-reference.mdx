...
The [Fonts API](/en/guides/fonts/#fonts-api) allows you to access fonts in a unified way. Each family requires the use of an Astro Font Provider, which either downloads font files from a remote service or loads local font files from disk.
...
The provider comes with family specific [options](/en/reference/configuration-reference/#fontoptions).
...
The provider comes with required family specific [options](/en/reference/configuration-reference/#fontoptions).
