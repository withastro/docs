...
You can then use these hints in your pages. If you have [route caching](/en/guides/caching/) enabled, pass cache hints directly to [`Astro.cache.set()`](/en/reference/api-reference/#cacheset):
