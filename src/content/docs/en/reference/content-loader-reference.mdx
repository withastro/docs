...
A loader function returns an object describing how to fetch data from your source. When using TypeScript, this object is typed with the `LiveLoader` generic type to provide [type safety in your loader](/en/guides/content-collections/#type-safety-in-live-loaders). This type accepts the following type parameters, in this order:
...
**Type:** <code><a href="#creating-live-loader-error-types">CustomError</a> | LiveCollectionError</code>
</p>
