...
`clientAddress` specifies the [IP address](https://en.wikipedia.org/wiki/IP_address) of the request. It must be provided by the adapter using the context of the possible edge function.
