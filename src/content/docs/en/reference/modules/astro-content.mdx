...
<ReadMore>Learn how to [define and use collections references](/en/guides/content-collections/#defining-collection-references) with guided explanations and usage examples.</ReadMore>
...
<ReadMore>Learn how to [render the body content](/en/guides/content-collections/#rendering-body-content) with guided explanations and example usage.</ReadMore>
