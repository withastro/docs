...
// if a referenced entry is invalid, the array will contain undefined
...
- `remarkPluginFrontmatter ` - The modified frontmatter object after any [Markdown processor plugins have been applied](/en/guides/markdown-content/#modifying-frontmatter-programmatically). Set to type `any`.
