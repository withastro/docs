...
By default, Sharp uses a black background when flattening an image. This property lets you specify a different background color.

This is especially useful when requesting an output format that does not support transparency, e.g. `jpeg`:
