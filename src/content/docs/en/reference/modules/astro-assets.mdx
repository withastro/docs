...
**Type:** <code>(options: UnresolvedImageTransform, imageConfig: <a href="/en/reference/configuration-reference/#image-options">AstroConfig['image']</a> & AstroAdapterClientConfig) => Promise\<GetImageResult\></code>
</p>
...
Checks whether the given image service is local or remote.
...
**Type:** `{ src: string; width: number; height: number; format: ImageInputFormat; orientation?: number; }`<br />
<Since v="2.1.3" />
</p>
...
**Type:** `ImageQualityPreset | number`<br />
<Since v="2.2.0" />
</p>
