...
The [`cssVariable`](#TODO:) registered in your Astro configuration:
...
**Type:** <code>Record\<CssVariable, Array\<<a href="#TODO:">FontData</a>\>\></code><br />
<Since v="6.0.0" />
</p>

An object where each key is a [`cssVariable`](#TODO:) and the value is an array describing the associated fonts. Each font is an object containing an array of `src` available for that font and the following optional properties: `weight` and `style`:
...
Returns a buffer for the font file from a source URL obtained from [`fontData`](#TODO:):
