...
<ReadMore>Learn how to [add type safety to custom context providers](/en/guides/routing/#typing-custom-context-providers) in the advanced routing guide.</ReadMore>
...
```ts
import {
  type AstroFetchState,
} from "astro/fetch";
```

### `AstroFetchState`

The [`FetchState`](#fetchstate) instance passed to all handlers.
