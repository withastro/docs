...
An alternative method that throws an error on failure instead of returning a [`SafeResult`](#saferesult). This is useful when you want exceptions rather than error handling.
