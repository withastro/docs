...
Astro is designed to support any UI frameworks. This ability is powered by renderers, which are [integrations](/en/reference/integrations-reference/). See the [front-end frameworks guide](/en/guides/framework-components/) to learn how to use UI components from different frameworks in Astro.

## What is a renderer?

A renderer is a special kind of [integration](/en/reference/integrations-reference/) that tell Astro how to detect and render component syntaxes it does not handle natively, such as [UI framework components](/en/guides/framework-components/). A renderer consists of two parts:
