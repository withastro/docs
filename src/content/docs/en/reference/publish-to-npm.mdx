...
To get started developing your component quickly, you can use a template already setup for you.
...
To create a new package, you should configure your development environment to use **workspaces** within your project. This will allow you to develop your component alongside a working copy of Astro.
...
The project root’s `package.json` file:
...
To use `index.js` as an entrypoint with `import` and `export`, use `"type": "module"`.
...
Astro does not currently ship a test runner. _(If you are interested in helping out tackling this, [join us on Discord!](https://astro.build/chat/))_
