...
```json
{
  ...
  "exports": {
    ".": "./index.js",
    "./astro": "./src/MyAstroComponent.astro",
    "./react": "./src/MyReactComponent.jsx"
  },
  "files": ["index.js", "src/MyAstroComponent.astro", "src/MyReactComponent.jsx"],
...
export { default as MyReactComponent } from './src/MyReactComponent.jsx';
```
