...
<!-- Optional: meta string (see below) -->
<Code code={`const foo = 'bar';`} lang="js" meta="/Highlighted/" />
```
...
The [`meta`](https://shiki.style/guide/transformers#meta) attribute lets you pass a special string with options for transformers.

The code below will highlight lines 1 and 3:
