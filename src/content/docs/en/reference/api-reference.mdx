...
:::tip
When using TypeScript, use the [`InferGetStatic*`](https://docs.astro.build/en/guides/typescript/#infer-getstaticpaths-types) type utilities to ensure type-safe access of your `params` and `props`.
:::
