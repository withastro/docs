...
It accepts an optional URL path parameter in the form of a string, `URL`, or `Request` to trigger a [rewrite](/en/guides/routing/#rewrites) of the current request.
