...
`Astro.locals` is an API available via [Astro middleware](/en/guides/middleware/). It's an object that can contain any arbitrary information.
...
This is complementary API of [`context.locals`](#contextlocals)
...
This is complementary API of [`Astro.locals`](#astrolocals)
