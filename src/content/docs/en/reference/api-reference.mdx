...
| Name      | Type                        | Description                                                                                                    |
| :-------- | :-------------------------- | :------------------------------------------------------------------------------------------------------------- |
| `domain`   | `string`       | Specifies the domain. If no domain is set, most clients will intepret to apply to the current domain. |
| `expires` | `Date` |                           Species the date in which the cookie will expire.                                             |
| `httpOnly` | `boolean` | If true, the cookie will not be accessible client-side. |
| `maxAge` | `number` | Specifies a number, in seconds, in which the cookie is valid. |
