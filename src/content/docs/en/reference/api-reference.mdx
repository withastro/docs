...
[See the `Content Collection` guide](/en/guides/collection-queries/#querying-collections) for example usage.
...
See the `Content Collections` guide for examples of [querying collection entries](/en/guides/collection-queries/#querying-collections).
...
[See the `Content Collection` guide](/en/guides/collection-queries/#rendering-body-content) for example usage.
