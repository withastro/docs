...
<Meta>`ResponseInit & { readonly headers: Headers }`</Meta>
...
<Meta version="1.4.0">`AstroCookies`</Meta>
...
<Meta>
<code>(key: string, options?: <a href="#astrocookiegetoptions">AstroCookieGetOptions</a>) => <a href="#astrocookie">AstroCookie</a> | undefined</code>
</Meta>
...
<Meta>
<code>(key: string, options?: <a href="#astrocookiegetoptions">AstroCookieGetOptions</a>) => boolean</code>
</Meta>
...
<Meta>
<code>(key: string, value: string | object, options?: <a href="#astrocookiesetoptions">AstroCookieSetOptions</a>) => void</code>
</Meta>
...
<Meta>`(key: string, options?: AstroCookieDeleteOptions) => void`</Meta>
...
<Meta>`(cookies: AstroCookies) => void`</Meta>
...
<Meta>`boolean | 'lax' | 'none' | 'strict'`</Meta>
...
<Meta>`(path: string, status?: number) => Response`</Meta>
...
<Meta version="1.0.0-rc">`URL`</Meta>
...
<Meta version="1.0.0-rc">`string`</Meta>
...
<Meta version="1.0.0">`string`</Meta>
...
<Meta>`(slotName: string) => boolean`</Meta>
...
<Meta>`(slotName: string, args?: any[]) => Promise<string>`</Meta>
...
<Meta version="3.5.0">`string | undefined`</Meta>
...
<Meta version="3.5.6">`string | undefined`</Meta>
...
<Meta version="1.5.0">`string`</Meta>
...
<Meta version="1.5.0">`URL | undefined`</Meta>
...
<Meta version="1.5.0">`(path: string, status?: number) => Response`</Meta>
...
<Meta>
`(options: GetStaticPathsOptions) => Promise<GetStaticPathsResult> | GetStaticPathsResult`
</Meta>
...
<Meta>`(options: UnresolvedImageTransform) => Promise<GetImageResult>`</Meta>
...
<Meta>`(input: CollectionConfig) => CollectionConfig`</Meta>
...
<Meta default="`'content'`" version="2.5.0">`'content' | 'data'`</Meta>
...
<Meta version="2.5.0">
`(collection: string) => ZodEffects<ZodString, { collection, id: string } | { collection, slug: string }>`
</Meta>
...
<Meta>
`(collection: string, filter?: (entry: CollectionEntry<collection>) => boolean) => CollectionEntry<collection>[]`
</Meta>
...
<Meta>
`(collection: string, slug: string) => Promise<CollectionEntry<collection>>`
</Meta>
...
<Meta version="2.5.0">
`(collection: string, id: string) => Promise<CollectionEntry<collection>>`
</Meta>
...
<Meta>`(rewritePayload?: string | URL | Request) => Promise<Response>`</Meta>
...
<Meta>`(...handlers: MiddlewareHandler[]) => MiddlewareHandler`</Meta>
...
<Meta version="2.8.0">`(context: CreateContext) => APIContext`</Meta>
...
<Meta version="2.8.0">`(value: unknown) => string`</Meta>
...
<Meta>`(path?: string, options?: GetLocaleOptions) => string[]`</Meta>
...
<Meta>`(locale: string) => string`</Meta>
...
<Meta version="4.6.0">
`(context: APIContext, statusCode?: ValidRedirectStatus) => Promise<Response>`
</Meta>
...
<Meta version="4.6.0">
`(context: APIContext, response: Response) => Promise<Response>`
</Meta>
...
<Meta version="4.6.0">
`(context: APIContext, response?: Response) => Promise<Response> | undefined`
</Meta>
...
<Meta version="4.6.0">
`(options: { prefixDefaultLocale: boolean, redirectToDefaultLocale: boolean }) => MiddlewareHandler`
</Meta>
...
<Meta version="4.6.0">`(context: APIContext) => boolean`</Meta>
...
<Meta default="`'auto'`" version="3.2.0">`'auto' | 'push' | 'replace'`</Meta>
...
<Meta version="3.5.0">`FormData`</Meta>
...
<Meta version="3.6.0">`Element`</Meta>
...
<Meta version="3.2.0">`boolean`</Meta>
...
<Meta version="3.6.0">`() => 'none' | 'animate' | 'swap'`</Meta>
...
<Meta>`'push' | 'replace' | 'traverse'`</Meta>
...
<Meta>`(newDocument: Document) => void`</Meta>
...
<Meta>`(newBody: Element, oldBody: Element) => void`</Meta>
...
<Meta version="4.15.0">
<code>(error?: unknown | <a href="#actionerror">ActionError</a>) => boolean</code>
</Meta>
