...
**Type**: `build | 'request'`<br />
<Since v="TODO" />
</p>

Specifies the phase of the build during which the code is executed.

You can use this property to run conditional logic in middleware, for example, to rewrite content during build time, and access user headers at request time.
...
<ReadMore>See the [caching guide](/en/guides/caching/) for more information on how to use caching in your Astro project.</ReadMore>
