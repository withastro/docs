...
An union of string of all collection names defined in your `src/content/config.*` file. This type can be useful when defining a generic function that accepts any collection name.
...
An union of string of all the names of `type: 'content'` collections defined in your `src/content/config.*` file.

#### `DataCollectionKey`

An union of string of all the names of `type: 'data'` collection defined in your `src/content/config.*` file.
