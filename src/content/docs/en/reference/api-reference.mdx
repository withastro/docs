...
You can use this property to run conditional logic in middlewares, for example, to avoid accessing headers in prerendered pages.
...
You can use this property to run conditional logic in middlewares, eg. to avoid accessing headers in prerendered pages.
...
[See the `Content Collection` guide](/en/guides/defining-collections/#defining-the-collection-schema) for example usage.
...
[See the `Content Collection` guide](/en/guides/defining-collections/#defining-collection-references) for example usage.
...
[See the `Content Collection` guide](/en/guides/working-with-collections/#querying-collections) for example usage.
...
See the `Content Collections` guide for examples of [querying collection entries](/en/guides/working-with-collections/#querying-collections).
...
`getEntries()` is a function that retrieves multiple collection entries from the same collection. This is useful for [returning an array of referenced entries](/en/guides/defining-collections/#defining-collection-references) to access their associated `data`, `body`, and `render()` properties.
...
[See the `Content Collection` guide](/en/guides/working-with-collections/#rendering-body-content) for example usage.
