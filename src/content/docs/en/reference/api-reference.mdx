...
| ------------ | ----------------------------------------------- | ------------------------------------------------------------ |
| `status`     | `number \| undefined`                            | The status code of the response, e.g., `200`.                   |
| `statusText` | `string`                                        | The status message associated with the status code, e.g., `OK`. |
| `headers`    | `Headers \| string[][] \| Record<string, string>` | The HTTP headers of the response.                  |
