...
This is the same [`context`](#endpoint-context) object that is passed to API routes.
...
A low-level API to create an [`APIContext`](#endpoint-context), that can be used by the Astro middleware.
