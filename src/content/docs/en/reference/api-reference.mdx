...
| ------------ | ----------------------------------------------- | ------------------------------------------------------------ |
| `status`     | `number \| undefined`                            | Indicates the status code of the response.                   |
| `statusText` | `string`                                        | Indicates the status message of the associating status code. |
| `headers`    | `Headers \| string[][] \| Record<string, string>` | Indicates the HTTP headers of the response.                  |
