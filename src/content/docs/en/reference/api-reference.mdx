...
Get the URL of the previous page (will be `undefined` if on page 1). If using a base path, prepend the base path to the URL.
...
Get the URL of the next page (will be `undefined` if no more pages). If using a base path, prepend the base path to the URL.
