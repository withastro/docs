...
## What went wrong?
In [Static Mode](/en/core-concepts/routing/#static-pre-rendered-mode), all routes must be determined at build time. As such, dynamic routes must `export` a `getStaticPaths` function returning the different paths to generate.
