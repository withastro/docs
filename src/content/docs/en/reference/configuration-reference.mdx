...
**Type:** `number`<br />
**Default:** `1024 * 1024`<br />
<Since v="5.17.5" />
</p>

Limits the size of the request body for actions in bytes. If an incoming request's body exceeds this limit, Astro will return a 413 status code and will not process the action.
