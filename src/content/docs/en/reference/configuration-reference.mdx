...
All properties of your fonts must be configured in the Astro config. Set these to customize the data loaded from your [font provider](#TODO:), for example, to only download certain font weights or styles. For more control, more [granular configuration](#TODO:) is available.
...
[`provider`](#TODO:), [`name`](#TODO:), and [`cssVariable`](#TODO:) are required.
...
See our guide for more information on the [Fonts API](#TODO:).
