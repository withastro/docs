...
Prioritizes redirects and injected routes equally alongside file-based project routes, following the same [route priority order rules](/en/basics/routing/#route-priority-order) for all routes.
