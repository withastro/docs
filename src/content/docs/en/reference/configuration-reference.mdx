...
:::caution[Deprecated]
This property is deprecated and will be removed in a future major version. Pass plugins to the configured [`markdown.processor`](#markdownprocessor) instead.

Learn more about [setting up a Markdown processor](/en/guides/markdown-content/#setting-up-a-markdown-processor) and [using plugins](/en/guides/markdown-content/#markdown-processor-plugins) in the Markdown guide.
:::
...
:::caution[Deprecated]
This property is deprecated and will be removed in a future major version. Pass `gfm` to the configured [`markdown.processor`](#markdownprocessor) instead.

Learn more about [setting up a Markdown processor](/en/guides/markdown-content/#setting-up-a-markdown-processor) and [using GitHub-flavored Markdown](/en/guides/markdown-content/#github-flavored-markdown) in the Markdown guide.
:::
...
:::caution[Deprecated]
This property is deprecated and will be removed in a future major version. Pass it to the configured [`markdown.processor`](#markdownprocessor) instead. Use `smartypants` for `unified()` or `smartPunctuation` for `satteri()`.

Learn more about [setting up a Markdown processor](/en/guides/markdown-content/#setting-up-a-markdown-processor) and [using smart punctuation](/en/guides/markdown-content/#smart-punctuation) in the Markdown guide.
:::
...
:::caution[Deprecated]
This property is deprecated and will be removed in a future major version.
...
Learn more about [setting up a Markdown processor](/en/guides/markdown-content/#setting-up-a-markdown-processor) and [using built-in features](/en/guides/markdown-content/#built-in-features) in the Markdown guide.
:::
...
Configures the [Markdown processor](/en/guides/markdown-content/#markdown-processors) used to render `.md` files. Defaults to `satteri()` from
...
Learn more about the [official Markdown processors and how to choose one](/en/guides/markdown-content/#choosing-a-markdown-processor) in the Markdown guide.
