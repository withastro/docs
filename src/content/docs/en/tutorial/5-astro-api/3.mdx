...
1. Add the following code to your component template:
    ...
    ```
    In your browser preview, verify that you can see your tags listed. If any blog posts are missing tags, or they are improperly formatted, Astro's built-in TypeScript will show you errors so you can check and correct your code.
