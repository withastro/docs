...
2. Filter your list of posts to only include posts that contain the page's own tag. As the 'tags' property may not exist you will need to use optional chaining. 
