...
:::tip[We'll use...]
This tutorial will use **Netlify**, but you are welcome to use your preferred hosting service for deploying your site to the internet. For more information, see [Deploy your Astro Site.](https://docs.astro.build/en/guides/deploy/)
:::
