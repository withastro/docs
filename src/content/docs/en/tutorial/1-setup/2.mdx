...
5. When the prompt asks, "Would you like to install dependencies?" Use the arrow keys (left and right) to navigate to "Yes", and then press return (enter) to submit your choice.

6. When the prompt asks you if you plan on writing TypeScript, Use the arrow keys (left and right) to navigate to "No", and then press return (enter) to submit your choice. 

7. When the prompt asks, "Would you like to initialize a new git repository?" Use the arrow keys (left and right) to navigate to "Yes", and then press return (enter) to submit your choice.
