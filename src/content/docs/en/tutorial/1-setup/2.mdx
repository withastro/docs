...
4. When the prompt asks you whether or not to install dependencies, say yes.

5. When the prompt asks you whether or not to initialize a new git repository, say yes.
</Steps>
