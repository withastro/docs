...
Want to complete this tutorial in an online code editor instead? Follow the instructions below for either IDX or StackBlitz.

<details>
<summary>Using IDX: Follow these instructions, then go directly to Unit 2!</summary>

**Set up IDX**

<Steps>
1. Visit [astro.new](https://astro.new) and click the button to open the "Empty Project" template in IDX. 

2. Follow the prompt to log into your Google account if you are not already logged in.

3. Enter a name for your project if you want to change it from the default "Empty Project". The template "Empty Project" will already be selected. (You will see other templates available that you can explore later, but this tutorial requires you to select "Empty Project.")
...
<Steps>
1. Visit [astro.new](https://astro.new) and use the drop down select to open the "Empty Project" template in StackBlitz. 
