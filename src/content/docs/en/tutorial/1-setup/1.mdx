...
For Astro to run on your system, you will also need to have [**Node.js**](https://nodejs.org/en/) installed, version `v18.20.8` or `v20.3.0`, `v22.0.0` or higher. (`v19` and `v21` are not supported.)
...
If the command returns a version number higher than `v18.20.8` or `v20.3.0` (excluding any `v19` or `v21`), you're good to go!
