...
:::tip[using bun]
You can use is [Bun](https://bun.sh/) as an alternative JavaScript runtime.
<details>
<summary>Check whether you have Bun installed.</summary>
```sh
bun -v
...
If you don't, you will need to [install Bun](https://bun.sh/docs/installation) onto your computer
</details>
:::
