...
**Content collections** are a more powerful way to manage groups of similar content, such as blog posts. Collections help to organize your documents, validate your YAML frontmatter, and provide automatic TypeScript type-safety for all of your content (even if you don't write any TypeScript yourself).

You will still use the `src/pages/` folder for individual pages, such as your About Me page. But, moving your blog posts to the special `src/content/` folder will allow you to use more powerful and performant APIs to generate your blog post index and display your individual blog posts.

At the same time, you'll receive more helpful guidance and autocompletion in your editor because you will be setting up a **schema** that allows you to specify when frontmatter properties are required, such as a description or an author.

Read more about Astro's content collections in our guide, and follow the instructions below to convert the completed Blog Tutorial code to using content collections for your blog entries! 
