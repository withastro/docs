...
3. Look for this page in your browser preview by adding `/posts/post-1` to the end of your existing preview URL. (e.g. `localhost:4321/posts/post-1`)
...
2. Check your browser preview again at `localhost:4321/posts/post-1`. You should now see content on this page.
