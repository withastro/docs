...
2. Check your browser preview at `localhost:4321/posts/post-1`. Now you should see content rendered by:
...
5. Check your browser preview again at `localhost:4321/posts/post-1` and verify that this line is no longer displayed and that your title is only displayed once. Make any other adjustments necessary to ensure that you do not have any duplicated content.
