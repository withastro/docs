...
<CardGrid>
  <LinkCard
    title="Convert to content collections"
    description="Refactor the tutorial code to manage your blog posts in a content collection."
    href="/en/tutorial/7-collections/"
  />
   <LinkCard
