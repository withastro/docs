...
## Next Steps
 ...
 You can enhance this project's final code by [refactoring it to manage your content with content collections](/en/tutorials/add-content-collections/) or [adding view transitions to customize page navigation](/en/tutorials/add-view-transitions/).