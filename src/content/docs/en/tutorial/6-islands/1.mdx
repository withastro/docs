...
This component will take an array of greeting messages as a prop and show the first as a welcome message. The user can click a button to get a new random message.
...
3. Import and use this component on your Home page `index.astro`.
    ...
    Check the preview in your browser: you should see a greeting, but the button won't work!
