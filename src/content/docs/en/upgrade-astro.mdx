...
The Core team will provide extended maintenance for security fixes, only to the previous major of the current release. This means that of the **current major** is `v4.*`, the Core team will backport security fixes on for `v3.*` versions. 
