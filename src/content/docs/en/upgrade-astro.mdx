...
- Upgrading the minimum **_extended_ LTS** version of Node.js can occur in a **minor** release of Astro.
  - Security exception: If a security flaw in Node.js that **affects Astro** is disclosed and fixed, the Core team can bump the minimum version of the **_extended_ LTS** in a **patch** release.
- Upgrading minor or major versions of Node.js (**not** extended LTS) occurs only in major versions of Astro.
