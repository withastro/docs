...
The main [Astro documentation is always **current**](#major-docs-upgrades) for the latest released version of Astro, and does not highlight updated or changed behavior.

See the upgrade guides below for an explanation of changes from one major version to the next, including breaking changes, deprecations, feature removals and additions as well as updated usage guidance.
