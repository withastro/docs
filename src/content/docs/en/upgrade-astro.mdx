...
- Upgrade of minimum required Node.js version (minor or patch), e.g. from `v18.4.0` to `v18.7.0`.
  :::note
  We take these kind of changes very seriously, and approve them only if we think that a new version of Node.js can improve the security or developer experience of our users, and impact core functionalities.
  :::
...
- **Experimental features**. This allows Astro developers the greatest flexibility to explore, and even radically change course, during development. Therefore, the behaviour of these features can break in minor and patch changes.
