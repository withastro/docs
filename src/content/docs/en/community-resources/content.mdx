...
For more Astro educational content, check out [the Astro Blog](https://astro.build/blog/) or sign up for [the official Astro newsletter](https://astro.build/newsletter) where we recap the best community content of each month.
...
[Astro recipes](https://contribute.docs.astro.build/guides/recipe-writing/#is-my-guide-a-recipe) are typically short, focused how-to guides that walk a reader through completing a working example of a specific task. Recipes are a great way to add new features or behavior to your Astro project by following step-by-step instructions!
