...
- [Learn Astro](https://learnastro.dev/) by Chris Pennington
- [Build Modern Websites with Astro]() by James Q Quick
- 
### Free

- [Astro Crash Course in 20 minutes!](https://www.youtube.com/watch?v=zrPVTf761OI) <span style="margin: 0.25em;"><Badge variant="neutral">Video</Badge></span>
- [How I created a movie application with Astro 3.x](https://www.youtube.com/watch?v=Gvr4WhgfP0w)<span style="margin: 0.25em;"><Badge variant="neutral">Video</Badge></span>
