...
Check out the following courses and tutorials to learn more about Astro.
  ...
  - [Learn Astro](https://learnastro.dev/) by Chris Pennington (@CodingInPublic)
  - [Build Modern Websites with Astro](https://astrocourse.dev/) by James Q Quick
  </ListCard>

  <ListCard title="Video Tutorials" icon="youtube">
...
{/* <CardGrid>
  <LinkCard 
    href="https://learnastro.dev/"
		title="Learn Astro"
		description="Chris Pennington"
  />
   <LinkCard 
    href="https://astrocourse.dev/"
...
<CardGrid>
  <LinkCard 
    href="https://www.youtube.com/watch?v=zrPVTf761OI"
		title="Astro Crash Course in 20 minutes!"
		description=""
  />
   <LinkCard 
    href="https://www.youtube.com/watch?v=Gvr4WhgfP0w"
		title="How I created a movie application with Astro 3.x"
		description=""
  />
</CardGrid> */}
