...
description: "Islands architecture is a webpage architecture pattern pioneered by Astro, optimized for performance. Islands architecture was first coined by Etsy's frontend architect Katie Sylor-Miller in 2019, and expanded on by Preact creator Jason Miller."
i18nReady: true
---
...
<ReadMore>Read more about [using JavaScript framework components](/en/guides/frameworkj-components/) in your project.</ReadMore>
