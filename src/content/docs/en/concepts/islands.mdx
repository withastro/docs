...
But sometimes, client-side JavaScript is required for creating interactive UI. Instead of forcing your entire page to become a SPA-like JavaScript application, Astro asks you to create an island.
