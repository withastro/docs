...
**Astro** is the web framework for building **dynamic, content-first websites.** Astro is optimized for web developers building content-first experiences like **blogging, marketing, and ecommerce websites.** If you need a website that loads fast with great SEO, then Astro was made for you.

## Features

Astro is an all-in-one web framework that includes everything you need to build a modern website. Some feature highlights include:

- **[Islands:](/en/concepts/islands/)** A new web architecture optimized for content-first websites.
- **UI-agnostic:** Supports React, Preact, Svelte, Vue, Solid, Lit and more.
- **Server-first:** Move expensive rendering off of your users' devices.
- **Zero JS, by default:** Less client-side JavaScript to slow your site down.
- **Batteries-included:** Building, bundling, Markdown, TypeScript, and more.
- **Customizable:** Tailwind, MDX, and 1,000+ integrations to choose from.
