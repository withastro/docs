---
title: Why Astro?
description: "Astro is an all-in-one web framework for building fast, content-driven websites. Learn more."
i18nReady: true
---

**Astro** is a web framework for building **content-driven websites** that load fast with great SEO.

:::tip
Explore the [collection of Astro themes](https://astro.build/themes/) for blogs, portfolios, docs, landing pages, SaaS, marketing, e-commerce sites, and more!
::: 

Astro is best known for pioneering and popularizing [**islands**](/en/concepts/islands/): a JavaScript frontend architecture optimized for performance, flexibility, and simplicity.

## Features

Astro includes everything you need built-in to get started quickly, with hundreds of available integrations for added features, performance, and developer experience. 
