...
Astro is best known for pioneering a new JavaScript frontend architecture called [Islands](/en/concepts/islands) optimized for performance and simplicity.  If you need a website that loads fast with great SEO, then Astro is for you.
