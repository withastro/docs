...
**Astro** is the web framework for building **content-driven websites** like blogs, marketing, and ecommerce. Astro is best known for pioneering a new JavaScript frontend architecture called [Islands](/en/concepts/islands) optimized for performance and simplicity. If you need a website that loads fast with great SEO, then Astro is for you.

## Features

Astro is an all-in-one web framework. It includes everything you need built-in with additional options to extend to your own use-cases and preferences. Some highlights include:

- **[Islands](/en/concepts/islands/)**: A new web architecture optimized for content-driven websites.
- **UI-agnostic:** Supports React, Preact, Svelte, Vue, Solid, Lit, HTMX, and more.
- **Server-first:** Moves expensive rendering off of your users' devices.
- **Zero JS, by default:** Less client-side JavaScript to slow your site down.
- **Content-obsessed:** [Content Collections](/en/guides/content-collections/) validate your Markdown with type-safe frontmatter.
- **Customizable:** Tailwind, MDX, and thousands of integrations to choose from.
...
1. [Content-first](#content-driven): Astro was designed to showcase your content.
...
5. SOMETHING_ABOUT_DEVELOPER_EXPERIENCE
