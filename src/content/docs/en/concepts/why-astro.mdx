---
title: Why Astro?
description: "Astro is the web framework for building content-driven websites like blogs, marketing, and ecommerce. Learn more about the things that make Astro special and why Astro might be a good choice for your next website."
i18nReady: true
---

**Astro** is the web framework for building **content-driven websites** like blogs, marketing, and ecommerce. Astro is best known for pioneering a new frontend architecture called [Islands](/en/concepts/islands), optimized for performance and simplicity. If you need a website that loads fast and has great SEO then Astro is for you.

## Features

**Astro is an all-in-one web framework.** It includes everything you need to create a website, built-in. There are also 100's of different [integrations](https://astro.build/integrations/) and [API hooks](/en/reference/integrations-reference/) available for you to customize a project to your exact use-case and needs. 
