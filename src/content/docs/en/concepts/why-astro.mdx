...
**Astro** is the web framework for building **content-driven websites** like porfolios, blogs, docs, marketing sites, landing pages, and ecommerce. 

Astro is best known for pioneering a JavaScript frontend architecture using [islands](/en/concepts/islands/), optimized for performance, flexibility, and simplicity.

## Features

Astro includes everything you need built-in to get started quickly, and hundreds of integrations to extend your site. 
...
- **[Content collections:](/en/guides/content-collections/)** Organize, query and validate your Markdown and data files.
