...
Layout components are commonly placed in a `src/layouts` directory in your project for organization, but this is not a requirement. You can place layout component anywhere in your project, and even colocate them alongisde your pages by prefixing the filename with `_`.
