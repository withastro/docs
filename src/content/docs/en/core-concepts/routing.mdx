...
sMoreover, endpoints always take precedence over pages. Also, if you have dynamic routes (using rest parameters or named parameters) that are prerendered, they will take precedence too over dynamic routes that aren't.
