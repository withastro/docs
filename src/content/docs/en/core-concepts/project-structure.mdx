...
The [`src/assets`](/en/guides/images/#srcassets-vs-colocated-images) directory is the recommended folder to use for storing assets (e.g. images) that are processed by Astro if you are grouping all your images together. This is not required, and this is not a special reserved folder. You can store your images anywhere, even alongside your content.
