...
In Astro, you can't use JSX node in script body.

```astro title="TodoList.astro" "<TodoItem todo={todo} />"
---
...
// 🚫 This doesn't work
const renderedTodos = todos.map(todo => <TodoItem todo={todo} />) 
---
...
#### Node as Property Input

In Astro, you can't use component or html nodes as property input.

```astro title="CardExample.astro" "<CollapseIcon />"
---
import Card from "./Card.astro"
import CollapseIcon from "./CollapseIcon.astro"
---
<Card icon={<CollapseIcon />}>
  <p>Card body</p>
</Card>
```
