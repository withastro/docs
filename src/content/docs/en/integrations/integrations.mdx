...
[Chris Bongers](https://www.youtube.com/watch?v=LU5utR5S6Bc) - **Video**: Adding Typesense Search to an Astro Website
...
You can start a new astro project based on an existing github repository by passing a `--template` argument to the `create astro` command.
