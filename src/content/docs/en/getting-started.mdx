...
:::tip[Astro version 2.2 has arrived!]
**New in Astro v2.2:** [CDN support &  `image()` schema API change](https://astro.build/blog/astro-220/).  
Still on Astro v1? [Read our v2.0 announcement post](https://astro.build/blog/astro-2/) and [follow our upgrade guide](/en/guides/upgrade-to/v2/).
:::
