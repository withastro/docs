...
Use the [`--bun` CLI flag](https://bun.sh/docs/cli/bunx#shebangs) to tell Bun to use it's runtime in place of Node for the `astro` command.
...
Once you build a project with `bun --bun astro build`, use the following to run your built site.
