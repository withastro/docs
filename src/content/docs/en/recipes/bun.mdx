...
Using Bun with Astro still is experimental. Some integrations may not work as expected. If you have any problems using Bun, please [open an issue in their GitHub repository](https://github.com/oven-sh/bun/issues/new/choose)!
