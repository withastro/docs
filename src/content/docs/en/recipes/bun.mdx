...
As of Bun `1.15`, if a crash or panic occurs, Bun will print out a bug report with a link that when clicked, redirects to open a pre-filled GitHub issue form.
:::
