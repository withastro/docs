...
4. Change the form's default data transfer `method` to `POST` to... or to avoid....(link this to what happens when submitting) The form submission will cause the browser to request the page again, with the form data stored in the [`Request` body](/en/reference/api-reference/#astrorequest).
