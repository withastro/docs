...
2. Create a Remark Plugin
   ...
   :::note
   It's highly recommended to use Git to get the modified time of the files. Git operations (like cloning) will result in the file system modified time being updated.
   :::
