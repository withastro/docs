...
1. Install Helper Packages
   ...
   Install [`@astrojs/markdown-remark`](https://www.npmjs.com/package/@astrojs/markdown-remark) to help [modify frontmatter](/en/guides/markdown-content/#modifying-frontmatter-programmatically):
