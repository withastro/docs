...
For more information on the hooks and helpers available in the `init()` function, see the [Astro Toolbar API documentation](https://docs.astro.build/api/astro/toolbar).
