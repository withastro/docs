...
If you start your project now, you should see a new app in the dev toolbar with the name "My Toolbar App" and the icon "🚀". You won't be able to click on it just now, as we haven't implemented any logic yet, however.
