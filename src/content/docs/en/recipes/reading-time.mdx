...
4. Display Reading Time
    ...
    If you're using a [Markdown layout](/en/guides/integrations-guide/mdx/#markdown-and-mdx-pages), use the `minutesRead` frontmatter property from `Astro.props` in your layout template.
