...
1. Install the following packages:
    ...
    You also need additional packages depending on the Markdown processor you use.

    <MarkdownProcessorTabs>
      <Fragment slot="satteri">
        Install:
        - [`@astrojs/markdown-satteri`](https://www.npmjs.com/package/@astrojs/markdown-satteri) to use [the `satteri()` processor](/en/guides/markdown-content/#using-sätteri-plugins-and-features)
