---
title: Add Reading Time to Markdown
description: Learn how to add a reading time every Markdown or MDX file.
i18nReady: false
type: recipe
---
...
- The [remark or rehype plugin](/en/guides/markdown-content#markdown-plugins).
