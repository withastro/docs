...
1. Install the following packages depending on the Markdown processor used:
    ...
    <MarkdownProcessorTabs>
      <Fragment slot="satteri">
        ...
        - [`@astrojs/markdown-satteri`](https://www.npmjs.com/package/@astrojs/markdown-satteri) to configure [the `satteri()` processor](/en/guides/markdown-content/#using-sätteri-plugins-and-features)
