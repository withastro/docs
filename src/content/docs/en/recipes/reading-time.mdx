...
Create a [remark plugin](https://github.com/remarkjs/remark) which adds a reading time property which can be accessed from your files's frontmatter and displayed on the page.
