...
2. Set up `src/pages/index.astro` to redirect to your default language.
    ...
    This approach uses a [meta refresh](https://en.wikipedia.org/wiki/Meta_refresh), which will work no matter how you deploy your site.
    
    If you are using an SSR adapter, you can use [`Astro.redirect`](/en/guides/server-side-rendering/#astroredirect) instead:
