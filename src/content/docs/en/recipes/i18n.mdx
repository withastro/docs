...
In v4.0, Astro received [built-in support for internationalization (i18n) routing](/en/guides/internationalization/). However, if you prefer, you can build your own i18n solution. 
