...
<Tabs syncKey="markdown-processor">
  <TabItem label="Sätteri">
    ...
    2. Create a [Sätteri `hast` plugin](https://satteri.bruits.org/docs/plugins/#hast-plugins).

        Create a new file in your project, for example `src/hast/hast-external-links.ts`, and add the following code:
