...
You can use [Tailwind](https://tailwindcss.com)'s Typography plugin to style rendered Markdown from sources such as Astro's [**content collections**](https://docs.astro.build/en/guides/content-collections/).
...
An Astro project that:  
	...
	- is [initialized with Tailwind](https://docs.astro.build/en/guides/integrations-guide/tailwind/),  
