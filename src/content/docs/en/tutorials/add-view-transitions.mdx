...
In the [Build a Blog introductory tutorial](/en/tutorial/0-introduction/), you learned about Astro's [built-in file-based routing](/en/basics/routing/#static-routes): any `.astro`, `.md`, or `.mdx` file anywhere within the `src/pages/` folder automatically became a new page on your site.
