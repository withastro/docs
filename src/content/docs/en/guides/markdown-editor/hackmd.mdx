...
After importing a file from your Astro repository into a HackMD note, the note will remain "linked" with that file and you can use it again for further editing.
...
5. To confirm that your blog post published successfully, visit your site or check your deploy host's logs.
   ...
   If there were any errors that can be fixed by updating the YAML/Markdown content, you can make changes to the HackMD note and `Push` changes back to GitHub. Otherwise, you may need to use a code editor to update your site.
