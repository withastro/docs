...
- (optional) HackMD Hub configured on your GitHub account or organization to allow additional GitHub contributors.
...
You can update an existing HackMD note that has been linked to a file in your Astro repo, then push your changes back to your project. This is a convenient way for you or your collaborators to maintain and update the content of files that change regularly.
...
4. Follow the instructions to [publish this note as a new file in your Astro repository (starting at Step 2)](#adding-new-markdown-files-to-your-astro-repo-from-hackmd).
