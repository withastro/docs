...
## Using Dillinger as a CMS

You can use Dillinger as a minimal Content Management System (CMS) to edit and update existing content files (`.md` and `mdx`) in your Astro project. You can make content-only changes to your site without the need for any software installed nor a running server.
