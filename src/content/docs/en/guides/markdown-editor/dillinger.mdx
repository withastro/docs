...
It is not possible to create a new file in your repository from Dillinger. You can only [import and edit an existing file](#creating-a-new-dillinger-note-from-an-existing-file-in-your-repository).
