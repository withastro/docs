...
description: Update and manage your Markdown content using Dillinger
sidebar:
  label: Dillinger
type: markdown
service: Dillinger
...
[Dillinger](https://dillinger.io/) is an open-source, online, in-browser Markdown editor that can link with your GitHub account to edit, push, and pull `.md` and `.mdx` files from a GitHub-hosted repository.
...
### Editing an existing file from your Astro repository in Dillinger
...
After importing a file from your Astro repository into a Dillinger note, the note will remain "linked" with that file and you can use it again from your dashboard for further editing.
...
Otherwise, you may wish to import the latest version of the file from GitHub every time you want to make a change to a document, then delete your local Dillinger note when you have published your changes.

### Adding new Markdown files to your Astro repo from Dillinger

It is not possible to create a new file in your repository from Dillinger. You can only [import and edit an existing file](#editing-an-existing-file-from-your-astro-repository-in-dillinger).
