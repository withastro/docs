...
Composing in Markdown does not require knowledge of HTML, nor any other programming language, and can provide a convenient shorthand for writing formatted text content. Storing your content in local Markdown files allows content collaborators on your Astro project of all technical abilities.
