---
title: Holocron & Astro
description: Add content to your Astro project using Holocron as a CMS
sidebar:
  label: Holocron
type: markdown
service: Holocron
...
[Holocron](https://holocron.so/) is an open-source, online, in-browser Markdown editor that can link with your GitHub account to edit, push, and pull `.md` and `.mdx` files from a GitHub-hosted repository.
