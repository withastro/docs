...
Populate the `posts` table with some initial content by **[DOING THIS THING, IDEALLY LINKING TO TURSO DOCS]**.  This is required so you can write queries and have data to fetch.
...
The `execute()` method can take [an object to pass variables to the SQL statement](https://docs.turso.tech/libsql/client-access/javascript-typescript-sdk#positional-placeholders), such as `slug`, `id`, or pagination.
