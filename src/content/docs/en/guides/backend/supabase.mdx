...
### Initialize Supabase
Run `supabase init` in the root of the project, it should include this folder:
...
The Project structure should include this file:
<FileTree title="Project Structure">
- ...
- supabase/
- .env
...
```ts title="src/pages/api/signout.ts"
