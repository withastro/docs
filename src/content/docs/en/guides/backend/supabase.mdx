...
Create these endpoints in the `src/pages/api/auth` directory of your project. Make sure to specify `export const prerender = false` to render the endpoints on demand. Your project should now include these new files:
