...
- An Astro project with `output: 'server'` configured for [on-demand rendering](/en/core-concepts/rendering-modes/#on-demand-rendered).
...
- [Astro and Firebase app example](https://github.com/kevinzunigacuellar/astro-firebase)
