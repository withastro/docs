...
:::caution
Cookie must be called '__session'. Firebase functions [will remove all cookies except for that one](https://firebase.google.com/docs/hosting/manage-cache#using_cookies).
:::
