...
2. Using [Server-Side Rendering](/en/guides/server-side-rendering/) and fetching every time your page is rendered.
...
npx degit xataio/examples/apps/starter-astro my-awesome-app
  ...
  <Fragment slot="pnpm">
  ```shell
pnpm dlx degit xataio/examples/apps/starter-astro my-awesome-app

  ```
  </Fragment>
  <Fragment slot="yarn">
  ```shell
  yarn dlx degit xataio/examples/apps/starter-astro my-awesome-app
  ```
  </Fragment>
</PackageManagerTabs>
