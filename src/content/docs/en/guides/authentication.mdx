...
Clerk is a complete suite of embeddable UIs, flexible APIs, and admin dashboards to authenticate and manage your users. An [official SDK](https://clerk.com/docs/references/astro/overview) for Astro is available.
...
Follow the ["Quick Start"](https://clerk.com/docs/quickstarts/astro) guide to set up Clerk integration and middleware in your Astro project.

### Usage

Protecting your pages in the client
...
Protecting your routes in the server
...
export default clerkMiddleware((auth, context, next) => {
...
- [Quickstart project](https://github.com/clerk/clerk-astro-quickstart)
