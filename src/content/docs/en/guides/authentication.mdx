...
<ReadMore>Follow the [Scalekit & Astro guide](/en/guides/backend/scalekit/) to add authentication to your Astro SSR project using social login, enterprise SSO, and more.</ReadMore>
