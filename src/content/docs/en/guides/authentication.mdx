...
Use a trusted authentication library (e.g. [Lucia Auth](https://lucia-auth.com/), [Auth.js](https://authjs.dev/)) to protect sensitive information in your Astro site. Authentication libraries provide utilities for multiple authentication methods such as email sign-in and OAuth providers.
