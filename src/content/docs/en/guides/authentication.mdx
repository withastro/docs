...
For detailed setup instructions, check out the [Installtion Guide](https://www.better-auth.com/docs/installation).

### Configuration

Once you have installed and configured Better Auth in your project, you'll need to mount Better Auth handler in your Astro project.
...
Follow [Better Auth Astro Guide](https://www.better-auth.com/docs/integrations/astro) to learn more.

### Usage

Better Auth offers clients for various frameworks, including Vanilla JS, React, Vue, Svelte, and Solid. To create a client for your chosen framework:
...
Once your client is set up, you can use it to authenticate users in your Astro components or any framework-specific files.
...
You can then use the `auth` object to get the user's session in your server-side code.
...
And you can use the `auth` object to protect your routes as well.
