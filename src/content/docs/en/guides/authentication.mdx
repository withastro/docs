...
Clerk is a complete suite of embeddable UIs, flexible APIs, and admin dashboards to authenticate and manage your users. An official adapter [`@clerk/astro`](https://clerk.com/docs/references/astro/overview) is available.
