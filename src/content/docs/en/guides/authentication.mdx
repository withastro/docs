...
:::tip
Follow one of Lucia's complete Astro tutorials to add [username and password authentication](https://lucia-auth.com/tutorials/username-and-password/astro) or [GitHub OAuth](https://lucia-auth.com/tutorials/github-oauth/) to your Astro project.
:::
...
<PackageManagerTabs>
  ...
  <Fragment slot="pnpm">
  ```shell
  pnpm add auth-astro @auth/core cookie
  ```
  </Fragment>
  <Fragment slot="yarn">
  ```shell
  yarn add auth-astro @auth/core
  ```
  </Fragment>
</PackageManagerTabs>
