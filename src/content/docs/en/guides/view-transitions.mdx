...
- [How can I remove flickering in transitions?](#astrobefore-swap)
- [Why is my JavaScript not working on page change?](#script-behavior-with-view-transitions)
- [How can I keep a video playing when I navigate to another page](#maintaining-state)

### Community question and answers

Find people asking and answering questions about view transitions in Astro:

- [Search for questions about view transitions on Stack Overflow](https://stackoverflow.com/search?q=%5Bastrojs%5D+view+transitions).
- [Search for questions about view transitions on Reddit](https://www.reddit.com/r/astrojs/search/?q=view+transitions).
- [Visit our Discord `#support` channel](https://astro.build/chat) tagged with `view transitions`.