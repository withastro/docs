...
Therefore, it is now possible to override the default scroll restore for history navigation if desired. The following example resets the horizontal and vertical scroll position to the top left corner of the page for each navigation. 
