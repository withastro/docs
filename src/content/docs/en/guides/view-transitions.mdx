...
1. A visitor to your site triggers navigation by any of the following actions:
    - Clicking an `<a>` tag linking internally to another page in your site.
...
The event `astro:load` has been renamed to `astro:page-load`. Rename all occurances in your project.
...
The event `astro:beforeload` has been renamed to `astro:after-swap`. Rename all occurances in your project.
