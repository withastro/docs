...
Switching to client-side routing and animating the pages both come with accessibility challenges, and Astro aims to make sites opt-ing into View Transitions as accesible-by-default as possible.
