...
:::note
This example requires the [Netlify server adapter](/en/guides/integrations-guide/netlify/) to run. Feel free to adapt this example to your storage platform of choice.
:::
