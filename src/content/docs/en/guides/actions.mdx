...
If you want to understand more about how this library works, you can check it out [here](https://github.com/Rich-Harris/devalue).  

For details about the `handler()` property mentioned, take a look [here](/en/reference/modules/astro-actions/#handler-property).
</Aside>
