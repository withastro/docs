...
- [How can I fetch data from an API inside a React component?](#fetch-in-framework-components)
- [Can I write GraphQL queries in Astro?](#graphql-queries)
- [How do I use data fetched from an API in my component?](#fetch-in-astro)

### Community question and answers

Find people asking and answering questions about CSS and styling in Astro:

- [Search for questions about view transitions on Stack Overflow](https://stackoverflow.com/search?q=%5Bastrojs%5D+fetch).
- [Search for questions about view transitions on Reddit](https://www.reddit.com/r/astrojs/search/?q=fetch).
