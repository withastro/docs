...
<CommunityLinks
  query="fetch"
  stackOverflow="Search for questions about data fetching on Stack Overflow"
  reddit="Search for questions about data fetching on Reddit"
  discord="Visit our Discord `#support` channel"
/>
