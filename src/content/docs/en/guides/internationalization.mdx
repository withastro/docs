...
Even with your default locale routes prefixed, it is possible to opt-out of that behaviour for only your site's index page. This is useful when you want to have a home page that exists outside of your configured locale structure.
