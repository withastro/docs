...
By default, this allows you to have a site home page that exists outside of your configured locale folder structure.

[Setting `prefixDefaultLocale: true`](/en/reference/configuration-reference/#i18nroutingredirecttodefaultlocale) will also automatically set `redirectToDefaultLocale: true` in your `routing` config object. The required `src/pages/index.astro` file will automatically redirect to the index page of your default locale.
