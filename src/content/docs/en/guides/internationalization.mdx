...
If `prefixDefaultLocale: true` (see [routing options](#routing-options) below), your default language content would also reside in a locale-specific folder (e.g., `src/pages/en/about.astro`).
