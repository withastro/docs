...
- [How can I prevent my home page from redirecting to my default language?](#redirecttodefaultlocale)
- [How do I create one path to support regional variations of a language?](#custom-locale-paths)
- [Can I access the language browser settings of my visitors?](#browser-language-detection)
