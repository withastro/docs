...
- (PLT-2169) astro:env stable - This needs more docs
...
These features are all available by default in Astro v5.0. Only `astro:env` [requires some configuration](/en/guides/environment-variables/#astroenv) to be used.
