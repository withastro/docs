...
Astro 5.0 now renders the result of an action as a POST result without any forwarding. This introduces the "confirm form resubmission?" dialog when a user attempts to refresh the page, and will not persist action results across sessions.
