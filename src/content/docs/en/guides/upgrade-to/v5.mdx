...
<SourcePR>[Source](https://github.com/withastro/astro/pull/11715)</SourcePR>
...
<SourcePR>[Source](https://github.com/withastro/astro/pull/11660)</SourcePR>
...
<SourcePR>[Source](https://github.com/withastro/astro/pull/11661)</SourcePR>
...
<SourcePR>[Source](https://github.com/withastro/astro/pull/11788)</SourcePR>
...
<SourcePR>[Source](https://github.com/withastro/astro/pull/11782)</SourcePR>
...
<SourcePR>[Source](https://github.com/withastro/astro/pull/11770)</SourcePR>
...
<SourcePR>[Source](https://github.com/withastro/astro/pull/11741)</SourcePR>
...
<SourcePR>[Source](https://github.com/withastro/astro/pull/11253)</SourcePR>
...
<SourcePR>[Source](https://github.com/withastro/astro/pull/11825)</SourcePR>
...
### Changed: - (PLT-1897) Move `__astroHeadings` and `imagePaths` into `vfile.data.astro`
...
<SourcePR>[Source](https://github.com/withastro/astro/pull/11861)</SourcePR>

### Changed: - (PLT-2338) Expose `RouteData[]` to integrations
...
<SourcePR>[Source](https://github.com/withastro/astro/pull/11864)</SourcePR>

### Changed: - (PLT-989) Rework `supportedAstroFeatures.assets`
...
<SourcePR>[Source](https://github.com/withastro/astro/pull/11806)</SourcePR>

### Changed: Where ts `include` and `exclude` config is set (PLT2479)
...
<SourcePR>[Source](https://github.com/withastro/astro/pull/11859)</SourcePR>
...
<SourcePR>[Source](https://github.com/withastro/astro/pull/11819)</SourcePR>
...
### Removed: `prerender` option in `injectRoute`
