...
We recommend [converting any existing collections to the new Content Layer API](#converting-existing-collections-to-the-content-layer-api) as soon as you are able and making any new collections using the Content Layer API.
...
##### Converting existing collections to the Content Layer API

See the instructions below for converting an existing content collection with Markdown, MDX, Markdoc, or JSON entries.
