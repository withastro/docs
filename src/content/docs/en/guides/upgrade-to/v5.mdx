...
### Changed: Shiki internal rehype plugin highlights code blocks as hast
...
### Changed: Astro-specfic metadata attached in Remark and Rehype plugins
...
### Changed: URLs returned by `paginate()` include `base` when set
