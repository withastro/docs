...
- The [new content collections](/en/guides/content-collections/) using the [Content Layer API](/en/reference/api-reference/#content-collections-astrocontent) and [Content Loader API](/en/reference/content-loader-reference/)
