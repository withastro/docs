...
{/* If you need to refer to the documentation for a v4.x project, you can browse this [(unmaintained) snapshot of the docs from before v5.0 was released](https://v4.docs.astro.build/en/getting-started/). */}
