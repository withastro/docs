...
The following features are no longer experimental in Astro v5.0: actions, rewrites, environment variables, server islands.
...
```js del={5-10} ins={12-14} title="astro.config.mjs"
...
Read more about these exciting features and more in [the v5.0-beta Blog post](https://astro.build/blog/astro-4/). 
