...
### Changed: Merge `static` and `hybrid` (PLT2434 - alpha.6)
...
### Legacy: Content collections using the original API

In Astro 4.x, content collections were defined, queried, and rendered using the original API first introduced in Astro v2.0.
...
<ReadMore>Please see the updated [content collections guide](/en/guides/content-collections/) to see how to use the new collections.</ReadMore>
