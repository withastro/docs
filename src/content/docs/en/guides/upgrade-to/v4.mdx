...
If you need to refer to documentation for a v3.x project, you can browse this (unmaintained) version of the docs from before v4.0 was released.
...
Astro v4.0 returns a 404 status without a base path prefix for public directory assets when the preview server is running, matching the behaviour of the dev server.
