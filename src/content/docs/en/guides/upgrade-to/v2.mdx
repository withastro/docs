...
Use [`Astro.glob()`](/en/reference/api-reference/#astroglob) to fetch Markdown files, or convert to the [Content Collections](/en/guides/content-collections/) feature.
