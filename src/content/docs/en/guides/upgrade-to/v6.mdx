...
In Astro 6, Shiki code blocks styles are now emitted as CSS classes. These classes are hashed based on the content of style. 
...
If you relayed on in line styles, you'll have to change your strategy.
