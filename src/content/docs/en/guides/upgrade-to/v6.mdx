...
If you are using Vitest with [Astro's `getViteConfig()` helper](/en/guides/testing/#vitest), Astro v6.0 requires Vitest [v3.2.0](https://github.com/vitest-dev/vitest/releases/tag/v3.2.0) or higher.
...
<ReadMore>See the [Cloudflare adapter upgrade instructions](/en/guides/integrations-guide/cloudflare/#upgrading-to-astro-6) for detailed migration guidance.</ReadMore>
...
- [Cloudflare adapter upgrade instructions](/en/guides/integrations-guide/cloudflare/#upgrading-to-astro-6)
