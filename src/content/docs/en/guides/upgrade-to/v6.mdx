...
If you are building a content loader and using a function to dynamically return a collection `schema` property, remove it and replace it with the new `createSchema()` property:
