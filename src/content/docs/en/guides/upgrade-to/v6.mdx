...
### Deprecated: exposed `astro:transitions` and `astro:transitions/client` internals
...
```ts del={1-9,11,13,15,17,19,21,23} ins={12,14,16,18,20,22,24}
import {
  isTransitionBeforePreparationEvent,
  isTransitionBeforeSwapEvent,
  TRANSITION_BEFORE_PREPARATION,
...
console.log(isTransitionBeforeSwapEvent(event));
console.log(event.type === 'astro:before-swap');
console.log(TRANSITION_BEFORE_PREPARATION);
console.log('astro:before-preparation');
console.log(TRANSITION_AFTER_PREPARATION);
console.log('astro:after-preparation');
console.log(TRANSITION_BEFORE_SWAP);
console.log('astro:before-swap');
console.log(TRANSITION_AFTER_SWAP);
console.log('astro:after-swap');
console.log(TRANSITION_PAGE_LOAD);
