...
In Astro 5.5.6, `rewrite()` on Actions context was deprecated as it was not meant to be exposed here.

Astro 6.0 removes this property entirely on Actions context.
