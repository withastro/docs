...
If you were accessing the `hrefRoot` property, you will need to remove it as is no longer available on the manifest.

Update any use of `serverIslandMappings` and `sessionDriver`, they are now async methods:
