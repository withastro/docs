...
<ReadMore> See [the Astro v5 upgrade guide](/en/guides/upgrade-to/v5/#legacy-v20-content-collections-api) for previous guidance about maintaining backwards compatibility of legacy collections in Astro v5.</ReadMore>
