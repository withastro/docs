...
<ReadMore>When working with MDX entries, you can also [pass your own components to `<Content />`](/en/guides/integrations-guide/mdx/) to replace HTML elements with custom alternatives.</ReadMore>
