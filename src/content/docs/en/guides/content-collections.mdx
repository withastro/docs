...
<ReadMore>When working with MDX entries, you can also [pass your own components to `<Content />`](/en/guides/integrations-guide/mdx/#custom-components-with-imported-mdx) to replace HTML elements with custom alternatives.</ReadMore>
