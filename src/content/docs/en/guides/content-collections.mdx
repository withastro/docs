...
- [Why am I not getting full TyepScript support like autocompletion for my content collections?](#setting-up-typescript)
- [How do I make draft posts?](#filtering-collection-queries)
- [How do I use frontmatter values from my collection items in my HTML?](#rendering-content-to-html)

### Community question and answers

Find people asking and answering questions about content collections in Astro:

- [Search for questions about content collections on Stack Overflow](https://stackoverflow.com/search?q=%5Bastrojs%5D+content+collections).
- [Search for questions about content collections on Reddit](https://www.reddit.com/r/astrojs/search/?q=content+collections).
- [Visit our Discord `#support` channel](https://astro.build/chat).