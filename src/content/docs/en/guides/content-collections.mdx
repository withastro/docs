...
If you are building a static website (Astro's default behavior), use the [`getStaticPaths()`](/en/reference/modules/astro-content/#getstaticpaths) function to create multiple pages from a single page component (e.g. `src/pages/[slug]`) during your build.
