...
```astro /CollectionEntry(?:<.+>)?/ title="src/components/BlogCard.astro"
---
...
```astro {5} title="src/pages/render-example.astro"
---
...
```astro "{ slug: entry.slug }" title="src/pages/posts/[...slug].astro"
---
import { getCollection } from 'astro:content';
