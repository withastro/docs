...
You can find complete documentation for collections using the original API in the Astro 4.x content collections guide. No updates will be made to how these collections are used, and you can rely on that documentation until these collections are no longer supported.
