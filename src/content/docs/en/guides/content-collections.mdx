...
The correct date format you should use in your frontmatter should be `yyyy-mm-dd` (e.g. `2021-07-28`). This is the same format used by the [`Date()`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date) constructor. 
