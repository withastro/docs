...
Once queried, you can render Markdown and MDX entries to HTML using the [`render()`](https://docs.astro.build/en/reference/modules/astro-content/#render) function from `astro:content`. Calling this function gives you access to rendered HTML content, including both a `<Content />` component and a list of all rendered headings.
