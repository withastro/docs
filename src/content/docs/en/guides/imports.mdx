...
- [How can I use a JSON data file?](#json)
- [Why is my NPM package not working?](#npm-packages)
- [How do I import a file from my `public/` folder?](#files-in-public)

### Community question and answers

Find people asking and answering questions about file and asset imports in Astro:

- [Search for questions about imports on Stack Overflow](https://stackoverflow.com/search?q=%5Bastrojs%5D+imports).
- [Search for questions about imports on Reddit](https://www.reddit.com/r/astrojs/search/?q=imports).
