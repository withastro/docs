...
- [How do I share fetched data in a layout with other components?](#storing-data-in-contextlocals)
- [Can I use Astro middleware with static SSG sites?](#overview)
- [How can I customize page content for each user?](#storing-data-in-contextlocals)
