...
Astro exposes a utility function called `defineMiddleware` that you can use to take advantage of type-safety
 ...
 */
export const onRequest = (context, next) => { // `context` and `next` are automatically typed
