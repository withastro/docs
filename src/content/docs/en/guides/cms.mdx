...
Find people asking and answering questions about using a CMS with Astro:

<CommunityLinks
  query="cms"
  stackOverflow="Search for questions about using a CMS with Astro on Stack Overflow"
  reddit="Search for questions about using a CMS with Astro on Reddit"
