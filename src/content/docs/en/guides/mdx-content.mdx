---
title: MDX
description: Learn how to create content using MDX with Astro
i18nReady: true
---
...
You can manage your Markdown and MDX files in Astro with [content collections](/en/guides/content-collections/) to help you organize your content, validate your frontmatter, and provide automatic TypeScript type-safety while working with your content.
...
:::note
If you are using [content collections](/en/guides/content-collections/), please see "Modifying Frontmatter with Remark".
:::
