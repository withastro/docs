...
Find people asking and answering questions about migrating to Astro:

import CommunityLinks from '~/components/CommunityLinks.astro'

<CommunityLinks
  query="migrating"
  stackOverflow="Search for questions about migrating to Astro on Stack Overflow"
  reddit="Search for questions about migrating to Astro on Reddit"
