...
- [UI framework components](/en/basics/framework-components/) directly in Astro. 
...
- Providing client-side interactivity with [client-side `<script>` tags](/en/guides/client-side-scripts/) or [UI framework components](/en/basics/framework-components/).

- Managing [shared state](/en/basics/sharing-state/) with Nano Stores or local storage instead of app-wide hooks or wrappers.
