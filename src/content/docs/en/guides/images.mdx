...
:::caution
The `image()` helper is incompatible with `layout` property, please [importing layouts manually](/en/basics/layouts/#importing-layouts-manually-mdx) if you use `image()` helper.
:::
