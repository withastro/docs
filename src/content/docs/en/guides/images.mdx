...
:::caution[Consider trying Assets (Experimental)]
_Experimental_ asset support was added in `astro@2.1.0`. Consider following the [Assets (Experimental)](/en/guides/assets) guide for a smoother experience with Image assets.
:::
