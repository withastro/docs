...
See details about all properties in the [`astro:assets` reference](/en/reference/modules/astro-assets/#image-properties).
...
See details about all properties in the [`astro:assets` reference](/en/reference/modules/astro-assets/#picture-properties).
