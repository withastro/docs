...
:::note
Any images on SSR'd pages will have to be generated dynamically (even if they're stored in `src/`) since the build may not know about the needed images ahead of time.
