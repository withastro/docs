...
<img src="https://astro.build/assets/press/logomark-light.png" width="25" alt="Astro">
...
<!-- Remote image on another server -->
![Astro](https://astro.build/assets/press/logomark-light.png)
<img src="https://astro.build/assets/press/logomark-light.png" width="25" alt="Astro">
```
...
import localImage from '../assets/logo.png';
const remoteImage = 'https://astro.build/assets/press/full-logo-light.png';
---
...
export const logo = 'https://astro.build/assets/press/full-logo-light.png';
