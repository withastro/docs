...
```astro title="src/component/Avatar.astro" ins="inferSize={true}" del='"height="64" width="64"'
---
import { Image } from 'astro:assets';
---
<Image src="https://avatars.githubusercontent.com/u/622227?s=64," height="64" width="64" inferSize={true} alt="My GitHub Avatar" />
```
