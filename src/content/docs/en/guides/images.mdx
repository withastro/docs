...
Store your images in the `public/` folder if you want to avoid any processing (which for [on-demand pages](/en/guides/on-demand-rendering/) happens on every page view) or to have a direct public link to them.
