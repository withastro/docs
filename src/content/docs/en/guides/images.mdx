...
### Inlining svg in `.astro` files

For tiny svg, inlining them as base64 can speed up loading times.

```astro
---
import svgAsStr from "../image.svg?raw";

const svgBase64 = `data:image/svg+xml;base64,${btoa(svgAsStr)}`;
---

<img src={svgBase64} alt="A sleeping cat." >
```
