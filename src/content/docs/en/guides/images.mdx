...
When this responsive behavior is [configured globally](/en/reference/configuration-reference/#imageresponsivestyles), it will apply to all image components and also to any local and remote images using [the Markdown `![]()` syntax](/en/guides/images/#images-in-markdown-files).
