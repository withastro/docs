...
- [Why aren't my remote images working?](#authorizing-remote-images)
- [Can I use the Image component in React, Vue, Svelte etc?](#images-in-UI-framework-components)
- [How can I import images in Markdown?](#images-in-markdown-files)
- [Do I have to install Sharp as a dependency?](#default-image-service)

### Community question and answers

Find people asking and answering questions about images in Astro:

- [Search for image questions on StackOverflow](https://stackoverflow.com/search?q=%5Bastrojs%5D+image+OR+images).
- [Search for image questons on Reddit](https://www.reddit.com/r/astrojs/search/?q=image+OR+images).
- [Visit our Discord `#support` channel](https://astro.build/chat) for posts tagged with `🖼️ images`.

<CommunityLinks
  query="image OR images"
  stackOverflow="Search for image questions on StackOverflow"
  reddit="Search for image questons on Reddit"
