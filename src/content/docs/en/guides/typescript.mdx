...
Astro includes helpers for working with the types returned in your [getStaticPaths()](/en/reference/api-reference/#getstaticpaths) export for dynamic pages.

To get the type of [params](/en/reference/api-reference/#params) you can do the following:

```astro title="src/pages/posts[...slug].astro" "@components" "@layouts"
---
...
Likewise, to get the [props](/en/reference/api-reference/#astroprops) for the page, use the `InferGetStaticPropsType` type function:
