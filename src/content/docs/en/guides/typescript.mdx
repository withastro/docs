...
If you are not using VSCode, it is also advisable to [install the typescript plugin from npm](https://www.npmjs.com/package/@astrojs/ts-plugin):
...
Once you have done this, add the following to your `tsconfig.json`:
...
The plugin should now be working. To check, create a ts file and import an astro component into it. You should have no warning messages from your editor saying the import cannot be found.
