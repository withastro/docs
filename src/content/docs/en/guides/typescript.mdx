...
:::note
The `jsx` setting specifies what JSX code is generated. You may have to change it depending on the particular framework you are using. For example, SolidJS users may prefer the "preserve" option. For plain Astro projects, "react" works well. Valid values are "preserve", "react", "react-jsx", "react-jsdev" and "react-native".
:::
