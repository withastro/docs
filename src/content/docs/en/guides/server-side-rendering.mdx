...
`Astro.locals` is an object that can be used to access data from your [Astro middleware](/en/guides/middleware/) or your server inside your page. This can be useful for passing per-request data like user sessions.
