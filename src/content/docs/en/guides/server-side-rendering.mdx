...
The `Astro.locals` object is a user-defined object that can be used to access data from your Astro middleware or your server inside your page. This can be useful for passing per-request data like user sessions.

```astro title="src/pages/account.astro" {2}
---
