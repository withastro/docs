...
[`Astro.response`](https://docs.astro.build/en/reference/api-reference/#astroresponse) is a standard [`ResponseInit`](https://developer.mozilla.org/en-US/docs/Web/API/Response/Response#options) object. It can be used to set the response status and headers.

```astro title="src/pages/index.astro" {8-9}
---
...
Setting these values will change the response status and status text for the page.
