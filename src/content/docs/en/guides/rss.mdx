...
RSS autodiscovery, [as explained by the RSS Advisory Board](https://www.rssboard.org/rss-autodiscovery), is "a technique that makes it possible for browsers and other software to automatically find a site's RSS feed."
