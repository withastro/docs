...
Come and chat with us on [Discord](https://astro.build/chat) and explain your issue in the `#support` forum channel, or on [GitHub](https://github.com/withastro/community-support/discussions). We’re always happy to help!
