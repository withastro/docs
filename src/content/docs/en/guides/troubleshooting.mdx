...
We ask you to use [StackBlitz](https://stackblitz.com) because it allows maintainers and people willing to help quickly reproduce your issue without setting up a local environment. Whereas with a complete project or repo, we would have to clone it, install dependencies, and run it locally, which can introduce more issues.

### Minimal code

When your repo is set up in StackBlitz, go through all steps to reproduce your issue. This can include adding packages, changing configuration, etc.
