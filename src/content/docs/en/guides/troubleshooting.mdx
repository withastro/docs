...
Come and chat with us on [Discord](https://astro.build/chat) and explain your issue in the `#support` forum channel. You can also ask your questions directly on [GitHub](https://github.com/withastro/community-support/discussions). We’re always happy to help!
