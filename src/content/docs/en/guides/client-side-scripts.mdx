...
- [Why isn't `onClick` working?](#handle-onclick-and-other-events)
- [How do I use variables in a `<script>` tag?](#pass-frontmatter-variables-to-scripts)
- [How can I refresh or rerender an Astro component when data changes?](#web-components-with-custom-elements)

### Community question and answers

Find people asking and answering questions about client-side interactivity and scripts in Astro:

- [Search for questions about scripts on StackOverflow](https://stackoverflow.com/search?q=%5Bastrojs%5D+script).
- [Search for questions about scripts on Reddit](https://www.reddit.com/r/astrojs/search/?q=script).
