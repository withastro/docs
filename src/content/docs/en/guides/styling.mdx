...
:::note
This is a [Vite-specific setting](https://vitejs.dev/config/ssr-options.html#ssr-noexternal) that does _not_ relate to (or require) [Astro's on-demand server rendering modes](/en/core-concepts/rendering-modes/#on-demand-rendered).
:::
