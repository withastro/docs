...
This pattern lets you style child components directly. If your [`scopedStyleStrategy` option](/en/reference/configuration-reference/#scopedstylestrategy) is set to either `'where'` or `'class'` you can remove the `...rest` props to make it simpler.
