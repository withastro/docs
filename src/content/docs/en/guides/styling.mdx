...
### Style objects can be used inline instead of strings

When styling components in Astro, you may use inline style objects. For example: `<div  style={{ '--cssVariable': 'brown' }} >`

When you run Astro , this will be transformed into the following: `<div style="--css-variable:brown" class="astro-J7PV25F6">`
