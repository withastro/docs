...
You must also pass the `data-astro-cid-*` attribute, unless you have changed `scopedStyleStrategy` to `class` or `where`. You can do this by passing the `...rest` of the props to the component.
