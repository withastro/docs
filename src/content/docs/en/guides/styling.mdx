...
To use Tailwind in your project, install the official [Vite plugin][tailwind]. Or if you're using Astro `>=5.x.x`, use the `astro add tailwind` command for your package manager:
