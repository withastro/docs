...
<Steps>
1. Add Tailwind 4 support to your project as described in the [tailwind](#tailwind) section. This can be done through the CLI for the latest version of Astro, or by adding the Vite plugin manually.
