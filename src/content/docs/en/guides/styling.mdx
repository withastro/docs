...
You can add Tailwind 4 to support to your project with a CLI command, or install `@astrojs/tailwind` manually for [legacy Tailwind 3 support](#legacy-tailwind-3-support).
...
To add (or keep) support for Tailwind 3, you will need to have both `tailwindcss@3` and the official Astro Tailwind integration `@astrojs/tailwind` installed. These dependencies are only used for legacy Tailwind 3 compatibility, and are not required for Tailwind 4. You will also need a legacy Tailwind configuration:
...
1. Install Tailwind and the Astro Tailwind integration to your project dependencies using your preferred package manager:
   ...
   <PackageManagerTabs>
     ...
     <Fragment slot="pnpm">
     ```shell
     pnpm add @astrojs/tailwind@5.1.5
     ```
     </Fragment>
     <Fragment slot="yarn">
     ```shell
     yarn add @astrojs/tailwind@5.1.5
     ```
     </Fragment>
   </PackageManagerTabs>
