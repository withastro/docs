...
<CommunityLinks
  query="style"
  stackOverflow="Search for questions about styling on Stack Overflow"
  reddit="Search for questions about styling on Reddit"
  discord="Visit our Discord <code>#support</code> channel for posts tagged with <code>🎨 css/styling</code>"
/>
