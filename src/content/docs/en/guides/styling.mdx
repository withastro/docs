...
You can add Tailwind 4 to support to your project with a CLI command, or install legacy dependencies manually for [legacy Tailwind 3 support](#legacy-tailwind-3-support).
