...
You'll need a css file (`src/styles/global.css` by default) importing tailwind:

```css title="src/styles/global.css"
@import "tailwindcss";
```

Then import this file in the pages where you want Tailwind to apply, that should likely be in a layout:
