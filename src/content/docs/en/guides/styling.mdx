...
You can add Tailwind to support to your project with a CLI command, or install `@astrojs/tailwind` manually for [legacy Tailwind 3 support](#legacy-tailwind-3-support).
