...
> ⚠️ This integration is deprecated in Astro v3.0 (Fall 2023) in favor of the `astro:assets` module. Please see the [Image documentation](/en/guides/images/) for more information.
