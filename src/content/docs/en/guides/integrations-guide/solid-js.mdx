...
Use a SolidJS component as you would any [UI framework component](/en/core-concepts/framework-components/).
...
For example, you can use Solid's [`createResource`][solid-create-resource] to fetch async remote data on the the server. The remote data will be included in the initial server-rendered HTML from Astro:
