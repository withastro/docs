...
Hydrating SolidJS components are automatically wrapped in Suspense boundaries and rendered on the server using the [`renderToStringAsync`][solid-render-to-string-async] function.
