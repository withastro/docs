...
#       https://github.com/withastro/astro/tree/next/packages/integrations/solid/
#
...
githubURL: 'https://github.com/withastro/astro/tree/next/packages/integrations/solid/'
hasREADME: true
category: renderer
i18nReady: true
---
