...
Depending on your theme, to include MDX content in collection, you may have to adjust the [collection loader](/en/guides/content-collections/#defining-the-collection-loader) to include mdx files :

```js title="src/content/config.ts" ins="{md,mdx}"
