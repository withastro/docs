...
See [passing components to MDX content](/en/guides/content-collections/#passing-components-to-mdx-content) for examples of using the `components` prop with content collections.
