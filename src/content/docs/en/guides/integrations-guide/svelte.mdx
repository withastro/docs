...
#       https://github.com/withastro/astro/tree/next/packages/integrations/svelte/
#
...
githubURL: 'https://github.com/withastro/astro/tree/next/packages/integrations/svelte/'
hasREADME: true
category: renderer
i18nReady: true
---
