...
#       https://github.com/withastro/astro/tree/next/packages/integrations/preact/
#
...
githubURL: 'https://github.com/withastro/astro/tree/next/packages/integrations/preact/'
hasREADME: true
category: renderer
i18nReady: true
---
...
See [CHANGELOG.md](https://github.com/withastro/astro/tree/next/packages/integrations/preact/CHANGELOG.md) for a history of changes to this integration.
