...
**Type:** `BabelOptions`<br />
<Since pkg="@astrojs/preact" v="4.3.0" />
</p>
...
For example, to enable Babel to load `.babelrc` when processing your Preact components, pass the following object to the Preact integration:
