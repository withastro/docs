...
When using the [`astro:env`](/en/guides/environment-variables/#type-safe-environment-variables) secrets or `process.env` at runtime, Astro nor the adapter loads environment variables for you. Here are a few examples of how you can load them:
