...
* `standaloneMiddleware` specify the filename thats going to export the one (or many combined) middleware. These middleware will be added when starting standalone server.
