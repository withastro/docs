...
However, we recommend that you uninstall this integration as soon as you are able. The  [`astro add tailwind` command](#installation) will now set up the Vite plugin for you and will no longer install this integration. Or, you can follow the [Tailwind documentation for manual installation](https://tailwindcss.com/docs/installation/framework-guides/astro).
:::
