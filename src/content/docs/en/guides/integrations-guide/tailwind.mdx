...
#       https://github.com/withastro/astro/tree/next/packages/integrations/tailwind/
#
...
githubURL: 'https://github.com/withastro/astro/tree/next/packages/integrations/tailwind/'
hasREADME: true
category: other
i18nReady: true
---
...
See [CHANGELOG.md](https://github.com/withastro/astro/tree/next/packages/integrations/tailwind/CHANGELOG.md) for a history of changes to this integration.
