...
- If any page on your site uses on-demand rendering, this means that requests that don't go to a static page will be server-side-rendered by a Netlify Function. This includes paths that result in a 404.
