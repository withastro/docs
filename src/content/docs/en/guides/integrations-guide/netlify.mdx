...
You may need to include specific files in your Netlify Functions for on-demand rendering that aren't automatically bundled during deployment.
The `includeFiles` property allows you to explicitly specify additional files that should be bundled with your function.
