...
If you want to use the automatic `_routes.json` generation, but want to include additional routes, you can use the `routes.extend.include` option to add additional routes to the `include` array. The routes are not automatically deduplicated and will be appended to the existing routes as is.
...
If you want to use the automatic `_routes.json` generation, but want to exclude additional routes, you can use the `routes.exclude` option to add additional routes to the `exclude` array. The routes are not automatically deduplicated and will be appended to the existing routes as is.
...
All supported bindings are updated on the Cloudflare docs. You can find the list of supported bindings [here](https://developers.cloudflare.com/workers/wrangler/api/#supported-bindings).
