...
This adapter allows Astro to deploy your [on-demand rendered routes](/en/basics/rendering/#on-demand-rendered-routes) to [Cloudflare](https://www.cloudflare.com/).

If you're using Astro as a [static site builder](/en/basics/rendering/#prerendered-pages), you don't need an adapter.
...
Then, add the adapter and your desired [on-demand rendering mode](/en/basics/rendering/#on-demand-rendered-routes) to your `astro.config.mjs` file:
