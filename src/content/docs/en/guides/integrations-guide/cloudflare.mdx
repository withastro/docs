...
:::danger
DESCRIBE THIS e.g. This configuration allows you to cutomize `_routes.json` by specifying routes to `include` or `exclude`.
:::
...
:::danger
MAKE THIS ACCURATE, BUT WE DO NEED AN EXAMPLE OF CONFIGURING HERE 
:::
