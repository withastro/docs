...
#       https://github.com/withastro/astro/tree/next/packages/integrations/cloudflare/
#
...
githubURL: 'https://github.com/withastro/astro/tree/next/packages/integrations/cloudflare/'
hasREADME: true
category: adapter
i18nReady: true
---
