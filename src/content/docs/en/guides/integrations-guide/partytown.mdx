...
#       https://github.com/withastro/astro/tree/next/packages/integrations/partytown/
#
...
githubURL: 'https://github.com/withastro/astro/tree/next/packages/integrations/partytown/'
hasREADME: true
category: other
i18nReady: true
---
...
See [CHANGELOG.md](https://github.com/withastro/astro/tree/next/packages/integrations/partytown/CHANGELOG.md) for a history of changes to this integration.
