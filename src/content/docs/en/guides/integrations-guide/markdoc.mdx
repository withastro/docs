...
#       https://github.com/withastro/astro/tree/next/packages/integrations/markdoc/
#
...
githubURL: 'https://github.com/withastro/astro/tree/next/packages/integrations/markdoc/'
hasREADME: true
category: other
i18nReady: true
---
