...
<Meta availableFor="Serverless, Static" pkg="@astrojs/vercel" version="3.8.0">
...
<Meta availableFor="Serverless, Static" pkg="@astrojs/vercel" version="3.3.0">
`VercelImageConfig`
</Meta>
...
<Meta availableFor="Serverless, Static" default="`sharp`" pkg="@astrojs/vercel" version="3.8.0">
...
<Meta availableFor="Serverless" default="`false`" pkg="@astrojs/vercel" version="7.2.0">
`boolean | VercelISRConfig`
</Meta>
...
<Meta availableFor="Serverless">`string[]`</Meta>
...
<Meta availableFor="Serverless">`number`</Meta>
...
<Meta availableFor="Serverless" pkg="@astrojs/vercel" version="7.6.0">
`boolean`
</Meta>
