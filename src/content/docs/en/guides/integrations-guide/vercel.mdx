...
Use this property to enable [Vercel Skew protection](https://vercel.com/docs/deployments/skew-protection). Reminder that Skew protection is only available for Pro and Enterprise accounts.
