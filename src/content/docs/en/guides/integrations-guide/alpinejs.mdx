...
#       https://github.com/withastro/astro/tree/next/packages/integrations/alpinejs/
#
...
githubURL: 'https://github.com/withastro/astro/tree/next/packages/integrations/alpinejs/'
hasREADME: true
category: renderer
i18nReady: true
---
...
See [CHANGELOG.md](https://github.com/withastro/astro/tree/next/packages/integrations/alpinejs/CHANGELOG.md) for a history of changes to this integration.
