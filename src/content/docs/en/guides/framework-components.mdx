...
You can import and render components from multiple frameworks in the same Astro component. [Additional configuration](https://docs.astro.build/en/guides/integrations-guide/react/#combining-multiple-jsx-frameworks) is required when mixing JSX frameworks.
