...
- [How can I pass an Astro component to React?](#can-i-use-astro-components-inside-my-framework-components)
- [Can I use the Image component in React, Vue, Svelte etc?](#images-in-UI-framework-components)
- [How do I make my framework island component interactive?](#hydrating-interactive-components)

### Community question and answers

Find people asking and answering questions about UI framework components in Astro:

- [Search for questions about UI frameworks on Stack Overflow](https://stackoverflow.com/search?q=%5Bastrojs%5D+ui+framework) (e.g. [React](https://stackoverflow.com/search?q=%5Bastrojs%5D+react), [Vue](https://stackoverflow.com/search?q=%5Bastrojs%5D+vue), [Svelte](https://stackoverflow.com/search?q=%5Bastrojs%5D+svelte)).
- [Search for questions about UI frameworks on Reddit](https://www.reddit.com/r/astrojs/search/?q=ui+frameworks+OR+islands).
- [Visit our Discord `#support` channel](https://astro.build/chat) for posts tagged with the framework of your choice.