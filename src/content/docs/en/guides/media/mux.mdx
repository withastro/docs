...
In Astro, you can use the full-featured [Mux Player](https://www.mux.com/docs/guides/mux-player-web) as a native Astro comonent for optimized, responsive video playback. Mux Player has built-in support for Mux's data analytics, and will automatically show visitor engagement and video quality metrics in your dashboard once your video has views on your deployed site.
...
You will need the `playbackId` for your video asset which can be found in your Mux dashboard or [retrieved from its `ASSET_ID`](#fetching-asset-data).
...
The [Mux Node SDK](https://github.com/muxinc/mux-node-sdk) provides helper functions to interact with your Mux assets and data.
...
From your video's fetch data from your video's `ASSET_ID`.
