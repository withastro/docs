...
The [Cloudinary Astro SDK](https://astro.cloudinary.dev/) supports native Astro components, including image, video, and upload components, as well as a content loader that can be used with Astro content collections.
