...
sidebar:
  label: Build with AI
i18nReady: true
description: Learn how to enhance AI tools with up-to-date Astro knowledge, and get best practices for building Astro sites with AI assistance.
---
...
Astro provides several resources to help AI tools access the latest documentations:
