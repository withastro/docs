...
To learn more about this AI tool and availability, check out [About GitHub Copilot coding agent](https://docs.github.com/en/copilot/concepts/agents/coding-agent/about-coding-agent).
You can configure the MCP server at `https://github.com/<org>/<repo>/settings/copilot/coding_agent`:
```json title="MCP Configuration"
{
  "mcpServers": {
    "astro-docs": {
