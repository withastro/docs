...
To learn more about this feature and availability, check out [About GitHub Copilot coding agent](https://docs.github.com/en/copilot/concepts/agents/coding-agent/about-coding-agent).

MCP Configuration (located at `https://github.com/<org>/<repo>/settings/copilot/coding_agent`):
```json
{
  "mcpServers": {
    "astro-docs": {
