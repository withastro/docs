...
* **A Builder API key** - This public key will be used when fetching your content from Builder. Builder's guide on how to find it is [here](https://www.builder.io/c/docs/using-your-api-key#finding-your-public-api-key). 
...
* **A basic understanding of Builder or another CMS system** - [section models](https://www.builder.io/c/docs/models-sections), [custom data fields](https://www.builder.io/c/docs/custom-fields) and especially the [the preview URL](https://www.builder.io/c/docs/html-api#previewing-content-on-your-site).
...
Before you can create new content in Builder, make sure [the preview URL for your model is working](#setting-up-the-preview-url). 
:::

:::note[For the visual types]
You can find a short video illustrating this process in [one of Builder's official tutorials](https://www.builder.io/blog/creating-blog#create-a-blog-article).
:::

1. Open the visual editor for a content entry of our 'blogpost' model. If you followed [the previous step](#testing-the-preview-url-set-up), you can use that entry. Otherwise create a new one: Go to the **Content** tab in your Builder space and click on **+ New**. 
...
:::note
Not disabling the payload can cause the automated build process to break as your site grows and Builder sends more and more data to your hosting provider. With the payload disabled, Builder always sends a simple POST request.
::::
