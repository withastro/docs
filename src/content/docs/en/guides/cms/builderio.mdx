...
[] go through stars * notes, mb make TODOs out of them
* settle on tone; structure of steps; tutorial project structure (remove Baselayout?) --- look at other docs 
[] unify tone --- AI, other astro stuff
[] fix typos -- AI
[] go through code -- AI - import scripts.js in <Baselayout> 
