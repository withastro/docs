...
#### Creating content to test it 
1. In your Builder space under the **Content** tab, click on **New** to create a new content entry and if a list pops up choose the "blogpost" model you just created.
