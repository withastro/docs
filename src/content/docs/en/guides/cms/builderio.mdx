...
[x] read WRITING.md
[] look at other astro stuff for ideas about tone and structure --- contently, storyblok, ghost
...
* from ghost CMS: think about mb taking a step-by-step approach to the [slug] section 
