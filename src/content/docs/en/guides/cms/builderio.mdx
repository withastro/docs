...
Then the following `getStaticPaths()` function to fetch information from Builder and create a static route for each blog post, based on the `slug` data field:
