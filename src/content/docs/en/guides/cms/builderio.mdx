...
- A fetch call to the Builder API using the `slug` to return individual post content and metadata (e.g. `title`).
- A `<Fragment />` in the template to render your content as HTML.
