...
In this section, you'll use [Builder's REST APIs](xxx) to connect your Builder space to Astro with zero client-side JavaScript.
...
2. **A Builder account and space** - If you don't have an account yet, [sign up for free](https://www.builder.io/) and create a new space.

3. **A Builder API key** - This key will be used when fetching your content from Builder. [Here's](https://www.builder.io/c/docs/using-your-api-key) Builder's guide how to find it. 

4. ??? **A basic understanding of Builder** - specifically [section models](xxx), [custom data fields]() and [the preview URL]().
