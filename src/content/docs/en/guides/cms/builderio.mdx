...
In the Builder app create the model that will represent a blogpost: go to the **Models** tab and click the **+ Create Model** button to create a model of the "section" type. 
...
:::caution
In this guide these fields are required, and later code will break if these fields don't exist or are empty.
:::
