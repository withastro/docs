...
The fetch call is very similar to the one in the previous step(#displaying-a-list-of-blog-posts). Here, the `getStaticPaths` function creates a static route for each blog post, based on the `slug` data field.
