...
3. In the panel on the right under the **options** tab, you should see the data fields `title` and `slug`. These are the fields you've created when you [set up your model](#creating-a-model-for-a-blogpost). Fill them in with the following values:
...
[x] awkward: some repetition between #### testing it and the next step ### creating a blog post. idea: remove testing it and put create a blog post in its place
