...
:::tip[Official ressource 👍]
Find Builder's quickstart guide [here](https://www.builder.io/c/docs/quickstart#step-1-add-builder-as-a-dependency) (in the list of frameworks pick 'REST API' on the far right). 
...
* **A basic knowledge of how Astro works** - Including [`.astro` files](https://docs.astro.build/en/core-concepts/astro-pages/#astro-pages) and[dynamic routes](https://docs.astro.build/en/core-concepts/routing/#dynamic-routes).
...
* **The concept of a REST APIs** - [Here](https://www.freecodecamp.org/news/what-is-rest-rest-api-definition-for-beginners/) is a beginner-friendly introduction. Basically, we send queries, they send back data.
...
- Find Builder's quickstart guide [here](https://www.builder.io/c/docs/quickstart#step-1-add-builder-as-a-dependency) - it covers both the use of the REST API as well as through an integration with a JavaScript framework like Qwik, React or Vue. 
