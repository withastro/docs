...
If you are already using [content collections](/en/guides/defining-collections/) in your Astro project, then update the schema above to exactly match the collection(s) defined in your existing schema.
:::
...
Use Astro's Content Collections API to [query and display your posts and collections](/en/guides/working-with-collections/#querying-collections), just as you would in any Astro project.
...
To display content from an individual post, you can import and use the `<Content />` component to [render your content to HTML](/en/guides/working-with-collections/#rendering-body-content):
