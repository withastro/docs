...
This guide assumes you already have **an existing Astro project**. If you don’t, you can follow the instructions in our [Installation guide](/en/install/auto/).
...
Now, you can import that file in our `keystatic/[...params].astro` page, and mount the component on the client side only:
