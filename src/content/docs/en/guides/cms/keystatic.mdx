...
Use Astro's Content Collections API to [query and display your posts and collections](/en/guides/collection-queries/#querying-collections), just as you would in any Astro project.
...
To display content from an individual post, you can import and use the `<Content />` component to [render your content to HTML](/en/guides/collection-queries/#rendering-body-content):
