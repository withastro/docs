...
[Hashnode](https://hashnode.com/) is Hosted CMS that allows you to create a blog or a publication. It is a great choice for developers who want to write and share their content without worrying about the infrastructure. This guide, will go over how to integrate Hashnode with your Astro project.

## Integrating with Astro
In this section, we’ll use the [graphql-request](https://github.com/jasonkuhrt/graphql-request) project to bring your data into your Astro project.
...
2. **A Hashnode site** - Its free to get started and create a Solo site on Hashnode. You can create a site by visiting [Hashnode](https://hashnode.com/).
