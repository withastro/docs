...
If you are using Astro's default static site generation, you will use [dynamic routes](/en/basics/routing/#dynamic-routes) and the `getStaticPaths` function to generate your project pages.
