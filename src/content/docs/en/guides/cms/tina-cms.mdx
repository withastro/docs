...
4. Set up your collections by editing the `schema.collections` property in `.tina/config.ts`.
...
5. In production, TinaCMS can commit changes directly to your GitHub repository. To set up TinaCMS for production, you can choose to use [Tina Cloud](https://app.tina.io/register) or self-host the [Tina Data Layer](https://tina.io/docs/self-hosted/overview/). You can read how to do this in [the Tina Cloud documentation](https://tina.io/docs/tina-cloud/).
