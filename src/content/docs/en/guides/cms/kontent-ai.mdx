...
In this section, you'll use the [`static` (pre-rendered) mode](/en/core-concepts/routing/#static-pre-rendered-mode) with Astro.
...
If you've opted into an on-demand rendering mode, you will use dynamic routes to fetch the page data from Kontent.ai.
