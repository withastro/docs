...
2. **A Drupal site** - If you haven't set up a Drupal site, you can follow the official guidelines [Installing Drupal](https://www.drupal.org/docs/getting-started/installing-drupal). Alternatively you can:
    ...
    - **DDEV**: Set up your application locally using [DDEV](https://ddev.readthedocs.io/) by following the [Drupal CSM Quickstart](https://ddev.readthedocs.io/en/latest/users/quickstart/#drupal)
