...
```astro title="src/pages/index.astro" ins={15-23}
...
When you view the website on your localhost, you'll see something like the image below.
...
Now when you view the page, each article has its own link. Continue with the next step to fetch the article details.
