...
Configure the Prepr endpoint with a new file called prepr.js in a new `lib` folder in the `src`:
...
Now that your app is connected to Prepr, you can fetch some blog articles from Prepr.

First, add a GraphQL query:
