...
The page `src/pages/post/[slug].astro` [dynamically generates a page](/en/core-concepts/routing/#dynamic-routes) for each post in Static Site Generation Mode, for a SSR reference check [Community Resources](#community-resources) entry by Adam.
...
- Adam Matthiesen wrote [a blog post](https://matthiesen.xyz/blog/tutorial-ghost-cms-astro) showing how to deal with SSR changes with Ghost, as well as better layout of the Ghost CONTENT_API.
