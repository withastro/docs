...
<CardGrid>
  ...
  <LinkCard title="`astro-ghostcms`" href="https://github.com/MatthiesenXYZ/astro-ghostcms" />

</CardGrid>

:::note[Have a resource to share?]
If you found (or made!) a helpful video or blog post about using Ghost with Astro, edit this page and add it here!
:::
