...
The page `src/pages/post/[slug].astro` [dynamically generates a page](/en/core-concepts/routing/#dynamic-routes) for each post in Static Generation Mode, for a SSR reference check [Community Resources](#community-resources) entry by Adam.
