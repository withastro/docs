...
This component uses the `<AposArea>` component to display any widgets added to the `main` area and the `authorName` and `publicationDate` content entered into the fields of the same names.
