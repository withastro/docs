...
In order to display individual blog posts create a `BlogShow.astro` file in the Astro project `src/templates` folder with the following code:
...
You can repeat this step and add as many posts as you desire. You will also follow these steps every time you want to add a new post.
