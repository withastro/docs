...
If you've [opted in to an on-demand rendering mode](/en/core-concepts/rendering-modes/#on-demand-rendered), you will use a dynamic route that uses a `slug` parameter to fetch the data from Contentful.
