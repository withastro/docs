...
We'll use an example Blog Post type. Log in to your Flotiq account and create a Content Type Definition with the following configuration:
- **Label**: Blog Post
- **API Name**: blogpost
- **Fields**:
  - **Title**: text, required
...
```
Now, on the homepage at `http://localhost:4321`, you should see a list of blog posts. To enable navigation to individual posts, we still need to generate a dedicated page for each one.
