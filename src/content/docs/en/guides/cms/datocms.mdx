...
If you want to dynamically build your page in DatoCMS and support the rearrangement of blocks, you can create a "Modular Content" block in the homepage. You can find more info on that [here](https://www.datocms.com/docs/content-modelling/modular-content)
