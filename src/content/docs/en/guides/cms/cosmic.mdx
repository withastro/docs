...
To generate an individual page with full content for each blog post, create a [dynamic routing page](/en/basics/routing/#dynamic-routes) at `src/pages/blog/[slug].astro`.
