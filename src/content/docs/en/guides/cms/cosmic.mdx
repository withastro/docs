...
To seamlessly pull content from Cosmic, add the [Cosmic JavaScript SDK](https://www.npmjs.com/package/@cosmicjs/sdk).
...
In our HTML markup, we access the various data from Cosmic, such as the post title, cover image, and the rich text content. By using [set&colon;html](/en/reference/directives-reference/#sethtml), the rich text content from Cosmic is parsed and rendered into HTML elements on our page.
