...
- Use the [`astro-decap-cms`](https://github.com/advanced-astro/astro-decap-cms) Astro integration to add Decap CMS to your project.

- You can get started with the [Astro Blog Starter with Decap CMS](https://github.com/advanced-astro/astro-decap-cms-starter).
