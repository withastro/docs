...
Decap CMS was originally developed by Netlify and has first class support for [Netlify Identity](https://docs.netlify.com/security/secure-access-to-sites/identity/). This allows you to have JSON web token (JWT)-based user authentication for your sites deployed to Netlify. You can use this for gated content, site administration, and more.
