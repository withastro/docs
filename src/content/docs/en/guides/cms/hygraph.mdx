...
In this section, we'll gonna create a [Hygraph](https://hygraph.com/) endpoint GraphQL endpoint to fetch with Astro.

### Prerequisites

To get started, you will need to have the following:

1. **An Astro project** - If you don't have an Astro project yet, check out this [Installation guide](/en/install/auto/).

2. **A Hygraph account and a Hygraph project**. If you don't have an account, you can [sign up](https://app.hygraph.com/signup) for a free account and create a new Hygraph project. You can also use an existing project if you have one. 

3. **Hygraph access permissions** - You can configure public Content API access permissions for requests from any website in **Project Settings > API Access**. If you don't have any permission setted, it's gonna ask you to **initialize some defaults** click on the **Yes, initialize defaults** button. Now you can use the different GraphQL endpoints
...
4. In this guide we are gonna work with the **High Performance Read-only Content API**

### Setting up the endpoint

To add your Hygraph endpoint to Astro, create an `.env` file in the root of your project with the following variable:
