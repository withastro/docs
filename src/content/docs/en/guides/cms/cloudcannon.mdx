...
:::tip
For visual editing and page building with components in MDX files, see [CloudCannon's Bookshop integration](https://cloudcannon.com/blog/how-cloudcannons-live-editing-works-with-astro-and-bookshop/) that allows you to configure live-editable [CloudCannon Snippets](https://cloudcannon.com/documentation/articles/what-is-a-snippet/) in your Markdown context.
:::
