...
By default, session drivers are configured at build time and any [environment variables](https://docs.astro.build/en/guides/environment-variables) used will be inlined into the build. This means you cannot override the configuration at runtime.
