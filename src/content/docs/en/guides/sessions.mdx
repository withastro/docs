...
When you need to override options at runtime using environment variables, define the driver in a separate file and use the module as the [entrypoint for the session driver](/en/reference/session-driver-reference/#entrypoint).
