...
When you need to override options at runtime using environment variables, you can define the driver in a separate file and use the module as [entrypoint for the session driver](/en/reference/session-driver-reference/#entrypoint) in your configuration.
...
You can then reference this file as the driver entrypoint in your Astro configuration:
