...
<RecipeBox icon="puzzle-piece">
  <a href="/en/guides/fonts/">Add custom fonts</a>
</RecipeBox>

<RecipeBox icon="puzzle-piece">
  <a href="/en/guides/recipes/nanostores/">Build an eCommerce cart flyout with nanostores</a>
</RecipeBox>

<RecipeBox icon="puzzle-piece">
  <a href="/en/guides/recipes/captcha/">Verify a Captcha</a>
</RecipeBox>

<RecipeBox icon="puzzle-piece">
  <a href="/en/guides/recipes/add-yaml-support/">Add support for importing YAML</a>
</RecipeBox>
