...
The redirect route have **less** priority than file system route, which means if you configure a `/old-page` redirect to `/new-page`, and you have a `src/pages/old-page.astro` in your file system, Astro will render the physical page and the redirect won't be emitted.
...
- Physical pages take precedence over redirects.
