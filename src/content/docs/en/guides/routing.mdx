...
Astro accepts external URL as a destination. Only URLs that [can be parsed](https://developer.mozilla.org/en-US/docs/Web/API/URL/canParse_static) and start with `http` or `https` are accepted:
