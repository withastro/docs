...
Sometimes there are situations where you want to serve *a different* page **without** the need of redirect. This possible via rewrites. A rewrites allows you to serve different routes, while still using the same Astro component.Since
