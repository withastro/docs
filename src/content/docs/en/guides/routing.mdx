...
- [Why are my internal links to other pages 404?](#link-between-pages)
- [How can I dynamically create routes at multiple depths?](#example-dynamic-pages-at-multiple-levels)
- [How do I redirect pages in Astro?](#redirects)
- [How can I handle if an SSR route doesn't exist?](#modifying-the-slug-example-for-ssr)

### Community question and answers

Find people asking and answering questions about routing in Astro:

- [Search for questions about view transitions on Stack Overflow](https://stackoverflow.com/search?q=%5Bastrojs%5D+routing).
- [Search for questions about view transitions on Reddit](https://www.reddit.com/r/astrojs/search/?q=routing).
- [Visit our Discord `#support` channel](https://astro.build/chat) tagged with `🛤️ routing`.