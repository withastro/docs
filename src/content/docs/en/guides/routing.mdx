...
Some Astro features require exposing routes to be accessible by the clients. Those routes take priority over any user-defined or integration-defined routes.

- `_astro/`: Serves all the static assets to the client. Including CSS documents, bundled client scripts, optimized images and any Vite asset;
...
- `_actions/`: Serves the defined [Actions](/en/guides/actions/).
