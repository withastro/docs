...
Due to [HTML streaming](https://docs.astro.build/en/guides/on-demand-rendering/#html-streaming), redirects must be done at the page level, not inside components.
