...
## TODO: removed Astro Studio

TODO: extrapolate some usefull commands that are not exclusive to Studio and put them here.
the libSQL portion below is usefull, but some commands to do basic stuff are needed.
...
If you deploy your site to a self-managed host such as a [virtual private server](https://en.wikipedia.org/wiki/Virtual_private_server), you can choose to use a database file.
