...
`foreignKeys` is an advanced API for relating multiple table columns. If you only need to reference a single column, the column `references` property is recommended.
