...
To connect to your Studio project database, you can add the `--remote` flag. Use this flag for production deploys to have both readable and writable access to your hosted database. This will allow you to [accept and persist user data](#insert-data-from-a-server-route).
