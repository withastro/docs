...
[Astro DB](https://astro.build/db/) is a fully-managed SQL database designed exclusively for Astro. Develop locally or connect to hosted database manage on our [Astro Studio](https://studio.astro.build) platform.
...
If you prefer to set things up from scratch yourself, skip `astro add` and follow these manual instructions to install Astro DB yourself.
...
1. via the Astro CLI using `astro link`
