...
Astro DB is a complete solution to configuring, developing and querying your data. A local database is created whenever you run `astro dev` to manage your data without the need for Docker or a network connection.
