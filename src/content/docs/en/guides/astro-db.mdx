...
Adding the `--remote` flag will switch to a remote connection with Astro Studio. Use this flag for production deploys to have both readable and writable access to your hosted database. This will allow you to [accept and persist inserted data](#insert-data-from-a-server-route) such as form submissions.
