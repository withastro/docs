...
You can query your database from any [Astro page](/en/basics/astro-pages/#astro-pages) or [endpoint](/en/guides/endpoints/) in your project using the provided `db` Drizzle ORM import from the `astro:db` module. This gives you access to all configured tables and seeded development data to build type-safe SQL queries.
