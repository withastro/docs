...
:::note
Platforms like **Cloudflare and Deno currently don't support server-side database interactions with libSQL**, but this feature is expected to be added in the future.
:::
