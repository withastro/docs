...
Astro DB includes a set of CLI commands to interact with your Studio project database. These commands are called automatically when using a GitHub CI action, and can be called manually using the `astro db` CLI. 
