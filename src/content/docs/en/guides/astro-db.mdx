...
The `AstroDbHooks` type can be used to augment `AstroIntegrationHooks` and add TypeScript auto-complete for the `astro:db:setup` hook.

```ts {3,5-7,14-19} title="my-integration/index.ts"
