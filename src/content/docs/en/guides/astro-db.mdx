...
[Astro DB](https://preview-astro-build-git-db-lp-astrodotbuild.vercel.app/db/) is a fully-managed SQL database designed for the Astro ecosystem: develop locally in Astro and deploy from your Astro Studio dashboard.

With [`@astrojs/db` integration](/en/guides/integrations-guide/db/) installed, you have a powerful, local, type-safe tool to query and model content as a relational database. View, manage and deploy your hosted remote data through your interactive [Astro Studio dashboard](https://stardate.astro.build/auth/login).
