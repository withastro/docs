...
## Create a production database with Astro Studio
...
## Connect to your Studio project database
...
To connect to your Studio project database, you can add the `--remote` flag. Use this flag for production deploys to have both readable and writable access to your hosted database. This will allow you to [accept and persist inserted data](#insert-data-from-a-server-route) such as form submissions.
...
To use a remote connection, you will need an app token to authenticate with Studio. Visit your Studio project dashboard for token creation and setup instructions.
