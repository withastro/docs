...
Add Astro DB to any new or existing Astro project with the [`@astrojs/db` integration](/en/guides/integrations-guide/db/). Astro includes a built-in `astro add` command to automate this setup process for you.
...
Astro DB can [connect to the Astro Studio platform](/en/guides/studio/) to quickly add a hosted database to your project. You can view, manage and deploy new hosted databases all from the Astro Studio web portal.
