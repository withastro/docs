...
The Actions feature provides a more straightforward approach for inserting data into Astro DB. Here's an example of how to perform a database insert using Actions:
