...
With an [Astro Studio account](), you can view, manage and deploy hosted remote [Astro DB data](/en/guides/integrations-guide/db/) through an interactive Astro Studio dashboard.

## Manage hosted production databases with Studio

Astro DB offers [database hosting](https://astro.build/db/) to a globally distributed network with a free Astro Studio account.

The Astro Studio dashboard provides access to all of your Astro DB hosted database projects. From here, you can view, manage and deploy hosted remote data.
