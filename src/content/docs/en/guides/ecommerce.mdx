...
The following is an example of adding a Lemon Squeezy "Buy now" element to an Astro page. Clicking this link will open a checkout an allow the visitor to complete a single purchase.
...
The following is an example of adding a Paddle "Buy Now" element to an Astro page. Clicking this link will open a checkout an allow the visitor to complete a single purchase.
