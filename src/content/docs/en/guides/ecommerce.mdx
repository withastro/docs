...
The following is an example of how a Lemon Squeezy product can be added to an Astro page.
...
The following is an example of how a Paddle product can be added to an Astro page.
...
:::tip
Start from a fully functional [Astro Snipcart community template](https://astro-snipcart.vercel.app/), including an optional design system, ready for you to integrate with your existing Snipcart account.
:::

### Basic Usage

The following is an example of how a Snipcart product can be added to an Astro page. This is not a complete tutorial.
...
This allows you to allows you to perform actions such as:
...
The [`astro-snipcart` community integration](https://github.com/Adammatthiesen/astro-snipcart) can be added to an existing Astro project. This integration provides both a `<HeaderAstro/>` component to include the necessary Snipcart JavaScript and some Astro components (or Vue components) you can add to your `.astro` pages for creating products, controling the cart, and more.
...
3. Make sure your [Snipcart allowed domain](https://docs.snipcart.com/v3/dashboard/store-configuration#5-domains--urls) is configured for your own web domain.
...
5. Add a purchase button using the `<SC.MakeProduct>` component with any desired [Snipcart product attributes](https://docs.snipcart.com/v3/setup/products) in your page template for each product.
...
6. Add a check out button using the `<SC.Cart/>` component:
...
<ReadMore>See a [full tutorial for using Astro-Snipcart (Astro + Vue)](https://matthiesen.xyz/blog/getting-started-with-my-astro-snipcart-addon) by Adam Matthiesen.</ReadMore>
