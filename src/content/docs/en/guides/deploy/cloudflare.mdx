...
2. If your site uses SSR, install the `@astrojs/cloudflare` adapter 
...
2. Create a [Wrangler configuration file](https://developers.cloudflare.com/workers/wrangler/configuration/)
    If your Astro project is purely static, you can use the following configuration:
    ...
    If your Astro project uses SSR, you can use the following configuration:
    ```json title="wrangler.jsonc"
      {
        "name": "my-astro-app",
