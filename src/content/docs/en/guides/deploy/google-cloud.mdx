...
Before you can deploy your Astro site to Cloud Run, you need to create a Dockerfile that will be used to build the container. You can find more [documentation on how to use Docker with Astro in our Docker Recipe](</en/recipes/docker/#creating-a-dockerfile>).
