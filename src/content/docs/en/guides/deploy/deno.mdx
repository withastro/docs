...
Your Astro project can be deployed as a static site, or as a on-demand rendered site.
...
2. Install the project dependencies using your preferred package manager. If you’re using npm or aren’t sure, run this in the terminal:
   
   ```bash
   npm ci
   ```

3. Build your Astro site by invoking the build script with your preferred package manager. If you’re using npm or aren’t sure, run this in the terminal:
