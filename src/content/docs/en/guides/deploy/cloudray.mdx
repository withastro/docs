...
- The [CloudRay Agent](https://cloudray.io/docs/agent) installed and running on your server
...
<Steps>
1. Install the CloudRay Agent to securely register your machine and enable remote automation.

2. Write a reusable Bash script that clones your Astro repo, installs dependencies, builds your site, and configures a web server. Define any repo-specific values using [CloudRay’s variable groups](https://cloudray.io/docs/variable-groups).
