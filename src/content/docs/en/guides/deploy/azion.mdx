...
- [How to Deploy through Azion Console Dashboard](#how-to-deploy-a-static-site-github)
- [How to deploy using the Azion CLI](#how-to-deploy-a-site-using-azion-cli)
...
- [Azion CLI](https://www.azion.com/documentation/products/azion-cli/) installed for faster project setup and deployment.
...
If you are building a project that is using some NPM Package and fails to build with an error message such as `[Error] Could not resolve "XXXX. The package "XXXX" wasn't found on the file system but is built into node.`:
