...
6. **Add-ons**: Unless you're using a database or Keycloak, you shouldn't need any add-ons.
7. Inject **environment variables**:

    - For **Node.js**, no specific environment variable is needed to deploy Astro if you're using **npm**. If you're using **yarn** or **pnpm**, set these environment variables:
