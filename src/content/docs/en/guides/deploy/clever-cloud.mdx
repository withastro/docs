...
[Clever Cloud](https://www.clever.cloud) is a European cloud platform that provides automated, scalable services.
...
6. Skip [connecting **Add-ons** to your Clever application](https://www.clever.cloud/developers/doc/addons/) unless you're using a database or Keycloak.
...
## Official Resources
- [Clever Cloud documentation for deploying a Node.js application](https://www.clever.cloud/developers/doc/applications/nodejs/)
- [Clever Cloud documentation for deploying Astro as a static application](https://www.clever.cloud/developers/guides/astro/)
