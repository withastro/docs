...
- A [Hostinger account](https://www.hostinger.com/) with an active hosting plan.
  ...
  - Server-rendered (Node.js) deployment requires a plan that supports Node.js applications, such as Business Web Hosting or Cloud hosting.
...
## Server-rendered (Node.js) deployment
...
6. Select a Node.js version that satisfies Astro's [minimum requirement](/en/install-and-setup/#prerequisites) (for example, Node.js 22 or later).
