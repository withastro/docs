...
4. Give your website a name, select the branch and specify the build command and publish directory
   ...
   - **publish directory:** `dist`, `dist/client` if you're using SSR. Make sure to include `export const prerender = true;` at the top of pages you want to serve as static.
