...
In order to deploy your project as a server-rendered site, you will need to use [the Amplify adapter](https://github.com/alexnguyennz/astro-aws-amplify) and make some changes to your config.

:::note
The Amplify adapter for Astro is open-source, and is not maintained by Astro or AWS.
:::
