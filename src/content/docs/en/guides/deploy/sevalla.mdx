...
- Your Astro project pushed to a Git repository (e.g. GitHub, GitLab, or Bitbucket).
...
Sevalla's Application Hosting supports full-stack applications. You can deploy Astro projects using server-side rendering (SSR) via the Node.js adapter.

<Steps>
1. Add the [Node.js adapter](/en/guides/integrations-guide/node/) to your Astro project.
...
:::tip
For common Astro errors, check the [Troubleshooting Guide](/en/guides/troubleshooting/).
:::
