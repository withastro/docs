...
2. Add two new lines to your `astro.config.mjs` project configuration file.
    ...
    If you use Middleware to implement authentication, redirects, or similar things, you may need to enable this flag. Otherwise, your Middleware will not run at runtime for pre-rendered pages.
</Steps>
