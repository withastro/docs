...
- [Deploying Astro SSG with Node.js on Zerops with One Click Deploy - Youtube Video](https://youtu.be/-4KTa4VWtBE)
- [Deploying Astro SSR with Node.js on Zerops with One Click Deploy - Youtube Video](https://youtu.be/eR6b_JnDH6g)