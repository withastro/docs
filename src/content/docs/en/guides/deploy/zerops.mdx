...
Zerops continuous deployment on push to branch or a new release connecting your Zerops service with either GitHub or GitLab repository. Open Zerops, navigate to service detail, connect with GitHub / GitLab.
