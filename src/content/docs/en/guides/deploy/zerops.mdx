...
You can either add project and your first Node.js service through the [project add](https://app.zerops.io/dashboard/project-add) wizard in Zerops app, or by importing it using a yaml structure.
...
To setup continuous deployment on push to branch or a new release connecting your Zerops service with either GitHub or GitLab repository. Open Zerops, navigate to service detail, connect with GitHub / GitLab.
