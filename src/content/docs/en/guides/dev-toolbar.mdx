...
The Settings app allows you to tweak different settings for the development toolbar. For example:

- Adjust the placement of the dev toolbar. Available options:
  - Bottom left
