...
- [Why does pinging my API route give me the same output every time?](#server-endpoints-api-routes)
- [Why does my GET function ignore my dynamic paramaters?](#server-endpoints-api-routes)
- [Which HTTP methods are supported for static sites?](#static-file-endpoints)
- [How can I check page headers?](#request-1)
- [How do I use an API endpoint in `hybrid` mode?](#server-endpoints-api-routes)
