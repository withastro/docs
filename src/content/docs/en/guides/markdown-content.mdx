...
**Astro does not include built-in support for remote Markdown outside of [experimental content layer](/en/reference/configuration-reference/#experimentalcontentlayer)!**
