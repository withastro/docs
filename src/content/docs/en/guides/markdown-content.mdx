...
#### CSS Configuration for dual theme

As you can use the new themes prop, it's now necessary to implement two short CSS snippets to make the funcionality of dual themes work. 
