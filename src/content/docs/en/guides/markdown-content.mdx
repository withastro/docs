...
If you want to link to a heading from an anchor link, Astro generates `id`s based on [github-slugger](https://github.com/Flet/github-slugger), you can find more examples in [the github-slugger documentation](https://github.com/Flet/github-slugger?tab=readme-ov-file#usage).
