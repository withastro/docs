...
:::caution
If you are using [content collections to manage Markdown and MDX files](#content-collections), please [import the layout manually](/en/basics/layouts/#importing-layouts-manually-mdx) as there is some incompatibility between the layout frontmatter property and content collections.
:::
