...
You can similarly [render the HTML content of a Markdown collection entry](/en/guides/working-with-collections/#rendering-body-content) by rendering a `<Content />` component.
