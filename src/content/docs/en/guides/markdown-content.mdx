...
- [How can I add dual light and dark Shiki themes?](#shiki-configuration)
- [How do I set a layout for my Markdown pages?](#frontmatter-layout)
- [How display a Markdown file's content as HTML?](#the-content-component)
- [How can i change the color scheme of code blocks generated from Markdown files?](#adding-your-own-theme)

### Community question and answers

Find people asking and answering questions about Markdown content in Astro:

- [Search for questions about content collections on Stack Overflow](https://stackoverflow.com/search?q=%5Bastrojs%5D+markdown).
- [Search for questions about content collections on Reddit](https://www.reddit.com/r/astrojs/search/?q=markdown).
- [Visit our Discord `#support` channel](https://astro.build/chat) for posts tagged with `Markdown/MDX/Markdoc`.