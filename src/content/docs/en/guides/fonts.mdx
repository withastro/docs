...
Font preloading should be done sparingly, as it can block the loading of other important resources or download fonts unnecessary for the current page. Consider preloading only the most essential fonts, necessary for displaying content visible above the fold.
