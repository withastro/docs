...
- Font file buffers from the [`experimental_getFontBuffer()`](/en/reference/modules/astro-assets/#experimental_getfontbuffer) function.
...
```tsx title="src/pages/og.png.ts" {2,14} "fontData[\"--font-roboto\"]"
