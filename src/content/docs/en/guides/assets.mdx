...
We **strongly recommend** storing all local images in the `src/assets/` directory. This location is optional for now, but may become the required location for all asset types in the future.
