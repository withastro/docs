...
```md title="src/pages/posts/post-1.md" "/_astro" ".hash" "../../assets/" del={8,12} ins={4}
# My Markdown Page

<!-- Local images now possible! -->
![A starry night sky.](~/assets/stars.png)

<!-- Public images in Markdown only! -->
![A starry night sky.](/images/stars.png)
<img src="/images/stars.png" alt="A starry night sky.">

<!-- Remote images in Markdown only! -->
![Astro logo](https://docs.astro.build/assets/logo.png)
<img src="https://docs.astro.build/assets/logo.png" alt="Astro logo">
```
