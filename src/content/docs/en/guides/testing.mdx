...
Once the test run is finished, you should see green marks in the output confirming that your test passed:
...
and then run the test again. You should see a red mark in the output confirming that your test failed.
:::
