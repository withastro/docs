...
No-compromise test automation framework with a powerful set of tools to write, run and debug your tests across web, using Google Chrome, Firefox, Safari, and their mobile equivalents, as well as  native mobile applications.

### Installation

You can install NightwatchJS within your Astro project using the package manager of your choice. Follow the CLI steps to choose JavaScript/TypeScript, name your test folder, if you want to do component testing and if you want to test on mobile browsers.
<PackageManagerTabs>
  <Fragment slot="npm">
  ```shell
...
1. To run the tests against a specific browser use the `--environment` or `-e` CLI argument. If you don't have the relevant browser installed, Nightwatch will attempt to get it set up for you using [Selenium Manager](https://www.selenium.dev/blog/2022/introducing-selenium-manager/)
