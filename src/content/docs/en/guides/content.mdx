...
### MDX Authoring
If you add the [Astro MDX integration](/en/guides/integrations-guide/mdx/) to your project, you can also write content using `.mdx` files, can include JavaScript expressions and custom components within your Markdown. This includes both static [Astro components](/en/basics/astro-components/) and interactive [framework components](/en/guides/framework-components/). Add UI elements such as a banner or an interactive carousel right in your text to turn your content into full-fledged web pages.

Write and edit `.mdx` files directly in your code editor, alongside your project files. MDX files are a [supported page file type](/en/basics/astro-pages/#supported-page-files) in Astro, and may also be used as [content collection entries](#managing-content-pages).
...
You can also [fetch markdown remotely](https://docs.astro.build/en/guides/markdown-content/#fetching-remote-markdown) from a source outside of your project. This will require your own Markdown parser, or a community integration (e.g. [`astro-remote`](https://github.com/natemoo-re/astro-remote)).
