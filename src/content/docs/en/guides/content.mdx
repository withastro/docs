...
Astro's own [content collections](/en/guides/content-collections/) provide a powerful, type-safe way to work with Markdown, MDX, or Markdoc content. 
...
To build common features to organize and display your content, such as a blog archive or a page for each blog tag, Astro allows you to [fetch filenames and metadata](/en/reference/api-reference/#astroglob) from your Markdown and MDX frontmatter or use [content collection helper utilities](/en/guides/collection-queries/#querying-collections) to query your entries and generate page content and routes.
