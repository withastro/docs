...
- Both Astro and GitBook use some form of [file-based routing](/en/basics/routing/). Using Astro's file structure for your existing content and when adding new pages should feel familiar.
