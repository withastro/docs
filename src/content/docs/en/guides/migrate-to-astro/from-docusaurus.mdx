...
- Both Astro and Docusaurus are modern, JavaScript-based (Jamstack) site builders intended for [content-heavy websites](/en/concepts/why-astro/#content-driven), like documentation sites. 
