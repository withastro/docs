...
When part of a [content collection](/en/guides/content-collections/), you will [generate pages dynamically](/en/guides/working-with-collections/#generating-routes-from-content) from your content entries.
