...
When part of a [content collection](/en/guides/content-collections/), you will [generate pages dynamically](/en/guides/collection-queries/#generating-routes-from-content) from your content entries.
