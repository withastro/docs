...
- `gatsby-ssr.js`: If you choose to use on-demand rendering in Astro, you will [add and configure an adapter](/en/guides/server-side-rendering/) of your choice directly in `astro.config.mjs`.
