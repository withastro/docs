...
<CardGrid>
  ...
  <LinkCard title="Moving an 8-year-old WordPress site without losing a single URL" href="https://synapsereality.io/wordpress-site-migration-without-losing-a-url/" />
</CardGrid>
