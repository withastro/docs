...
- Astro uses file-based routing, and [allows specially named pages to create dynamic routes](/en/basics/routing/#dynamic-routes).
...
4. Decide whether any imported components also need to be converted to Astro. With the official integration installed, you can [use existing React components in your Astro file](/en/basics/framework-components/). But, you may want to convert them to `.astro` components, especially if they do not need to be interactive!
