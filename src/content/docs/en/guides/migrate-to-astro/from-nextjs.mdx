...
See more about [local files imports with `import.meta.glob()`](https://vitejs.dev/guide/features.html#glob-import), [querying using the Collections API](/en/guides/collection-queries/#querying-collections) or [fetching remote data](/en/guides/data-fetching/).
