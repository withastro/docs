...
Astro's [React integration](/en/guides/integrations-guide/react/) provides support for using React components inside Astro components, including entire React apps like Create React App!
...
- [Content-first](/en/concepts/why-astro/): Astro was designed for content-focused sites that opt-in to interactivity only as they need them. An existing Create React App app might be built for high client-side interactivity and may require advanced Astro techniques to include items that are more challenging to replicate using `.astro` components, such as dashboards.
