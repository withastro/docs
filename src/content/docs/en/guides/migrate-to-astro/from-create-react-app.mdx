...
- [Content-first](/en/concepts/why-astro/): Astro was designed to showcase your content and to allow you to opt-in to interactivity only as needed. An existing Create React App app might be built for high client-side interactivity and may require advanced Astro techniques to include items that are more challenging to replicate using `.astro` components, such as dashboards.
...
After [adding your existing app to Astro](#add-your-create-react-app-to-astro), you will probably want to convert your app itself to Astro! 
