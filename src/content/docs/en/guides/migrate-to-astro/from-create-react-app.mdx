...
Astro's [React integration](/en/guides/integrations-guide/react/) provides support for [using React components inside Astro components](/en/basics/framework-components/), including entire React apps like Create React App (CRA)!
