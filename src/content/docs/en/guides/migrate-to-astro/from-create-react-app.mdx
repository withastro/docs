...
Astro's [React integration](/en/guides/integrations-guide/react/) supports using React components inside Astro components, including entire React apps like Create React App!
