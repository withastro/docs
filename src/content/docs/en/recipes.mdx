...
- [Astro Setup: Svelte, Tailwind CSS, Vercel, Prettier and TypeScript](https://straffesites.com/en/blog/astro-setup-svelte-tailwindcss-vercel-prettier-typescript)
