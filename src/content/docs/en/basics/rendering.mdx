...
Both of Astro's rendering modes allow you to prerender and to render on demand in the same project. The only difference is which kind of rendering happens by default.
