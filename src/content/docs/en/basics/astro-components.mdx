...
When your Astro component does need client-side interactivity, you can add [standard HTML `<script>` tags](/en/guides/client-side-scripts/) or [UI Framework components](/en/basics/framework-components/#hydrating-interactive-components).
...
:::tip
Named slots can also be passed to [UI framework components](/en/basics/framework-components/)!
:::
...
<ReadMore>Read more about using [UI framework components](/en/basics/framework-components/) in your Astro project.</ReadMore>
