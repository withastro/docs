...
1. **Does Astro use JSX?**
    ...
    No. The Astro component templating language is a superset of HTML. The syntax for writing dynamic HTML is similar to JSX, but it is not identical. ([overview](#_top))
