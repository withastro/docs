...
Page layouts are especially useful for [individual Markdown pages](/en/guides/markdown-content/#individual-markdown-pages) which otherwise would not have any page formatting. 
...
:::note
A Markdown layout will have access to all its file's [available properties](/en/guides/markdown-content/#available-properties) from `Astro.props` **with two key differences:**
