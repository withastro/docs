...
<CardGrid>
  <SplitCard title="Start a new project with the CLI tool" icon="rocket">
     <Tabs>
      <TabItem label="npm">
      ```shell
  ...
  <Card title="Start from a theme" icon="laptop">
    Begin your project [using any existing theme or starter template](#use-a-theme-or-starter-template).
  </Card>

  <Card title="Install manually" icon="star">
