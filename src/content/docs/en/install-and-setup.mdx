...
Astro is built with Vite, meaning it targets browsers with modern JavaScript support by default. For reference, you can see the [list of currently supported browser versions in Vite](https://vitejs.dev/guide/build.html#browser-compatibility).
