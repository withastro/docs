...
1. Run the following command in your terminal to start the install wizard:
    ...
    <PackageManagerTabs>
      ...
      ```
       ...
       To use a template or theme, substitute the official Astro starter template name, or the GitHub username and repository of any theme or template you want to use:
