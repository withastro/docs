...
[Stylelint](https://stylelint.io/) is a popular linter for CSS. [A community maintained configuration]([stylelint-config-html](https://github.com/ota-meshi/stylelint-config-html)) provides Astro support. 

Installation instructions, editor integration, and additional information can be found in the plugin's [README.](https://github.com/gucong3000/postcss-html)
