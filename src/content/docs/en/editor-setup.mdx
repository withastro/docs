...
- Emacs <span style="margin: 0.25em;"><Badge variant="neutral">Community</Badge></span> - [See instructions](https://medium.com/@jrmjrm/configuring-emacs-and-eglot-to-work-with-astro-language-server-9408eb709ab0) for Configuring Emacs and Eglot to work with Astro
