...
[Zed](https://zed.dev/) is a high-performance, multiplayer code editor code editor from the creators of [Atom](https://atom-editor.cc/) and [Tree-sitter](https://tree-sitter.github.io/tree-sitter/). It's optimized for speed and large projects, making it a great fit for Astro workflows. 

Install the [Astro extension](https://zed.dev/extensions/astro) to unlock key features like syntax highlighting for `.astro` files, code completion, formatting, diagnostics, and go-to-definition.
