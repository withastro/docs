...
Since version 2024.2, [Webstorm supports the Astro Language Server Protocol](https://blog.jetbrains.com/webstorm/2024/08/webstorm-2024-2/#astro-language-server-enabled-by-default), leading to improved code completion, better eveloper experience, and fixing several known issues. 
