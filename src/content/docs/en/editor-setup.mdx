...
[Stylelint](https://stylelint.io/) is a popular linter for CSS. [A community maintained configuration](https://github.com/ota-meshi/stylelint-config-html) provides Astro support. 

Installation instructions, editor integration, and additional information can be found in the project's [README.](https://github.com/ota-meshi/stylelint-config-html#cd-installation)
