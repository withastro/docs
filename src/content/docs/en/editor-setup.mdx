...
[Zed](https://zed.dev/) is a newly open sourced code editor that added built-in language support for Astro in version 0.123.2. It includes syntax highlighting, code completion, and formatting.
