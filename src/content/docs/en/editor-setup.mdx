...
Initial support for Astro landed in WebStorm 2023.1. You can install the official plugin through [JetBrains Marketplace](https://plugins.jetbrains.com/plugin/20959-astro) or by searching for "Astro" in the IDE's Plugins tab. This plugin includes features like syntax highlighting, code completion, and formatting. 

Since version 2024.2, [Webstorm supports the Astro Language Server Protocol](https://blog.jetbrains.com/webstorm/2024/08/webstorm-2024-2/#astro-language-server-enabled-by-default), leading to improved code completion, better developer experience, and fixing several known issues. 
