...
- [Astro syntax highlighting for Sublime Text](https://packagecontrol.io/packages/Astro) <span style="margin: 0.25em;"><Badge variant="accent">Official</Badge></span> - The official package for Sublime Text, available on the Sublime Text package manager.
