...
[Zed](https://zed.dev/) is an high-performance and open-source code editor. You can install the [Astro extension](https://github.com/zed-extensions/astro) in the IDE's Extensions tab. This extension includes features like syntax highlighting, code completion, and formatting.
