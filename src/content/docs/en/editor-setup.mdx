...
[Zed](https://zed.dev/) is a newly open sourced code editor that added support for Astro in version 0.123.2. You can install the [Astro extension](https://github.com/zed-industries/zed/tree/main/extensions/astro) in the IDE's Plugin tab. This plugin includes syntax highlighting, code completion, and formatting.
