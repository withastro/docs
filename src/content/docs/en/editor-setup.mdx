...
Installation instructions, editor integration, and additional information can be found in the plugin's [README.](https://github.com/ota-meshi/stylelint-config-html#cd-installation)
