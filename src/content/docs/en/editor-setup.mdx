...
If you want to use Prettier without Astro’s language server, for example to run [Prettier’s CLI](https://prettier.io/docs/en/cli.html), you can add support for formatting `.astro` files with [the official Astro Prettier plugin](https://github.com/withastro/prettier-plugin-astro).
