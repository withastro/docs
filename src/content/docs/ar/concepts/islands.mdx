...
**جزر أسترو** (المعروفة أيضا باسم جزر المكونات) هي معمارية ويب ابتكرتها أسترو. تمت صياغة فكرة “هندسة الجزر” لأول مرة من قبل مهندسة الواجهات [Katie Sylor-Miller](https://twitter.com/ksylor) في عام 2019، وتوسعت في [هذا المنشور](https://jasonformat.com/islands-architecture/) من قبل Jason Miller
 منشئ Preact.
...
معمارية الجزر مبنية على ما يُعرف بـ (**partial**, **selective hydration**) أو **الترطيب الجزئي** وفيها يُصير المكون على الخادوم كـ HTML ثم يرسل محتواه أولا إلى المتصفح، يتلوها إرسال الخادوم شفرة جافاسكربت للمكون إلى المتصفح ليصير المكون تفاعلي. يستفيد استرو من هذه التقنية تحت الكواليس، ليشغل الجزر تلقائيا.
