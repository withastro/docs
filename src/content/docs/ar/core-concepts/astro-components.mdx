---
title: مكونات الويب
description: مقدمة الى بناء مكونات الويب في .astro 
i18nReady: true
---

**مكونات ويب أسترو** هي اللبنات الأساسية لأي مشروع أسترو. إنها مكونات قوالب HTML فقط بلا وقت تشغيل من جانب العميل. يمكنك التعرف على مكون ويب أسترو عن طريق إمتداد الملف: `.astro`
...
مكونات ويب أسترو مرنة للغاية. غالبًا ما تحتوي مكونات ويب أسترو على بعض من **واجهة المستخدم القابلة لإعادة الإستخدام**،
