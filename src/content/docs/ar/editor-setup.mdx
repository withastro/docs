...
[Prettier](https://prettier.io/) هو [منسق](https://ar.wikipedia.org/wiki/برتي_برنت) شائع لأكواد JavaScript, HTML, CSS وغيرها. إذا كنت تستخدم [اضافة استرو لـ VS Code](https://marketplace.visualstudio.com/items?itemName=astro-build.astro-vscode) أو [اضافة استرو للمحررات الأخرى](#محررات-برمجية-أخرى), فستجدها تتضمن تنسيق الكود بـ Prettier.
