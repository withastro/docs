...
[أمر `create astro` عبر CLI](#install-from-the-cli-wizard) هو أسرع طريقة لبدء مشروع Astro جديد من الصفر. سيرشدك خلال كل خطوة من خطوات إعداد مشروع Astro الجديد ويتيح لك الاختيار من بين عدة قوالب ابتدائية رسمية مختلفة.
...
يمكنك بدء مشروع Astro جديد وتثبيت أي [رسمية integrations](/ar/guides/integrations/) أو integrations مجتمعية تدعم أمر `astro add` في نفس الوقت عن طريق تمرير الوسيط `--add` إلى أمر `create astro`.
...
5. إنشاء `astro.config.mjs`
    ...
    إذا كنت تريد تضمين [UI framework components](/ar/guides/framework-components/) مثل React أو Svelte وما إلى ذلك، أو استخدام أدوات أخرى مثل MDX أو Partytown في مشروعك، فهنا ستقوم [باستيراد وتكوين integrations يدويًا](/ar/guides/integrations/).

    <ReadMore>اطلع على [مرجع تكوين API الخاص بـ Astro](/ar/reference/configuration-reference/) لمزيد من المعلومات.</ReadMore>
...
6. إضافة دعامة TypeScript
    ...
    <ReadMore>اطلع على [دليل إعداد TypeScript الخاص بـ Astro](/ar/guides/typescript/#setup) لمزيد من المعلومات.</ReadMore>
