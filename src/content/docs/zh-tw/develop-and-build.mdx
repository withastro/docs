...
要修改專案，請在程式碼編輯器上開啟專案資料夾。To make changes to your project, open your project folder in your code editor. Working in development mode with the dev server running allows you to see updates to your site as you edit the code.
