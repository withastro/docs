...
在許多網頁框架中，開發時很容易可以建立出一個看起來很棒的網站，但在部署後載入速度會非常慢。JavaScript 通常是罪魁禍首，因為使用者的手機或低功耗設備鮮少能和開發者的筆電速度相比。
...
與最受歡迎的 React web 框架相比，當建立出相同的網站時，Astro 網站可以有 [40% 快的載入速度並減少使用了 90% 的 JavaScript](https://twitter.com/t3dotgg/status/1437195415439360003)。但請對我們的說法存疑：歡迎觀看 Astro 的性能讓 Ryan Carniato（Solid.js 及 Marko 的創造者）[啞口無言](https://youtu.be/2ZEMb_H-LYE?t=8163)。
