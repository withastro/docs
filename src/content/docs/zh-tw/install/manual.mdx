...
如果你想要引入像是 React, Svelte 等 [UI framework components](/zh-tw/basics/framework-components/) 或使用其它工具像是 Tailwind 或 Partytown 到你的專案中，在這裡你可以[手動引入並配置整合](/zh-tw/guides/integrations-guide/)。
