...
- 使用你現有的 [Markdown/MDX 檔案](/zh-tw/guides/markdown-content/)，搭配支援外掛且[可設定的 Markdown 處理器](/zh-tw/guides/markdown-content/#markdown-processors)。
...
- 使用 [Astro 群島](/zh-tw/concepts/islands/#什麼是群島)設計以避免向瀏覽器發送不必要的 JavaScript。
