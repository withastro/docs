...
3. 建構網站並部署到服務主機
    ...
    其他服務主機則會要求你先[在本地端建構你的網站](#building-your-site-locally)，接著用命令列部署。

## 在本地端建構你的網站 \{#building-your-site-locally\}
...
## 為 SSR 新增配接器 \{#adding-an-adapter-for-ssr\}

:::note
以 [SSR（伺服器端算繪）](/zh-tw/guides/server-side-rendering/)部署 Astro 網站之前，請先確定以下事項：
