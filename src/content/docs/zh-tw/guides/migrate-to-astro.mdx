...
## 為什麼將您的網站遷移到 Astro？ \{#why-migrate-your-site-to-astro\}
...
## 我可以將哪些專案轉換為 Astro？ \{#which-projects-can-i-convert-to-astro\}
...
## 從何改變我的專案設計？ \{#how-will-my-project-design-change\}

根據您現有的專案，您可能需要從不同方面進行思考：

- 使用 [Astro 群島](/zh-tw/concepts/islands/#what-is-an-island) 設計以避免向瀏覽器發送不必要的 JavaScript。
