...
- 在 Astro 中直接使用您現有的 [UI 框架元件](/zh-tw/basics/framework-components/)。
...
- 使用 [客戶端 `<script>` 標籤](/zh-tw/guides/client-side-scripts/) 或 [UI 框架元件](/zh-tw/basics/framework-components/) 提供客戶端互動性。

- 使用 Nano Stores 或 local storage 管理 [共用狀態](/zh-tw/basics/sharing-state/)，而不是全局 hooks 或包裝類別。
