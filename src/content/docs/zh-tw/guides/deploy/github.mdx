...
你可以使用 [GitHub Pages](https://pages.github.com/) 透過 [GitHub Actions](https://github.com/features/actions) 直接從 [GitHub.com](https://github.com/) 的儲存庫架設靜態、預先算繪的 Astro 網站。
        ...
        steps:
          ...
          - name: Install, build, and upload your site
            ...
            # with:
              ...
              # node-version: 24 # 用於建置網站的特定 Node.js 版本，預設為 24。（可選）
...
4. 在 GitHub 網站上，請切換到儲存庫中的 **Settings** 分頁，並找到設定的 **Pages** 部分。
