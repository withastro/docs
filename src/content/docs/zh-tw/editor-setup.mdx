...
[Zed](https://zed.dev/) 是開源的程式編輯器，從 0.123.2 版本開始新增對 Astro 的支援。你可以在延伸模組 標籤安裝 [Astro 延伸模組](https://github.com/zed-industries/zed/tree/main/extensions/astro)。這個延伸模組包括語法突顯、程式碼自動完成和格式化等功能。
