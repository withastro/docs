...
- [前端 components （React 等）](/zh-tw/basics/framework-components/)
...
**Components** 是你 HTML 網頁中可重複使用的元件程式碼。這些元件可以是 [Astro components](/zh-tw/basics/astro-components/) 或是 [前端 components](/zh-tw/basics/framework-components/) 如 React 或 Vue。一般來說會在這個資料夾中組合和組織你專案所有的 components。
