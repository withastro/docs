export const SIDEBAR = {
	en: [
		...
		{ text: 'Island Architecture', link: 'en/core-concepts/partial-hydration' },
		...
		{ text: 'Astro Integration API', link: 'en/reference/renderer-reference' },
		{ text: 'Astro Runtime API', link: 'en/reference/api-reference' },
		{ text: 'Astro Component Syntax', link: 'en/guides/markdown-content' },
		{ text: 'Markdown Syntax', link: 'en/guides/markdown-content' },
