export default [
	{ text: 'التهيئة', header: true, type: 'learn', key: 'startHere' },
	{ text: 'ابدأ', slug: 'getting-started', key: 'getting-started' },
	{ text: 'Installation', slug: 'install/auto', key: 'install' },
	{ text: 'إعداد البيئة البرمجية', slug: 'editor-setup', key: 'editor-setup' },
	{ text: 'Upgrade to v2', slug: 'guides/upgrade-to/v2', key: 'guides/upgrade-to/v2' },

	{ text: 'المفاهيم اﻷساسية', header: true, type: 'learn', key: 'coreConcepts' },
	{ text: 'لماذا استرو؟', slug: 'concepts/why-astro', key: 'concepts/why-astro' },
	{ text: 'معمارية الصفحة الواحدة مقابل الصفحات المتعددة', slug: 'concepts/mpa-vs-spa', key: 'concepts/mpa-vs-spa' },
	{ text: 'جزر استرو', slug: 'concepts/islands', key: 'concepts/islands' },
