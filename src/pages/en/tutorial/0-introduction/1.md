...
1. Create a free account at [StackBlitz](https://stackblitz.com). This site will provide you with a **code editor** (an alternative to locally-installed software like VSCode) where you will edit your files and a **terminal pane** for running server commands.

<!-- 2. Visit [astro.new](https://astro.new) and click to open the "Completely Empty" project in the editor of your choice.  "Fork" the project to save it to your own account. -->
