...
<PreCheck>
  ...
  - create the necessary online accounts to deploy your site to the web
</PreCheck>

## Background Knowledge 

This tutorial is designed to be accessible to new web developers, as well as devs who are simply new to Astro. 

It assumes some basic familiarity with **HTML**, **Markdown**, **CSS**, and a little **JavaScript**. But, you will be able to learn everything you need to know by following the tutorial itself.
