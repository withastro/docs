...
Astro has several official _____________ that can be installed via the terminal command line to extend a project. To access the command line in my code editor, I can quit the __________ by pressing `CTRL-C`. Then, I can type the appropriate ___________ command for any Astro package and follow the instructions.

To begin working on my website again, I can type _____________________ like I do every time I start a new working session.
