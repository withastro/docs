...
1. Copy the `<div class="tags">`... `</div>` from `src/pages/tags/index.astro` and reuse it inside `MarkdownLayoutPost.astro`: 

```astro title="src/layouts/MarkdownPostLayout.astro" ins={14-18}
---
