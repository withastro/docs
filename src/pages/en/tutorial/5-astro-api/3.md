...
<Goals>
  - added a new page using the `/tags/index.astro` routing pattern
  - displayed a list of all your tags, linking to each tag page
...
- The entire contents of `<style>`...`</style>`

- Past `<div class="tags">`... `</div>` just above the `<slot />`.
...
--- 
<BaseLayout t edititle={frontmatter.title}>
