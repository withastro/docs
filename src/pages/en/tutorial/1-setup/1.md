...
**Follow the steps below,then skip all the way down to ["Before You Go"](#before-you-go)**: 
1. Visit StackBlitz.com and log in.
2. Visit [astro.new](https://astro.new) and click the button to open the "Empty Project" template in StackBlitz. This will take you to StackBlitz.
3. On the StackBlitz page, click the button to "fork" the template (save to your own account dashboard).
4. Wait for the project to load, and you will see a live preview of the "Empty Project."
:::
