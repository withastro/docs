...
1. Astro files can use these alongside Astro components in their template:
  <MultipleChoice>
    <Option>
      reusable
    </Option>
...
3. Astro components give you fragments of HTML that are:
  <MultipleChoice>
    <Option isCorrect>
      reusable
    </Option>
...
4. Unless you want to make a new page on your site, don't put your components here:
  <MultipleChoice>
    <Option>
      reusable
    </Option>
