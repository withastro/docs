...
<Goals>
  - defined variables in frontmatter script, and then used them in the HTML template
  - written a combination of static and dynamic HTML 
  - conditionally displayed HTML elements
</Goals>

Any HTML file is valid Astro language. But, you can do more with Astro than just regular HTML!

<!-- An `.astro` file also has a section at the top for **frontmatter script**. This script area is for writing JavaScript (TypeScript) and allows you to add **dynamic** HTML content to your page template. This is content that depends on and is determined by **values defined elsewhere**, not static text typed directly into your HTML element. -->
