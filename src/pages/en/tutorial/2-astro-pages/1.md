...
The content you can see on your about page is determined by the HTML elements **between `<body></body>`**. For the rest of this page, you will only modify the HTML between these `<body></body>` tags. You will leave the other code untouched.
...
```astro title="src/pages/about.astro" ins={3-7}
<body>
  <h1>About Me</h1>
...
```astro title="src/pages/blog.astro" ins={4}
<body>
  <a href="/">Home</a>
  <a href="/about/">About</a>
  <a href="/blog/">Blog</a>
