...
3. Remove the `setup:` property from your frontmatter, and write its [ECMAScript Module](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/import) import statements below the frontmatter.
