...
### Changed: Building chunks ???? 

Astro 2.0 moves the location of all build output assets to a new `_astro/` folder (configurable using the `build.assets` option). Previously, these assets would end up in various places.
