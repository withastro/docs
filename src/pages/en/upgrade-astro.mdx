...
3. Check that you are running **at least Node `16.12.0`**. In v2.0, Astro dropped support for Node `14`:
  ...
  If necessary, follow the instructions to [install Node.js](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm) via the command line.
...
- **a redesign of Markdown and MDX plugin configuration**
  ...
  Using plugins in [Markdown](#changed-markdown-plugin-configuration) and [MDX](#changed-mdx-plugin-configuration)? Covert to our simplified options!
...
- **three experimental flags into the codebase**
