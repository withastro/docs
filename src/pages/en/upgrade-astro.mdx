...
- **Vite 4**
  ...
  Astro should handle everything under the hood!

- **the removal of several previously-deprecated flags**

  Using one of the config options called out below? That's got to go!

- **a new, unified location for your built assets**

  Have some deploy config that depends on chunks? See below!

- **a redesign of Markdown and MDX plugin configuration**

  Using plugins in Markdown and MDX? See our simplified setup!

- **a new, reserved folder `src/content/` for our new Collections API**

  If you had your own folder called `src/content/`, we'd like a word with you!

- **three experimental flags into the codebase**

  You don't need these flags to get the goodies. Open to everyone now!
