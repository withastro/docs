...
- **a new, reserved folder `src/content/` for the new Collections API**
  ...
  Have [your own folder called `src/content/`](#reserved-srccontent)? Rename it to avoid conflicts!
...
You might have some work to do to fully upgrade your project, and [you might see Houston](#error-overlay) a few times before you're done! 
