...
:::tip[astro v2 is here]
Read the [announcement blog post](https://astro.build/blog/) and see how to [upgrade from v1](/en/guides/upgrade-to/v2/).
:::
...
[Astro Migration guide](/en/upgrade-astro/)
