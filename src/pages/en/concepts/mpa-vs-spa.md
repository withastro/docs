...
:::note[Accessibility]
MPAs use the standard `<a>` element for navigation. This provides important accessibility features such managing focus states and announcing route changes by default.
:::
