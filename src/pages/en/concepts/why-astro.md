...
:::tip
If your project falls into the second "application" camp, Astro might not be the right choice for your project... **and that's okay!** Check out other alternatives like [Remix](https://remix.run/), [SvelteKit](https://kit.svelte.dev), [Next.js](https://nextjs.org/), [NuxtJS](https://nuxtjs.org/), [RedwoodJS](https://redwoodjs.com/), or another web application framework.
:::
