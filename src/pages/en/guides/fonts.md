...
3. Import the font package in the layout or component where you want to use the font. This will automatically add the necessary `@font-face` rules needed to set up the font.
