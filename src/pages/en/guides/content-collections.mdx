...
These commands will also generate a [reference path](https://www.typescriptlang.org/docs/handbook/triple-slash-directives.html#-reference-path-) to include `.astro` types in your project. This will be added to your project's [`src/env.d.ts` file](/en/guides/typescript/#setup), or write the file automatically if none exists.
