...
By default, Astro's MDX integration inherits all Markdown configuration from your Astro config `markdown` options. To change this behavior, configure [`extendMarkdownConfig`](/en/guides/integrations-guide/mdx/#extendmarkdownconfig) in your `mdx` integration.
