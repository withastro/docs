...
Metadata are then available to the layout through `Astro.props`. For example, you can access frontmatter properties through `Astro.props.frontmatter`:
...
[See all properties](/en/core-concepts/layouts/#markdown-layout-props) available through `Astro.props` in a Markdown layout.
