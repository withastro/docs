...
If you were using `extendDefaultPlugins: false`, opt out of the defaults by setting the [new `gfm` and `smartypants` options](#added-gfm-and-smartypants) to `false` in your config.
