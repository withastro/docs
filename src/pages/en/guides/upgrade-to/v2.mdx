...
Node 14 is scheduled to reach its End of Life in April 2023. Astro 2.0 drops Node 14 support entirely, so that all Astro users can take advantage of Node's more modern features.

#### What should I do?

Astro 2.0 requires Node.js 16.12.0 or later. Both your development environment and your deployment environment must now meet this minimum standard.
...
Delete `extendPlugins: 'markdown'` in your configuration. MDX options will default to their equivalent in your Markdown config by default. 
