...
Additionaly it is also possible to attach headers to HTTP responses from your Deployments. 

📚 Learn more about Vercel’s [Project config](https://vercel.com/docs/project-configuration)
