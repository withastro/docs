...
:::note[notes]
Keep in mind you might need to change `node:lts` to a pinned version, if you're using another package manager than `npm`, you might need to install it and change the scripts.
:::
...
These are just examples of Dockerfiles. You can customize them to your needs. For example, using `node:lts-alpine`
:::
