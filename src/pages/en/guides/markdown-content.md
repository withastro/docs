...
#### How to access `VFile.data` generated by plugins

If a plugin adds anything on [`VFile.data`](https://github.com/vfile/vfile#filedata=), Astro will merge it into the `MarkdownMetadata` object.

Say, you've used [rehype-infer-reading-time-meta](https://github.com/rehypejs/rehype-infer-reading-time-meta) plugin, then you can access `meta.readingTime` property generated by the plugin in your page as follows.
...
const readingTime = (await page.default()).metadata.meta.readingTime
```
