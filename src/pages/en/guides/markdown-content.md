...
Any Astro component (not just layouts!) can receive the values defined in your Markdown or MDX frontmatter as props. You can specify several types of data using YAML frontmatter, and capture even richer meta information from each blog post to use throughout your Astro site.

Access and use these values in any `.astro` file as you would in a layout.
