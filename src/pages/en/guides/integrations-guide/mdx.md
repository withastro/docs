...
You can set a layout’s [`Props` type](https://github.com/withastro/astro/tree/main/packages/integrations/mdx/en/guides/typescript/#component-props) with the `MDXLayoutProps` helper.
...
All [exported properties](https://github.com/withastro/astro/tree/main/packages/integrations/mdx/#exported-properties) are available from `Astro.props` in your layout, **with two key differences:**
