...
Astro does not have a `permalink` property that accepts placeholders. You may need to read more about [Astro's page routing](/en/core-concepts/routing/), or [configuring Markdown](/en/guides/markdown-content/#configuring-markdown-and-mdx) if you want to keep your existing URL structure. Or, consider [setting redirects at your host, like Netlify](https://docs.netlify.com/routing/redirects/).
