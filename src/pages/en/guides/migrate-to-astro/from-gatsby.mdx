...
See [examples from Gatsby's Blog starter template converted step-by-step](#guided-examples-see-the-steps).
...
3. Add any needed JavaScript, props, imports.
  ...
  ```astro title="src/layouts/Layout.astro" ins={2-3, 15, 16, 20, 24} "class" "<a" "</a>" "<slot />"
  ---
