...
Each project migration will look different, but there are some common steps  to follow when converting from Next.js to Astro. This page will get you started in the right direction.
...
You may also need to replace any [CSS-in-JS libraries](https://github.com/withastro/astro/issues/4432) (e.g. styled-components) with other available CSS options in Astro.
