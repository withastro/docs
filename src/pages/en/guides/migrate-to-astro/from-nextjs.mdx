...
- [Content-focus](/en/concepts/why-astro/): Astro was designed primarily for [content-focused websites](/en/concepts/why-astro/#content-focused). An existing Next.js app might be built for high client-side interactivity and may include items that are difficult to replicate in Astro, such as dashboards.
