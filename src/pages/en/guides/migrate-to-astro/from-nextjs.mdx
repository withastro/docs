...
- Both Next.js and Astro are modern Javascript static-site generators. Both use a `src/` folder for your project files and a [special folder for file-based routing](/en/core-concepts/astro-pages/). Creating and managing pages for your site should feel familiar.
