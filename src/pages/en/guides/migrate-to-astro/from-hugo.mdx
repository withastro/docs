...
- Hugo uses Go for page templating. [Astro syntax](/en/core-concepts/astro-components/) is a JSX-like superset of HTML.
...
- Astro does not use shortcodes for dynamic content in standard Markdown files, but [Astro's Markdown integration](/en/guides/integrations-guide/mdx/) does allow you to use JSX and import components in MDX files.
