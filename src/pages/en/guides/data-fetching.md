...
Your deployed Astro site will fetch data **once, at build time**. In dev, you will see data fetches on component refreshes. If you need to re-fetch data multiple times client-side, use a [framework component](/en/core-concepts/framework-components) or vanilla JS in a `<script>` tag. As-well as, importing from a seperate JS file also known as (Loading External Scripts)[https://docs.astro.build/en/core-concepts/astro-components/]. 
