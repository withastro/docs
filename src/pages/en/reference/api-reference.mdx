...
- `remarkPluginFrontmatter ` - The [modified frontmatter object](/en/guides/markdown-content/#modifying-frontmatter-programmatically) applied via remark or rehype plugins. Set to type `any`.
