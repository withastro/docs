...
A callback function to inject routes into an Astro project. Injected routes can be [`.astro` pages](/en/core-concepts/astro-pages/) or [`.js` route handlers](/en/core-concepts/astro-pages/#non-html-pages).
