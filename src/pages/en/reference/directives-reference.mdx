...
A client directive must be placed on an imported component (i.e., not a [dynamic](/en/core-concepts/astro-components/#dynamic-tags) or [passed](/en/guides/markdown-content/#custom-components-with-imported-mdx) component).
