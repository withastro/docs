...
### MDXの執筆
MDXインテグレーションをプロジェクトに追加すると、JavaScriptの式やカスタムコンポーネントをMarkdownに含める`.mdx`ファイルを使用してコンテンツを記述できます。このファイル形式では、静的な[Astroコンポーネント](/ja/core-concepts/astro-components/)とインタラクティブな[フレームワークコンポーネント](/ja/core-concepts/framework-components/)の両方を含むカスタムコンポーネントやJavaScriptの式をMarkdownに含むことができます。バナーやインタラクティブなカルーセルなどのUI要素をテキスト内に追加して、コンテンツを本格的なウェブページにできます。
