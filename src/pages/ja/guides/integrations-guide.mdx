...
- React、Vue、Svelte、Solidなどの一般的な UI フレームワークを使用できます。
...
:::caution
ファイルを更新する前に必ず確認があり  ますが、念のためバージョン管理されたバックアップを用意しておくに越したことはないでしょう。
:::
...
Falsyなインテグレーションは無視されるため、`undefined`や真偽値が設定されてしまうことを気にすることなく、インテグレーションのオンとオフを切り替えることができます。
...
[インテグレーションAPI](/ja/reference/integrations-reference/)を確認し、インテグレーションができること、自分で作成する方法について学んでみてください。
