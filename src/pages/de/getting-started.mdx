...
**Was gibt es neues in Astro v2?** [Erfahren es im Ankündigungs-Blogpost](https://astro.build/blog/astro-2/).  
**Bereit fürs upgrade?** [Folge unserer Upgrade-Anleitung](/en/guides/upgrade-to/v2/).
:::
