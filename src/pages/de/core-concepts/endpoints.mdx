...
Zusätzlich zu der `get`-Funktion kannst Du Funktionen mit den Namen aller möglichenn [HTTP-Methoden](https://developer.mozilla.org/en-US/docs/Web/HTTP/Methods) exportieren. Wenn eine Anfrage ankommt, wird Astro die Methode prüfen und die entsprechende Funktion aufrufen.
