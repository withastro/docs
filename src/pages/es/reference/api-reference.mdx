...
- `remarkPluginFrontmatter` - El objeto frontmatter moficado después de cualquier [plugin remark o rehype ha sido aplicado](/es/guides/markdown-content/#modificación-programática-de-frontmatter). Configurado para el tipo `any`.
