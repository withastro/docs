...
Un slug listo para usar en una URL. Por defecto es el `id` sin la extensión de archivo, pero puede ser descartado por ajustes [la propiedad del slug](/es/guides/content-collections/#defining-custom-slugs) en el frontmatter del archivo
