...
La ruta base en la que se desplegará. Astro compilará tus páginas y recursos usando esta ruta como la raiz. En este momento, esto no tiene efecto durante el desarrollo.
