...
Nuestra [guía de instalación](/es/install/auto/) iene instrucciones completas y paso a paso para instalar Astro usando nuestro asistente CLI, crear un nuevo proyecto desde un repositorio Astro GitHub existente y para instalar Astro manualmente.
