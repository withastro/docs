...
Un archivo puede generar múltiples páginas usando [enrutamiento dinámico](/es/core-concepts/routing/#enrutamiento-dinámico). Esto te permite crear páginas incluso si tu contenido está fuera del directorio especial `/pages/`, como en una [colección de contenido](/es/guides/content-collections/#rendering-entry-content) o un [CMS](/es/guides/cms/).
...
[Las colecciones de contenido de página Markdown o MDX](/es/guides/content-collections/) en `src/content/` pueden ser usadas para [generar páginas dinámicamente](/es/core-concepts/routing/#enrutamiento-dinámico).
