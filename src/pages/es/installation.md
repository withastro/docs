...
El asistente de instalación [`create-astro`](https://github.com/withastro/astro/tree/main/packages/create-astro), te permite escoger de una lista de [plantillas de inicio](/docs/en/themes); por otro lado, puedes importar tus propios proyectos de Astro directamente desde GitHub.
