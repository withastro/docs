...
Esta guía te guíara paso a paso para instalar manualmentey configurar un nuevo proyecto Astro si prefieres no usar la [la herramienta CLI automática](/es/install/auto/).
