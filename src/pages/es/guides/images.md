...
La integración oficial de Astro proporciona dos componentes de Astro diferentes para renderizar imágenes optimizadas: `<Image />` y `<Picture />`. Tiene soporte para todos los sitios estáticos y para [algunos hosts de server-side-rendering](/es/guides/integrations-guide/image/#installation)
