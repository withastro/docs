...
Cualquier método de estilo de Astro está disponible para un [componente de diseño de Markdown](/es/core-concepts/layouts/#plantillas-de-markdownmdx).

You can apply global styles to your Markdown content by adding [`<style>` tags](#estilos-globales) and [imported stylesheets](#estilos-externos) to the layout that wraps your page content. You can also add [CSS integrations](##integraciones-css) including [Tailwind](/es/guides/integrations-guide/tailwind/).
