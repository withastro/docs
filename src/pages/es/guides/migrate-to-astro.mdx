...
- [Componentes de framework](/es/core-concepts/framework-components/) directly in Astro. 

- [Hojas de estilo CSS o bibliotecas](/es/guides/styling/) including Tailwind.
...
- [Contenido de una CMS](/en/guides/cms/) a través de una integración o API.
...
- Diseño con [Islas de Astro](/es/concepts/islands/#qué-es-una-astro-island) para evitar enviar JavaScript innecesario al navegador.
