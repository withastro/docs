...
Cualquier archivo `.astro` dentro de `pages/` puede optar por el prerenderizado, o el comportamiento estático de construcción estándar, incluyendo la siguiente línea.
