...
También puedes usar el [helper de Vite `loadEnv`](https://main.vitejs.dev/config/#using-environment-variables-in-config) para manualmente cargar los archivos `.env`.
