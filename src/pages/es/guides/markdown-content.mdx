...
See more about using [content collections in Astro](/es/guides/content-collections/).
...
Puedes también [estilizar tu Markdown](/es/guides/styling/#estilando-markdown) en tu componente plantilla.
