...
Si tu has instalado un paquete de NPM, puedes importarlo en Astro.
...
Si un paquete fue publicado usando un formato antiguo, Astro convertirá el paquete a ESM para que las declaraciones `import` funcionen. En algunos casos, tu necesitarás ajustar tu [configuración de `vite`](/es/reference/configuration-reference/#vite) para que funcione.
