...
Puedes desplegar un sitio Astro usando [SST](https://sst.dev), un framework de código abierto para desplegar aplicaciones completamente sin servidor en AWS con soporte SSG y SSR.
...
### Constructos SST
Para usar cualquier [constructo SST adicional](https://docs.sst.dev/), añádelos a `sst.config.ts`. 
