...
### Configuración de proyecto con vercel.json

Tu puedes usar `vercel.json` para sobrescribir el comportamiento predeterminado de Vercel y para configurar ajustes adicionales. Por ejemplo, es posible que desees adjuntar encabezados a las respuestas HTTP de tus despliegues.

📚 Aprende más sobre la [configuración de proyecto de Vercel](https://vercel.com/docs/configuration).
