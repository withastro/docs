...
Los componentes Astro importados usando `Astro.glob()` son de tipo [`AstroInstance`](/es/reference/api-reference/#astro-files). Puedes renderizar cada instancia del componente usando su propiedad `default`:
