...
Astro 内置对 [TypeScript](https://www.typescriptlang.org/) 的支持。你可以在 Astro 项目中直接导入 `.ts` 和 `.tsx` 文件，甚至可以直接在 [Astro 组件脚本](/zh-cn/core-concepts/astro-components/#组件脚本)和任意 [hoisted script 标签](/zh-cn/core-concepts/astro-components/#客户端脚本) 中编写 TypeScript 代码。
