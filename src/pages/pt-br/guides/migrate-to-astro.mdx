...
- [Arquivos Markdown/MDX](/pt-br/guides/markdown-content/), configurados usando seus [plugins remark e rehype](/en/guides/markdown-content/#configuring-markdown-and-mdx).
