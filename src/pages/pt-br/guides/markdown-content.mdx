...
Astro aplica o plugin [GitHub-flavored Markdown](https://github.com/remarkjs/remark-gfm) por padrão. Ele trás algumas coisas legais como gerar links clicáveis a partir de texto.
