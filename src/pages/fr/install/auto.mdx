...
Vous pouvez exécuter `create astro` n'importe où sur votre machine, il n'est donc pas nécessaire de créer un nouveau répertoire vide pour votre projet avant de commencer. Si vous n'avez pas encore de répertoire vide pour votre nouveau projet, l'assistant créera automatiquement un pour vous.
...
Vous pouvez également démarrer un nouveau projet Astro basé sur un dépôt GitHub existant en passant un argument `--template` à la commande `create astro`.
