...
Les fragments peuvent également être utiles pour éviter d'utiliser des éléments englobants lors de l'ajout [de directives `set:*`](/fr/reference/directives-reference/#sethtml) , comme dans l'exemple suivant :
