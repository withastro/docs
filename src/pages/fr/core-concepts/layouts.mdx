...
Par exemple, une mise en page commune pour les articles de blog peut afficher un titre, une date et un auteur. Un composant de mise en page `BlogPostLayout.astro` pourrait ajouter cette UI à la page et aussi utiliser une mise en page plus générale pour gérer le reste de votre page.
