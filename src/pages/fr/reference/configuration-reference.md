...
Déployez-le sur votre serveur préféré, sans serveur ou hôte périphérique avec des adaptateurs de build. Importez l'un de nos adaptateurs pour [Netlify](/fr/guides/deploy/netlify/#adaptateur-pour-ssredge), [Vercel](/fr/guides/deploy/vercel/#adapter-for-ssr), et plus encore pour activer Astro SSR.
