...
Voir les [propriétés exportées vers un composant de mise en page Astro](/en/core-concepts/layouts/#markdown-layout-props) en utilisant la [mise en page spéciale d'Astro pour le frontmatter](#frontmatter-layout).
:::
