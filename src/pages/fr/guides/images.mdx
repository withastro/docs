...
Nous recommandons de garder vos images dans [`public/`](#public) ou de les stocker [à distance](#using-images-from-a-cms-or-cdn) si vous devez utiliser des fichiers Markdown.
