...
<!-- Image locale optimisée, gardant largeur, hauteur et format d'image originaux -->
...
Passez à l'attribut `src` du composant un chemin relatif au dossier publique et incluez une valeur pour `alt`.
...
<!-- Image distante (le ratio d'aspect est requis) -->
