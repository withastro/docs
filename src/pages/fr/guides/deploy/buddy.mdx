...
Vous pouvez déployer votre projet Astro en utilisant [Buddy](https://buddy.works/), une solution CI/CD qui peut construire votre site et le pousser vers de nombreuses cibles de déploiement différentes, y compris les serveurs FTP et les fournisseurs d'hébergement en nuage.
...
1. [Creér un compte](https://buddy.works/sign-up).
